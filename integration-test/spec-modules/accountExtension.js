...
exports.default = function (auth, client, accountExtension, account) {
  describe('AccountExtension:', function () {
    ...
    it("Should not load numbers when there isn't ReadExtensions permission", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
