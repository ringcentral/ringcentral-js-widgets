...
exports.default = function (auth, client, blockedNumber, account) {
  describe('BlockedNumber:', function () {
    ...
    it('Should load numbers when there is ReadBlockedNumbers permission', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    ...
    it("Should not load numbers when there isn't ReadBlockedNumbers permission", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
