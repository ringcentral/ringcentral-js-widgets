...
exports.default = function (auth, client, presence, account) {
  describe('Presence:', function () {
    ...
    it('Should load presenceStatus when there is ReadPresenceStatus permission', (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
    ...
    it("Should not load presenceStatus when there isn't ReadPresenceStatus permission", (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {
