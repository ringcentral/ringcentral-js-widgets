  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var Connect = function (_Component) {
      ...
      _createClass(Connect, [{
        ...
        value: function computeStateProps(store, props, phone) {
          if (!this.finalMapStateToProps) {
            return this.configureFinalMapState(store, props, phone);
          }

          var state = store.getState();
          var stateProps = this.doStatePropsDependOnOwnProps ? this.finalMapStateToProps(state, props, phone) : this.finalMapStateToProps(state, undefined, phone);
        ...
        value: function configureFinalMapState(store, props, phone) {
          var mappedState = mapState(store.getState(), props, phone);
          ...
          if (isFactory) {
            return this.computeStateProps(store, props, phone);
          }
        ...
        value: function updateStatePropsIfNeeded() {
          var nextStateProps = this.computeStateProps(this.store, this.props, this.phone);
