...
describe('<ActiveCall />', function () {
  it('count the duration', function (done) {
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_2.default, (0, _test.postProcess)(_test3.default['ActiveCall.react.js'])));
  ...
  it('can bye when click right button of call footer', function () {
    ...
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, _extends({}, (0, _test.postProcess)(_test3.default['ActiveCall.react.js']), {
      bye: onButtonClick
    })));
  ...
  it('can transfer', function () {
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, (0, _test.postProcess)(_test3.default['ActiveCall.react.js'])));
