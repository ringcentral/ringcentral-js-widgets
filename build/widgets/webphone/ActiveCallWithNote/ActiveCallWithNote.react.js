...
var _CallInfo = require('../CallInfo/CallInfo.react');
...
var _Closable = require('../Closable/Closable.react');

var _Closable2 = _interopRequireDefault(_Closable);

var _Note = require('../Note/Note.react');

var _Note2 = _interopRequireDefault(_Note);

var _ActiveCallWithNote = require('./ActiveCallWithNote.css');
    ...
    value: function render() {
      ...
      var content = function content() {
        return _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)(_ActiveCallWithNote.main, _ActiveCallWithNote.container) },
          _react2.default.createElement(_CallInfo2.default, _extends({}, _this3.props.callInfo, { duration: _this3.state.duration })),
          _react2.default.createElement(
            'select',
            { className: _ActiveCallWithNote.list },
            _react2.default.createElement(
              'option',
              null,
              'Contacts'
      ...
      return _react2.default.createElement(
        'div',
        { className: _ActiveCallWithNote.main },
        content()
      );
    }
  }]);
