...
/***/ function(module, exports, __webpack_require__) {
	...
	var _phone = __webpack_require__(63);
	...
	var origin = (0, _utils.getURLParameter)('origin');
	...
	window.addEventListener('message', function (e) {
	    _store2.default.dispatch(e.data);
	});
	...
	parent.postMessage(_store2.default.getState(), origin);
	_store2.default.dispatch({
	    type: _actions2.default.GUEST_INIT,
	    width: width,
	    height: height
	});
	_phone2.default.on('resize', function (width, height) {
	    _store2.default.dispatch({
	        type: _actions2.default.GUEST_PHONE_RESIZE,
	        width: width,
	        height: height
	    });
	});
	...
	_phone2.default.on('unmount', function () {
	    _store2.default.dispatch({
	        type: _actions2.default.GUEST_PHONE_UNMOUNT
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function status() {
	    ...
	    switch (action.type) {
	        case _actions2.default.GUEST_INIT:
	            return Object.assign({}, state, {
	                init: true
	            });
	        case _actions2.default.GUEST_PHONE_UNMOUNT:
	            return Object.assign({}, state, {
	                unmount: true
	            });
	        case _actions2.default.GUEST_PHONE_READY:
	            return Object.assign({}, state, {
	                ready: true
	            });
	        default:
	...
	function size() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.size : arguments[0];
	    var action = arguments[1];
	    ...
	    switch (action.type) {
	        ...
	        case _actions2.default.GUEST_PHONE_RESIZE:
	            return Object.assign({}, state, {
	                width: action.width,
	                height: action.height
	            });
	...
	function dialPad() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.dialPad : arguments[0];
	    var action = arguments[1];
	
	    switch (action.type) {
	        case _actions2.default.HOST_DIALPAD_NUMBER:
	        case _actions2.default.GUEST_DIALPAD_NUMBER:
	            return Object.assign({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createStore = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbolObservable = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(72)(global || window || this);
