 ...
 */
var useMicroApp = exports.useMicroApp = function useMicroApp(target, options) {
  var Component = (0, _mfeReact.useApp)(_objectSpread({
    bootstrap: function () {
      var _bootstrap = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref) {
        var init;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              init = _ref.init;
              _context2.n = 1;
              return init(/*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(options) {
                  var container, viewModule;
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.n) {
                      case 0:
                        _context.n = 1;
                        return (0, _nextCore.load)(target, [options.main].concat(_toConsumableArray(options.modules)));
                      case 1:
                        container = _context.v;
                        viewModule = container.get(options.main);
                        viewModule.isAppShell = false;
                        return _context.a(2, viewModule.component);
                    }
                  }, _callee);
                }));
                return function (_x2) {
...
//# sourceMappingURL=useMicroApp.js.map
