 ...
 */
var getTranslateFn = exports.getTranslateFn = function getTranslateFn() {
  ...
  return function (key) {
    var _RUNTIME$getTranslate;
    var i18nString = key;
    var currentLocale = (_RUNTIME$getTranslate = _i18n.RUNTIME.getTranslateLocale) === null || _RUNTIME$getTranslate === void 0 ? void 0 : _RUNTIME$getTranslate.call(_i18n.RUNTIME);
    i18nInstances.some(function (i18nInstance) {
      var result = i18nInstance.getString(key, currentLocale);
      if (result !== key) {
        i18nString = result;
        return true;
      }
