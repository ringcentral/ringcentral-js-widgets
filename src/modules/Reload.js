...
var Reload = exports.Reload = (_dec = (0, _lib.injectable)({
  name: 'Reload'
}), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", [typeof _Storage.StoragePlugin === "undefined" ? Object : _Storage.StoragePlugin]), _dec(_class = _dec2(_class = _dec3(_class = /*#__PURE__*/function () {
  function Reload(_storage) {
    var _this = this;
    _classCallCheck(this, Reload);
    this._storage = _storage;
    this._reload$ = new _rxjs.Subject();
    this.reloadGuards = [];
    /**
     * when reload be trigger will emit value out
     */
    this.reload$ = this._reload$.asObservable();
    this.reloadProcess$ = this._reload$.pipe((0, _rxjs.switchMap)(/*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(reason) {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _this._storage.flush()].concat(_toConsumableArray(_this.reloadGuards.map(function (guard) {
                return guard(reason);
              }))));
            case 1:
              _lib.logger.log('[debug] refresh', reason);
            case 2:
              return _context.a(2);
          }
        }, _callee);
  ...
  return _createClass(Reload, [{
    ...
    key: "addReloadGuard",
    value: function addReloadGuard(guard) {
