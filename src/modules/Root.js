...
exports.Root = exports.DEFAULT_WIDTH = void 0;
...
var DEFAULT_WIDTH = exports.DEFAULT_WIDTH = _constant.DEFAULT_APP_WINDOW_SIZE.fold.width;
var Root = exports.Root = (_dec = (0, _lib.injectable)({
  ...
  function Root(_rootOptions) {
    ...
    _this = _callSuper(this, Root);
    _this._rootOptions = _rootOptions;
    /**
     * expand state of the whole app view container
     */
    _initializerDefineProperty(_this, "expanded", _descriptor, _this);
    _this.destroy$ = _destroy.GLOBAL_DESTROY$.asObservable();
    /**
    ...
    _this.takeUntilAppDestroy = (0, _rxjs.takeUntil)(_this.destroy$);
    if (process.env.THEME_SYSTEM === 'spring-ui') {
      var _this$_rootOptions3;
      var onExpand = (_this$_rootOptions3 = _this._rootOptions) === null || _this$_rootOptions3 === void 0 ? void 0 : _this$_rootOptions3.onExpand;
      if (onExpand) {
        (0, _lib.fromWatchValue)(_this, function () {
          return _this.expanded;
        }).pipe((0, _rxjs.switchMap)(function (expanded) {
          var result = onExpand(expanded);
          if ((0, _rxjs.isObservable)(result)) {
            return result;
          }
          return _rxjs.EMPTY;
        }), _this.takeUntilAppDestroy).subscribe();
      }
    }
    return _this;
  }
  ...
  return _createClass(Root, [{
    ...
    key: "setExpanded",
    value: function () {
      var _setExpanded2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(val) {
...
}), _applyDecoratedDescriptor(_class2.prototype, "_setExpanded", [_lib.action, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "_setExpanded"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setExpanded", [_dec8, _dec9, _dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "setExpanded"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class);
