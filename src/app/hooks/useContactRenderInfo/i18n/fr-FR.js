...
var _default = exports["default"] = {
  ...
  Abandoned: 'Abandonné',
  Accepted: 'Accepté',
  'Answered Not Accepted': 'Réponse obtenue - non accepté',
  Blocked: 'Bloqué',
  Busy: 'Occupé',
  'Call Failed': 'L’appel a échoué',
  'Call Failure': 'Échec de l’appel',
  'Call connected': 'Appel établi',
  'Carrier is not active': 'Opérateur inactif',
  Declined: 'Refusé',
  'EDGE trunk misconfigured': 'Tronçon EDGE mal configuré',
  'Fax Not Sent': 'Fax non envoyé',
  'Fax Partially Sent': 'Fax partiellement envoyé',
  'Fax Poor Line': 'Mauvaise qualité de ligne de fax',
  'Fax Receipt Error': 'Erreur de réception de fax',
  'Fax on Demand': 'Fax à la demande',
  'Hang Up': 'Raccrocher',
  'IP Phone Offline': 'Téléphone IP hors ligne',
  'In Progress': 'En cours',
  'Internal Error': 'Erreur interne',
  'International Disabled': 'Appels à l’international désactivés',
  'International Restricted': 'Appels à l’international limités',
  Missed: 'Manqué',
  ...
  Sent: 'Envoyé',
  'Sent to Voicemail': 'Envoyé vers la messagerie vocale',
  Stopped: 'Interrompu',
  ...
  'Answered Elsewhere': 'Réponse apportée ailleurs',
  'Ringing Elsewhere': 'Sonnerie ailleurs',
  'Fax Send Error': 'Erreur d’envoi du fax',
  Account: 'Compte',
  'Call accepted': 'Appel accepté',
  'Hang up': 'Raccrocher',
  'International Restriction': 'Restriction internationale',
  'No fax machine': 'Aucun fax',
  'Partially Sent': 'Envoi partiel',
  'Poor Line Quality': 'Mauvaise qualité de la ligne',
  ResultEmpty: 'vide',
  ResultInProgress: 'En cours',
  Suspended: 'Suspendu',
  'Fax Receipt': 'Réception du fax',
  'Suspended Account': 'Compte suspendu',
  Disconnected: 'Déconnecté',
  multiMatchesContactName: '{name} et {count} autre(s)',
  ...
  optOutAlertTooltip: 'Le destinataire doit se réinscrire pour recevoir des SMS envoyés depuis ce numéro.'
}; // @key: @#@"to"@#@ @source: @#@"To"@#@
