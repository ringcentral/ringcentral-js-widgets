...
var _default = exports["default"] = {
  ...
  from: 'De',
  ext: 'Ext.',
  myCallerId: 'O meu ID do autor da chamada',
  ...
  otherDevice: 'Noutro dispositivo',
  onHold: 'Em espera',
  day: 'dia',
  hr: 'h',
  min: 'min',
  ...
  Accepted: 'Aceite',
  'Answered Not Accepted': 'Atendida não aceite',
  Blocked: 'Bloqueado',
  Busy: 'Ocupado',
  'Call Failed': 'Chamada falhada',
  'Call Failure': 'Falha na chamada',
  'Call connected': 'Chamada ligada',
  'Carrier is not active': 'A operadora não está ativa',
  Declined: 'Recusada',
  'EDGE trunk misconfigured': 'Ramal EDGE configurado incorretamente',
  'Fax Not Sent': 'Fax não enviado',
  'Fax Partially Sent': 'Fax parcialmente enviado',
  'Fax Poor Line': 'Linha de fax fraca',
  'Fax Receipt Error': 'Erro de receção de fax',
  'Fax on Demand': 'Fax por subscrição',
  'Hang Up': 'Desligar',
  'IP Phone Offline': 'Telefone IP offline',
  'In Progress': 'Em curso',
  'Internal Error': 'Erro interno',
  'International Disabled': 'Internacional desativado',
  'International Restricted': 'Internacional restrito',
  Missed: 'Não atendida',
  'No Answer': 'Sem resposta',
  'No Calling Credit': 'Sem crédito de chamadas',
  'Not Allowed': 'Não permitida',
  'Partial Receive': 'Receção parcial',
  'Phone Login': 'Início de sessão do telefone',
  'Receive Error': 'Erro de receção',
  Received: 'Recebida',
  Rejected: 'Rejeitada',
  Reply: 'Responder',
  ...
  Sent: 'Enviado',
  'Sent to Voicemail': 'Enviada para correio de voz',
  Stopped: 'Parado',
  ...
  'Answered Elsewhere': 'Atendida noutro local',
  'Ringing Elsewhere': 'A tocar noutro local',
  'Fax Send Error': 'Erro de envio de fax',
  Account: 'Conta',
  'Call accepted': 'Chamada aceite',
  'Hang up': 'Desligar',
  'International Restriction': 'Restrição internacional',
  'No fax machine': 'Sem aparelho de fax',
  'Partially Sent': 'Parcialmente enviado',
  'Poor Line Quality': 'Má qualidade da linha',
  ResultEmpty: 'vazio',
  ResultInProgress: 'Em curso',
  Suspended: 'Suspenso',
  'Fax Receipt': 'Recibo de fax',
  'Suspended Account': 'Conta suspensa',
  ...
  optedOut: 'O destinatário recusou receber.',
  optOutAlertTooltip: 'O destinatário tem de aceitar novamente para receber SMS deste número.'
}; // @key: @#@"to"@#@ @source: @#@"To"@#@
