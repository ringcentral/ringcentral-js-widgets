...
exports.CopyIconButtonSpring = void 0;
...
var CopyIconButtonSpring = exports.CopyIconButtonSpring = function CopyIconButtonSpring(_ref) {
  var text = _ref.text,
  ...
  var _useLocale = (0, _hooks.useLocale)(_i18n["default"]),
    t = _useLocale.t;
  var _useRefState = (0, _springUi.useRefState)(false),
  ...
  return copied ? /*#__PURE__*/_react["default"].createElement(_springUi.IconButton, _extends({
    variant: "icon",
  ...
  }, rest)) : /*#__PURE__*/_react["default"].createElement(_springUi.IconButton, _extends({
    variant: "icon",
    TooltipProps: {
      placement: 'top',
      title: t('copy')
    ...
    onClick: function onClick() {
      ...
      if (process.env.NODE_ENV !== 'production' && !copyText) {
        _nextCore.logger.warn('[CopyIconButton] cannot get correct text, make sure you have set `text` or `getText` prop');
        return;
      }
...
//# sourceMappingURL=CopyIconButtonSpring.js.map
