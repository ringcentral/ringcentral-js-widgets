...
export default {
  ...
  MultiWithNAMessage:
    'Stel het land en netnummer in voor uw regio. Dit wordt gebruikt voor lokale oproepen en het formatteren van telefoonnummers.',
  MultiWithoutNAMessage:
    'Selecteer het land waar u zich bevindt. Dit wordt gebruikt voor lokale oproepen en het formatteren van telefoonnummers.',
  country: 'Land',
  areaCode: 'Netnummer',
