...
var _FeedbackPanel = _interopRequireDefault(require("@ringcentral-integration/widgets/components/FeedbackPanel"));
var _react = _interopRequireWildcard(require("react"));
var _services2 = require("../../services");
var _FeedbackPanel2 = require("./FeedbackPanel");
  ...
  return _createClass(FeedbackView, [{
    ...
    value: function getUIFunctions(_ref) {
      ...
      return {
        ...
        sendFeedback: function sendFeedback(mailToUrl) {
          ...
          _this2._feedback.sendFeedback(mailToUrl);
        }
      };
    }
  }, {
    ...
    value: function component(props) {
      ...
      if (process.env.THEME_SYSTEM === 'spring-ui') {
        var _this$_feedbackViewOp;
        var _Component = ((_this$_feedbackViewOp = this._feedbackViewOptions) === null || _this$_feedbackViewOp === void 0 ? void 0 : _this$_feedbackViewOp.component) || _FeedbackPanel2.FeedbackPanel;
        return /*#__PURE__*/_react["default"].createElement(_Component, _extends({}, _props, uiFunctions));
      }
      var Component = ((_this$_feedbackViewOp2 = this._feedbackViewOptions) === null || _this$_feedbackViewOp2 === void 0 ? void 0 : _this$_feedbackViewOp2.component) || _FeedbackPanel["default"];
