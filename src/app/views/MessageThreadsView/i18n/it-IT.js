...
var _default = exports["default"] = {
  personal: 'Personale',
  shared: 'Condiviso',
  resolveThread: 'Risolvi',
  assignThread: 'Assegna',
  unassignThread: 'Annulla assegnazione',
  assignToMe: 'Rispondi',
  assignConversationTo: 'Assegna conversazione a',
  companyContacts: 'Contatti aziendali',
  resolvedBanner: 'Questa conversazione è risolta.',
  unassignedBannerText: "L'assegnazione di questa conversazione è stata annullata.",
  assignedToOtherBanner: 'Questa conversazione è assegnata a {name}.',
  reply: 'Rispondi',
  assign: 'Assegna',
  ...
  failedToResolveThread: 'Impossibile risolvere la conversazione',
  failedToUnassignThread: "Impossibile annullare l'assegnazione della conversazione"
