...
var _default = exports["default"] = {
  ...
  unassignedBannerText: 'Esta conversación no está asignada.',
  assignedToOtherBanner: 'Esta conversación está asignada a {name}.',
  reply: 'Responder',
  assign: 'Asignar',
  assignToMeText: 'Asignarme',
  resolved: 'Conversación resuelta.',
  autoResolved: 'Conversación resuelta automáticamente.',
  assignedToYouTooltip: 'Conversación asignada a usted',
  assignedToOtherTooltip: 'Conversación asignada a {name}',
  conversationUnassigned: 'Conversación sin asignar.',
  failedToAssignThread: 'Error al asignar la conversación',
  failedToResolveThread: 'Error al resolver la conversación',
  failedToUnassignThread: 'Error al anular la asignación de la conversación'
