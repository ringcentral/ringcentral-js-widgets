...
export default {
  ...
  unassignThread: '取消指派',
  assignToMe: '回覆',
  assignConversationTo: '將對話指派給',
  companyContacts: '公司連絡人',
  resolvedBanner: '此對話已解決。',
  unassignedBannerText: '此對話已取消指派。',
  assignedToOtherBanner: '此對話已指派給 {name}。',
  reply: '回覆',
  assign: '指派',
  assignToMeText: '指派給我',
  resolved: '對話已解決。',
  autoResolved: '對話已自動解決。',
  assignedToYouTooltip: '對話已指派給您',
  assignedToOtherTooltip: '對話已指派給 {name}',
  conversationUnassigned: '對話已取消指派。',
  failedToAssignThread: '無法指派對話',
  failedToResolveThread: '無法解決對話',
  failedToUnassignThread: '無法取消指派對話',
} as const;
