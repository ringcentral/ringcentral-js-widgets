...
var _default = exports["default"] = {
  ...
  unassignThread: '取消分配',
  assignToMe: '回复',
  assignConversationTo: '将对话分配给',
  companyContacts: '公司联系人',
  resolvedBanner: '此对话已解决。',
  unassignedBannerText: '此对话已取消分配。',
  assignedToOtherBanner: '此对话已分配给 {name}。',
  reply: '回复',
  assign: '分配',
  assignToMeText: '分配给我',
  resolved: '对话已解决。',
  autoResolved: '对话已自动解决。',
  assignedToYouTooltip: '对话已分配给您',
  assignedToOtherTooltip: '对话已分配给 {name}',
  conversationUnassigned: '对话已取消分配。',
  failedToAssignThread: '无法分配对话',
  failedToResolveThread: '无法解决对话',
  failedToUnassignThread: '无法取消分配对话'
