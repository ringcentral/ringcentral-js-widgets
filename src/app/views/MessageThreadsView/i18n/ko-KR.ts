...
export default {
  ...
  resolveThread: '해결',
  assignThread: '할당',
  unassignThread: '할당 취소',
  assignToMe: '회신',
  assignConversationTo: '대화 할당 대상',
  companyContacts: '회사 연락처',
  resolvedBanner: '이 대화는 해결되었습니다.',
  unassignedBannerText: '이 대화는 할당 취소되었습니다.',
  assignedToOtherBanner: '이 대화가 {name}님에게 할당되었습니다.',
  reply: '회신',
  assign: '할당',
  ...
  failedToUnassignThread: '대화 할당을 취소하는 데 실패했습니다',
} as const;
