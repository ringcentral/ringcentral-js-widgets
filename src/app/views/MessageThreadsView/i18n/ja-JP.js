...
var _default = exports["default"] = {
  ...
  resolveThread: '解決',
  assignThread: '割り当て',
  unassignThread: '割り当て解除',
  assignToMe: '応答',
  assignConversationTo: '会話の割り当て先',
  companyContacts: '会社の連絡先',
  resolvedBanner: 'この会話は解決済みです。',
  unassignedBannerText: 'この会話は割り当てられていません。',
  assignedToOtherBanner: 'この会話は{name}に割り当てられています。',
  reply: '応答',
  assign: '割り当て',
  ...
  failedToUnassignThread: '会話の割り当て解除に失敗しました'
