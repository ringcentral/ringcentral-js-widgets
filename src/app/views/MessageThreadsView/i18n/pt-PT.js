...
var _default = exports["default"] = {
  ...
  assignThread: 'Atribuir',
  unassignThread: 'Cancelar atribuição',
  assignToMe: 'Responder',
  assignConversationTo: 'Atribuir conversa a',
  companyContacts: 'Contactos da empresa',
  resolvedBanner: 'Esta conversa está resolvida.',
  unassignedBannerText: 'Esta conversa não está atribuída.',
  assignedToOtherBanner: 'Esta conversa está atribuída a {name}.',
  reply: 'Responder',
  assign: 'Atribuir',
  assignToMeText: 'Atribuir a mim',
  resolved: 'Conversa resolvida.',
  autoResolved: 'Conversa resolvida automaticamente.',
  assignedToYouTooltip: 'Conversa atribuída a si',
  assignedToOtherTooltip: 'Conversa atribuída a {name}',
  conversationUnassigned: 'Conversa não atribuída.',
  failedToAssignThread: 'Ocorreu uma falha ao atribuir a conversa',
  failedToResolveThread: 'Ocorreu uma falha ao resolver a conversa',
  failedToUnassignThread: 'Ocorreu uma falha ao cancelar a atribuição da conversa'
