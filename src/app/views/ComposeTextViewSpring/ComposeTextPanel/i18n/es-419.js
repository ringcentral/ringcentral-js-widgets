...
var _default = exports["default"] = {
  createNewText: 'Crear nuevo mensaje',
  createGroupText: 'Crear mensaje grupal',
  groupTextHint: 'Enviar mensajes de texto grupales (hasta 10 personas) para comenzar una conversación de texto. O bien, desactive la casilla para enviar un mensaje de texto de forma individual a cada uno; no verán quiénes son los otros destinatarios.',
  optOutSingleRecipient: 'Este destinatario canceló la suscripción.',
  optOutMultipleRecipients: 'Algunos destinatarios cancelaron la suscripción.',
