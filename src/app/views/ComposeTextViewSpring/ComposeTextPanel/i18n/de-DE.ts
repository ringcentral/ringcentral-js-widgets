...
export default {
  ...
  createGroupText: 'Gruppentext erstellen',
  groupTextHint:
    'Senden Sie Gruppentextnachrichten (an bis zu 10 Personen), um eine Textkonversation zu starten. Oder heben Sie die Auswahl auf, um allen Personen einzeln eine Textnachricht zu senden, ohne dass die anderen Empfänger davon erfahren.',
