...
export default {
  ...
  groupTextHint:
    'Envíe mensajes de texto de grupo (hasta 10 personas) para iniciar una conversación de texto. También puede desactivar la casilla para enviar un mensaje de texto de forma individual a cada uno y que los usuarios no vean a los demás destinatarios.',
  optOutSingleRecipient: 'Este destinatario ha cancelado la suscripción.',
