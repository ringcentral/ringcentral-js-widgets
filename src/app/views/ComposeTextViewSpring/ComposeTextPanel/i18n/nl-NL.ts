/* eslint-disable */
export default {
  createNewText: 'Nieuw tekstbericht maken',
  createGroupText: 'Groepstekstbericht maken',
  groupTextHint:
    'Verzend groepstekstberichten (maximaal 10 personen) om een gesprek te starten. Of schakel het selectievakje uit om tekstberichten afzonderlijk te versturen. De ontvangers weten dan niet dat er andere ontvangers zijn.',
