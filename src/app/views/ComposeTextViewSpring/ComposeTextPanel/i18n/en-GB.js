...
var _default = exports["default"] = {
  ...
  createGroupText: 'Create group text',
  groupTextHint: 'Send group text messages (up to 10 people) to start a text conversation. Or untick the box to send a text message to everyone individually. They will be unaware of the other recipients.',
