/* eslint-disable */
export default {
  createNewText: 'Créer un nouveau texto',
  createGroupText: 'Créer un texto de groupe',
  groupTextHint:
    'Envoyez des messages texte de groupe (jusqu’à 10 personnes) pour entamer une conversation textuelle. Vous pouvez également décocher la case pour envoyer un message texte à chaque personne individuellement, qui n’aura pas connaissance des autres destinataires.',
  optOutSingleRecipient: 'Ce destinataire a choisi de se désinscrire.',
  optOutMultipleRecipients:
    'Certains destinataires ont choisi de se désinscrire.',
  optOutRemove: 'Retirer',
} as const;
