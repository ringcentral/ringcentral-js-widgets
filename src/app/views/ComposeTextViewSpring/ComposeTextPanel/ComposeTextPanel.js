...
var ComposeTextPanel = exports.ComposeTextPanel = function ComposeTextPanel(_ref) {
  var send = _ref.send,
    ...
    createGroupChecked = _ref.createGroupChecked,
    acceptFileTypes = _ref.acceptFileTypes,
    onBackClick = _ref.onBackClick,
    originalMessageText = _ref.messageText,
    ...
    onCreateGroupTextOptionChanged = _ref.onCreateGroupTextOptionChanged,
  ...
  var handleContactSelect = /*#__PURE__*/function () {
    ...
    return function handleContactSelect(_x) {
  ...
  var title = (0, _i18n.t)('createNewText');
  var optOutCount = (0, _react.useMemo)(function () {
    return toNumbers.filter(function (toNumber) {
      return toNumber.error && toNumber.errorReason === 'optOut';
    }).length;
  }, [toNumbers]);
  var showOptOutWarning = optOutCount > 0;
  var handleOptOutRemove = function handleOptOutRemove() {
    toNumbers.forEach(function (toNumber) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_components.AppHeaderNav, {
    ...
    helperText: showOptOutWarning ? /*#__PURE__*/_react["default"].createElement("span", null, optOutCount === 1 ? (0, _i18n.t)('optOutSingleRecipient') : (0, _i18n.t)('optOutMultipleRecipients'), ' ', /*#__PURE__*/_react["default"].createElement(_springUi.Link, {
      variant: "primary",
      onClick: handleOptOutRemove
    }, (0, _i18n.t)('optOutRemove'))) : undefined
  }), !disabledGroupMessage && /*#__PURE__*/_react["default"].createElement(_springUi.FormLabel, {
    ...
    label: /*#__PURE__*/_react["default"].createElement("span", {
      ...
      className: (0, _clsx["default"])(allowedCreateGroupText ? 'text-neutral-b0' : 'text-neutral-b3', 'typography-mainText')
    }, (0, _i18n.t)('createGroupText')), /*#__PURE__*/_react["default"].createElement(_springUi.Tooltip, {
      title: (0, _i18n.t)('groupTextHint')
