...
export default {
  ...
  ForwardedCompanyNumber: 'Renvoyé',
  ForwardedNumber: 'Renvoyé',
  ContactCenterNumber: 'Contact Center',
  ConferencingNumber: 'Conférences',
  ...
  noFaxes: 'Aucun fax pour le moment',
  noUnreadFaxes: 'Aucun fax non lu pour le moment',
  noVoicemail: 'Aucun message vocal à ce jour',
  noSearchResults: 'Aucun résultat',
  searchAll: 'Rechercher dans tout',
