...
var _default = exports["default"] = {
  faxTitle: 'Fax',
  textTitle: 'Tekstbericht',
  DirectNumber: 'Direct',
  MainCompanyNumber: 'Primair',
  CompanyNumber: 'Bedrijf',
  CompanyFaxNumber: 'Fax',
  Blocked: 'Geblokkeerd',
  AdditionalCompanyNumber: 'Bedrijf',
  ForwardedCompanyNumber: 'Doorgeschakeld',
  ForwardedNumber: 'Doorgeschakeld',
  ...
  noFaxes: 'Nog geen faxen',
  noUnreadFaxes: 'Nog geen ongelezen faxen',
  noVoicemail: 'Nog geen voicemail',
  noSearchResults: 'Geen zoekresultaten gevonden',
  searchAll: 'Alle doorzoeken',
