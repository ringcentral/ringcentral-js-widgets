...
var _default = exports["default"] = {
  ...
  "delete": 'Eliminar',
  faxSent: 'Enviado',
  faxSubmitted: 'Enviado',
  faxReceived: 'Recibido',
  faxSendFailed: 'Fax no entregado',
  faxProcessing: 'Procesando…',
  pages: 'páginas',
  page: 'Página',
  preview: 'Ver',
  download: 'Descargar',
  mmsWithOneAttachment: 'MMS con 1 archivo adjunto',
  mmsWithAttachments: 'MMS con {count} archivos adjuntos',
  account: 'Cuenta',
  contact: 'Contacto',
