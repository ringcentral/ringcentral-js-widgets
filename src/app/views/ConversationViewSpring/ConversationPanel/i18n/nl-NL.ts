/* eslint-disable */
export default {
  dncAlert: 'Deze contactpersoon staat op een Niet bellen-lijst.',
  optOutAlert:
    'Deze contactpersoon heeft zich afgemeld voor het ontvangen van berichten.',
  smsCapabilityAlert:
    'Uw nummer ({phoneNumber}) moet geregistreerd zijn om sms-berichten te kunnen verzenden en ontvangen. U kunt ook het tekstbericht beantwoorden vanaf een geregistreerd nummer.',
  saveLog: 'Logboek opslaan',
  viewInCrm: 'Weergeven in {crmName}',
  createLog: 'Lijst maken',
  insertOptOut: 'Afmelding invoegen',
  removeOptOut: 'Afmelding verwijderen',
} as const;
