...
var _default = exports["default"] = {
  ...
  optOutAlert: 'Este contacto canceló la suscripción para recibir mensajes.',
  smsCapabilityAlert: 'Su número {phoneNumber} debe estar registrado para enviar y recibir mensajes. De manera alternativa, puede responder al mensaje desde un número registrado.',
  saveLog: 'Guardar registro',
  viewInCrm: 'Ver en {crmName}',
  createLog: 'Crear registro',
  insertOptOut: 'Insertar cancelación de suscripción',
  removeOptOut: 'Eliminar cancelación de suscripción'
