...
var _default = exports["default"] = {
  ...
  smsCapabilityAlert: 'Votre numéro {phoneNumber} doit être enregistré pour envoyer et recevoir des SMS. Vous pouvez aussi répondre aux SMS depuis un numéro enregistré.',
  saveLog: 'Enregistrer le journal',
  viewInCrm: 'Afficher dans {crmName}',
  createLog: 'Créer un journal',
  insertOptOut: 'Insérer la désincription',
  removeOptOut: 'Supprimer la désincription'
