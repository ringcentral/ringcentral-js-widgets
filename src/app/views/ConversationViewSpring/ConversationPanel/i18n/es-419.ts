...
export default {
  ...
  smsCapabilityAlert:
    'Su número {phoneNumber} debe estar registrado para enviar y recibir mensajes. De manera alternativa, puede responder al mensaje desde un número registrado.',
