...
export default {
  ...
  smsCapabilityAlert:
    'Ihre Nummer {phoneNumber} muss registriert sein, damit Sie Textnachrichten senden und empfangen können. Alternativ können Sie von einer registrierten Nummer aus auf die Textnachricht antworten.',
