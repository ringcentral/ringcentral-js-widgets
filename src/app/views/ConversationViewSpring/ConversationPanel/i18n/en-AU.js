...
var _default = exports["default"] = {
  ...
  smsCapabilityAlert: 'Your number {phoneNumber} must be registered to send and receive texts. Alternatively, you can reply to the text from a registered number.',
  saveLog: 'Save log',
