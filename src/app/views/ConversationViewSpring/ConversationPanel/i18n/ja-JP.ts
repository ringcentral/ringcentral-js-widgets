/* eslint-disable */
export default {
  dncAlert: 'この連絡先は通話拒否リストに記載されています。',
  optOutAlert: 'この連絡先はメッセージの受信をオプトアウトしました。',
  smsCapabilityAlert:
    'テキストを送受信するには、番号{phoneNumber}を登録する必要があります。または、登録された番号からテキストに返信することもできます。',
  saveLog: 'ログを保存',
  viewInCrm: '{crmName}で表示する',
  createLog: 'ログを作成',
  insertOptOut: 'オプトアウトを挿入',
  removeOptOut: 'オプトアウトを削除',
} as const;
