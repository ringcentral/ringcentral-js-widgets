/* eslint-disable */
export default {
  dncAlert: 'Este contacto está numa lista Não ligar.',
  optOutAlert: 'Este contacto recusou receber mensagens.',
  smsCapabilityAlert:
    'O seu número, {phoneNumber}, tem de estar registado para enviar e receber SMS. Em alternativa, pode responder à SMS a partir de um número registado.',
  saveLog: 'Guardar registo',
  viewInCrm: 'Ver no {crmName}',
  createLog: 'Criar registo',
  insertOptOut: 'Inserir recusa',
  removeOptOut: 'Remover recusa',
} as const;
