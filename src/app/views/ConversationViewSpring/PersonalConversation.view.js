...
exports.PersonalConversationViewSpring = void 0;
...
function sortByCreationTimeDesc(a, b) {
  if (!a.creationTime || !b.creationTime || a.creationTime === b.creationTime) return 0;
  return a.creationTime > b.creationTime ? 1 : -1;
}
var PersonalConversationViewSpring = exports.PersonalConversationViewSpring = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('ConversationViewOptions')(target, undefined, 15);
  ...
  _inherits(PersonalConversationViewSpring, _RcViewModule);
  return _createClass(PersonalConversationViewSpring, [{
    key: "messages",
    get: function get() {
      ...
      return this._conversations.getMessages(conversationId).sort(function (a, b) {
        return sortByCreationTimeDesc(a, b);
      });
    }
  }, {
    key: "getUIProps",
