...
exports.SharedConversationView = void 0;
...
var SharedConversationView = exports.SharedConversationView = (_dec = (0, _nextCore.injectable)({
  ...
  function SharedConversationView(_smsTemplateView, _theme, _extensionInfo, _regionSettings, _rateLimiter, _connectivityMonitor, _router, _integrationConfig, _conversationsViewSpring, _messageThread, _block, _conversationAlert, _conversationLogger, _contactMatcher, _conversationViewOptions, _smsOptOutView) {
    ...
    _this._conversationsViewSpring = _conversationsViewSpring;
  ...
  return _createClass(SharedConversationView, [{
    ...
    value: function getUIProps(_ref) {
      ...
      var conversation = this._messageThread.getThreadConversation(conversationId);
      if (!conversation) {
        return {
    ...
    value: function getUIFunctions(_ref2) {
      ...
      return {
          ...
          var _replyToReceivers = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(text) {
            ...
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.n) {
                ...
                case 1:
                  threads = _this2._messageThread.data.threads;
                  ...
                  _context2.n = 2;
                  return _this2._block.next(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                    var response;
                    return _regenerator().w(function (_context) {
                      while (1) switch (_context.n) {
                        ...
                        case 1:
                          ...
                          _context.n = 2;
                          return _this2._router.push("/conversations/".concat(response.threadId));
                        case 2:
                          return _context.a(2);
                      }
                    }, _callee);
        ...
        updateMessageText: function () {
          var _updateMessageText = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(text) {
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.n) {
                ...
                case 1:
                  _this2._messageThread.setInputValue(conversationId, text);
        ...
        onLinkClick: function onLinkClick(href) {
          ...
          (0, _services.trackEvent)(_trackEvents.trackEvents.clickConversationHyperlink, {
            'Hyperlink type': linkType
          });
        },
        goBack: function () {
          var _goBack = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
            var _this2$_theme;
    ...
    value: function component(props) {
      ...
      var uiFunctions = (0, _react.useMemo)(function () {
        return _this3.getUIFunctions(props);
      }, [props]);
      var messages = (0, _nextCore.useConnector)(function () {
        return _this3._messageThread.getThreadMessages(props.conversationId);
      });
      ...
      return /*#__PURE__*/_react["default"].createElement(Component, _extends({}, rest, uiFunctions, {
        ...
        }), this._smsOptOutView && /*#__PURE__*/_react["default"].createElement(this._smsOptOutView.component, {
          conversation: conversation
        })),
        endAdornment: this._smsOptOutView ? /*#__PURE__*/_react["default"].createElement(this._smsOptOutView.Chip, {
          conversation: conversation
        }) : undefined
      }));
    }
