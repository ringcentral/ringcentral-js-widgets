...
var _default = exports["default"] = {
  ...
  requirePasswordDescription: 'Mantenga la seguridad de su reunión. Las personas que usen el enlace no deberán proporcionar una contraseña.',
  password: 'Contraseña',
  edit: 'Editar',
  noPasswordSet: 'No se estableció la contraseña',
  manageWhoCanJoin: 'Administre quién puede unirse',
  useWaitingRoom: 'Usar sala de espera',
  useWaitingRoomDescription: 'Los participantes esperan hasta que los admite. Ideal para entrevistas o asistentes externos.',
  startMeetingAfterJoin: 'Iniciar reunión después de unirse',
  startMeetingAfterJoinDescription: 'La reunión comenzará después de que se una para evitar que se den conversaciones con anticipación.',
  usePersonalMeetingLink: 'Usar el enlace de reunión personal',
  personalMeetingLink: 'Enlace de reunión personal',
  editSettings: 'Editar configuración',
  scheduleMeeting: 'Programar reunión',
  cancel: 'Cancelar',
  update: 'Actualizar',
  updating: 'Actualizando…',
  passwordFormatError: 'Su contraseña debe contener de 1 a 10 letras y números, pero no puede tener símbolos',
  passwordRequiredError: 'La contraseña es obligatoria',
  updatePassword: 'Actualizar contraseña',
  passwordRequired: 'La contraseña es obligatoria',
  passwordValidationHint: 'Ingrese una contraseña de 1 a 10 caracteres de longitud (solo letras y números)',
  anyoneWithLink: 'Cualquier persona que tenga un enlace',
  onlyRingCentralAccounts: 'Solo cuentas de {shortName}',
  onlyMyCoworkers: 'Solo mis compañeros',
  allParticipants: 'Todos los participantes',
  forAnyoneOutsideMyCompany: 'Para cualquier persona fuera de mi empresa',
  forAnyoneNotSignedIn: 'Para cualquier persona que no haya iniciado sesión',
  personalMeetingSettings: 'Configuración de la reunión personal',
  personalMeetingSettingsDescription: 'Establezca quién puede unirse y cómo en relación con el enlace de su reunión personal.',
  hour: 'h',
  minute: 'min',
  adminLockedSetting: 'El administrador de su empresa gestiona esta configuración',
  passwordPlaceholder: 'Ingresar la contraseña'
