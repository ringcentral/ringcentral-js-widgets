...
var _default = exports["default"] = {
  video: 'Vídeo',
  meetingTitle: 'Nombre de la reunión',
  date: 'Fecha',
  time: 'Hora',
  duration: 'Duración',
  scheduleVideoMeeting: 'Programar reunión por vídeo',
  requirePassword: 'Solicitar contraseña',
  requirePasswordDescription: 'Mantenga su reunión segura. No se le pedirá una contraseña a ninguna persona que use el enlace.',
  password: 'Contraseña',
  edit: 'Editar',
  noPasswordSet: 'No se ha establecido una contraseña',
  manageWhoCanJoin: 'Gestionar quién puede unirse',
  useWaitingRoom: 'Usar sala de espera',
  useWaitingRoomDescription: 'Los participantes esperan hasta que los admita. Ideal para entrevistas o asistentes externos.',
  startMeetingAfterJoin: 'Iniciar reunión después de unirse',
  startMeetingAfterJoinDescription: 'La reunión comenzará después de que se una para evitar conversaciones antes de unirse.',
  usePersonalMeetingLink: 'Usar enlace de reunión personal',
  ...
  passwordFormatError: 'La contraseña debe tener entre 1 y 10 caracteres o números y no puede incluir símbolos.',
  passwordRequiredError: 'La contraseña es obligatoria',
  updatePassword: 'Actualizar contraseña',
  passwordRequired: 'La contraseña es obligatoria',
  passwordValidationHint: 'Introduzca una contraseña de 1 a 10 caracteres (solo letras y números)',
  anyoneWithLink: 'Cualquier persona con un enlace',
  onlyRingCentralAccounts: 'Solo {shortName} cuentas',
  onlyMyCoworkers: 'Solo mis compañeros',
  allParticipants: 'Todos los participantes',
  forAnyoneOutsideMyCompany: 'Para quien no sea de mi empresa',
  forAnyoneNotSignedIn: 'Para cualquiera que no haya iniciado sesión',
  personalMeetingSettings: 'Ajustes de la reunión personal',
  personalMeetingSettingsDescription: 'Establezca quién puede unirse y cómo para el enlace de su reunión personal.',
  hour: 'h',
  minute: 'min',
  adminLockedSetting: 'Esta configuración la gestiona el administrador de su empresa',
