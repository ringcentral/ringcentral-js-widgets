...
var _default = exports["default"] = {
  ...
  requirePasswordDescription: 'Protégez votre réunion. Les personnes utilisant le lien ne seront pas invitées à saisir un mot de passe.',
  password: 'Mot de passe',
  edit: 'Modifier',
  noPasswordSet: 'Aucun mot de passe défini',
  manageWhoCanJoin: 'Gérer qui peut s’y joindre',
  useWaitingRoom: 'Utiliser la salle d’attente',
  useWaitingRoomDescription: 'Les participants attendent jusqu’à ce vous les admettiez. Idéal pour les entrevues ou pour les participants externes.',
  startMeetingAfterJoin: 'Commencer la réunion après vous être joint',
  startMeetingAfterJoinDescription: 'La réunion commencera après que vous vous joigniez pour éviter les conversations prématurées.',
  usePersonalMeetingLink: 'Utiliser le lien de la réunion personnelle',
  personalMeetingLink: 'Lien de la réunion personnelle',
  editSettings: 'Modifier les paramètres',
  scheduleMeeting: 'Planifier une réunion',
  cancel: 'Annuler',
  update: 'Mettre à jour',
  updating: 'Mise à jour en cours...',
  passwordFormatError: 'Votre mot de passe doit contenir de 1 à 10 lettres et chiffres, mais ne pas contenir de symboles.',
  passwordRequiredError: 'Mot de passe obligatoire',
  updatePassword: 'Mettre à jour le mot de passe',
  passwordRequired: 'Mot de passe obligatoire',
  passwordValidationHint: 'Entrez un mot de passe de 1 à 10 caractères (lettres et chiffres uniquement)',
  anyoneWithLink: 'Toute personne avec le lien',
  onlyRingCentralAccounts: 'Seulement les comptes {shortName}',
  onlyMyCoworkers: 'Seulement mes collègues',
  allParticipants: 'Tous les participants',
  forAnyoneOutsideMyCompany: 'Pour toute personne en dehors de mon entreprise',
  forAnyoneNotSignedIn: 'Pour toute personne non connectée',
  personalMeetingSettings: 'Paramètres de la réunion personnelle',
  personalMeetingSettingsDescription: 'Définissez qui peut se joindre à la réunion et comment le faire pour le lien de votre réunion personnelle.',
  hour: 'h',
  minute: ' min',
