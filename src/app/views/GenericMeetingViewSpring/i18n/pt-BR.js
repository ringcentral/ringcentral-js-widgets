...
var _default = exports["default"] = {
  ...
  requirePasswordDescription: 'Mantenha sua reunião segura. Qualquer pessoa que usar o link não será solicitada a fornecer uma senha.',
  password: 'Senha',
  edit: 'Editar',
  noPasswordSet: 'Nenhuma senha definida',
  manageWhoCanJoin: 'Gerenciar quem pode entrar',
  useWaitingRoom: 'Usar sala de espera',
  useWaitingRoomDescription: 'Os participantes aguardam até que você os aceite. Ideal para entrevistas ou participantes externos.',
  startMeetingAfterJoin: 'Iniciar reunião após você entrar',
  startMeetingAfterJoinDescription: 'A reunião começará depois que você entrar para evitar conversas antecipadas.',
  usePersonalMeetingLink: 'Usar link da reunião pessoal',
  personalMeetingLink: 'Link da reunião pessoal',
  editSettings: 'Editar configurações',
  scheduleMeeting: 'Agendar reunião',
  cancel: 'Cancelar',
  update: 'Atualizar',
  updating: 'Atualizando…',
  passwordFormatError: 'A senha deve ter de 1 a 10 letras e números, mas não pode conter símbolos',
  passwordRequiredError: 'A senha é obrigatória',
  updatePassword: 'Atualizar senha',
  passwordRequired: 'A senha é obrigatória',
  passwordValidationHint: 'Insira uma senha de 1 a 10 caracteres (somente letras e números)',
  anyoneWithLink: 'Qualquer pessoa com um link',
  onlyRingCentralAccounts: 'Apenas contas {shortName}',
  onlyMyCoworkers: 'Somente meus colegas de trabalho',
  allParticipants: 'Todos os participantes',
  forAnyoneOutsideMyCompany: 'Para qualquer pessoa fora da minha empresa',
  forAnyoneNotSignedIn: 'Para pessoas não conectadas',
  personalMeetingSettings: 'Configurações da reunião pessoal',
  personalMeetingSettingsDescription: 'Defina quem pode entrar e como para o link da reunião pessoal.',
  hour: 'hora',
  minute: 'min',
  adminLockedSetting: 'Esta configuração é gerenciada pelo administrador da empresa',
