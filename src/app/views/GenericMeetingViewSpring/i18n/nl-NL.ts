...
export default {
  ...
  requirePasswordDescription:
    'Houd uw meeting veilig. Deelnemers die de link gebruiken, worden niet om een wachtwoord gevraagd.',
  password: 'Wachtwoord',
  edit: 'Bewerken',
  ...
  useWaitingRoomDescription:
    'Deelnemers wachten tot u ze toelaat. Geweldig voor sollicitatiegesprekken of deelnemers van buitenaf.',
  startMeetingAfterJoin: 'Meeting starten nadat u deelneemt',
  startMeetingAfterJoinDescription:
    'De meeting start nadat u deelneemt om vroegtijdige gesprekken te voorkomen.',
  ...
  passwordValidationHint:
    'Voer een wachtwoord in van 1-10 tekens lang (alleen letters en cijfers)',
  ...
  personalMeetingSettingsDescription:
    'Stel voor uw persoonlijke meetinglink in wie kan deelnemen en hoe.',
  hour: 'uur',
  minute: 'min',
