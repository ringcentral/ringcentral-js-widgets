...
var _default = exports["default"] = {
  ...
  time: '시간',
  duration: '지속 시간',
  scheduleVideoMeeting: '화상 모임 예약',
  requirePassword: '비밀번호 필요',
  requirePasswordDescription: '모임을 안전하게 보호하세요. 이 링크를 사용하는 사용자에게는 비밀번호를 입력하라는 메시지가 표시되지 않습니다.',
  password: '비밀번호',
  edit: '편집',
  noPasswordSet: '설정된 비밀번호 없음',
  manageWhoCanJoin: '참가할 수 있는 사용자 관리',
  useWaitingRoom: '대기실 사용',
  useWaitingRoomDescription: '참가자는 내가 수락할 때까지 대기합니다. 인터뷰나 외부 참석자에 적합합니다.',
  startMeetingAfterJoin: '내가 참가한 후 모임 시작',
  startMeetingAfterJoinDescription: '초기 대화 방지를 위해 내가 참가한 후 모임이 시작됩니다.',
  usePersonalMeetingLink: '개인 모임 링크 사용',
  personalMeetingLink: '개인 모임 링크',
  editSettings: '설정 편집',
  scheduleMeeting: '모임 예약',
  cancel: '취소',
  update: '업데이트',
  updating: '업데이트 중...',
  passwordFormatError: '비밀번호는 1~10자의 문자 및 숫자여야 하며 기호를 포함하지 않아야 합니다.',
  passwordRequiredError: '비밀번호는 필수 항목입니다.',
  updatePassword: '비밀번호 업데이트',
  passwordRequired: '비밀번호는 필수 항목입니다.',
  passwordValidationHint: '1~10자 길이의 비밀번호를 입력하세요(글자 및 숫자만).',
  anyoneWithLink: '링크가 있는 모든 사용자',
  onlyRingCentralAccounts: '{shortName} 계정만',
  onlyMyCoworkers: '동료만',
  allParticipants: '모든 참가자',
  forAnyoneOutsideMyCompany: '회사 외부 사용자용',
  forAnyoneNotSignedIn: '로그인하지 않은 사용자용',
  personalMeetingSettings: '개인 모임 설정',
  personalMeetingSettingsDescription: '개인 모임 링크에 참가할 수 있는 사람 및 참가 방법을 설정합니다.',
  hour: '시간',
  minute: '분',
  adminLockedSetting: '이 설정은 회사 관리자가 관리합니다',
