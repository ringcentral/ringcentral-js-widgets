...
var _default = exports["default"] = {
  ...
  requirePasswordDescription: '会議を安全に保ちます。このリンクを使用するとパスワードの入力を求められません。',
  password: 'パスワード',
  edit: '編集',
  noPasswordSet: 'パスワードが設定されていません',
  manageWhoCanJoin: '参加できるユーザーを管理',
  useWaitingRoom: '待機ルームを使用',
  useWaitingRoomDescription: '参加者はあなたが許可するまで待機します。面接や外部の出席者の場合に最適です。',
  startMeetingAfterJoin: 'あなたが参加した後に会議を開始',
  startMeetingAfterJoinDescription: '会話が早く始まらないように、会議はあなたが参加した後に開始されます。',
  usePersonalMeetingLink: '個人会議リンクを使用',
  personalMeetingLink: '個人会議リンク',
  editSettings: '設定を編集',
  scheduleMeeting: '会議をスケジュール',
  cancel: 'キャンセル',
  update: '更新',
  updating: '更新中...',
  passwordFormatError: 'パスワードは1～10文字で英数字を使用できます。記号は使用できません',
  passwordRequiredError: 'パスワードは必須です',
  updatePassword: 'パスワードを更新',
  passwordRequired: 'パスワードは必須です',
  passwordValidationHint: '1～10文字でパスワードを入力してください(英数字のみ)',
  anyoneWithLink: 'リンクを知っている人',
  onlyRingCentralAccounts: '{shortName}アカウントのみ',
  onlyMyCoworkers: '同僚のみ',
  allParticipants: 'すべての参加者',
  forAnyoneOutsideMyCompany: '社外ユーザー',
  forAnyoneNotSignedIn: 'サインインしていないユーザー',
  personalMeetingSettings: '個人会議の設定',
  personalMeetingSettingsDescription: '個人会議リンクで参加できるユーザーと参加方法を設定します。',
  hour: '時間',
  minute: '分',
  adminLockedSetting: 'この設定は会社の管理者によって管理されています',
