...
var _default = exports["default"] = {
  video: 'Video',
  meetingTitle: 'Tapaamisen otsikko',
  date: 'Päivämäärä',
  time: 'Aika',
  duration: 'Kesto',
  scheduleVideoMeeting: 'Ajoita videotapaaminen',
  requirePassword: 'Edellytä salasanaa',
  requirePasswordDescription: 'Pidä tapaamisesi turvallisena. Linkin käyttäjiltä ei pyydetä salasanaa.',
  password: 'Salasana',
  edit: 'Muokkaa',
  noPasswordSet: 'Salasanaa ei ole asetettu',
  manageWhoCanJoin: 'Hallitse, ketkä voivat liittyä',
  useWaitingRoom: 'Käytä odotushuonetta',
  useWaitingRoomDescription: 'Osallistujat odottavat, kunnes annat heidän liittyä. Sopii erinomaisesti haastatteluihin tai ulkopuolisille osallistujille.',
  startMeetingAfterJoin: 'Aloita tapaaminen liittymisen jälkeen',
  startMeetingAfterJoinDescription: 'Ennenaikaisten keskustelujen estämiseksi tapaaminen alkaa, kun olet liittynyt.',
  usePersonalMeetingLink: 'Käytä henkilökohtaista tapaamislinkkiä',
  personalMeetingLink: 'Henkilökohtainen tapaamislinkki',
  editSettings: 'Muokkaa asetuksia',
  scheduleMeeting: 'Ajoita tapaaminen',
  cancel: 'Peruuta',
  update: 'Päivitä',
  updating: 'Päivitetään...',
  passwordFormatError: 'Salasanasi on oltava 1–10 kirjainta ja numeroa pitkä, eikä se saa sisältää symboleita',
  passwordRequiredError: 'Salasana vaaditaan',
  updatePassword: 'Päivitä salasana',
  passwordRequired: 'Salasana vaaditaan',
  passwordValidationHint: 'Anna salasana, jonka pituus on 1–10 merkkiä (vain kirjaimia ja numeroita)',
  anyoneWithLink: 'Kuka tahansa, jolla on linkki',
  onlyRingCentralAccounts: 'Vain {shortName} -tilit',
  onlyMyCoworkers: 'Vain työtoverini',
  allParticipants: 'Kaikki osallistujat',
  forAnyoneOutsideMyCompany: 'Yritykseni ulkopuolisille henkilöille',
  forAnyoneNotSignedIn: 'Henkilöille, jotka eivät ole kirjautuneet sisään',
  personalMeetingSettings: 'Henkilökohtaisen tapaamisen asetukset',
  personalMeetingSettingsDescription: 'Määritä henkilökohtaiseen tapaamislinkkiisi, ketkä voivat liittyä ja miten.',
  hour: 't',
  minute: 'min',
  adminLockedSetting: 'Asetus on yrityksen järjestelmänvalvojan hallinnassa',
