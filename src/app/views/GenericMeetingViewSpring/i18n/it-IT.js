...
var _default = exports["default"] = {
  video: 'Video',
  meetingTitle: 'Titolo della riunione',
  date: 'Data',
  time: 'Ora',
  duration: 'Durata',
  scheduleVideoMeeting: 'Pianifica riunione video',
  requirePassword: 'Richiedi password',
  requirePasswordDescription: 'Mantieni sicura la tua riunione. A chiunque utilizzi il collegamento non verrà richiesta una password.',
  password: 'Password',
  edit: 'Modifica',
  noPasswordSet: 'Nessuna password impostata',
  manageWhoCanJoin: 'Gestisci chi può partecipare',
  useWaitingRoom: "Usa sala d'attesa",
  useWaitingRoomDescription: 'I partecipanti attendono finché non vengono ammessi. Ideale per colloqui o partecipanti esterni.',
  startMeetingAfterJoin: 'Avvia riunione dopo il tuo accesso',
  startMeetingAfterJoinDescription: 'La riunione inizierà dopo il tuo accesso per evitare conversazioni anticipate.',
  usePersonalMeetingLink: 'Usa collegamento riunione personale',
  personalMeetingLink: 'Collegamento riunione personale',
  editSettings: 'Modifica impostazioni',
  scheduleMeeting: 'Pianifica riunione',
  cancel: 'Annulla',
  update: 'Aggiorna',
  updating: 'Aggiornamento...',
  passwordFormatError: 'La password deve avere 1-10 lettere e numeri e non può contenere simboli',
  passwordRequiredError: 'La password è obbligatoria',
  updatePassword: 'Aggiorna password',
  passwordRequired: 'La password è obbligatoria',
  passwordValidationHint: 'Inserisci una password di 1-10 caratteri (solo lettere e numeri)',
  anyoneWithLink: 'Chiunque abbia un link',
  onlyRingCentralAccounts: 'Solo account {shortName}',
  onlyMyCoworkers: 'Solo i miei collaboratori',
  allParticipants: 'Tutti i partecipanti',
  forAnyoneOutsideMyCompany: 'Per chiunque al di fuori della mia azienda',
  forAnyoneNotSignedIn: "Per chi non ha effettuato l'accesso",
  personalMeetingSettings: 'Impostazioni riunione personale',
  personalMeetingSettingsDescription: 'Imposta chi può partecipare e come per il tuo collegamento alla riunione personale.',
  hour: 'h',
  minute: 'min',
  adminLockedSetting: "L'impostazione è gestita dall'amministratore dell'azienda",
