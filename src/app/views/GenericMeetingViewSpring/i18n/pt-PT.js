...
var _default = exports["default"] = {
  ...
  time: 'Hora',
  duration: 'Duração',
  scheduleVideoMeeting: 'Agendar videoconferência',
  requirePassword: 'Exigir palavra-passe',
  requirePasswordDescription: 'Mantenha a sua reunião segura. Não será solicitada uma palavra-passe às pessoas que utilizem a ligação.',
  password: 'Palavra-passe',
  edit: 'Editar',
  noPasswordSet: 'Nenhuma palavra-passe definida',
  manageWhoCanJoin: 'Gerir quem pode entrar',
  useWaitingRoom: 'Utilizar sala de espera',
  useWaitingRoomDescription: 'Os participantes aguardam até que os admita. Ideal para entrevistas ou participantes externos.',
  startMeetingAfterJoin: 'Iniciar reunião após a sua entrada',
  startMeetingAfterJoinDescription: 'A reunião começará depois de entrar para evitar conversas antecipadas.',
  usePersonalMeetingLink: 'Utilizar ligação da reunião pessoal',
  personalMeetingLink: 'Ligação da reunião pessoal',
  editSettings: 'Editar definições',
  scheduleMeeting: 'Agendar reunião',
  cancel: 'Cancelar',
  update: 'Atualizar',
  updating: 'A atualizar…',
  passwordFormatError: 'A palavra-passe deve ter 1 a 10 letras e números, mas não pode conter símbolos',
  passwordRequiredError: 'A palavra-passe é obrigatória',
  updatePassword: 'Atualizar palavra-passe',
  passwordRequired: 'A palavra-passe é obrigatória',
  passwordValidationHint: 'Introduza uma palavra-passe com 1 a 10 carateres (apenas letras e números)',
  anyoneWithLink: 'Qualquer pessoa com a ligação',
  onlyRingCentralAccounts: 'Apenas contas {shortName}',
  onlyMyCoworkers: 'Apenas os meus colegas',
  allParticipants: 'Todos os participantes',
  forAnyoneOutsideMyCompany: 'Para qualquer pessoa fora da minha empresa',
  forAnyoneNotSignedIn: 'Para qualquer pessoa sem sessão iniciada',
  personalMeetingSettings: 'Definições da reunião pessoal',
  personalMeetingSettingsDescription: 'Defina quem pode entrar e como o pode fazer para a sua ligação da reunião pessoal.',
  hour: 'h',
  minute: 'min',
  adminLockedSetting: 'Esta definição é gerida pelo administrador da empresa',
