...
exports.PasswordEditDialog = void 0;
...
var PasswordEditDialog = exports.PasswordEditDialog = function PasswordEditDialog(_ref) {
  var open = _ref.open,
  ...
  var handlePasswordChange = function handlePasswordChange(value) {
    setPassword(value);
    var validationError = validatePassword(value);
  ...
  var isValid = !error && password.length > 0;
  return /*#__PURE__*/_react["default"].createElement(_springUi.Dialog, {
    ...
    className: "px-3"
  }, t('updatePassword')), /*#__PURE__*/_react["default"].createElement(_springUi.DialogContent, {
    className: "px-3"
  ...
  }, t('password')), /*#__PURE__*/_react["default"].createElement(_springUi.TextField, {
    variant: "outlined",
    size: "medium",
    value: password,
...
//# sourceMappingURL=PasswordEditDialog.js.map
