...
var _default = exports["default"] = (_RINGS_TYPE$Phone_Rin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Phone_Ring1, 'Sonnerie 1'), _const.RINGS_TYPE.Phone_Ring2, 'Sonnerie 2'), _const.RINGS_TYPE.Acoustic_Dreams, 'Acoustique'), _const.RINGS_TYPE.Air_Raid, 'Raid aérien'), _const.RINGS_TYPE.Allusive, 'Allusif'), _const.RINGS_TYPE.Attention, 'Attention'), _const.RINGS_TYPE.Blub_Blub, 'Blub Blub'), _const.RINGS_TYPE.Buzzy, 'Vibration'), _const.RINGS_TYPE.Channel_Open, 'Canal ouvert'), _const.RINGS_TYPE.Contemplation, 'Contemplation'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Crystal_Ball, 'Cristal'), _const.RINGS_TYPE.Disco, 'Disco'), _const.RINGS_TYPE.Door_Bell, 'Sonnette'), _const.RINGS_TYPE.Fairy, 'Fée'), _const.RINGS_TYPE.Fast_Bells, 'Cloches Rapides'), _const.RINGS_TYPE.High_Gong, 'Gong aigu'), _const.RINGS_TYPE.Immersion, 'Immersion'), _const.RINGS_TYPE.Indeed, 'En effet'), _const.RINGS_TYPE.Lazy_Day, 'Détente'), _const.RINGS_TYPE.Neural_Funk, 'Neurone'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Nice, 'Agréable'), _const.RINGS_TYPE.Ring, 'Sonnerie'), _const.RINGS_TYPE.Ringing_Bells, 'Cloches'), _const.RINGS_TYPE.Simple, 'Simple'), _const.RINGS_TYPE.Soothing, 'Apaisant'), _const.RINGS_TYPE.Sunshine, 'Ensoleillement'), _const.RINGS_TYPE.Off, 'Désactivé'), "add", 'Ajouter'), "delete", 'Supprimer'), "play", 'Lire'), _defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, "cancel", 'Annuler'), "confirmToDelete", 'Supprimer {name}?')); // @key: @#@"[RINGS_TYPE.Phone_Ring1]"@#@ @source: @#@"Phone Ring 1"@#@
