...
var _default = exports["default"] = (_RINGS_TYPE$Phone_Rin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Phone_Ring1, 'Toque do telefone 1'), _const.RINGS_TYPE.Phone_Ring2, 'Toque do telefone 2'), _const.RINGS_TYPE.Acoustic_Dreams, 'Sonhos acústicos'), _const.RINGS_TYPE.Air_Raid, 'Ataque aéreo'), _const.RINGS_TYPE.Allusive, 'Alusivo'), _const.RINGS_TYPE.Attention, 'Atenção'), _const.RINGS_TYPE.Blub_Blub, 'Blub Blub'), _const.RINGS_TYPE.Buzzy, 'Zumbido'), _const.RINGS_TYPE.Channel_Open, 'Canal aberto'), _const.RINGS_TYPE.Contemplation, 'Contemplação'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Crystal_Ball, 'Bola de cristal'), _const.RINGS_TYPE.Disco, 'Discoteca'), _const.RINGS_TYPE.Door_Bell, 'Campainha de porta'), _const.RINGS_TYPE.Fairy, 'Fada'), _const.RINGS_TYPE.Fast_Bells, 'Sinos rápidos'), _const.RINGS_TYPE.High_Gong, 'Gongo alto'), _const.RINGS_TYPE.Immersion, 'Imersão'), _const.RINGS_TYPE.Indeed, 'Realmente'), _const.RINGS_TYPE.Lazy_Day, 'Dia de preguiça'), _const.RINGS_TYPE.Neural_Funk, 'Funk neural'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Nice, 'Agradável'), _const.RINGS_TYPE.Ring, 'Campainha'), _const.RINGS_TYPE.Ringing_Bells, 'Sinos a tocar'), _const.RINGS_TYPE.Simple, 'Simples'), _const.RINGS_TYPE.Soothing, 'Calmante'), _const.RINGS_TYPE.Sunshine, 'Luz do sol'), _const.RINGS_TYPE.Off, 'Desativado'), "add", 'Adicionar'), "delete", 'Eliminar'), "play", 'Reproduzir'), _defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, "cancel", 'Cancelar'), "confirmToDelete", 'Eliminar {name}?')); // @key: @#@"[RINGS_TYPE.Phone_Ring1]"@#@ @source: @#@"Phone Ring 1"@#@
