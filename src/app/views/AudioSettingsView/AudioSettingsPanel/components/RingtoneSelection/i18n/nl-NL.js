...
var _default = exports["default"] = (_RINGS_TYPE$Phone_Rin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Phone_Ring1, 'Beltoon 1'), _const.RINGS_TYPE.Phone_Ring2, 'Beltoon 2'), _const.RINGS_TYPE.Acoustic_Dreams, 'Akoestische dromen'), _const.RINGS_TYPE.Air_Raid, 'Luchtaanval'), _const.RINGS_TYPE.Allusive, 'Zinspelend'), _const.RINGS_TYPE.Attention, 'Let op'), _const.RINGS_TYPE.Blub_Blub, 'Blub blub'), _const.RINGS_TYPE.Buzzy, 'Zoemend'), _const.RINGS_TYPE.Channel_Open, 'Kanaal open'), _const.RINGS_TYPE.Contemplation, 'Reflectie'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Crystal_Ball, 'Kristallen bol'), _const.RINGS_TYPE.Disco, 'Disco'), _const.RINGS_TYPE.Door_Bell, 'Deurbel'), _const.RINGS_TYPE.Fairy, 'Elfje'), _const.RINGS_TYPE.Fast_Bells, 'Snelle bellen'), _const.RINGS_TYPE.High_Gong, 'Hoge gong'), _const.RINGS_TYPE.Immersion, 'Onderdompeling'), _const.RINGS_TYPE.Indeed, 'Inderdaad'), _const.RINGS_TYPE.Lazy_Day, 'Luie dag'), _const.RINGS_TYPE.Neural_Funk, 'Neurale funk'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Nice, 'Mooi'), _const.RINGS_TYPE.Ring, 'Ring'), _const.RINGS_TYPE.Ringing_Bells, 'Rinkelende bellen'), _const.RINGS_TYPE.Simple, 'Simpel'), _const.RINGS_TYPE.Soothing, 'Kalmerend'), _const.RINGS_TYPE.Sunshine, 'Zonneschijn'), _const.RINGS_TYPE.Off, 'Uit'), "add", 'Toevoegen'), "delete", 'Verwijderen'), "play", 'Afspelen'), _defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, "cancel", 'Annuleren'), "confirmToDelete", '{name} verwijderen?')); // @key: @#@"[RINGS_TYPE.Phone_Ring1]"@#@ @source: @#@"Phone Ring 1"@#@
