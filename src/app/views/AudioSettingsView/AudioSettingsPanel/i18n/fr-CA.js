...
var _default = exports["default"] = {
  ...
  autoAdjustMicLevel: 'Régler automatiquement le volume du micro',
  output: 'Sortie',
  speakerSource: 'Source du haut-parleur',
  speakerVolume: 'Volume du haut-parleur',
  ringtoneSource: 'Sonnerie et source de notification',
  ringtoneVolume: 'Volume de la sonnerie et de la notification',
  ringtones: 'Sonneries',
  noDevices: 'Aucun appareil',
  off: 'Désactivé',
  noLabel: 'Périphérique inconnu',
  stopRecordDescription: 'Dites quelque chose pour vérifier le volume de votre micro ({countDown} s)',
  stopPlaybackDescription: 'Lecture de votre enregistrement…',
  startRecordButton: 'Tester le microphone',
