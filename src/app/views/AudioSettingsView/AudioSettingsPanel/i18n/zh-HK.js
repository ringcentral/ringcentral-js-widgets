...
var _default = exports["default"] = {
  ...
  input: '輸入',
  microphone: '麥克風',
  autoAdjustMicLevel: '自動調整麥克風音量',
  output: '輸出',
  speakerSource: '喇叭來源',
  speakerVolume: '喇叭音量',
  ringtoneSource: '鈴聲和通知聲源',
  ringtoneVolume: '鈴聲和通知音量',
  ringtones: '鈴聲',
  noDevices: '無裝置',
  off: '關閉',
  noLabel: '未知的裝置',
  stopRecordDescription: '請說話以測試麥克風音量（{countDown} 秒）',
  stopPlaybackDescription: '正在播放錄音…',
  startRecordButton: '測試麥克風',
  stopRecordButton: '停止錄製',
  stopPlaybackButton: '停止測試',
  startTestButton: '測試喇叭',
  stopTestDescription: '正在播放範例音效...'
