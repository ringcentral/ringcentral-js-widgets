...
var _default = exports["default"] = {
  ...
  input: 'Entrée',
  microphone: 'Micro',
  autoAdjustMicLevel: 'Régler automatiquement le niveau de mon micro',
  output: 'Sortie',
  speakerSource: 'Source du haut-parleur',
  speakerVolume: 'Volume du haut-parleur',
  ringtoneSource: 'Source de la sonnerie et des notifications',
  ringtoneVolume: 'Volume de la sonnerie et des notifications',
  ringtones: 'Sonneries',
  noDevices: 'Aucun terminal',
  off: 'Désactivé',
  noLabel: 'Périphérique inconnu',
  stopRecordDescription: 'Dites quelque chose pour vérifier le niveau de votre micro ({countDown} secondes)',
  stopPlaybackDescription: 'Lecture de votre enregistrement…',
  startRecordButton: 'Tester le micro',
  stopRecordButton: 'Arrêter l’enregistrement',
  stopPlaybackButton: 'Arrêter le test',
  startTestButton: 'Tester le haut-parleur',
  stopTestDescription: 'Lecture de l’échantillon sonore…'
