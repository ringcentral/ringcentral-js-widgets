...
var _default = exports["default"] = {
  ...
  autoAdjustMicLevel: 'Ajustar automáticamente el nivel del micrófono',
  output: 'Salida',
  speakerSource: 'Origen de altavoz',
  speakerVolume: 'Volumen de altavoz',
  ringtoneSource: 'Origen de tono de llamada y notificación',
  ringtoneVolume: 'Volumen de tono de llamada y notificación',
  ringtones: 'Tonos de llamada',
  noDevices: 'No hay dispositivos',
  off: 'Desactivado',
  noLabel: 'Dispositivo desconocido',
  stopRecordDescription: 'Diga algo para comprobar el nivel del micrófono ({countDown}s)',
  stopPlaybackDescription: 'Reproduciendo su grabación...',
  startRecordButton: 'Probar micrófono',
  stopRecordButton: 'Detener grabación',
  stopPlaybackButton: 'Detener prueba',
  startTestButton: 'Probar altavoz',
  stopTestDescription: 'Reproduciendo sonido de muestra…'
