...
var _default = exports["default"] = {
  ...
  autoAdjustMicLevel: 'Säädä mikrofonin äänenvoimakkuutta automaattisesti',
  output: 'Lähtö',
  speakerSource: 'Kaiutinlähde',
  speakerVolume: 'Kaiuttimen äänenvoimakkuus',
  ringtoneSource: 'Soittoäänen ja ilmoitusten lähde',
  ringtoneVolume: 'Soittoäänen ja ilmoitusten äänenvoimakkuus',
  ringtones: 'Soittoäänet',
  noDevices: 'Ei laitteita',
  off: 'Pois päältä',
  noLabel: 'Tuntematon laite',
  stopRecordDescription: 'Testaa mikrofonin äänitaso puhumalla jotain ({countDown} s)',
  stopPlaybackDescription: 'Toistetaan tallennettasi...',
  startRecordButton: 'Testaa mikrofonia',
  stopRecordButton: 'Lopeta tallentaminen',
  stopPlaybackButton: 'Pysäytä testi',
  startTestButton: 'Testaa kaiutinta',
  stopTestDescription: 'Toistetaan ääninäytettä...'
