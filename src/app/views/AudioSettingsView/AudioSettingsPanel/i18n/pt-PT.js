...
var _default = exports["default"] = {
  ...
  autoAdjustMicLevel: 'Ajustar automaticamente o volume do microfone',
  output: 'Saída',
  speakerSource: 'Origem do altifalante',
  speakerVolume: 'Volume do altifalante',
  ...
  stopRecordDescription: 'Diga alguma coisa para verificar o nível do seu microfone ({countDown} s)',
  stopPlaybackDescription: 'A reproduzir a sua gravação...',
  startRecordButton: 'Testar microfone',
  stopRecordButton: 'Parar gravação',
  stopPlaybackButton: 'Parar o teste',
  startTestButton: 'Testar altifalante',
  stopTestDescription: 'A reproduzir exemplo de som...'
