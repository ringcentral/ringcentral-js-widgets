...
var iconContainerClassName = 'inline-flex items-center justify-start flex-col gap-2 w-20';
var TransferPage = exports.TransferPage = function TransferPage(_ref) {
  var _ref$onAction = _ref.onAction,
    onAction = _ref$onAction === void 0 ? _rxjs.noop : _ref$onAction,
    callVolume = _ref.callVolume,
    outputDeviceId = _ref.outputDeviceId,
    enableWarmTransfer = _ref.enableWarmTransfer,
    actionButtonDisabled = _ref.actionButtonDisabled,
    toNumberProp = _ref.toNumber,
    onToNumberChange = _ref.onToNumberChange,
    recipientsProp = _ref.recipients,
    onRecipientsChange = _ref.onRecipientsChange,
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_components.PageHeader, {
    ...
    symbol: _springIcon.AskFirstMd,
    value: "warmTransfer",
    onClick: function onClick() {
      return onAction('startWarmTransfer');
    }
  }), /*#__PURE__*/_react["default"].createElement("div", {
    className: "typography-descriptorMini text-center"
  }, t('warmTransfer'))), /*#__PURE__*/_react["default"].createElement("div", {
    className: iconContainerClassName
  }, /*#__PURE__*/_react["default"].createElement(_springUi.IconButton, {
    size: "xlarge",
    color: "primary",
    ...
    value: "blindTransfer",
    onClick: function onClick() {
      return onAction('startTransfer');
    }
  }), /*#__PURE__*/_react["default"].createElement("div", {
    className: "typography-descriptorMini text-center"
  }, t('blindTransfer'))), /*#__PURE__*/_react["default"].createElement("div", {
    className: iconContainerClassName
  }, /*#__PURE__*/_react["default"].createElement(_springUi.IconButton, {
    size: "xlarge",
    ...
    onClick: function onClick() {
      return onAction('startTransferToVoicemail');
    }
  }), /*#__PURE__*/_react["default"].createElement("div", {
    className: "typography-descriptorMini text-center"
  }, t('toVoicemail')))))));
