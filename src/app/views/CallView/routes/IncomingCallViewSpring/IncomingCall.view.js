...
var _i18n = require("./IncomingCallPage/i18n");
...
var IncomingCallView = exports.IncomingCallView = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('IncomingCallViewOptions')(target, undefined, 6);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _nextCore.Root === "undefined" ? Object : _nextCore.Root, typeof _services2.CallAction === "undefined" ? Object : _services2.CallAction, typeof _services2.CallMonitor === "undefined" ? Object : _services2.CallMonitor, typeof _services2.ForwardingNumber === "undefined" ? Object : _services2.ForwardingNumber, typeof _services.AppFeatures === "undefined" ? Object : _services.AppFeatures, typeof _services2.CallingSettings === "undefined" ? Object : _services2.CallingSettings, typeof IncomingCallViewOptions === "undefined" ? Object : IncomingCallViewOptions]), _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = /*#__PURE__*/function (_RcViewModule) {
  function IncomingCallView(_root, _callAction, _callMonitor, _forwardingNumber, _appFeatures, _callingSettings, _incomingCallViewOptions) {
    var _this;
    ...
    _this.classes = {
      miniContainer: _this._root.expandedLayoutMainClass
    };
    return _this;
  }
  ...
  return _createClass(IncomingCallView, [{
    ...
    get: function get() {
      return [].concat(_toConsumableArray(this._forwardingNumber.forwardingNumbers), [{
        phoneNumber: 'custom',
        label: "".concat((0, _i18n.t)('custom'), "...")
      }]);
    }
  }, {
    key: "useCallActions",
    value: function useCallActions(_ref) {
      ...
      var _useConnector = (0, _nextCore.useConnector)(function () {
          return {
            hasActiveCalls: _this2._callMonitor.currDeviceHasActiveCalls,
            isCallForwardingEnabled: _this2._appFeatures.isCallForwardingEnabled
          };
        }),
        hasActiveCalls = _useConnector.hasActiveCalls,
        isCallForwardingEnabled = _useConnector.isCallForwardingEnabled;
      var disabled = actionsDisabled;
      var beQueueCall = (0, _services2.isQueueCall)(call);
      var onOtherDevice = (0, _services2.isOtherDeviceCall)(call);
      if (beQueueCall) {
        return [{
          type: 'ignoreQueue',
          disabled: disabled
    ...
    value: function getUIProps(_ref2) {
      ...
      return {
        ...
        mode: beQueueCall ? 'queue' : this._callMonitor.currDeviceHasActiveCalls ? 'multiple' : 'single',
    ...
    value: function getUIFunctions(_ref3) {
      ...
      return {
        onMinimized: function () {
          var _onMinimized = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(minimized) {
            return _regenerator().w(function (_context) {
              while (1) switch (_context.n) {
                case 0:
                  ...
                  if (!_this3._callAction.activeCallInfo) {
                    _context.n = 1;
                    break;
                  }
                  _context.n = 1;
                  return _this3._callAction.onActiveActions('back');
                case 1:
                  _context.n = 2;
                  return _this3._callAction.onActiveActions('activeCall', telephonySessionId);
                case 2:
                  _context.n = 3;
                  return _this3._callAction.updateCallMetaInfo(telephonySessionId, {
                    minimized: minimized
                  });
                case 3:
                  return _context.a(2);
          ...
          function onMinimized(_x) {
            return _onMinimized.apply(this, arguments);
          }
          return onMinimized;
        }(),
        ...
        onAction: function onAction() {
          return _this3._callAction.createActionsHandler(telephonySessionId).apply(void 0, arguments);
        }
      };
    }
  }, {
    ...
    value: function component(props) {
      ...
      var _useResultRef = (0, _useResultRef2.useResultRef)(function () {
          return _this4.getUIFunctions(props);
        }),
      ...
      var Component = ((_this$_incomingCallVi = this._incomingCallViewOptions) === null || _this$_incomingCallVi === void 0 ? void 0 : _this$_incomingCallVi.component) || _IncomingCallPage.IncomingCallPage;
      return /*#__PURE__*/_react["default"].createElement(Component, _extends({}, _props, {
        actions: actions
      }, uiFunctions));
    }
  }]);
}(_nextCore.RcViewModule), _applyDecoratedDescriptor(_class2.prototype, "forwardingNumbers", [_nextCore.computed, _dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "forwardingNumbers"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class);
