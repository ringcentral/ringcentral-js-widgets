...
export default {
  [HintsType.thirdPartyNoRecordsContent]:
    'Escriba al menos {minimumLength} caracteres para buscar {sourceName} contactos.',
  [HintsType.noFilterOrSearchRecordsTitle]: 'No hay resultados',
  [HintsType.noFilterOrSearchRecordsContent]:
    'Verifique los resultados desde otras fuentes o cambie la palabra clave.',
  ...
  doNotCall: 'No llamar',
  enterNameOrNumber: 'Ingresar nombres o números de teléfono',
  enterANameOrNumber: 'Ingresar un nombre o número',
  to: 'Para',
  dial: 'Marcación',
  message: 'Mensaje',
  transfer: 'Transferir',
