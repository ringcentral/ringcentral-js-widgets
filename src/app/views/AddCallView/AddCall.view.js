...
var AddCallView = exports.AddCallView = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('AddCallViewOptions')(target, undefined, 14);
}, _dec8 = Reflect.metadata("design:type", Function), _dec9 = Reflect.metadata("design:paramtypes", [typeof _services3.Locale === "undefined" ? Object : _services3.Locale, typeof _services.RegionSettings === "undefined" ? Object : _services.RegionSettings, typeof _nextCore.RouterPlugin === "undefined" ? Object : _nextCore.RouterPlugin, typeof _services4.CallMonitor === "undefined" ? Object : _services4.CallMonitor, typeof _services.AccountInfo === "undefined" ? Object : _services.AccountInfo, typeof _services4.Call === "undefined" ? Object : _services4.Call, typeof _services4.CallingSettings === "undefined" ? Object : _services4.CallingSettings, typeof _DialerView.DialerView === "undefined" ? Object : _DialerView.DialerView, typeof _views.ContactSearchView === "undefined" ? Object : _views.ContactSearchView, typeof _services4.AudioSettings === "undefined" ? Object : _services4.AudioSettings, typeof _services2.ContactSearch === "undefined" ? Object : _services2.ContactSearch, typeof _services4.Webphone === "undefined" ? Object : _services4.Webphone, typeof _services4.ActiveCallControl === "undefined" ? Object : _services4.ActiveCallControl, typeof _services2.CompanyContacts === "undefined" ? Object : _services2.CompanyContacts, typeof AddCallViewOptions === "undefined" ? Object : AddCallViewOptions]), _dec0 = (0, _services.track)(function (that, eventName, contactType) {
  return [eventName, {
    contactType: contactType,
    location: 'Add Call'
  }];
}), _dec1 = Reflect.metadata("design:type", Function), _dec10 = Reflect.metadata("design:paramtypes", [String, String]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = _dec8(_class = _dec9(_class = (_class2 = /*#__PURE__*/function (_RcViewModule) {
  function AddCallView(_locale, _regionSettings, _router, _callMonitor, _accountInfo, _call, _callingSettings, _dialerView, _contactSearchView, _audioSettings, _contactSearch, _webphone, _activeCallControl, _companyContacts, _addCallViewOptions) {
    var _this;
  ...
  return _createClass(AddCallView, [{
    ...
    value: function getUIProps() {
      var _this$_contactSearch$, _this$_contactSearch, _this$_activeCallCont, _this$_audioSettings$, _this$_audioSettings, _this$_audioSettings$2, _this$_audioSettings2;
      return {
        ...
        controlBusy: ((_this$_activeCallCont = this._activeCallControl) === null || _this$_activeCallCont === void 0 ? void 0 : _this$_activeCallCont.busy) || !this._call.isIdle,
    ...
    value: function getUIFunctions() {
      ...
      return {
        ...
        searchContact: function searchContact(searchString) {
          ...
          (_this2$_contactSearch = _this2._contactSearch) === null || _this2$_contactSearch === void 0 ? void 0 : _this2$_contactSearch.debouncedSearch({
            searchString: searchString
          });
        },
        onAddCall: function () {
          var _onAddCall = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(params) {
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.n) {
                case 0:
                  _context2.n = 1;
                  return _this2._dialerView.call(params);
                case 1:
                  _this2._router.push('/dialer');
                case 2:
                  return _context2.a(2);
              }
            }, _callee2);
          }));
          function onAddCall(_x3) {
    ...
    value: function component(props) {
      ...
      var Component = ((_this$_addCallViewOpt = this._addCallViewOptions) === null || _this$_addCallViewOpt === void 0 ? void 0 : _this$_addCallViewOpt.component) || _deprecated.AddCallPanel;
      return (
        /*#__PURE__*/
        // TODO: fix type
        // @ts-ignore
        _react["default"].createElement(Component, _extends({}, _props, {
          ContactSearch: this._contactSearchView.component
        }, uiFunctions))
      );
    }
  }]);
}(_nextCore.RcViewModule), _applyDecoratedDescriptor(_class2.prototype, "triggerEventTracking", [_dec0, _dec1, _dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "triggerEventTracking"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class);
