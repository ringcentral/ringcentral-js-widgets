...
var _default = exports["default"] = {
  ...
  title: 'Plantillas de mensaje de texto',
  fieldTitle: 'Nombre de la plantilla',
  fieldTitlePlaceholder: 'Introduzca el nombre de la plantilla',
  fieldContent: 'Contenido de la plantilla',
  fieldContentPlaceholder: 'Introducir texto de la plantilla',
  cancel: 'Cancelar',
  save: 'Guardar',
  noTemplatesYet: 'Aún no hay plantillas de mensaje de texto',
  createTemplatesHint: 'Cree plantillas de mensaje de texto para ahorrar tiempo y esfuerzo.',
  apply: 'Aplicar',
  copy: 'Copiar',
  edit: 'Editar',
  "delete": 'Eliminar',
  ...
  discardChangesMessage: 'Tiene cambios sin guardar. ¿Seguro de que desea descartarlos?',
  discard: 'Descartar'
