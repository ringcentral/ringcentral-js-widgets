...
var _default = exports["default"] = {
  ...
  title: '簡訊範本',
  fieldTitle: '範本名稱',
  fieldTitlePlaceholder: '輸入範本名稱',
  fieldContent: '範本內容',
  fieldContentPlaceholder: '輸入範本文字',
  cancel: '取消',
  save: '儲存',
  noTemplatesYet: '尚無簡訊範本',
  createTemplatesHint: '建立簡訊範本以節省時間和人力。',
  apply: '套用',
  copy: '複製',
  edit: '編輯',
  "delete": '刪除',
  ...
  searchTemplate: '搜尋範本',
  noResults: '找不到搜尋結果',
  discardChangesTitle: '是否捨棄變更？',
  discardChangesMessage: '您有未儲存的變更。確定要捨棄這些變更嗎？',
  discard: '捨棄'
