...
export default {
  ...
  title: 'Modelos de mensagens de texto',
  fieldTitle: 'Nome do modelo',
  fieldTitlePlaceholder: 'Insira o nome do modelo',
  fieldContent: 'Conteúdo do modelo',
  fieldContentPlaceholder: 'Insira o texto do modelo',
  cancel: 'Cancelar',
  save: 'Salvar',
  noTemplatesYet: 'Nenhum modelo de mensagens de texto ainda',
  createTemplatesHint:
    'Crie modelos de mensagens de texto para economizar tempo e esforço.',
  apply: 'Aplicar',
  copy: 'Copiar',
  edit: 'Editar',
  delete: 'Excluir',
