...
var _default = exports["default"] = {
  ...
  fieldTitlePlaceholder: 'Saisir le nom du modèle',
  fieldContent: 'Contenu du modèle',
  fieldContentPlaceholder: 'Saisissez le texte du modèle',
  cancel: 'Annuler',
  save: 'Enregistrer',
  noTemplatesYet: 'Aucun modèle SMS pour l’instant',
  createTemplatesHint: 'Créez des modèles SMS pour travailler plus rapidement.',
  apply: 'Appliquer',
  copy: 'Copier',
  edit: 'Modifier',
  "delete": 'Supprimer',
  ...
  discardChangesMessage: 'Vous avez des modifications non enregistrées. Voulez-vous vraiment les abandonner ?',
  discard: 'Annuler'
