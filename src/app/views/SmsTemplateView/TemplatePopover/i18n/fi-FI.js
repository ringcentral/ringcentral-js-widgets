...
var _default = exports["default"] = {
  useTemplate: 'Käytä mallipohjaa',
  addTemplate: 'Uusi mallipohja',
  title: 'Tekstiviestimallipohjat',
  fieldTitle: 'Mallipohjan nimi',
  fieldTitlePlaceholder: 'Anna mallipohjan nimi',
  fieldContent: 'Mallipohjan sisältö',
  fieldContentPlaceholder: 'Syötä mallipohjan teksti',
  cancel: 'Peruuta',
  save: 'Tallenna',
  noTemplatesYet: 'Tekstiviestimallipohjia ei vielä ole',
  createTemplatesHint: 'Säästä aikaa ja vaivaa luomalla tekstiviestimallipohjia.',
  apply: 'Käytä',
  copy: 'Kopioi',
  edit: 'Muokkaa',
  "delete": 'Poista',
  more: 'Enemmän',
  searchTemplate: 'Hae malleja',
  noResults: 'Hakutuloksia ei löytynyt',
  discardChangesTitle: 'Hylätäänkö muutokset?',
  discardChangesMessage: 'Muutoksia ei ole tallennettu. Haluatko varmasti hylätä ne?',
  discard: 'Hylkää'
