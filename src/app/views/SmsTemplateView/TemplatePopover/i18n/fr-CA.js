...
var _default = exports["default"] = {
  ...
  title: 'Modèles de messages texte',
  fieldTitle: 'Nom du modèle',
  fieldTitlePlaceholder: 'Entrer le nom du modèle',
  fieldContent: 'Contenu du modèle',
  fieldContentPlaceholder: 'Entrer le texte du modèle',
  cancel: 'Annuler',
  save: 'Enregistrer',
  noTemplatesYet: 'Aucun modèle de texto pour le moment',
  createTemplatesHint: 'Créez des modèles de textos pour gagner du temps.',
  apply: 'Appliquer',
  copy: 'Copier',
  edit: 'Modifier',
  "delete": 'Supprimer',
  more: 'Plus',
  searchTemplate: 'Chercher des modèles',
  noResults: 'Aucun résultat de recherche',
  discardChangesTitle: 'Abandonner les modifications?',
  discardChangesMessage: 'Vous avez des modifications non enregistrées. Voulez-vous vraiment les supprimer?',
  discard: 'Abandonner'
