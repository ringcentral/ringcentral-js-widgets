...
var _default = exports["default"] = {
  ...
  title: 'Modelli di messaggio di testo',
  fieldTitle: 'Nome modello',
  fieldTitlePlaceholder: 'Inserisci nome modello',
  fieldContent: 'Contenuto modello',
  fieldContentPlaceholder: 'Inserisci testo modello',
  cancel: 'Annulla',
  save: 'Salva',
  noTemplatesYet: 'Ancora nessun modello di messaggio di testo',
  createTemplatesHint: 'Crea modelli di messaggi di testo per risparmiare tempo e fatica.',
  apply: 'Applica',
  copy: 'Copia',
  edit: 'Modifica',
  "delete": 'Elimina',
  ...
  noResults: 'Nessun risultato di ricerca trovato',
  discardChangesTitle: 'Eliminare le modifiche?',
  discardChangesMessage: 'Sono presenti modifiche non salvate. Eliminarle?',
  discard: 'Elimina'
