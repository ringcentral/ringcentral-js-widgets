...
var _default = exports["default"] = {
  ...
  title: '텍스트 메시지 템플릿',
  fieldTitle: '템플릿 이름',
  fieldTitlePlaceholder: '템플릿 이름 입력',
  fieldContent: '템플릿 내용',
  fieldContentPlaceholder: '템플릿 텍스트 입력',
  cancel: '취소',
  save: '저장',
  noTemplatesYet: '아직 텍스트 메시지 템플릿 없음',
  createTemplatesHint: '텍스트 메시지 템플릿을 만들어 시간과 노력을 절약하세요.',
  apply: '적용',
  copy: '복사',
  edit: '편집',
  "delete": '삭제',
  ...
  noResults: '검색 결과 없음',
  discardChangesTitle: '변경 사항을 삭제하시겠습니까?',
  discardChangesMessage: '저장되지 않은 변경 사항이 있습니다. 삭제하시겠습니까?',
  discard: '삭제'
