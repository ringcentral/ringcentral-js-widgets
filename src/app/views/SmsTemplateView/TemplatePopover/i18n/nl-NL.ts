...
export default {
  ...
  addTemplate: 'Nieuwe sjabloon',
  title: 'Tekstberichtsjablonen',
  fieldTitle: 'Sjabloonnaam',
  fieldTitlePlaceholder: 'Voer een sjabloonnaam',
  fieldContent: 'Sjablooninhoud',
  fieldContentPlaceholder: 'Sjabloontekst invoeren',
  cancel: 'Annuleren',
  save: 'Opslaan',
  noTemplatesYet: 'Nog geen sjablonen voor tekstberichten',
  createTemplatesHint:
    'Maak sjablonen voor tekstberichten om tijd en moeite te besparen.',
  apply: 'Toepassen',
  copy: 'Kopiëren',
  edit: 'Bewerken',
  delete: 'Verwijderen',
  ...
  noResults: 'Geen zoekresultaten gevonden',
  discardChangesTitle: 'Wijzigingen verwijderen?',
  discardChangesMessage:
    'Er zijn niet-opgeslagen wijzigingen. Weet u zeker dat u ze wilt weggooien?',
  discard: 'Verwijderen',
} as const;
