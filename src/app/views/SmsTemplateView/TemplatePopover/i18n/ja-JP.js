...
var _default = exports["default"] = {
  ...
  addTemplate: '新規テンプレート',
  title: 'テキストメッセージのテンプレート',
  fieldTitle: 'テンプレート名',
  fieldTitlePlaceholder: 'テンプレート名を入力',
  fieldContent: 'テンプレートの内容',
  fieldContentPlaceholder: 'テンプレートのテキストを入力',
  cancel: 'キャンセル',
  save: '保存',
  noTemplatesYet: 'まだテキストメッセージのテンプレートがありません',
  createTemplatesHint: 'テキストメッセージのテンプレートを作成して、時間と労力を節約しましょう。',
  apply: '適用',
  copy: 'コピー',
  edit: '編集',
  "delete": '削除',
  ...
  discardChangesMessage: '保存されていない変更があります。本当に破棄してもよろしいですか？',
  discard: '破棄'
