...
var _default = exports["default"] = {
  ...
  selectToDialSMS: 'Seleccione para marcar/enviar SMS',
  selectToDial: 'Seleccione para marcar',
  selectToSMS: 'Seleccione para enviar SMS',
  ...
  logExtensionCall: 'Registrar llamadas de extensión',
  audio: 'Audio',
  language: 'Idioma',
  ...
  openEntityFrom: 'Comportamiento de objetos de Salesforce',
  ...
  selectToDialHint: 'Para una mejor experiencia, seleccione el número de teléfono para marcar con {brandName} en una página con gran cantidad de números telefónicos.',
  phone: 'Teléfono',
  log: 'Registro',
  general: 'General',
  showMatches: 'Mostrar coincidencias para llamadas entrantes',
  popUpAppForInboundCall: 'Abrir la aplicación para llamadas entrantes',
  theme: 'Tema',
  syncSettings: 'Sincronizar la configuración de administrador más reciente'
