...
var _default = exports["default"] = {
  ...
  analytics: '分析',
  shareIdea: '分享想法',
  openEntityFrom: 'Salesforce 对象行为',
  openInNewTab: '在新选项卡中打开',
  openInCurrentTab: '在当前选项卡中打开',
  reportIssue: '报告问题',
  contactSupport: '联系支持人员',
  selectToDialHint: '为了获得更好的体验，请在大量电话号码页选择要使用 {brandName} 拨打的电话号码。',
  phone: '电话',
  log: '记录',
  general: '常规',
  showMatches: '显示来电的匹配项',
  popUpAppForInboundCall: '有来电时弹出应用',
  theme: '主题',
  syncSettings: '同步最新的管理员设置'
