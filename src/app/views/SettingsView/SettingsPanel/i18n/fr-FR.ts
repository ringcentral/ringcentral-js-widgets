...
export default {
  ...
  version: 'Version',
  settings: 'Paramètres',
  selectToDialSMS: 'Sélectionner pour appeler/envoyer un SMS',
  selectToDial: 'Sélectionner pour appeler',
  ...
  logSMSContent: 'Enregistrer le contenu des SMS',
  clickToDialSMS: 'Cliquer pour appeler ou envoyer un SMS',
  logExtensionCall: 'Journal des appels d’extension',
  audio: 'Audio',
  language: 'Langue',
  feedback: 'Commentaires',
  userGuide: 'Nouveautés',
  quickAccess: 'Paramètre d’accès rapide',
  report: 'Rapport d’analyses',
  analytics: 'Analyses',
  shareIdea: 'Partager une idée',
  openEntityFrom: 'Comportement des objets Salesforce',
  openInNewTab: 'Ouvrir dans un nouvel onglet',
  openInCurrentTab: 'Ouvrir dans l’onglet actuel',
  reportIssue: 'Signaler un problème',
  contactSupport: 'Contacter l’assistance',
  selectToDialHint:
    'Nous vous conseillons de sélectionner le numéro de téléphone à composer avec {brandName} sur la page des numéros de téléphone en lot.',
  phone: 'Téléphone',
  log: 'Journal',
  general: 'Général',
  showMatches: 'Afficher les correspondances pour les appels entrants',
  popUpAppForInboundCall:
    'Faire apparaître l’application pour les appels entrants',
  theme: 'Thème',
  syncSettings: 'Synchroniser les derniers paramètres d’administration',
} as const;
