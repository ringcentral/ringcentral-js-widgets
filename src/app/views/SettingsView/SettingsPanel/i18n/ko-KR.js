...
var _default = exports["default"] = {
  ...
  version: '버전',
  settings: '설정',
  selectToDialSMS: '전화 걸기/SMS 보내기 선택',
  selectToDial: '전화 걸기 선택',
  selectToSMS: 'SMS 보내기 선택',
  clickToDial: '클릭하여 통화',
  autoCreateLog: '통화 기록 자동으로 만들기',
  autoCreateSMSLog: 'SMS 기록 자동으로 만들기',
  autoLogCalls: '통화 자동 기록',
  autoLogNotes: '메모 자동 기록',
  autoLogSMS: 'SMS 자동 기록',
  clickToSMS: '클릭하여 SMS 보내기',
  logSMSContent: 'SMS 콘텐츠 기록',
  clickToDialSMS: '클릭하여 통화/SMS 보내기',
  logExtensionCall: '내선 통화 기록',
  audio: '오디오',
  language: '언어',
  feedback: '피드백',
  userGuide: '새로운 기능',
  ...
  analytics: '분석',
  shareIdea: '아이디어 공유',
  openEntityFrom: 'Salesforce 개체 동작',
  openInNewTab: '새 탭에서 열기',
  openInCurrentTab: '현재 탭에서 열기',
  reportIssue: '문제 보고',
  ...
  popUpAppForInboundCall: '수신 통화용 앱 팝업',
  theme: '테마',
  syncSettings: '최신 관리자 설정 동기화'
