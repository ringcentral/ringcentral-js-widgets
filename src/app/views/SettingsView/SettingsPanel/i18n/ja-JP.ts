...
export default {
  ...
  analytics: '分析',
  shareIdea: 'アイデアを共有',
  openEntityFrom: 'Salesforceオブジェクトの動作',
  openInNewTab: '新しいタブで開く',
  openInCurrentTab: '現在のタブで開く',
  reportIssue: '問題を報告',
  contactSupport: 'サポートへのお問い合わせ',
  selectToDialHint:
    'エクスペリエンスを向上させるため、大量の電話番号が記載されているページから{brandName}でダイヤルする電話番号を選択してください。',
  phone: '電話',
  log: 'ログ',
  general: '一般',
  showMatches: '着信呼の一致を表示',
  popUpAppForInboundCall: '着信呼に対してアプリをポップアップ',
  theme: 'テーマ',
  syncSettings: '最新の管理者設定を同期',
} as const;
