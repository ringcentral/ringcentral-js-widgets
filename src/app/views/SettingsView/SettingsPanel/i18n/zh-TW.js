...
var _default = exports["default"] = {
  ...
  analytics: '分析',
  shareIdea: '分享意見',
  openEntityFrom: 'Salesforce 物件行為',
  openInNewTab: '在新索引標籤中開啟',
  openInCurrentTab: '在目前索引標籤中開啟',
  reportIssue: '回報問題',
  contactSupport: '聯絡支援部門',
  selectToDialHint: '為了獲得更佳的體驗，請在大量電話號碼頁面中選取要使用 {brandName} 撥打的電話號碼。',
  phone: '電話',
  log: '記錄',
  general: '一般',
  showMatches: '顯示來電的相符項目',
  popUpAppForInboundCall: '有來電時快顯應用程式',
  theme: '主題',
  syncSettings: '同步最新的管理員設定'
