...
var _default = exports["default"] = {
  ...
  selectToDialSMS: 'Selecione para discar/enviar SMS',
  selectToDial: 'Selecione para discar',
  selectToSMS: 'Selecione para enviar SMS',
  ...
  logExtensionCall: 'Registrar chamadas do ramal',
  audio: 'Áudio',
  language: 'Idioma',
  ...
  openEntityFrom: 'Comportamento do objeto do Salesforce',
  openInNewTab: 'Abrir em nova guia',
  openInCurrentTab: 'Abrir na guia atual',
  reportIssue: 'Relatar problema',
  contactSupport: 'Entrar em contato com o suporte',
  selectToDialHint: 'Para ter a melhor experiência, selecione o número de telefone para discar com o {brandName} na página de números de telefone em grande quantidade.',
  phone: 'Telefone',
  log: 'Log',
  general: 'Geral',
  showMatches: 'Mostrar correspondências de chamadas de entrada',
  popUpAppForInboundCall: 'Abrir o aplicativo em janela pop-up para chamadas de entrada',
  theme: 'Tema',
  syncSettings: 'Sincronizar as configurações de administrador mais recentes'
