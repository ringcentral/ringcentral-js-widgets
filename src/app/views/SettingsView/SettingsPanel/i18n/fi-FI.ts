...
export default {
  ...
  version: 'Versio',
  settings: 'Asetukset',
  selectToDialSMS: 'Valitse, kun haluat soittaa / lähettää SMS:n',
  selectToDial: 'Valitse, kun haluat soittaa',
  selectToSMS: 'Valitse, kun haluat lähettää SMS:n',
  clickToDial: 'Valitse napsauttamalla',
  autoCreateLog: 'Luo puheluloki automaattisesti',
  autoCreateSMSLog: 'Luo SMS-loki automaattisesti',
  autoLogCalls: 'Lisää puhelut lokiin automaattisesti',
  autoLogNotes: 'Lisää muistiinpanot lokiin automaattisesti',
  autoLogSMS: 'Lisää SMS:t lokiin automaattisesti',
  clickToSMS: 'Lähetä SMS klikkaamalla',
  logSMSContent: 'Lisää SMS-sisältö lokiin',
  clickToDialSMS: 'Valitse/lähetä SMS napsauttamalla',
  logExtensionCall: 'Kirjaa alanumeron puhelut',
  audio: 'Ääni',
  language: 'Kieli',
  feedback: 'Palaute',
  userGuide: 'Uutta',
  ...
  shareIdea: 'Jaa idea',
  openEntityFrom: 'Salesforce-kohteen toiminta',
  openInNewTab: 'Avaa uudessa välilehdessä',
  openInCurrentTab: 'Avaa nykyisessä välilehdessä',
  ...
  popUpAppForInboundCall: 'Avaa sovellus saapuville puheluille',
  theme: 'Teema',
  syncSettings: 'Synkronoi viimeisimmät järjestelmänvalvojan asetukset',
} as const;
