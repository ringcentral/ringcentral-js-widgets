...
export default {
  ...
  selectToDialSMS: "Selecteren om te bellen/sms'en",
  selectToDial: 'Selecteren om te bellen',
  selectToSMS: "Selecteren om te sms'en",
  ...
  autoLogCalls: 'Automatisch oproepen registreren',
  ...
  logExtensionCall: 'Extensieoproepen loggen',
  audio: 'Audio',
  language: 'Taal',
  feedback: 'Feedback',
  userGuide: 'Nieuw',
  ...
  openEntityFrom: 'Gedrag Salesforce-object',
  openInNewTab: 'Openen in een nieuw tabblad',
  openInCurrentTab: 'Openen in het huidige tabblad',
  reportIssue: 'Probleem melden',
  contactSupport: 'Contact opnemen met de klantenservice',
  selectToDialHint:
    'Voor een betere ervaring selecteert u het telefoonnummer om te bellen met {brandName} op de pagina voor grote hoeveelheden telefoonnummers.',
  phone: 'Telefoon',
  log: 'Lijst',
  general: 'Algemeen',
  showMatches: 'Overeenkomsten tonen voor inkomende oproepen',
  popUpAppForInboundCall: 'De app weergeven voor inkomende oproepen',
  theme: 'Thema',
  syncSettings: 'Nieuwste beheerdersinstellingen synchroniseren',
} as const;
