...
export default {
  ...
  selectToDialHint:
    'Für eine bessere Erfahrung wählen Sie die Telefonnummer, die mit {brandName} gewählt werden soll, auf der Seite für Telefonnummern in großer Menge aus.',
  phone: 'Telefonie',
  log: 'Protokoll',
  general: 'Allgemein',
  showMatches: 'Übereinstimmungen für eingehende Anrufe anzeigen',
  popUpAppForInboundCall: 'Bei eingehenden Anrufen die App als Pop-up anzeigen',
  theme: 'Thema',
  syncSettings: 'Neueste Administratoreinstellungen synchronisieren',
} as const;
