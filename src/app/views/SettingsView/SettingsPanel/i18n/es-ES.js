...
var _default = exports["default"] = {
  ...
  selectToDialSMS: 'Seleccionar para marcar/enviar SMS',
  selectToDial: 'Seleccionar para marcar',
  selectToSMS: 'Seleccionar para enviar SMS',
  ...
  logSMSContent: 'Registro de contenido SMS',
  clickToDialSMS: 'Haga clic para marcar/enviar SMS',
  logExtensionCall: 'Registrar llamadas con extensión',
  audio: 'Audio',
  language: 'Idioma',
  ...
  openEntityFrom: 'Comportamiento del objeto de Salesforce',
  openInNewTab: 'Abrir en una nueva pestaña',
  openInCurrentTab: 'Abrir en la pestaña actual',
  reportIssue: 'Informar de un problema',
  contactSupport: 'Contactar con el servicio de asistencia técnica',
  selectToDialHint: 'Para mejorar su experiencia, seleccione el número de teléfono para marcar con {brandName} en la página de números de teléfono en gran cantidad.',
  phone: 'Teléfono',
  log: 'Registro',
  general: 'General',
  showMatches: 'Mostrar coincidencias de llamadas entrantes',
  popUpAppForInboundCall: 'Abrir la aplicación para llamadas entrantes',
  theme: 'Tema',
  syncSettings: 'Sincronizar la última configuración de administrador'
