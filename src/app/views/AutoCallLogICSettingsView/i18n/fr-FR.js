...
var _default = exports["default"] = {
  ...
  callLogging: 'Journalisation des appels',
  recordMatching: 'Correspondance des enregistrements',
  setWhichCallsToAutoLog: 'Définir les appels à enregistrer automatiquement',
  callLoggingInfo: 'Seuls les types d’appels spécifiés seront enregistrés automatiquement. Cliquez sur le bouton Enregistrer pour enregistrer manuellement les appels de votre choix.',
  callType: 'Type d’appel',
  contactType: 'Type de contact',
  multipleMatchedRecords: 'Plusieurs correspondances d’enregistrements',
  unknownNumbers: 'Numéros inconnus'
