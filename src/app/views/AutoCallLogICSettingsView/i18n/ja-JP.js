...
var _default = exports["default"] = {
  ...
  callLogging: '通話ログ',
  recordMatching: 'レコードの照合',
  setWhichCallsToAutoLog: '自動ログ記録する通話を設定',
  callLoggingInfo: '指定された通話タイプのみが自動的に保存されます。[保存]ボタンをクリックすると、通話を手動で保存できます。',
  callType: '通話タイプ',
  contactType: '連絡先タイプ',
  multipleMatchedRecords: '複数の一致した記録',
  unknownNumbers: '不明な番号'
