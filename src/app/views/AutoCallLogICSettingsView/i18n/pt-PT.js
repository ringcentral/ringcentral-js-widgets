...
var _default = exports["default"] = {
  ...
  callLogging: 'Registo de chamadas',
  recordMatching: 'Correspondência de registos',
  setWhichCallsToAutoLog: 'Defina as chamadas a registar automaticamente',
  callLoggingInfo: 'Apenas os tipos de chamadas designados serão guardados automaticamente. Pode guardar manualmente qualquer chamada ao clicar no botão Guardar.',
  callType: 'Tipo de chamada',
  contactType: 'Tipo de contacto',
  multipleMatchedRecords: 'Vários registos correspondentes',
  unknownNumbers: 'Números desconhecidos'
