...
export default {
  ...
  callLogging: '통화 기록 중',
  recordMatching: '일치하는 레코드',
  setWhichCallsToAutoLog: '자동 기록할 통화 설정',
  callLoggingInfo:
    '지정된 통화 유형만 자동으로 저장됩니다. 저장 버튼을 클릭하여 통화를 수동으로 저장할 수 있습니다.',
  callType: '통화 유형',
  contactType: '연락처 유형',
  multipleMatchedRecords: '여러 일치 레코드',
  unknownNumbers: '알 수 없는 번호',
} as const;
