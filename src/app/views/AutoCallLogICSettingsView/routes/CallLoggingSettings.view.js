...
exports.CallLoggingSettingsView = void 0;
require("core-js/modules/es.object.get-own-property-descriptor.js");
var _components = require("@ringcentral-integration/micro-core/src/app/components");
var _hooks = require("@ringcentral-integration/micro-core/src/app/hooks");
var _Section = require("@ringcentral-integration/micro-setting/src/app/components/Section");
...
var CallLoggingSettingsView = exports.CallLoggingSettingsView = (_dec = (0, _nextCore.injectable)({
  ...
  function CallLoggingSettingsView(_router, _aalOptions) {
    var _this;
    _classCallCheck(this, CallLoggingSettingsView);
    _this = _callSuper(this, CallLoggingSettingsView);
    _this._router = _router;
    _this._aalOptions = _aalOptions;
    return _this;
  }
  _inherits(CallLoggingSettingsView, _RcViewModule);
  return _createClass(CallLoggingSettingsView, [{
    key: "MainContent",
    value: function MainContent() {
      ...
      var _useConnector = (0, _nextCore.useConnector)(function () {
          ...
          return {
            configuration: (_this2$_aalOptions = _this2._aalOptions) === null || _this2$_aalOptions === void 0 ? void 0 : _this2$_aalOptions.autoCallLoggingPreference
          };
        }),
        configuration = _useConnector.configuration;
      return /*#__PURE__*/_react["default"].createElement(_Section.Section, {
        label: t('setWhichCallsToAutoLog'),
        info: t('callLoggingInfo')
    ...
    value: function component() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_components.AppHeaderNav, {
        ...
        "data-sign": "call-logging-ic-settings"
...
//# sourceMappingURL=CallLoggingSettings.view.js.map
