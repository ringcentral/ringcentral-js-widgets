...
import type { ActiveCallsPanel } from '@ringcentral-integration/widgets/components/ActiveCallsPanel';
import type { ConfirmModalOptions } from '@ringcentral-integration/widgets/modules/ModalUI/ModalUI.interface';
...
export interface ActiveCallsViewProps {
  ...
  getAvatarUrl?: (...args: any) => string | Promise<string | null>;
...
export interface ActiveCallsPanelProps {
  ...
  ) => Promise<WebphoneSession | void> | undefined;
