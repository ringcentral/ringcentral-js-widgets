...
var IssuesTrackingView = exports.IssuesTrackingView = (_dec = (0, _nextCore.injectable)({
  ...
  function IssuesTrackingView(_router, _brand, _cPRClientView, _issuesTrackingViewOptions) {
    ...
    _this = _callSuper(this, IssuesTrackingView);
    _this._router = _router;
    _this._brand = _brand;
    _this._cPRClientView = _cPRClientView;
    _this._issuesTrackingViewOptions = _issuesTrackingViewOptions;
    _initializerDefineProperty(_this, "_theme", _descriptor, _this);
    return _this;
  }
  _inherits(IssuesTrackingView, _RcViewModule);
  return _createClass(IssuesTrackingView, [{
    key: "goBack",
    value: function () {
      var _goBack = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              route = _args.length > 0 && _args[0] !== undefined ? _args[0] : '/settings';
              _context.n = 1;
    ...
    key: "openSupportCase",
    value: function openSupportCase(supportLink) {
    ...
    value: function component(_ref) {
      var _this2 = this,
        _this$_issuesTracking,
        _this$_issuesTracking2;
      var backRoute = _ref.backRoute;
      var _useConnector = (0, _nextCore.useConnector)(function () {
          return {
            eulaLink: _this2._brand.brandConfig.eulaLink,
            privacyNotice: _this2._brand.brandConfig.privacyNotice,
            supportLink: _this2._brand.brandConfig.supportLink,
            brandName: _this2._brand.brandConfig.name
          };
        }),
        eulaLink = _useConnector.eulaLink,
        privacyNotice = _useConnector.privacyNotice,
        supportLink = _useConnector.supportLink,
        brandName = _useConnector.brandName;
      var _useLocale = (0, _hooks.useLocale)(_i18n["default"]),
        t = _useLocale.t;
      var showHeader = (_this$_issuesTracking = (_this$_issuesTracking2 = this._issuesTrackingViewOptions) === null || _this$_issuesTracking2 === void 0 ? void 0 : _this$_issuesTracking2.showHeader) !== null && _this$_issuesTracking !== void 0 ? _this$_issuesTracking : true;
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, showHeader && (process.env.THEME_SYSTEM === 'spring-ui' ? /*#__PURE__*/_react["default"].createElement(_components.AppHeaderNav, {
        override: true
      ...
      }, t('header'))) : /*#__PURE__*/_react["default"].createElement(_PageHeader.PageHeader, null, /*#__PURE__*/_react["default"].createElement(_PageHeader.PageHeaderBack, {
        ...
        component: "p"
      }, t('step1Title')), /*#__PURE__*/_react["default"].createElement(_springUi.Text, {
        "data-sign": "step1Desc",
        className: "typography-mainText mb-4 text-neutral-b2",
        component: "p"
      }, t('step1Description')), /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement(_springUi.Button, {
        ...
        href: eulaLink,
        target: "_blank"
      }, t('privacyNoticeLink')), t('and'), /*#__PURE__*/_react["default"].createElement(_springUi.Link, {
        "data-sign": "privacyNoticeEnd",
        href: privacyNotice,
        target: "_blank"
      }, t('privacyNoticeEnd'))))), /*#__PURE__*/_react["default"].createElement(_components.AppFooterNav, null));
    }
  }]);
