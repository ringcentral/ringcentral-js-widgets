...
var ToastView = exports.ToastView = (_dec = (0, _nextCore.injectable)({
  name: 'ToastView'
  ...
  function ToastView(_toastItemView, _toast, _toastViewOptions) {
    var _this;
    _classCallCheck(this, ToastView);
    _this = _callSuper(this, ToastView);
  ...
  _inherits(ToastView, _RcViewModule);
  return _createClass(ToastView, [{
    key: "component",
