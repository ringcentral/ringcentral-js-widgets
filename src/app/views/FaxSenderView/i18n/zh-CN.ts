/* eslint-disable */
export default {
  faxScheduledSuccessToast: '已安排稍后 ({time}) 发送传真',
  maxAttachmentSizeReached: '附加文件不应超过 {maxAllowedSize}MB。',
  maxAttachmentsSizeReached: '附加文件不应超过 {maxAllowedSize}MB。',
  faxSuccessSubmitted: '传真已提交。',
  faxSubmitFailed: '传真提交失败。',
};
