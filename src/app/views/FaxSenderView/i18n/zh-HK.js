...
var _default = exports["default"] = {
  faxScheduledSuccessToast: '已排程稍後 ({time}) 傳送傳真',
  maxAttachmentSizeReached: '附加檔案不應超過 {maxAllowedSize} MB。',
  maxAttachmentsSizeReached: '附加檔案不應超過 {maxAllowedSize} MB。',
  faxSuccessSubmitted: '已提交傳真。',
  faxSubmitFailed: '傳出傳真失敗。'
