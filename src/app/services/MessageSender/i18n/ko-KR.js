...
var _default = exports["default"] = {
  ...
  noAttachmentToExtension: '내선으로 MMS 보내기는 지원되지 않습니다.',
  notSmsToExtension: '대표 전화번호가 포함된 내선 번호로 보낼 수 없습니다. 내선 번호로 보내려면 내선 번호만 입력하세요.',
  shortNumbersNotAvailable: '단축 번호로는 SMS를 보낼 수 없습니다.',
  internationalSMSNotSupported: '국제 전화번호로 SMS 보내기는 지원되지 않습니다.',
  noInternalSMSPermission: '메시지를 보낼 권한이 없습니다. 업그레이드에 대한 자세한 내용은 {brand} 계정 관리자에게 문의하세요.',
  sendError: '메시지를 보낼 때 문제가 발생했습니다.'
