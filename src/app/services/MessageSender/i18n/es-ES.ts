...
export default {
  specialNumber:
    'No se admite el envío de mensajes de texto a números de servicios de emergencia o especiales.',
  textEmpty: 'Escriba el texto para enviar.',
  textTooLong: 'El mensaje es demasiado largo, limitado a 1000',
  multipartTextTooLong: 'El mensaje es demasiado largo, limitado a 5000',
  recipientsEmpty: 'Escriba un número de destinatario válido.',
  senderNumberInvalid:
    'Se requiere un número de teléfono válido para enviar mensajes de texto a los destinatarios externos a su empresa. Póngase en contacto con su administrador para añadir un número directo a su cuenta.',
  recipientNumberInvalids: 'Indique un número de teléfono válido.',
  notAnExtension: 'El número de la extensión no existe.',
  noAttachmentToExtension: 'No es posible enviar MMS a una extensión.',
  notSmsToExtension:
    'No se puede enviar un número de extensión con el número de teléfono principal. Si desea enviar a un número de extensión, solo tiene que introducirlo.',
  shortNumbersNotAvailable:
    'El envío de SMS a números cortos no está disponible.',
  internationalSMSNotSupported:
    'No se pueden enviar SMS a números de teléfono internacionales.',
  noInternalSMSPermission:
    'No tiene permiso para enviar mensajes. Póngase en contacto con el administrador de la cuenta de {brand} para actualizar.',
  sendError: 'Se ha producido un error al enviar el mensaje.',
} as const;
