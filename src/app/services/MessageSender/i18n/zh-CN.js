...
var _default = exports["default"] = {
  ...
  senderNumberInvalid: '必须输入有效的电话号码，才能向您公司之外的收件人发送短信。请联系管理员为您的帐户添加直拨号码。',
  recipientNumberInvalids: '请输入有效的电话号码。',
  notAnExtension: '分机号码不存在。',
  noAttachmentToExtension: '不支持向分机发送彩信。',
  notSmsToExtension: '无法通过主电话号码发送至分机号。如果您要发送至分机号，请仅输入分机号。',
  shortNumbersNotAvailable: '不支持向短号码发送短信。',
  internationalSMSNotSupported: '不支持向国际电话号码发送短信。',
  noInternalSMSPermission: '您没有发送消息的权限。请联系 {brand} 帐户管理员进行升级。',
  sendError: '发送消息时出错。'
