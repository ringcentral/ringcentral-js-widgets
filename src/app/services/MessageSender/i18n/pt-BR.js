...
var _default = exports["default"] = {
  specialNumber: 'Não é possível enviar mensagens de texto para números de emergência/serviços especiais.',
  ...
  senderNumberInvalid: 'É necessário ter um número de telefone válido para enviar mensagens de texto a destinatários de fora da empresa. Entre em contato com o administrador para adicionar um número direto à sua conta.',
  recipientNumberInvalids: 'Insira um número de telefone válido.',
  notAnExtension: 'O número do ramal não existe.',
  noAttachmentToExtension: 'Não há suporte para enviar MMS para um ramal.',
  notSmsToExtension: 'Não é possível enviar para um número de ramal com o número de telefone principal. Se você deseja enviar para um número de ramal, insira o número do ramal.',
  shortNumbersNotAvailable: 'O envio de SMS para números curtos não está disponível.',
  internationalSMSNotSupported: 'Não é possível enviar SMS a números de telefone internacionais.',
  noInternalSMSPermission: 'Você não tem permissão para enviar mensagens. Entre em contato com o administrador da conta do {brand} para fazer a atualização.',
  sendError: 'Algo deu errado ao enviar a mensagem.'
