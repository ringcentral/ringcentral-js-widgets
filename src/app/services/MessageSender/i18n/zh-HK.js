...
var _default = exports["default"] = {
  ...
  senderNumberInvalid: '需要有效的電話號碼，才能將簡訊傳送給您公司外的收件者。請聯絡管理員，為您的帳戶加入直撥號碼。',
  recipientNumberInvalids: '請輸入有效的電話號碼。',
  notAnExtension: '分機號碼不存在。',
  noAttachmentToExtension: '不支援傳送多媒體訊息至分機。',
  notSmsToExtension: '無法透過主要電話號碼傳送至分機號碼。如果要傳送至分機號碼，請只輸入分機號碼。',
  shortNumbersNotAvailable: '不支援向短號碼傳送簡訊。',
  internationalSMSNotSupported: '不支援傳送簡訊給國際電話號碼。',
  noInternalSMSPermission: '您沒有傳送訊息的權限。請聯絡您的 {brand} 帳戶管理員以升級。',
  sendError: '傳送訊息時發生錯誤。'
