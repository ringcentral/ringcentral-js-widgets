...
var _default = exports["default"] = {
  specialNumber: 'Sending texts to emergency/special service numbers is not supported.',
  ...
  senderNumberInvalid: 'A valid phone number is required to send text messages to recipients outside of your company. Please contact your administrator to add a direct number to your account.',
  recipientNumberInvalids: 'Please enter a valid phone number.',
  notAnExtension: 'The extension number does not exist.',
  noAttachmentToExtension: 'Sending MMS to an extension is not supported.',
  notSmsToExtension: 'Cannot send to an extension number with main phone number. If you want to send to an extension number, please just enter extension number.',
  shortNumbersNotAvailable: 'Sending SMS to short numbers is not available.',
  internationalSMSNotSupported: 'Sending an SMS to an international phone number is not supported.',
  noInternalSMSPermission: "You don't have permission to send messages. Please contact your {brand} account administrator to upgrade.",
  sendError: 'Something went wrong when sending the message.'
