...
function loadLocale(locale) {
  return locale === 'en' || locale === 'en-US' ? Promise.resolve().then(function () {
    ...
    return _interopRequireWildcard(require(/* webpackChunkName: "pt-PT" */'./pt-PT'));
    ...
    return _interopRequireWildcard(require(/* webpackChunkName: "nl-NL" */'./nl-NL'));
  }) : locale === 'ko' || locale === 'ko-KR' ? Promise.resolve().then(function () {
    return _interopRequireWildcard(require(/* webpackChunkName: "ko-KR" */'./ko-KR'));
  }) : locale === 'fi' || locale === 'fi-FI' ? Promise.resolve().then(function () {
    return _interopRequireWildcard(require(/* webpackChunkName: "fi-FI" */'./fi-FI'));
  }) : null;
}
