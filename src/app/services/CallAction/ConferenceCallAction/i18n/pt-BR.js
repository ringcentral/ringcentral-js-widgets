...
var _default = exports["default"] = {
  ...
  removeDescription: 'Remover {name} desta conferência?',
  confirmButtonText: 'Remover',
  cancelButtonText: 'Cancelar',
  endCallForEveryone: 'Encerrar chamada para todos',
  leaveCall: 'Sair da chamada',
  leaveOrEndCall: 'Sair ou encerrar chamada?',
  mergeTitle: 'Mesclar com chamada ativa?',
  mergeMessage: 'Sua chamada atual será mesclada em uma chamada em conferência com {contactName}',
  mergeDoNotAsk: 'Não perguntar novamente',
  mergeCancel: 'Cancelar',
  mergeConfirm: 'Mesclar',
