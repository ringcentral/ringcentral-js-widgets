...
export default {
  ...
  removeTitle: 'Retirer le participant',
  removeDescription: 'Retirer {name} de cette conférence?',
  confirmButtonText: 'Retirer',
  cancelButtonText: 'Annuler',
  endCallForEveryone: 'Mettre fin à l’appel pour tous',
  leaveCall: 'Quitter l’appel',
  leaveOrEndCall: 'Quitter l’appel ou y mettre fin?',
  mergeTitle: 'Fusionner avec un appel actif?',
  mergeMessage:
    'Votre appel en cours sera fusionné en une téléconférence avec {contactName}',
  mergeDoNotAsk: 'Ne plus me demander',
  mergeCancel: 'Annuler',
