...
export default {
  ...
  removeTitle: 'Poista osallistuja',
  removeDescription: 'Poistetaanko {name} tästä neuvottelusta?',
  confirmButtonText: 'Poista',
  cancelButtonText: 'Peruuta',
  endCallForEveryone: 'Lopeta puhelu kaikkien osalta',
  leaveCall: 'Poistu puhelusta',
  leaveOrEndCall: 'Poistutaanko puhelusta tai lopetetaanko se?',
  mergeTitle: 'Yhdistetäänkö käynnissä olevaan puheluun?',
  mergeMessage:
    'Nykyinen puhelusi yhdistetään neuvottelupuheluksi puhelun {contactName} kanssa',
  mergeDoNotAsk: 'Älä kysy uudelleen',
  mergeCancel: 'Peruuta',
  mergeConfirm: 'Yhdistä',
