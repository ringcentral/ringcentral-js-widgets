...
export default {
  ...
  endCallForEveryone: 'Termina la chiamata per tutti',
  leaveCall: 'Esci dalla chiamata',
  leaveOrEndCall: 'Abbandonare o terminare la chiamata?',
  mergeTitle: 'Unire a chiamata attiva?',
  mergeMessage:
    'La chiamata attuale verrà unita in una conferenza telefonica con {contactName}',
  mergeDoNotAsk: 'Non chiedermelo più',
  mergeCancel: 'Annulla',
  mergeConfirm: 'Unisci',
