...
export default {
  ...
  removeTitle: '참가자 제거',
  removeDescription: '이 전화 회의에서 {name}님을 제거하시겠습니까?',
  confirmButtonText: '삭제',
  cancelButtonText: '취소',
  endCallForEveryone: '모든 사람의 통화 종료',
  leaveCall: '통화에서 나가기',
  leaveOrEndCall: '통화에서 나가거나 종료하시겠습니까?',
  mergeTitle: '진행 중인 통화와 병합하시겠습니까?',
  mergeMessage: '현재 통화가 {contactName}님과의 원격 회의로 병합됩니다.',
  mergeDoNotAsk: '다시 묻지 않음',
  mergeCancel: '취소',
  mergeConfirm: '병합',
