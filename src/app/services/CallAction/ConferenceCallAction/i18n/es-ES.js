...
var _default = exports["default"] = {
  ...
  removeDescription: '¿Eliminar a {name} de esta conferencia?',
  confirmButtonText: 'Quitar',
  cancelButtonText: 'Cancelar',
  endCallForEveryone: 'Finalizar llamada para todos',
  leaveCall: 'Abandonar llamada',
  leaveOrEndCall: '¿Abandonar o finalizar la llamada?',
  mergeTitle: '¿Combinar con la llamada activa?',
  mergeMessage: 'Su llamada actual se combinará en una llamada de conferencia con {contactName}',
  mergeDoNotAsk: 'No volver a preguntar',
