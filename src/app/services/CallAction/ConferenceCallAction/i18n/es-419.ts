...
export default {
  ...
  removeDescription: '¿Desea quitar a {name} de esta conferencia?',
  confirmButtonText: 'Eliminar',
  cancelButtonText: 'Cancelar',
  endCallForEveryone: 'Finalizar llamada para todos',
  leaveCall: 'Salir de la llamada',
  leaveOrEndCall: '¿Desea salir o finalizar la llamada?',
  mergeTitle: '¿Desea combinar con la llamada activa?',
  mergeMessage:
    'Su llamada actual se combinará en una conferencia telefónica con {contactName}.',
  mergeDoNotAsk: 'No preguntarme de nuevo',
