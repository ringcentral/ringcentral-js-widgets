...
export default {
  ...
  removeDescription: '{name} uit deze conference verwijderen?',
  ...
  mergeTitle: 'Samenvoegen met actieve oproep?',
  mergeMessage:
    'Uw huidige gesprek wordt samengevoegd tot een conference call met {contactName}',
  mergeDoNotAsk: 'Niet meer vragen',
  mergeCancel: 'Annuleren',
