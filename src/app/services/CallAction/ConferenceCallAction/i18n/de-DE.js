...
var _default = exports["default"] = {
  ...
  removeDescription: '{name} aus dieser Konferenz entfernen?',
  confirmButtonText: 'Entfernen',
  cancelButtonText: 'Abbrechen',
  endCallForEveryone: 'Anruf für alle beenden',
  leaveCall: 'Anruf verlassen',
  leaveOrEndCall: 'Anruf verlassen oder beenden?',
  mergeTitle: 'Mit aktivem Anruf zusammenführen?',
  mergeMessage: 'Ihr aktueller Anruf wird zu einer Telefonkonferenz mit {contactName}',
  mergeDoNotAsk: 'Nicht erneut fragen',
