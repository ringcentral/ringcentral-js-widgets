...
import type { BeforeunloadOptions } from './Beforeunload.interface';
...
export class Beforeunload extends RcModule {
  _window: Window;
  ...
  constructor(
    @optional('BeforeunloadOptions')
    protected _beforeunloadOptions?: BeforeunloadOptions,
  ) {
    super();

    this._window = this._beforeunloadOptions?.originWindow ?? window;
  }
