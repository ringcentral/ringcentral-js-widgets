...
var AccountInfo = exports.AccountInfo = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('AccountInfoOptions')(target, undefined, 6);
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _Auth.Auth === "undefined" ? Object : _Auth.Auth, typeof _Client.Client === "undefined" ? Object : _Client.Client, typeof _services.Toast === "undefined" ? Object : _services.Toast, typeof _ExtensionFeatures.ExtensionFeatures === "undefined" ? Object : _ExtensionFeatures.ExtensionFeatures, typeof _DataFetcher.DataFetcher === "undefined" ? Object : _DataFetcher.DataFetcher, typeof _TierChecker.TierChecker === "undefined" ? Object : _TierChecker.TierChecker, typeof AccountInfoOptions === "undefined" ? Object : AccountInfoOptions]), _dec6 = (0, _nextCore.computed)(function (_ref) {
  var data = _ref.data;
  return [data];
}), _dec7 = Reflect.metadata("design:type", Function), _dec8 = Reflect.metadata("design:paramtypes", []), _dec9 = (0, _nextCore.computed)(function (_ref2) {
  var info = _ref2.info;
  return [info];
}), _dec0 = Reflect.metadata("design:type", Function), _dec1 = Reflect.metadata("design:paramtypes", []), _dec10 = (0, _nextCore.computed)(function (_ref3) {
  ...
  function AccountInfo(_auth, _client, _toast, _extensionFeatures, _dataFetcher, _tierChecker, _accountInfoOptions) {
    ...
    _this = _callSuper(this, AccountInfo, [_dataFetcher]);
    _this._auth = _auth;
    _this._client = _client;
    _this._toast = _toast;
    _this._extensionFeatures = _extensionFeatures;
    _this._dataFetcher = _dataFetcher;
    _this._tierChecker = _tierChecker;
    _this._accountInfoOptions = _accountInfoOptions;
    _this._source = new _DataFetcher.DataSource(_objectSpread(_objectSpread({}, _this._accountInfoOptions), {}, {
      key: 'accountInfo',
        ...
        var _fetchFunction = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _this._client.account().get();
              case 1:
  ...
  _inherits(AccountInfo, _DataFetcherConsumer);
  return _createClass(AccountInfo, [{
    key: "isCRMEnabled",
    get: function get() {
      var _this$_tierChecker;
      return (_this$_tierChecker = this._tierChecker) === null || _this$_tierChecker === void 0 ? void 0 : _this$_tierChecker.isCRMEnabled;
    }
  }, {
      ...
      var _onStateChange = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              if (!(this._auth.loginStatus === _Auth.loginStatus.loggedIn && this.ready && !this._checkPermission())) {
                _context2.n = 2;
                break;
              }
              _context2.n = 1;
