...
exports.execTracking = execTracking;
...
function execTracking(analytics, trackEvent, args) {
  if (typeof (analytics === null || analytics === void 0 ? void 0 : analytics.track) === 'function') {
    if (typeof trackEvent === 'string') {
      ...
      var trackReturn = trackEvent.apply(void 0, _toConsumableArray(args));
...
//# sourceMappingURL=execTracking.js.map
