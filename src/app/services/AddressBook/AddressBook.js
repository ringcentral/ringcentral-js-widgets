...
exports.DEFAULT_FETCH_INTERVAL = exports.DEFAULT_CONTACTS_PER_PAGE = exports.AddressBookSourceName = exports.AddressBook = void 0;
...
var _availabilityTypes = require("@ringcentral-integration/commons/enums/availabilityTypes");
...
var AddressBookSourceName = exports.AddressBookSourceName = 'personal';
var AddressBook = exports.AddressBook = (_dec = (0, _nextCore.injectable)({
  name: 'AddressBook'
}), _dec2 = function _dec2(target, key) {
  return (0, _nextCore.optional)('AddressBookOptions')(target, undefined, 3);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _services.Client === "undefined" ? Object : _services.Client, typeof _services.ExtensionFeatures === "undefined" ? Object : _services.ExtensionFeatures, typeof _services.DataFetcher === "undefined" ? Object : _services.DataFetcher, typeof AddressBookOptions === "undefined" ? Object : AddressBookOptions]), _dec5 = (0, _nextCore.delegate)('server'), _dec6 = Reflect.metadata("design:type", Function), _dec7 = Reflect.metadata("design:paramtypes", []), _dec8 = (0, _nextCore.computed)(function (_ref) {
  var data = _ref.data;
  return [data];
}), _dec9 = Reflect.metadata("design:type", Function), _dec0 = Reflect.metadata("design:paramtypes", []), _dec1 = (0, _nextCore.computed)(function (_ref2) {
  var data = _ref2.data;
  return [data];
  ...
  function AddressBook(_client, _extensionFeatures, _dataFetcher, _addressBookOptions) {
    ...
    _this = _callSuper(this, AddressBook, [_dataFetcher]);
  ...
  return _createClass(AddressBook, [{
    key: "_fetchInterval",
    get: function get() {
      var _this$_addressBookOpt2, _this$_addressBookOpt3;
      return (_this$_addressBookOpt2 = (_this$_addressBookOpt3 = this._addressBookOptions) === null || _this$_addressBookOpt3 === void 0 ? void 0 : _this$_addressBookOpt3.fetchInterval) !== null && _this$_addressBookOpt2 !== void 0 ? _this$_addressBookOpt2 : DEFAULT_FETCH_INTERVAL;
    }
  }, {
    key: "_perPage",
    get: function get() {
      var _this$_addressBookOpt4, _this$_addressBookOpt5;
      return (_this$_addressBookOpt4 = (_this$_addressBookOpt5 = this._addressBookOptions) === null || _this$_addressBookOpt5 === void 0 ? void 0 : _this$_addressBookOpt5.perPage) !== null && _this$_addressBookOpt4 !== void 0 ? _this$_addressBookOpt4 : DEFAULT_CONTACTS_PER_PAGE;
    }
  }, {
    key: "syncToken",
    get: function get() {
    ...
    key: "_fetch",
    value: function () {
      var _fetch2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(perPage, syncToken, pageId) {
        var params, _t;
    ...
    key: "_sync",
    value: function () {
      var _sync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var _response$records, syncToken, perPage, records, response, _response$records2, _response, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 6:
              _context2.p = 6;
              _t2 = _context2.v;
              if (!((_t2 === null || _t2 === void 0 ? void 0 : (_response = _t2.response) === null || _response === void 0 ? void 0 : _response.status) === 403)) {
                _context2.n = 7;
                break;
              }
              return _context2.a(2, {});
            case 7:
              console.error('[AddressBook] > _sync', _t2);
              throw _t2;
            case 8:
              return _context2.a(2);
          }
    ...
    key: "sync",
    value: function () {
      var _sync3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    ...
    get: function get() {
      ...
      return (0, _ramda.map)(function (rawContact) {
        ...
        return contact;
      }, (_this$data$records3 = (_this$data4 = this.data) === null || _this$data4 === void 0 ? void 0 : _this$data4.records) !== null && _this$data$records3 !== void 0 ? _this$data$records3 : []);
    }
    ...
    key: "rawContacts",
    get: function get() {
      var _this$data$records4, _this$data5;
      return (_this$data$records4 = (_this$data5 = this.data) === null || _this$data5 === void 0 ? void 0 : _this$data5.records) !== null && _this$data$records4 !== void 0 ? _this$data$records4 : [];
    }
  }, {
...
}(_services.DataFetcherConsumer), _applyDecoratedDescriptor(_class2.prototype, "sync", [_dec5, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "sync"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "contacts", [_dec8, _dec9, _dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "contacts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "rawContacts", [_dec1, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "rawContacts"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "rcPersonalMapping", [_dec12, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "rcPersonalMapping"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class);
