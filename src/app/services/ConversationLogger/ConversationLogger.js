...
var ConversationLogger = exports.ConversationLogger = (_dec = (0, _nextCore.injectable)({
  ...
  function ConversationLogger(_auth, _storage, _contactMatcher, _conversationMatcher, _dateTimeFormat, _extensionInfo, _messageStore, _appFeatures, _router, _conversationLoggerOptions, _tabManager) {
    ...
    _this = _callSuper(this, ConversationLogger);
    _this._auth = _auth;
    _this._storage = _storage;
    _this._contactMatcher = _contactMatcher;
    _this._conversationMatcher = _conversationMatcher;
    ...
    _this._formatDateTime = (_this$_conversationLo2 = _this._conversationLoggerOptions.formatDateTime) !== null && _this$_conversationLo2 !== void 0 ? _this$_conversationLo2 : function () {
    ...
    _this._isAutoUpdate = (_this$_conversationLo3 = _this._conversationLoggerOptions.isAutoUpdate) !== null && _this$_conversationLo3 !== void 0 ? _this$_conversationLo3 : true;
    _this._accordWithLogRequirement = _this._conversationLoggerOptions.accordWithLogRequirement;
    _this.getIsInLoggedStatus = (_this$_conversationLo4 = _this._conversationLoggerOptions.getIsInLoggedStatus) !== null && _this$_conversationLo4 !== void 0 ? _this$_conversationLo4 : function () {
      return false;
    };
    _this.serverAutoLog = false;
  ...
  return _createClass(ConversationLogger, [{
    ...
    get: function get() {
      var _this$_conversationMa,
        _this7 = this;
      var conversationStore = this._messageStore.conversationStore;
      var extensionNumber = this._extensionInfo.extensionNumber;
      var conversationLogMapping = (_this$_conversationMa = this._conversationMatcher.dataMapping) !== null && _this$_conversationMa !== void 0 ? _this$_conversationMa : {};
    ...
    key: "trackClickLogButton",
    value: function () {
      var _trackClickLogButton = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
      ...
      function trackClickLogButton() {
        return _trackClickLogButton.apply(this, arguments);
      }
      return trackClickLogButton;
    }()
  }, {
    key: "trackSMSSaveLogManually",
    value: function () {
      var _trackSMSSaveLogManually = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
      ...
      function trackSMSSaveLogManually() {
        return _trackSMSSaveLogManually.apply(this, arguments);
      }
      return trackSMSSaveLogManually;
    }()
  }, {
    key: "trackSMSSaveLogAutomatically",
    value: function () {
      var _trackSMSSaveLogAutomatically = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
      ...
      function trackSMSSaveLogAutomatically() {
        return _trackSMSSaveLogAutomatically.apply(this, arguments);
      }
      return trackSMSSaveLogAutomatically;
    }()
  }]);
}(_services3.LoggerBase), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_autoLog", [_nextCore.storage, _nextCore.state], {
  configurable: true,
  enumerable: true,
  writable: true,
