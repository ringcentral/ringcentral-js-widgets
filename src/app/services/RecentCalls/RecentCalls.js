...
var RecentCalls = exports.RecentCalls = (_dec = (0, _nextCore.injectable)({
  name: 'RecentCalls'
}), _dec2 = function _dec2(target, key) {
  return (0, _nextCore.optional)('RecentCallsOptions')(target, undefined, 3);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _services.Client === "undefined" ? Object : _services.Client, typeof _services.Auth === "undefined" ? Object : _services.Auth, typeof _CallHistory.CallHistory === "undefined" ? Object : _CallHistory.CallHistory, typeof RecentCallsOptions === "undefined" ? Object : RecentCallsOptions]), _dec5 = Reflect.metadata("design:type", typeof Record === "undefined" ? Object : Record), _dec6 = Reflect.metadata("design:type", String), _dec7 = Reflect.metadata("design:type", Function), _dec8 = Reflect.metadata("design:paramtypes", []), _dec9 = Reflect.metadata("design:type", Function), _dec0 = Reflect.metadata("design:paramtypes", [typeof LoadSuccessOptions === "undefined" ? Object : LoadSuccessOptions]), _dec1 = Reflect.metadata("design:type", Function), _dec10 = Reflect.metadata("design:paramtypes", [typeof CleanUpCallsOptions === "undefined" ? Object : CleanUpCallsOptions]), _dec11 = (0, _nextCore.delegate)('server'), _dec12 = Reflect.metadata("design:type", Function), _dec13 = Reflect.metadata("design:paramtypes", [typeof GetCallsOptions === "undefined" ? Object : GetCallsOptions]), _dec14 = (0, _nextCore.delegate)('server'), _dec15 = Reflect.metadata("design:type", Function), _dec16 = Reflect.metadata("design:paramtypes", [typeof Entity === "undefined" ? Object : Entity, String, Number]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = /*#__PURE__*/function (_RcModule) {
  function RecentCalls(_client, _auth, _callHistory, _recentCallsOptions) {
    var _this;
    ...
    _this._recentCallsOptions = _recentCallsOptions;
  ...
  return _createClass(RecentCalls, [{
    ...
    value: function _shouldInit() {
      return !!(_superPropGet(RecentCalls, "_shouldInit", this, 3)([]) && this._auth.loggedIn);
    }
  }, {
    key: "_shouldReset",
    value: function _shouldReset() {
      return !!(_superPropGet(RecentCalls, "_shouldReset", this, 3)([]) || this.ready && !this._auth.loggedIn);
    }
    ...
    value: function _getLocalRecentCalls(_ref4, calls, dateFrom) {
      ...
      return calls.reduce(function (acc, call) {
        if (call && call.to && call.from) {
          var matches = phoneNumbers === null || phoneNumbers === void 0 ? void 0 : phoneNumbers.find((0, _RecentCallsHelper.filterPhoneNumber)(call));
    ...
    value: function _fetchRemoteRecentCalls(_ref5, dateFrom, length) {
      ...
      var recentCallsPromises = phoneNumbers === null || phoneNumbers === void 0 ? void 0 : phoneNumbers.reduce(function (acc, _ref6) {
      ...
      return /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            ...
            case 1:
              return _context3.a(2, _this3._client.account().extension().callLog().list(params));
          }
        }, _callee3);
      }));
    }
  }]);
}(_nextCore.RcModule), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "calls", [_nextCore.state, _dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "callStatus", [_nextCore.state, _dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _applyDecoratedDescriptor(_class2.prototype, "initLoad", [_nextCore.action, _dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "initLoad"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "loadSuccess", [_nextCore.action, _dec9, _dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "loadSuccess"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "cleanUpCalls", [_nextCore.action, _dec1, _dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "cleanUpCalls"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getCalls", [_dec11, _dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "getCalls"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_fetchRemoteRecentCalls", [_dec14, _dec15, _dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "_fetchRemoteRecentCalls"), _class2.prototype), _class2)) || _class) || _class) || _class) || _class);
