...
var VideoConfiguration = exports.VideoConfiguration = (_dec = (0, _nextCore.injectable)({
  ...
  return (0, _nextCore.optional)('VideoConfigurationOptions')(target, undefined, 5);
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _services.Client === "undefined" ? Object : _services.Client, typeof _services.DataFetcher === "undefined" ? Object : _services.DataFetcher, typeof _services.AppFeatures === "undefined" ? Object : _services.AppFeatures, typeof Subscription === "undefined" ? Object : Subscription, Object, typeof VideoConfigurationOptions === "undefined" ? Object : VideoConfigurationOptions]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = /*#__PURE__*/function (_DataFetcherConsumer) {
  function VideoConfiguration(_client, _dataFetcher, _appFeatures, _subscription, _tabManager, _videoConfigurationOptions) {
    var _this$_subscription;
    var _this;
    _classCallCheck(this, VideoConfiguration);
    _this = _callSuper(this, VideoConfiguration, [_dataFetcher]);
    ...
    _this._videoConfigurationOptions = _videoConfigurationOptions;
    _this._stopWatching = null;
    _this._debouncedFetchData = void 0;
    _this._source = new _services.DataSource(_objectSpread(_objectSpread({}, _this._videoConfigurationOptions), {}, {
        ...
        var _fetchFunction = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _this._client.service.platform().get('/restapi/v1.0/account/~/extension/~/video-configuration');
              case 1:
                response = _context.v;
  ...
  _inherits(VideoConfiguration, _DataFetcherConsumer);
  return _createClass(VideoConfiguration, [{
    key: "_fetchDelay",
    get: function get() {
      var _this$_videoConfigura, _this$_videoConfigura2;
      return Math.max(0, (_this$_videoConfigura = (_this$_videoConfigura2 = this._videoConfigurationOptions) === null || _this$_videoConfigura2 === void 0 ? void 0 : _this$_videoConfigura2.fetchDelay) !== null && _this$_videoConfigura !== void 0 ? _this$_videoConfigura : DEFAULT_FETCH_DELAY);
    }
  }, {
    key: "_handleSubscription",
    value: function () {
      var _handleSubscription2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(message) {
        var _message$body, _message$body$hints, _this$_tabManager$act, _this$_tabManager;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              if (this.ready && (message === null || message === void 0 ? void 0 : (_message$body = message.body) === null || _message$body === void 0 ? void 0 : (_message$body$hints = _message$body.hints) === null || _message$body$hints === void 0 ? void 0 : _message$body$hints.includes(_subscriptionHints.subscriptionHints.videoConfiguration)) && (this._source.disableCache || ((_this$_tabManager$act = (_this$_tabManager = this._tabManager) === null || _this$_tabManager === void 0 ? void 0 : _this$_tabManager.active) !== null && _this$_tabManager$act !== void 0 ? _this$_tabManager$act : true))) {
    ...
    value: function onInit() {
      ...
      this._stopWatching = (0, _nextCore.watch)(this, function () {
        var _this2$_subscription;
        return (_this2$_subscription = _this2._subscription) === null || _this2$_subscription === void 0 ? void 0 : _this2$_subscription.message;
      }, function (message) {
...
}(_services.DataFetcherConsumer)) || _class) || _class) || _class) || _class) || _class) || _class);
