...
var _mapRcPresence = require("./mapRcPresence");
Object.keys(_mapRcPresence).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _mapRcPresence[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _mapRcPresence[key];
    }
  });
});
