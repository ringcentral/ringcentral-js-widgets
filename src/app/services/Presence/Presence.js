...
exports.presenceRegExp = exports.detailedPresenceRegExp = exports.Presence = exports.DEFAULT_PRESENCE_UPDATE_INTERVAL = void 0;
...
var DEFAULT_PRESENCE_UPDATE_INTERVAL = exports.DEFAULT_PRESENCE_UPDATE_INTERVAL = 10 * 1000;
var Presence = exports.Presence = (_dec = (0, _nextCore.injectable)({
  name: 'Presence'
  ...
  function Presence(_auth, _client, _connectivityMonitor, _dataFetcher, _extensionFeatures, _subscription, _storage, _tabManager, _presenceOptions) {
    ...
    _this = _callSuper(this, Presence, [_dataFetcher]);
    _this._auth = _auth;
    ...
    var presenceOptions = (_this$_presenceOption2 = _this._presenceOptions) !== null && _this$_presenceOption2 !== void 0 ? _this$_presenceOption2 : {};
    ...
    _this._source = new _DataFetcher.DataSource(_objectSpread(_objectSpread({}, presenceOptions), {}, {
      key: 'presence',
      cleanOnReset: true,
      ttl: ttl,
        ...
        var _fetchFunction = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _this._client.service.platform().get(_this._endPoint);
              case 1:
                response = _context.v;
                _context.n = 2;
      ...
      readyCheckFunction: function readyCheckFunction() {
        return _this._auth.ready && _this._auth.loggedIn && _this._subscription.ready && _this._extensionFeatures.ready && _this._connectivityMonitor.ready && _this._dataFetcher.ready;
      },
  ...
  _inherits(Presence, _DataFetcherConsumer);
  return _createClass(Presence, [{
    ...
    key: "_endPoint",
    get: function get() {
      return _subscriptionFilters.subscriptionFilters.detailedPresence;
    }
  }, {
    key: "_fetchDelay",
    get: function get() {
      var _this$_presenceOption3, _this$_presenceOption4;
      return Math.max(0, (_this$_presenceOption3 = (_this$_presenceOption4 = this._presenceOptions) === null || _this$_presenceOption4 === void 0 ? void 0 : _this$_presenceOption4.fetchDelay) !== null && _this$_presenceOption3 !== void 0 ? _this$_presenceOption3 : DEFAULT_FETCH_DELAY);
    }
  }, {
    key: "_maxFetchDelay",
    get: function get() {
      var _this$_presenceOption5, _this$_presenceOption6;
      return Math.max(this._fetchDelay, (_this$_presenceOption5 = (_this$_presenceOption6 = this._presenceOptions) === null || _this$_presenceOption6 === void 0 ? void 0 : _this$_presenceOption6.maxFetchDelay) !== null && _this$_presenceOption5 !== void 0 ? _this$_presenceOption5 : DEFAULT_MAX_FETCH_DELAY);
    }
  }, {
    ...
    value: function _checkPermission() {
      ...
      return (_this$_extensionFeatu = (_this$_extensionFeatu2 = this._extensionFeatures.features) === null || _this$_extensionFeatu2 === void 0 ? void 0 : (_this$_extensionFeatu3 = _this$_extensionFeatu2.ReadPresenceStatus) === null || _this$_extensionFeatu3 === void 0 ? void 0 : _this$_extensionFeatu3.available) !== null && _this$_extensionFeatu !== void 0 ? _this$_extensionFeatu : false;
    }
  }, {
    ...
    value: function _handleConnectivity(connectivity) {
      var _this$_tabManager$act2, _this$_tabManager2;
      if (this.ready && (this._source.disableCache || ((_this$_tabManager$act2 = (_this$_tabManager2 = this._tabManager) === null || _this$_tabManager2 === void 0 ? void 0 : _this$_tabManager2.active) !== null && _this$_tabManager$act2 !== void 0 ? _this$_tabManager$act2 : true)) && connectivity && this._checkPermission()) {
        this.fetchData();
      }
    }
  }, {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.n = 2;
              return this._client.service.platform().put('/restapi/v1.0/account/~/extension/~/presence', params);
            case 2:
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              this._dataFetcher.updateData(this._source, _objectSpread(_objectSpread({}, this.data), data), timestamp);
            case 1:
      ...
      var _fetchData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            case 0:
              this._debouncedFetchData.cancel();
              return _context0.a(2, this._dataFetcher.fetchData(this._source));
          }
        }, _callee0, this);
      }));
      function fetchData() {
