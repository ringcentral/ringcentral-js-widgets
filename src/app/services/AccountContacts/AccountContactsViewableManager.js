...
exports.AccountContactsViewableManager = void 0;
...
var AccountContactsViewableManager = exports.AccountContactsViewableManager = /*#__PURE__*/function (_ViewableManager) {
  function AccountContactsViewableManager(_portManager, _extensionInfo, options) {
    var _this;
    ...
    _this = _callSuper(this, AccountContactsViewableManager, [_portManager, {
      ...
      onViewable: function onViewable(distinctMap) {
        var result = _this.options.onViewable(distinctMap);
        return result;
      }
    }]);
