...
export interface CallLogOptions {
  ...
  /**
   * waiting time to retry
   *
   * @default 62 seconds.
   */
  timeToRetry?: number;
  /**
   * day span of call log,
   *
   * @default 7 days.
   */
  daySpan?: number;
  ...
  /**
   * enable daySpan or not
   *
   * @default true
   */
  limitDaySpan?: boolean;

  /**
   * enable limitation on fetching supplement(old) data (first page only)
   *
