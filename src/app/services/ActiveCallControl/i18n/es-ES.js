...
var _default = exports["default"] = {
  ...
  pauseRecordError: 'Lo sentimos, no pudimos dejar de grabar la llamada. Inténtelo de nuevo más tarde.',
  holdConflictError: 'Esta llamada se había reanudado en otro dispositivo. Ponga la llamada en espera antes de empezar a utilizar esta aplicación.',
  unHoldConflictError: 'Esta llamada se había puesto en espera en otro dispositivo. Reanude la llamada antes de empezar a utilizar esta aplicación.',
  ...
  noOutboundCallWithoutDL: 'En este momento, su extensión no puede realizar llamadas salientes con el navegador. Póngase en contacto con su representante de cuentas para acceder a una actualización.',
  ...
  replyEmptyError: 'Lo sentimos, no puede enviar un mensaje vacío.'
