...
var _default = exports["default"] = {
  muteConflictError: 'Esta llamada se había silenciado en otro dispositivo. Active el audio de la llamada antes de empezar a utilizar la aplicación.',
  unMuteConflictError: 'El audio de esta llamada se había activado en otro dispositivo. Silencie la llamada antes de controlar en esta aplicación.',
  recordError: 'No puede grabar la llamada en este momento. Código de error: {errorCode}',
  recordErrorWithoutCode: 'No puede grabar la llamada en este momento.',
  pauseRecordError: 'Lo sentimos, no pudimos detener la grabación de la llamada. Inténtelo de nuevo más tarde.',
  holdConflictError: 'Esta llamada se había reanudado en otro dispositivo. Ponga la llamada en espera antes de controlar en esta aplicación.',
  unHoldConflictError: 'Esta llamada se había puesto en espera en otro dispositivo. Reanude la llamada antes de empezar a controlar en esta aplicación.',
  generalError: 'Error inesperado del servidor. Inténtelo de nuevo más tarde.',
  replyCompleted: 'Mensaje de voz enviado.',
  transferCompleted: 'Llamada transferida',
  toVoiceMailError: 'No se puede enviar la llamada al buzón de voz debido a un error interno.',
  transferError: 'No se puede transferir la llamada. Inténtelo de nuevo más tarde.',
  forwardSuccess: 'Llamada desviada',
  somethingWentWrong: 'Se ha producido un error. Vuelva a intentarlo.',
  noOutboundCallWithoutDL: 'En este momento, su extensión no puede hacer llamadas salientes con el navegador. Comuníquese con el representante de su cuenta para acceder a la actualización.',
  tooManyParticipants: 'Se alcanzó el número máximo de participantes.',
  callsMerged: 'Las llamadas se combinaron.',
  failWithoutStatusCode: 'Se produjo un error en nuestro sistema. Si el error persiste, comuníquelo al servicio técnico de {brandName}.',
  replyEmptyError: 'No puede enviar un mensaje vacío.'
