/* eslint-disable */
export default {
  sending: 'Message en cours d’envoi… Cela peut prendre quelques minutes.',
  noSMSPermission:
    'Vous n’avez pas l’autorisation pour envoyer des messages à des destinataires externes à votre entreprise.',
