...
import type calleeTypes from '@ringcentral-integration/commons/enums/calleeTypes';
import type { NormalizedCall } from '@ringcentral-integration/commons/interfaces/Call.interface';
import type { Entity } from '@ringcentral-integration/commons/interfaces/Entity.interface';
import type { ObjectMapValue } from '@ringcentral-integration/core/lib/ObjectMap';

import type { sessionStatus } from '../Webphone';

export interface ConferenceCallOptions {
  pulling?: boolean;
  capacity?: number;
  timeout?: number;
}
...
export interface MergeSuccessHandler {
  (conferenceState: ConferenceState): void;
}
