...
export default {
  downloadFaxBackendError:
    'Lamentamos, mas ocorreu um erro da nossa parte e não conseguimos transferir o fax. Tente novamente mais tarde.',
  downloadFaxNetworkIssue:
    'Não conseguimos transferir o fax. Verifique a sua ligação de rede e tente novamente.',
  recipientNumberInvalids: 'Introduza um número de telefone válido.',
  maxAttachmentSizeReached:
    'O tamanho do ficheiro anexado não deve exceder {maxAllowedSize} MB.',
  maxAttachmentsSizeReached:
    'O tamanho dos ficheiros anexados não deve exceder {maxAllowedSize} MB.',
  faxSuccessSubmitted: 'Fax enviado.',
  faxSubmitFailed: 'Falha ao enviar o fax.',
} as const;
