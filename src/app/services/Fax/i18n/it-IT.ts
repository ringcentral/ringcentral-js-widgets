...
export default {
  downloadFaxBackendError:
    'Si è verificato un problema e non è possibile scaricare il fax. Riprova più tardi.',
  downloadFaxNetworkIssue:
    'Non è stato possibile scaricare il fax. Verifica la connessione di rete e riprova.',
  recipientNumberInvalids: 'Inserisci un numero di telefono valido.',
  maxAttachmentSizeReached:
    'Le dimensioni del file allegato non devono superare {maxAllowedSize} MB.',
  maxAttachmentsSizeReached:
    'Le dimensioni dei file allegati non devono superare {maxAllowedSize} MB.',
  faxSuccessSubmitted: 'Fax inviato.',
  faxSubmitFailed: 'Invio fax in uscita non riuscito.',
} as const;
