...
export default {
  downloadFaxBackendError:
    '申し訳ございません。問題が発生したため、FAXをダウンロードできませんでした。後でもう一度やり直してください。',
  downloadFaxNetworkIssue:
    'FAXをダウンロードできませんでした。ネットワーク接続を確認し、もう一度やり直してください。',
  recipientNumberInvalids: '有効な電話番号を入力してください。',
  maxAttachmentSizeReached:
    '添付ファイルは{maxAllowedSize}MBを超えないようにしてください。',
  maxAttachmentsSizeReached:
    '添付ファイルは{maxAllowedSize}MBを超えないようにしてください。',
  faxSuccessSubmitted: 'FAXが送信されました。',
  faxSubmitFailed: 'FAXの発信に失敗しました。',
} as const;
