...
export default {
  downloadFaxBackendError:
    'Nous avons rencontré un problème et n’avons pas pu télécharger le fax. Réessayez plus tard.',
  downloadFaxNetworkIssue:
    'Nous n’avons pas pu télécharger le fax. Vérifiez votre connexion réseau, puis réessayez.',
  recipientNumberInvalids: 'Veuillez saisir un numéro de téléphone valide.',
  maxAttachmentSizeReached:
    'La taille du fichier joint ne peut pas dépasser {maxAllowedSize} Mo.',
  maxAttachmentsSizeReached:
    'La taille des fichiers joints ne peut pas dépasser {maxAllowedSize} Mo.',
  faxSuccessSubmitted: 'Fax envoyé.',
  faxSubmitFailed: 'Fax non envoyé.',
} as const;
