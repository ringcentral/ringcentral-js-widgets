...
var _default = exports["default"] = {
  downloadFaxBackendError: 'Lo sentimos, se ha producido un error y no hemos podido descargar el fax. Vuelva a intentarlo más tarde.',
  downloadFaxNetworkIssue: 'No hemos podido descargar el fax. Compruebe su conexión de red y vuelva a intentarlo.',
  recipientNumberInvalids: 'Indique un número de teléfono válido.',
  maxAttachmentSizeReached: 'El archivo adjunto no debe superar los {maxAllowedSize} MB.',
  maxAttachmentsSizeReached: 'Los archivos adjuntos no deben superar los {maxAllowedSize} MB.',
  faxSuccessSubmitted: 'Fax enviado.',
  faxSubmitFailed: 'El fax saliente ha fallado.'
