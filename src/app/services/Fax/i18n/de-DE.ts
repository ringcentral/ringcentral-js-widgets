...
export default {
  downloadFaxBackendError:
    'Leider ist bei uns etwas schiefgelaufen und wir waren nicht in der Lage, das Fax herunterzuladen. Versuchen Sie es später erneut.',
  downloadFaxNetworkIssue:
    'Wir waren nicht in der Lage, das Fax herunterzuladen. Überprüfen Sie Ihre Netzwerkverbindung und versuchen Sie es dann erneut.',
  recipientNumberInvalids: 'Geben Sie eine gültige Telefonnummer ein.',
  maxAttachmentSizeReached:
    'Die Größe der angehängten Datei darf {maxAllowedSize} MB nicht überschreiten.',
  maxAttachmentsSizeReached:
    'Die Größe der angehängten Dateien darf {maxAllowedSize} MB nicht überschreiten.',
  faxSuccessSubmitted: 'Fax übermittelt.',
  faxSubmitFailed: 'Ausgehendes Fax fehlgeschlagen.',
} as const;
