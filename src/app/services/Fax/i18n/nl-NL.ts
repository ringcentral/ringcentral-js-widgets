...
export default {
  downloadFaxBackendError:
    'Er is een fout opgetreden en we kunnen het faxbericht niet downloaden. Probeer het later opnieuw.',
  downloadFaxNetworkIssue:
    'We kunnen de fax niet downloaden. Controleer uw netwerkverbinding en probeer het opnieuw.',
  recipientNumberInvalids: 'Voer een geldig telefoonnummer in.',
  maxAttachmentSizeReached:
    'Bijlage kan niet groter zijn dan {maxAllowedSize} MB.',
  maxAttachmentsSizeReached:
    'Bijlagen kunnen niet groter zijn dan {maxAllowedSize} MB.',
  faxSuccessSubmitted: 'Fax ingediend.',
  faxSubmitFailed: 'Uitgaande fax mislukt.',
} as const;
