...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _AudioSettings.audioSettingsErrors.userMediaPermission, '오디오에 액세스할 수 있도록 {application}에 권한을 부여하세요.'), _AudioSettings.audioSettingsErrors.ringtoneSizeOverLimit, '업로드하려는 파일이 너무 큽니다. 5MB 미만의 파일을 사용해 보세요.'), _AudioSettings.audioSettingsErrors.duplicateRingtone, '이미 추가하려는 벨소리가 있습니다.'), _AudioSettings.audioSettingsErrors.uploadRingtoneFailed, '벨소리를 추가하는 데 문제가 발생했습니다. 다시 시도하세요.'), _AudioSettings.audioSettingsErrors.deleteRingtoneFailed, '벨소리를 삭제하는 데 문제가 발생했습니다. 다시 시도하세요.'), "ringtoneAdded", '벨소리 추가됨'); // @key: @#@"[audioSettingsErrors.userMediaPermission]"@#@ @source: @#@"Please grant {application} to access your audio."@#@
