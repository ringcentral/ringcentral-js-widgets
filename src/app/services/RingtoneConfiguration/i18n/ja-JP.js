...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _AudioSettings.audioSettingsErrors.userMediaPermission, 'オーディオへのアクセスを{application}に許可してください。'), _AudioSettings.audioSettingsErrors.ringtoneSizeOverLimit, 'アップロードしようとしているファイルは大きすぎます。5MBより小さいサイズのファイルを試してください。'), _AudioSettings.audioSettingsErrors.duplicateRingtone, '追加しようとしている着信音は既に存在します。'), _AudioSettings.audioSettingsErrors.uploadRingtoneFailed, '問題が発生したため、着信音を追加できません。もう一度やり直してください。'), _AudioSettings.audioSettingsErrors.deleteRingtoneFailed, '問題が発生したため、着信音を削除できません。もう一度やり直してください。'), "ringtoneAdded", '着信音が追加されました'); // @key: @#@"[audioSettingsErrors.userMediaPermission]"@#@ @source: @#@"Please grant {application} to access your audio."@#@
