...
export default {
  provisionUpdate:
    'Une erreur s’est produite de notre côté. Nous allons automatiquement essayer de vous reconnecter sous peu.',
  serverConnecting:
  ...
  muteError: 'Le son de l’appel ne peut pas être désactivé pour le moment.',
  holdError: 'L’appel ne peut pas être mis en attente pour le moment.',
  recordDisabled:
  ...
  parked: 'Votre appel est parqué à l’emplacement suivant : {parkedNumber}',
  transferError:
    'Impossible de transférer l’appel. Veuillez réessayer ultérieurement.',
  flipError: 'Renvoi de l’appel impossible. Veuillez réessayer ultérieurement.',
  toVoiceMailError:
    'Impossible de joindre la messagerie vocale à cause d’une erreur interne',
  webphoneCountOverLimit: 'Il est possible d’enregistrer jusqu’à 5 appels.',
  failWithStatusCode:
