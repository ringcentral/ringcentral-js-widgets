...
var _default = exports["default"] = {
  provisionUpdate: 'Jokin meni vikaan palvelimellamme. Yritämme muodostaa yhteyden automaattisesti hetken kuluttua.',
  ...
  noOutboundCallWithoutDL: 'Alanumerostasi ei voi tällä hetkellä soittaa puheluita selaimella. Pyydä päivitystä tilisi järjestelmänvalvojalta.',
  checkDLError: 'Puhelun soittaminen epäonnistui. Ota yhteyttä tukeen ({brandName}), jos näet tämän virheilmoituksen uudelleen.',
  ...
  recordDisabled: 'Puheluiden tallennus ei ole käytössä tililläsi. Ota yhteyttä tilisi järjestelmänvalvojaan.',
  recordError: 'Puhelua ei voi tallentaa tällä hetkellä. Virhekoodi: {errorCode}',
  ...
  toVoiceMailError: 'Puhelun lähettäminen vastaajaan epäonnistui sisäisen virheen vuoksi',
  ...
  connectFailed: 'Puhelimen ominaisuudet eivät ole tällä hetkellä käytettävissä. Yritä myöhemmin uudelleen.'
