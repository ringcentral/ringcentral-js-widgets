...
var _default = exports["default"] = {
  provisionUpdate: 'Désolés, une erreur s’est produite de notre côté. Nous allons automatiquement essayer de vous reconnecter sous peu.',
  serverConnecting: 'Désolés, nous rencontrons un problème de connexion au serveur téléphonique.',
  browserNotSupported: 'Désolés, les appels effectués à l’aide de ce navigateur ne sont pas pris en charge.',
  noOutboundCallWithoutDL: 'Votre poste n’est pas autorisé à faire des appels sortants avec le navigateur pour le moment. Veuillez communiquer avec votre représentant de compte pour obtenir une mise à niveau.',
  checkDLError: 'Impossible de passer un appel téléphonique sortant. Communiquez avec {brandName} pour obtenir du soutien si cette erreur persiste.',
  ...
  muteError: 'Le son de l’appel ne peut être désactivé pour le moment.',
  holdError: 'L’appel ne peut être mis en attente pour le moment.',
  recordDisabled: 'Désolés, votre compte ne possède pas la fonctionnalité pour enregistrer un appel. Veuillez communiquer avec votre administrateur de compte.',
  recordError: 'Vous ne pouvez pas enregistrer l’appel pour le moment. Code d’erreur : {errorCode}',
  parked: 'Votre appel est parqué à : {parkedNumber}',
  transferError: 'Impossible de transférer l’appel. Veuillez réessayer plus tard.',
  flipError: 'Impossible de renvoyer l’appel. Veuillez réessayer plus tard.',
  toVoiceMailError: 'Impossible d’acheminer l’appel vers la messagerie vocale en raison d’une erreur interne',
  webphoneCountOverLimit: 'Jusqu’à 5 téléphones Web peuvent être enregistrés.',
  ...
  connectFailed: 'Désolés, les fonctionnalités du téléphone ne sont pas disponibles pour le moment. Veuillez réessayer plus tard.'
