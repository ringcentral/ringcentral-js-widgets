...
var _default = exports["default"] = {
  provisionUpdate: 'Er is bij ons iets fout gegaan. We proberen over een ogenblik automatisch opnieuw verbinding te maken.',
  serverConnecting: 'We kunnen geen verbinding maken met de telefoonserver.',
  browserNotSupported: 'Bellen met deze browser wordt niet ondersteund.',
  noOutboundCallWithoutDL: 'Uw extensie mag momenteel geen uitgaande oproepen plaatsen met de browser. Neem contact op met uw accountvertegenwoordiger voor een upgrade.',
  checkDLError: 'Kan uitgaande oproep niet plaatsen. Neem contact op met {brandName} voor hulp als deze fout zich blijft voordoen.',
  ...
  muteError: 'Oproep kan momenteel niet worden gedempt.',
  holdError: 'Oproep kan momenteel niet in de wacht worden gezet.',
  recordDisabled: 'Uw account heeft niet de functie om een oproep op te nemen. Neem contact op met uw accountbeheerder.',
  recordError: 'U kunt de oproep momenteel niet opnemen. Foutcode: {errorCode}',
  parked: 'Uw oproep is geparkeerd op locatie: {parkedNumber}',
  transferError: 'Kan de oproep niet doorschakelen. Probeer het later opnieuw.',
  flipError: 'Kan de oproep niet omkeren. Probeer het later opnieuw.',
  toVoiceMailError: 'Kan oproep niet naar voicemail verzenden vanwege een interne fout',
  webphoneCountOverLimit: 'Er kunnen maximaal vijf webtelefoons worden geregistreerd.',
  ...
  connectFailed: 'Telefoonfuncties zijn momenteel niet beschikbaar. Probeer het later opnieuw.'
