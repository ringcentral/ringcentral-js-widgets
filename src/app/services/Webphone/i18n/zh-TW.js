...
var _default = exports["default"] = {
  ...
  noOutboundCallWithoutDL: '您的分機目前不支援使用瀏覽器向外撥出電話。請聯絡您的客戶代表進行升級。',
  checkDLError: '無法撥出電話。如果此錯誤持續發生，請聯絡 {brandName} 尋求支援。',
  failWithoutStatusCode: '抱歉，系統發生錯誤。如果錯誤仍然存在，請向 {brandName} 支援人員回報此錯誤。',
  muteError: '目前無法靜音。',
  holdError: '目前無法保留通話。',
  recordDisabled: '抱歉，您的帳戶並不具進行通話錄音的功能。請聯絡您的帳戶管理員。',
