...
var _default = exports["default"] = {
  provisionUpdate: '죄송합니다. 시스템에서 문제가 발생했습니다. 곧 자동으로 다시 연결하려고 시도합니다.',
  serverConnecting: '죄송합니다. 전화 서버에 연결하는 데 문제가 있습니다.',
  browserNotSupported: '죄송합니다. 이 브라우저를 사용하여 전화를 거는 것은 지원되지 않습니다.',
  noOutboundCallWithoutDL: '현재 내선에서 브라우저를 사용하여 발신 전화를 걸 수 없습니다. 계정 담당자에게 문의하여 업그레이드하세요.',
  checkDLError: '발신 전화를 걸 수 없습니다. 이 오류가 계속 표시되면 {brandName}에 문의하여 지원을 받으세요.',
  ...
  recordDisabled: '죄송합니다. 계정에 통화를 녹음하는 기능이 없습니다. 계정 관리자에게 문의하세요.',
  ...
  connectFailed: '죄송합니다. 현재 전화 기능을 사용할 수 없습니다. 나중에 다시 시도하세요.'
