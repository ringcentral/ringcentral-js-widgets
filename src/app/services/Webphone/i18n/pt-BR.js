...
var _default = exports["default"] = {
  provisionUpdate: 'Algo deu errado do nosso lado. Tentaremos reconectar automaticamente em breve.',
  serverConnecting: 'Há um problema de conexão com o servidor de telefone.',
  browserNotSupported: 'Não há suporte para chamadas usando este navegador.',
  noOutboundCallWithoutDL: 'No momento, o ramal não pode fazer chamadas de saída com o navegador. Entre em contato com o representante da conta para fazer uma atualização.',
  checkDLError: 'Não é possível fazer uma chamada. Entre em contato com o {brandName} para obter suporte se esse erro continuar aparecendo.',
  failWithoutStatusCode: 'Algo deu errado do nosso lado. Se o erro continuar, reporte-o ao suporte do {brandName}.',
  muteError: 'Não é possível deixar a chamada sem som no momento.',
  holdError: 'Não é possível colocar a chamada em espera no momento.',
  recordDisabled: 'Sua conta não tem o recurso de gravação de chamadas. Entre em contato com o administrador da conta.',
  recordError: 'Não é possível gravar a chamada no momento. Código de erro: {errorCode}.',
  parked: 'Sua chamada está estacionada no local: {parkedNumber}',
  transferError: 'Não é possível transferir a chamada. Tente novamente mais tarde.',
  flipError: 'Não é possível transferir dinamicamente a chamada. Tente novamente mais tarde.',
  toVoiceMailError: 'Não é possível enviar chamadas para caixa postal devido a um erro interno',
  webphoneCountOverLimit: 'É possível registrar no máximo cinco telefones Web.',
  failWithStatusCode: 'Ocorreu um erro: {errorCode}. Se o problema continuar, reporte esse erro ao suporte da {brandName}.',
  registeringWithStatusCode: 'Ocorreu um problema. Estamos tentando reconectar. Se o problema continuar, reporte-o ao suporte da {brandName}. Código de erro: {errorCode}.',
  registeringWithoutStatusCode: 'Ocorreu um problema. Estamos tentando reconectar. Se o problema continuar, reporte-o ao suporte da {brandName}.',
  connectFailed: 'No momento, os recursos do telefone estão indisponíveis. Tente novamente mais tarde.'
