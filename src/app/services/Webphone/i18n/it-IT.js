...
var _default = exports["default"] = {
  provisionUpdate: 'Si è verificato un problema nei nostri sistemi. Tenteremo la riconnessione automatica a breve.',
  serverConnecting: 'Si è verificato un problema durante la connessione al server telefonico.',
  browserNotSupported: 'Le chiamate mediante questo browser non sono supportate.',
  noOutboundCallWithoutDL: "Con questo interno non è attualmente consentito effettuare chiamate in uscita con il browser. Contatta il rappresentante dell'account per un upgrade.",
  checkDLError: "Impossibile effettuare una chiamata in uscita. Se l'errore persiste, contatta {brandName} per assistenza.",
  ...
  muteError: "Impossibile disattivare l'audio della chiamata in questo momento.",
  holdError: 'Impossibile mettere in attesa la chiamata in questo momento.',
  recordDisabled: "La funzione di registrazione chiamata non è disponibile nel tuo account. Contatta l'amministratore del tuo account.",
  recordError: 'Non è possibile registrare la chiamata in questo momento. Codice errore: {errorCode}',
  ...
  toVoiceMailError: 'Errore interno: impossibile inviare la chiamata alla segreteria telefonica',
  ...
  connectFailed: 'Le funzioni telefoniche non sono attualmente disponibili. Riprova più tardi.'
