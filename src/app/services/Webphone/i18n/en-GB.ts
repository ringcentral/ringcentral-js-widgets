...
export default {
  ...
  noOutboundCallWithoutDL:
    'Your extension is currently not allowed to make outbound calls with a browser. Please contact your account representative for an upgrade.',
  checkDLError:
  ...
  failWithStatusCode:
    'Sorry, we have encountered an error: {errorCode}. If the problem persists, report this error to {brandName} support.',
