...
export default {
  provisionUpdate:
    'Se ha producido un error en nuestro sistema. Intentaremos restablecer la conexión automáticamente.',
  serverConnecting:
    'Tenemos un problema con la conexión al servidor del teléfono.',
  browserNotSupported:
    'No es posible realizar llamadas a través de este navegador.',
  noOutboundCallWithoutDL:
    'En este momento, su extensión no puede realizar llamadas salientes con el navegador. Póngase en contacto con su representante de cuentas para acceder a una actualización.',
  checkDLError:
    'No es posible realizar una llamada saliente. Si el error persiste, póngase en contacto con {brandName} para obtener asistencia.',
  failWithoutStatusCode:
    'Se ha producido un error en nuestro sistema. Si el error persiste, póngase en contacto con el soporte técnico de {brandName}.',
  muteError: 'No se puede silenciar la llamada en este momento.',
  holdError: 'No se puede poner la llamada en espera en este momento.',
  recordDisabled:
    'Su cuenta no incluye la función para grabar llamadas. Contacte con el administrador de la cuenta.',
  recordError:
    'No puede grabar la llamada en este momento. Código de error: {errorCode}.',
  parked:
    'Su llamada se ha puesto en espera en la ubicación siguiente: {parkedNumber}',
  transferError:
    'No se puede transferir la llamada. Inténtelo de nuevo más tarde.',
  flipError: 'No se puede traspasar la llamada. Inténtelo de nuevo más tarde.',
  toVoiceMailError:
    'No se puede enviar la llamada al buzón de voz debido a un error interno',
  webphoneCountOverLimit: 'Se han podido registrar 5 teléfonos web en total.',
  failWithStatusCode:
    'Hemos encontrado un error: {errorCode}. Si el problema persiste, póngase en contacto con el soporte técnico de {brandName}.',
  registeringWithStatusCode:
    'Se ha producido un error. Estamos intentando restablecer la conexión. Si el problema persiste, póngase en contacto con el soporte técnico de {brandName}. Código de error: {errorCode}.',
  registeringWithoutStatusCode:
    'Se ha producido un error. Estamos intentando restablecer la conexión. Si el problema persiste, póngase en contacto con el soporte técnico de {brandName}.',
  connectFailed:
    'Las funciones del teléfono no están disponibles actualmente. Inténtelo de nuevo más tarde.',
} as const;
