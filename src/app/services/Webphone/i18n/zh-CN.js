...
var _default = exports["default"] = {
  ...
  noOutboundCallWithoutDL: '当前您的分机不能通过浏览器向外拨打电话，请联系客户代表进行升级。',
  checkDLError: '无法拨出电话。如果重复出现此错误，请联系 {brandName} 寻求帮助。',
  ...
  failWithStatusCode: '抱歉，出错了：{errorCode}。如果问题仍然存在，请向 {brandName} 支持部门报告此错误。',
