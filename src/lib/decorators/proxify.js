 ...
 */
var proxify = exports.proxify = function proxify(target, key, descriptor) {
  ...
  descriptor.value = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          _getRef = (0, _reactantShare.getRef)(this), container = _getRef.container; // when the function is called without DI container
          if (container) {
            _context.n = 4;
            break;
          }
        ...
        case 5:
          ...
          if (!(portDetector.isClient || this[_reactantShare.proxyExecutorKey])) {
            _context.n = 6;
            break;
          }
