...
var _services4 = require("./app/services");
...
var _default = exports["default"] = (0, _nextMicro.exposeMicroApp)({
  modules: [_services2.ContactMatcher, _services4.ConversationLogger, {
    provide: 'ConversationLoggerOptions',
    useValue: {
      logFunction: function logFunction(data) {
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _nextMicro.globalTransport.emit('logConversation', data);
              case 1:
                return _context.a(2);
            }
          }, _callee);
  ...
  }, _services.Auth, _services.ExtensionInfo, _services3.SleepDetector, _nextCore.RouterPlugin, _plugins.ThemePlugin, _services3.Brand, _services3.Locale, {
    ...
    deps: [_services2.AccountContacts, _services2.AddressBook],
    useFactory: function useFactory(accountContacts, addressBook) {
      return [accountContacts, addressBook];
    }
  }, _services2.CompanyContacts, _services2.ContactSearch, _services.RateLimiter, _services.AccountInfo],
  main: _App.MessageAppView,
  share: {
    name: 'micro-message',
    type: 'Base'
  },
