...
var _services2 = require("./app/services");
...
var _default = exports["default"] = (0, _nextMicro.exposeMicroApp)({
  modules: [_nextCore.RouterPlugin, _plugins.ThemePlugin, _services.Brand, _services.Locale, {
    provide: 'Subscription',
    useClass: _services2.WebSocketSubscription
  }, _services.SleepDetector, _services2.RateLimiter, _services2.Environment, {
  ...
  }, _nextCore.StoragePlugin, _services2.Auth, {
    provide: 'Prefix',
