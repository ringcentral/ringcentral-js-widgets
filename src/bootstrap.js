...
var _plugins = require("./app/plugins");
...
var _default = exports["default"] = (0, _nextMicro.exposeMicroApp)({
  modules: [_nextCore.RouterPlugin, _plugins.ThemePlugin, _services.Brand, _services.Locale, _services.SleepDetector, {
