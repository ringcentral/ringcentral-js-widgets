...
var _default = exports["default"] = (0, _nextMicro.exposeMicroApp)({
  modules: [_services.AccountInfo, _services.Auth, _services2.SleepDetector, _nextCore.RouterPlugin, _plugins.ThemePlugin, _services2.Brand, _services2.Locale, {
  ...
  }, _services.RateLimiter],
  main: _App.MeetingAppView,
  share: {
    name: 'micro-meeting',
    type: 'Base'
  },
