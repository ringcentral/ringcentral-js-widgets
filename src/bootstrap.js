...
var _services3 = require("./app/services");
...
var _default = exports["default"] = (0, _nextMicro.exposeMicroApp)({
  modules: [_services.AccountInfo, _services.ExtensionInfo, _services.Auth, _services2.SleepDetector, _nextCore.RouterPlugin, _plugins.ThemePlugin, _services2.Brand, _services2.Locale, {
    ...
    deps: [_services3.AccountContacts, _services3.AddressBook],
