...
export default {
  [permissionMessages.invalidTier]: 'Votre édition ne prend pas en charge l\'intégration de {application}. Veuillez contacter votre représentant de compte pour mettre votre édition {brand} à niveau.',
  [permissionMessages.insufficientPrivilege]: 'Privilèges insuffisants. Veuillez communiquer avec votre représentant de compte pour une mise à niveau.',
};
