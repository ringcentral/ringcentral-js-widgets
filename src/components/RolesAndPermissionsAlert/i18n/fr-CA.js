...
export default {
  [permissionMessages.invalidTier]: 'Votre version ne prend pas en charge l\'intégration de {application}. Veuillez communiquer avec votre représentant de compte pour mettre votre version de {brand} à jour.',
  [permissionMessages.insufficientPrivilege]: 'Privilège insuffisant. Veuillez communiquer avec votre représentant de compte pour une mise à niveau.',
};
