...
export default {
  ...
  [messageSenderMessages.noToNumber]: 'Veuillez en'Veuillez entrer un numéro de destinataire valide.',
  ...
  [messageSenderMessages.multipartTextTooLong]: 'Veuillez configurer {areaCodeLink} pour utiliser des numéros de téléphone locaux à 7\xA0chiffres.',
  ...
  [mess'L\'envoi de textos à des numéros d\'urgence ou à des numéros pour services spéciaux n\'est pas pris en charge.',
  [messageSenderMessages.connectFailed]: 'Connexion impossible en raison de problèmes de réseau. Veuillez réessayer plus tard.',
  [messageSenderMessages.internalError]: 'Impossible d\'envoyer au numéro de poste avec le numéro de téléphone principal. Si vous souhaitez envoyer à un numéro de poste, veuillez simplement saisir ce numéro.',
  [messageSenderMessages.notAnExtension]: 'The extension number does not exist.',
  [messageSenderMessages.networkError]: 'L\'envoi de textos vers un numéro de téléphone international n\'est pas pris en charge.',
  [messageSenderMessages'indicatif régional'senderNumberInvalid]: 'Un numéro de téléphone valide est nécessaire pour envoyer des textos à des destinataires en dehors de votre entreprise. Veuillez communiquer avec votre administrateur afin qu\'il ajoute un numéro direct à votre compte.',
  ...
  [messageSenderMessages'Veuillez entrer un numéro de téléphone valide.'internationalSMSNotSupported]: 'Sending SMS to international phone number is not supported.',
