...
export default {
  ...
  [messageSenderMessages.senderNumberInvalid]: 'No tiene permiso para enviar mensajes a destinatarios que no pertenecen a su organización. Póngase en contacto con el administrador de cuentas de RingCentral para conseguir una actualización.',
  ...
  [messageSenderMessages.noInternalSMSPermission]: 'No tiene permiso para enviar mensajes. Póngase en contacto con el administrador de cuentas de RingCentral para conseguir una actualización.',
};
