...
export default {
  ...
  [messageSenderMessages.senderNumberInvalid]: 'Se necesita un número de teléfono válido para enviar mensajes de texto a destinatarios fuera de la compañía. Comuníquese con el administrador para añadir un número directo a su cuenta.',
