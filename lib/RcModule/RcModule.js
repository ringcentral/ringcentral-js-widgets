      ...
      try {
        if (typeof analytics !== 'undefined' && typeof analytics.track === 'function') {
          if (typeof trackEvent === 'string') {
            ...
            var _ref2 = (_trackEvent = trackEvent.apply(void 0, [this].concat(args))) !== null && _trackEvent !== void 0 ? _trackEvent : [],
        ...
        console.warn("Analytics Error: ".concat(target.__name__, ".").concat(name));
      }
...
var RcModuleV2 = (_class = (_temp = /*#__PURE__*/function (_BaseModule) {
  ...
  _createClass(RcModuleV2, [{
    ...
    value: function getReducers(actionTypes) {
      ...
      return Object.entries(reducers).reduce(function (reducers, _ref6) {
