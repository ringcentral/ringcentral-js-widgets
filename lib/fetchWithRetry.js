...
var isRetirableStatus = exports.isRetirableStatus = function isRetirableStatus(status) {
  return /(?:5\d{2}|429)/.test("".concat(status));
};
var backoffDelay = exports.backoffDelay = function backoffDelay(retries) {
 ...
 */
var fetchWithRetry = exports.fetchWithRetry = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(url, args) {
    var maxRetries, retries, delay, response, error, isMatched, retryAfter, _t;
