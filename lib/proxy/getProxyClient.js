  ...
  return (
    ...
    function (_RcModule) {
      ...
      function _class(_ref) {
        ...
        _this._transport = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, transport, 'transport');
        ...
        var _loop = function _loop(subModule) {
          ...
          if ((_context2 = _this._target, Object.prototype.hasOwnProperty).call(_context2, subModule) && _this._target[subModule] instanceof _RcModule2.default) {
            Object.defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), subModule, {
              configurable: false,
              enumerable: true,
              get: function get() {
      ...
      _createClass(_class, [{
        ...
        value: function _setTransport(target) {
          ...
          for (var subModule in target) {
            if (Object.prototype.hasOwnProperty.call(target, subModule) && target[subModule] instanceof _RcModule2.default) {
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    this._transport.on(this._transport.events.push,
                    /*#__PURE__*/
                    function () {
