    ...
    function _class(_ref) {
      ...
      transport.on(transport.events.request, /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(_ref2) {
          var requestId, _ref2$payload, type, functionPath, args, actionNumber, _functionPath$split$s, _functionPath$split$s2, pathTokens, fnName, target, _target, result, _t, _t2;
          return _regenerator().w(function (_context) {
            while (1) switch (_context.p = _context.n) {
              case 0:
                ...
                _t = type;
                _context.n = _t === _this.actionTypes.execute ? 1 : _t === _this.actionTypes.sync ? 6 : 7;
                break;
              case 1:
                _functionPath$split$s = functionPath.split('.').slice(1), _functionPath$split$s2 = _toArray(_functionPath$split$s), pathTokens = _arrayLikeToArray(_functionPath$split$s2).slice(0);
