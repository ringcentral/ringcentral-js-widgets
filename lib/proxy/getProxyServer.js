...
function getProxyServer(createTarget) {
  return function (_RcModule) {
    ...
    function _class(_ref) {
      ...
      _this._target = createTarget((0, _extends3.default)({}, options));
      ...
      transport.on(transport.events.request, function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref2) {
          var requestId = _ref2.requestId,
              ...
              functionPath = _ref2$payload.functionPath,
              args = _ref2$payload.args,
              actionNumber = _ref2$payload.actionNumber;
