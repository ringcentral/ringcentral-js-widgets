...
var _excluded = ["_state", "params", "_inversePatches"];
...
var dropStates = exports.dropStates = function dropStates(action) {
  ...
  var _state = action._state,
    ...
    actionRest = _objectWithoutProperties(action, _excluded);
...
var pushStates = exports.pushStates = function pushStates(target, action) {
  if (action._usm === _core.usmAction) {
