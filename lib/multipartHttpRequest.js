...
function multipartHttpRequest(platform) {
  ...
  var sendRequest = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(method, url, _ref6) {
      ...
      var fields, files, query, _ref6$headers, headers, batch, rest, contentType, result, hasNonASCII, uTF8FormData, formData, response, multipartResult, _result, responseData;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              fields = _ref6.fields, files = _ref6.files, query = _ref6.query, _ref6$headers = _ref6.headers, headers = _ref6$headers === void 0 ? {} : _ref6$headers, batch = _ref6.batch, rest = _objectWithoutProperties(_ref6, ["fields", "files", "query", "headers", "batch"]);
