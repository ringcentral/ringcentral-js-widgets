...
var _excluded = ["className", "maskClassName", "modalClassName", "show", "onClose", "clickOutToClose"];
...
function createModal(Comp) {
  var _KModal;
  return _KModal = /*#__PURE__*/function (_Component) {
    function KModal(props) {
      var _this;
      _classCallCheck(this, KModal);
      _this = _callSuper(this, KModal, [props]);
  ...
  }(_react.Component), _KModal.propTypes = {
  ...
  }, _KModal.contextTypes = {
    modalRoot: _propTypes["default"].object
  }, _KModal;
}
var _default = exports["default"] = createModal;
