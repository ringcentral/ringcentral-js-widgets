...
function padString() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      padRatio = _ref$padRatio === undefined ? 0.3 : _ref$padRatio,
      _ref$padChar = _ref.padChar,
      padChar = _ref$padChar === undefined ? ' ' : _ref$padChar;
...
function toPseudoString(_ref2) {
  ...
  var result = padString({ str: tokens.join(''), padRatio: padRatio, padChar: padChar });
  return '[' + result + ']';
}
