...
var _excluded = ["perPage", "parallel"];
...
function _parallelFetch() {
  _parallelFetch = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(fn, perPage, params) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          _context.v.reduce(function (output, item) {
...
function _serialFetch() {
  _serialFetch = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(fn, perPage, params) {
...
function _fetchList() {
  _fetchList = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(fn) {
    var _ref,
      _ref$perPage,
      perPage,
      _ref$parallel,
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          _ref$perPage = _ref.perPage, perPage = _ref$perPage === void 0 ? 'MAX' : _ref$perPage, _ref$parallel = _ref.parallel, parallel = _ref$parallel === void 0 ? true : _ref$parallel, params = _objectWithoutProperties(_ref, _excluded);
          return _context3.a(2, parallel ? parallelFetch(fn, perPage, params) : serialFetch(fn, perPage, params));
      }
    }, _callee3);
  }));
  return _fetchList.apply(this, arguments);
