  ...
  _createClass(EvClient, [{
    ...
    value: function pauseRecord(isRecord) {
      ...
      return new Promise(function (resolve, reject) {
        return _this11._sdk.pauseRecord(isRecord, function (response) {
    ...
    value: function record(state) {
      ...
      return new Promise(function (resolve, reject) {
        return _this12._sdk.record(state, function (response) {
          if (response.status === 'OK') {
            resolve(response);
          } else {
            reject(response);
    ...
    value: function coldTransferCall(_ref8) {
      ...
      return new Promise(function (resolve, reject) {
        _this13._sdk.coldXfer(dialDest, callerId, sipHeaders, function (data) {
          if (data.status === 'OK') {
            resolve(data);
          } else {
            reject(data);
    ...
    value: function warmTransferCall(_ref9) {
      ...
      return new Promise(function (resolve, reject) {
        _this14._sdk.warmXfer(dialDest, callerId, sipHeaders, function (data) {
          if (data.status === 'OK') {
            resolve(data);
          } else {
            reject(data);
    ...
    value: function coldTransferIntlCall(_ref10) {
      ...
      return new Promise(function (resolve, reject) {
        _this15._sdk.internationalColdXfer(dialDest, callerId, sipHeaders, countryId, function (data) {
          if (data.status === 'OK') {
            resolve(data);
          } else {
            reject(data);
    ...
    value: function warmTransferIntlCall(_ref11) {
      ...
      return new Promise(function (resolve, reject) {
        _this16._sdk.internationalWarmXfer(dialDest, callerId, sipHeaders, countryId, function (data) {
          if (data.status === 'OK') {
            resolve(data);
          } else {
            reject(data);
    ...
    value: function requeueCall(_ref12) {
      ...
      return new Promise(function (resolve, reject) {
        _this17._sdk.requeueCall(queueId, skillId, maintain, function (data) {
          if (data.status === 'OK') {
            resolve(data);
          } else {
            reject(data);
    ...
    value: function fetchDirectAgentList() {
      ...
      return new Promise(function (resolve) {
        _this18._sdk.directAgentXferList(function (data) {
          resolve(data);
        });
      });
    }
    ...
    value: function _multiLoginRequest() {
      ...
      return new Promise(function (resolve, reject) {
        _this19._sdk.multiLoginRequest();

        _this19.on(_callbackTypes.EvCallbackTypes.LOGIN, function (data) {
        ...
        _this19.on(_callbackTypes.EvCallbackTypes.GENERIC_NOTIFICATION, function (data) {
