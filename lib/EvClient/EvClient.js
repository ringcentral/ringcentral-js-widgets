...
var EvClient = (_dec = (0, _di.Module)({
  ...
  _createClass(EvClient, [{
    ...
    value: function authenticateAgentWithEngageAccessToken(engageAccessToken) {
      ...
      return new Promise(function (resolve) {
        _this4.setStatus(_enums2.evStatus.LOGIN);
    ...
    value: function authenticateAgent(rcAccessToken, tokenType) {
      ...
      return new Promise(function (resolve) {
        _this7.setStatus(_enums2.evStatus.LOGIN);
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    _this7.setStatus(_enums2.evStatus.LOGINED);
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                getAgentConfig = new Promise(function (resolve) {
                  _this10.on(_callbackTypes.EvCallbackTypes.LOGIN_PHASE_1, function () {
    ...
    value: function getScript(scriptId, version) {
      ...
      return new Promise(function (resolve, reject) {
        _this19._sdk.getScript(scriptId, version, function (res) {
          if (res.status) {
            resolve(res);
          }
        });
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return (0, _time.raceTimeout)(new Promise(function (resolve) {
                  _this20._sdk.saveScriptResult(uii, scriptId, jsonResult);

                  _fn = function fn(e) {
                    if (e.type === _enums2.EvMessageTypes.SCRIPT_RESULT) {
                      resolve(e);

                      _this20._eventEmitter.removeListener(_callbackTypes.EvCallbackTypes.ACK, _fn);
                    }
                  };

                  _this20._eventEmitter.on(_callbackTypes.EvCallbackTypes.ACK, _fn);
                }), {
                  timeout: 5 * 1000,
                  callback: function callback() {
                    return null;
              ...
              case 2:
                ...
                this._eventEmitter.removeListener(_callbackTypes.EvCallbackTypes.ACK, _fn);
