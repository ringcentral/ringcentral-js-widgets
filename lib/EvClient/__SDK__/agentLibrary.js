...
var _default = function () {
  ...
  return function (global) {
    ...
    ChatPresentedNotification.prototype.processResponse = function (notification) {
      var notif = notification.ui_notification; // TODO-TASK add operation id
    ...
    LoadMediaNotification.prototype.processResponse = function (notification) {
      ...
      dts = new Date(dts.replace(' ', 'T')); // set up new task obj
    ...
    NewChatNotification.prototype.processResponse = function (notification) {
      var notif = notification.ui_notification;
      var dts = utils.getText(notif, 'queue_dts');
      dts = new Date(dts.replace(' ', 'T')); // set up new chat obj
      ...
      processNotification: function processNotification(instance, data) {
        ...
        switch (type.toUpperCase()) {
          ...
          case MESSAGE_TYPES.CHAT_LOAD_MEDIA:
            ...
            utils.fireCallback(instance, CALLBACK_TYPES.CHAT_LOAD_MEDIA_NOTIF, loadMediaResp);
            break;
