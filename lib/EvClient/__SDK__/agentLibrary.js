...
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); } /* eslint-disable */
(function () {
  'use strict';
    ...
    LoginRequest.prototype.processResponse = function (response) {
      ...
      if (status === 'SUCCESS') {
        if (!model.agentSettings.isLoggedIn) {
          ...
          model.connectionSettings.isMultiSocket = utils.getText(resp, 'is_multisocket') === 'true';
    ...
    function initAgentLibrarySoftphoneService(context) {
      ...
      function _registered() {
        ...
        if (model.agentSettings.dialDest !== model.softphoneSettings.sipDialDest && model.agentSettings.dialDest.indexOf('@RC_SOFTPHONE') === -1) {
          ...
          utils.fireCallback(UIModel.getInstance().libraryInstance, CALLBACK_TYPES.SIP_DIAL_DEST_CHANGED, responseObj);
      ...
      function _ringing(notif) {
        ...
        var rcHeaderValue = rcHeader && rcHeader.length === 1 && rcHeader[0].raw;
