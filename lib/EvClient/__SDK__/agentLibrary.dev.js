...
var noLog = function noLog() {
  ...
  return (_localStorage = localStorage) === null || _localStorage === void 0 ? void 0 : _localStorage.getItem('__SIP_NO_LOG__');
}; // in develop mode, close log for webRTC


var NoLogUA = /*#__PURE__*/function (_SIP$UA) {
  _inherits(NoLogUA, _SIP$UA);

  var _super = _createSuper(NoLogUA);

  function NoLogUA(option) {
    _classCallCheck(this, NoLogUA);

    return _super.call(this, _objectSpread(_objectSpread({}, option), {}, {
      log: {
