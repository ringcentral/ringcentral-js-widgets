...
function (_RcModule) {
  ...
  _createClass(AdapterModuleCoreBase, [{
    ...
    key: "_syncClosed",
    value: function _syncClosed(closed) {
      return regeneratorRuntime.async(function _syncClosed$(_context) {
        while (1) {
    ...
    key: "_syncMinimized",
    value: function _syncMinimized(minimized) {
      return regeneratorRuntime.async(function _syncMinimized$(_context2) {
        while (1) {
    ...
    value: function _syncSize() {
      var size,
          _args3 = arguments;
      return regeneratorRuntime.async(function _syncSize$(_context3) {
        while (1) {
    ...
    value: function _syncPosition() {
      var position,
          _args4 = arguments;
      return regeneratorRuntime.async(function _syncPosition$(_context4) {
        while (1) {
    ...
    value: function _onPresenceItemClicked(presenceData) {
      return regeneratorRuntime.async(function _onPresenceItemClicked$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return regeneratorRuntime.awrap(this._presence.setPresence(presenceData));
    ...
    key: "showAdapter",
    value: function showAdapter() {
      return regeneratorRuntime.async(function showAdapter$(_context6) {
        while (1) {
    ...
    value: function _onNavigateToCurrentCall() {
      return regeneratorRuntime.async(function _onNavigateToCurrentCall$(_context7) {
        while (1) {
    ...
    value: function _onNavigateToViewCalls() {
      return regeneratorRuntime.async(function _onNavigateToViewCalls$(_context8) {
        while (1) {
