...
var _baseMessageTypes = _interopRequireDefault(require("../AdapterCore/baseMessageTypes"));
...
function (_RcModule) {
  ...
  function AdapterModuleCoreBase(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AdapterModuleCoreBase).call(this, _objectSpread({
      prefix: prefix,
      actionTypes: actionTypes
    }, options)));
    _this._messageTypes = (0, _Enum.prefixEnum)({
      enumMap: messageTypes,
      prefix: prefix
    });
    _this._locale = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, locale, 'locale');
    _this._messageTransport = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, messageTransport, 'messageTransport');
    ...
    _this._router = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, routerInteraction, 'routerInteraction');
    _this._storageKey = storageKey;
    _this._globalStorage = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, globalStorage, 'globalStorage');
  ...
  _createClass(AdapterModuleCoreBase, [{
    ...
    key: "_syncClosed",
    value: function () {
      var _syncClosed2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(closed) {
    ...
    key: "_syncMinimized",
    value: function () {
      var _syncMinimized2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(minimized) {
    ...
    key: "_syncSize",
    value: function () {
      var _syncSize2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "_syncPosition",
    value: function () {
      var _syncPosition2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _onPresenceItemClicked2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee5(presenceData) {
    ...
    key: "showAdapter",
    value: function () {
      var _showAdapter = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _onNavigateToCurrentCall2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _onNavigateToViewCalls2 = _asyncToGenerator(
      /*#__PURE__*/
