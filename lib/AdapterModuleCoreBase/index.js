...
function (_RcModule) {
  ...
  function AdapterModuleCoreBase(_ref) {
    ...
    _this._messageTransport = (_context = _assertThisInitialized(_this), _ensureExist["default"]).call(_context, messageTransport, 'messageTransport');
    _this._presence = (_context = _assertThisInitialized(_this), _ensureExist["default"]).call(_context, presence, 'presence');
    _this._router = (_context = _assertThisInitialized(_this), _ensureExist["default"]).call(_context, routerInteraction, 'routerInteraction');
