...
var baseActionTypes = exports.baseActionTypes = _ObjectMap.ObjectMap.prefixKeys([].concat(_toConsumableArray(_ObjectMap.ObjectMap.keys(_moduleActionTypes.moduleActionTypes)), _toConsumableArray(_ObjectMap.ObjectMap.keys(_proxyActionTypes.proxyActionTypes)), ['syncClosed', 'syncMinimized', 'syncSize', 'syncFocus', 'syncPosition', 'showAdapter']), 'adapterModuleCore');
var _default = exports["default"] = baseActionTypes;
