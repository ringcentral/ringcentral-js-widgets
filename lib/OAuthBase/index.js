...
var _oAuthMessages = _interopRequireDefault(require("./oAuthMessages"));
...
function (_RcModule) {
  ...
  function OAuthBase(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(OAuthBase).call(this, _objectSpread({}, options)));
    ...
    _this._brand = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, brand, 'brand');
    ...
    _this._redirectUri = (_context = _assertThisInitialized(_assertThisInitialized(_this)), _ensureExist.default).call(_context, redirectUri, 'redirectUri');
  ...
  _createClass(OAuthBase, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(callbackUri) {
        var refresh,
            query,
            message,
            _args = arguments;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 12:
                ...
                _context2.next = _context2.t1 === 'invalid_request' ? 18 : _context2.t1 === 'unauthorized_client' ? 18 : _context2.t1 === 'access_denied' ? 18 : _context2.t1 === 'unsupported_response_type' ? 18 : _context2.t1 === 'invalid_scope' ? 18 : _context2.t1 === 'server_error' ? 20 : _context2.t1 === 'temporarily_unavailable' ? 20 : 20;
                break;
    ...
    value: function () {
      var _loginWithCallbackQuery2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _refreshWithCallbackQuery2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "prepareOAuth",
    value: function () {
      var _prepareOAuth = _asyncToGenerator(
      /*#__PURE__*/
