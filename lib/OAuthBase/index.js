...
function (_RcModule) {
  ...
  _createClass(OAuthBase, [{
    ...
    value: function _handleCallbackUri(callbackUri) {
      var refresh,
          query,
          message,
          _args = arguments;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return regeneratorRuntime.awrap(this._refreshWithCallbackQuery(query));
            ...
            case 8:
              _context2.next = 10;
              return regeneratorRuntime.awrap(this._loginWithCallbackQuery(query));
    ...
    value: function _loginWithCallbackQuery(query) {
      return regeneratorRuntime.async(function _loginWithCallbackQuery$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              _context3.next = 4;
              return regeneratorRuntime.awrap(this._auth.login({
                code: query.code,
    ...
    value: function _refreshWithCallbackQuery(query) {
      return regeneratorRuntime.async(function _refreshWithCallbackQuery$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              _context4.next = 4;
              return regeneratorRuntime.awrap(this._auth.refreshImplicitToken({
                tokenType: query.token_type,
                accessToken: query.access_token,
                expiresIn: query.expires_in,
                endpointId: query.endpoint_id
    ...
    key: "prepareOAuth",
    value: function prepareOAuth() {
      return regeneratorRuntime.async(function prepareOAuth$(_context5) {
        while (1) {
    ...
    value: function destroyOAuth() {
      return regeneratorRuntime.async(function destroyOAuth$(_context6) {
        while (1) {
