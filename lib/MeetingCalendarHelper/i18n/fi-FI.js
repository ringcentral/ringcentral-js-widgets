...
var _default = {
  ...
  rcvE2EEInviteMeetingContent: "{accountName} kutsui sinut päästä päähän salattuun tapaamiseen palvelussa {rcvProductName}.\n\nLiity tästä linkistä. Huomaa, että sinun täytyy ensin kirjautua palvelun {brandName} sovellukseen:\n{joinUri}\n\nTähän tapaamiseen ei voi liittyä puhelimella.\n\n{e2EESupportLinkText}\n{rcvE2EESupportUrl}",
  e2EESupportLinkText: "Lue lisätietoja palvelun {brandName} päästä päähän salauksesta.",
  ...
  doNotModify: "===== Älä muokkaa tätä tekstiä =====",
  password: "\n\nSalasana",
  passwordPstn: "\n\nSoiton salasana:"
