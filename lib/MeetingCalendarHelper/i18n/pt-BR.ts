...
export default {
  ...
  rcvE2EEInviteMeetingContent:
    '{accountName} convidou você para uma reunião do {rcvProductName} criptografada de ponta a ponta.\n\nEntre usando este link. Antes, você precisará fazer login no aplicativo {brandName}:\n{joinUri}\n\nA discagem não está disponível para esta reunião.\n\n{e2EESupportLinkText}\n{rcvE2EESupportUrl}',
  e2EESupportLinkText:
    'Saiba mais sobre a criptografia de ponta a ponta do {brandName}.',
