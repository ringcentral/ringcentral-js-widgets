...
export default {
  ...
  rcvE2EEInviteMeetingContent:
    '{accountName}le ha invitado a una reunión cifrada de extremo a extremo de{rcvProductName}.\n\nÚnase mediante este enlace. Tenga en cuenta que primero necesitará iniciar sesión en la aplicación{brandName}:\n{joinUri}\n\nLa marcación no está disponible para esta reunión.\n\n{e2EESupportLinkText}\n{rcvE2EESupportUrl}',
  e2EESupportLinkText:
    'Obtenga más información sobre el cifrado de extremo a extremo de{brandName}.',
