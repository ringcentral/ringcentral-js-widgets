...
export default {
  ...
  rcvE2EEInviteMeetingContent:
    '{accountName} heeft u uitgenodigd voor een end-to-end gecodeerde {rcvProductName}-meeting.\n\nNeem deel via deze link. Let op: u moet u eerst aanmelden bij de {brandName}-app:\n{joinUri}\n\nInbellen is niet mogelijk voor deze meeting.\n\n{e2EESupportLinkText}\n{rcvE2EESupportUrl}',
  e2EESupportLinkText:
    'Meer informatie over de end-to-end codering van {brandName}.',
