...
function formatDialInSection(_ref2) {
  ...
  var dialingInfo = (0, _formatMessage["default"])(dialingString, {
...
function getRcvDialInInfo(_ref3) {
  ...
  var teleconferenceInfo = (0, _formatMessage["default"])(_i18n["default"].getString('rcvTeleconference', args.currentLocale), {
...
function getBaseRcvTpl(_ref4, brand, currentLocale) {
  ...
  if (enableE2EE && e2ee) {
    ...
    var _formattedMsg = (0, _formatMessage["default"])(meetingContent.join(''), {
      accountName: accountName,
      brandName: brand.name,
