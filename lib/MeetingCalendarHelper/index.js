...
function getRcvPasswordTpl(meetingPassword, currentLocale) {
  var passwordLiteral = _i18n["default"].getString('password', currentLocale);

  return "".concat(passwordLiteral, ": ").concat(meetingPassword);
}
/**
...
function getBaseRcvTpl(_ref3, brand, currentLocale) {
  ...
  var passwordPstnTpl = isMeetingSecret ? getRcvPstnPasswordTpl(meetingPasswordPSTN, currentLocale) : '';
  var passwordTpl = isMeetingSecret ? getRcvPasswordTpl(meetingPassword, currentLocale) : '';
  ...
  return {
    formattedMsg: (0, _formatMessage["default"])(meetingContent.join(''), {
      ...
      joinUri: joinUri,
      passwordTpl: passwordTpl,
      passwordPstnTpl: passwordPstnTpl,
