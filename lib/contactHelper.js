...
function isSearchHitContact(_ref) {
  ...
  return (// search names
    "".concat(contact.firstName, " ").concat(contact.lastName, " ").concat(contact.name).toLowerCase().includes(lowerSearch) || // search phones
...
function getMatchContactsByPhoneNumber(_ref4) {
  var contacts = _ref4.contacts,
      ...
      _ref4$normalizeNumber = _ref4.normalizeNumber,
      normalizeNumber = _ref4$normalizeNumber === void 0 ? function (number) {
    return number;
  } : _ref4$normalizeNumber,
