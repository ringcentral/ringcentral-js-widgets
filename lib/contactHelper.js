...
function getMatchContacts(_ref) {
  var contacts = _ref.contacts,
    ...
    return number;
      ...
      _ref$findContact = _ref.findContact,
      findContact = _ref$findContact === void 0 ? function (item) {
...
var isSameSite = function isSameSite(_ref2) {
  var _ref2$siteCode = _ref2.siteCode,
      siteCode = _ref2$siteCode === void 0 ? '' : _ref2$siteCode,
      extensionNumber = _ref2.extensionNumber,
      extensionFromContacts = _ref2.extensionFromContacts;
...
var isExtensionExist = function isExtensionExist(_ref3) {
  var _options$site$code, _options$site;

  var extensionNumber = _ref3.extensionNumber,
  ...
  if (options.isMultipleSiteEnabled && isSameSite({
    siteCode: (_options$site$code = (_options$site = options.site) === null || _options$site === void 0 ? void 0 : _options$site.code) !== null && _options$site$code !== void 0 ? _options$site$code : '',
...
var getFindContact = function getFindContact(_ref4) {
  var phoneNumber = _ref4.phoneNumber,
      _ref4$options = _ref4.options,
      options = _ref4$options === void 0 ? {} : _ref4$options;
  return function (item) {
    if (item.phoneType === _phoneTypes["default"].extension) {
