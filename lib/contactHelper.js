...
exports.getExtensionPhoneNumberLabel = void 0;
...
var isAnExtension = exports.isAnExtension = function isAnExtension(number) {
 ...
 */
var isExtensionExist = exports.isExtensionExist = function isExtensionExist(_ref6) {
...
var getFindPhoneNumber = exports.getFindPhoneNumber = function getFindPhoneNumber(_ref7) {
...
var getExtensionPhoneNumberLabel = exports.getExtensionPhoneNumberLabel = function getExtensionPhoneNumberLabel(phoneNumber, extPhoneNumbers) {
  var hasMatchedItem = extPhoneNumbers.find(function (number) {
    return number.phoneNumber === phoneNumber;
  });
  return hasMatchedItem === null || hasMatchedItem === void 0 ? void 0 : hasMatchedItem.label;
};
