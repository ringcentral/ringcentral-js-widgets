...
function (_Pollable) {
  ...
  _createClass(DataFetcher, [{
    ...
    value: function _fetchWithForbiddenCheck() {
      var data, result;
      return regeneratorRuntime.async(function _fetchWithForbiddenCheck$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 7:
              ...
              _context4.next = 12;
              return regeneratorRuntime.awrap(this._forbiddenHandler(_context4.t0));
    ...
    value: function _fetchData() {
      var ownerId, data;
      return regeneratorRuntime.async(function _fetchData$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.prev = 2;
              _context5.next = 5;
              return regeneratorRuntime.awrap(this._fetchWithForbiddenCheck());
