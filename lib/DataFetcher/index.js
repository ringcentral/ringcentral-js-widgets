      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!(_this._auth.loggedIn && (!_this._storage || _this._storage.ready) && (!_this._readyCheckFn || _this._readyCheckFn()) && (!_this._subscription || _this._subscription.ready) && _this.status === _moduleStatuses2.default.pending)) {
                _context.next = 18;
                break;
              }
