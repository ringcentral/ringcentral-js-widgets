...
var DataFetcher = (_dec = (0, _di.Library)({
  ...
  (0, _createClass3.default)(DataFetcher, [{
    ...
    key: 'data',
    get: function get() {
      return this._storage ? this._storage.getItem(this._storageKey).data : this.state.data;
    }
  }, {
    key: 'timestamp',
    get: function get() {
      return this._storage ? this._storage.getItem(this._storageKey).timestamp : this.state.timestamp;
    }
  }, {
    key: 'status',
    get: function get() {
