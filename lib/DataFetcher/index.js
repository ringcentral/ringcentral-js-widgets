...
var DataFetcher = function (_RcModule) {
  ...
  function DataFetcher(_ref) {
    var auth = _ref.auth,
        ...
        options = (0, _objectWithoutProperties3.default)(_ref, ['auth', 'client', 'storage', 'tabManager', 'ttl', 'timeToRetry', 'polling', 'name', 'actionTypes', 'getReducer', 'getDataReducer', 'getTimestampReducer', 'dataStorageKey', 'timestampStorageKey', 'fetchFunction']);
