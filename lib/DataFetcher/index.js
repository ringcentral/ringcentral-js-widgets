...
function (_Pollable) {
  ...
  function DataFetcher(_ref) {
    ...
    var auth = _ref.auth,
        ...
        options = _objectWithoutProperties(_ref, ["auth", "client", "storage", "subscription", "tabManager", "availabilityMonitor", "timeToRetry", "ttl", "pollingInterval", "polling", "disableCache", "cleanOnReset", "getReducer", "getDataReducer", "getTimestampReducer", "fetchFunction", "forbiddenHandler", "subscriptionFilters", "subscriptionHandler", "readyCheckFn"]);
