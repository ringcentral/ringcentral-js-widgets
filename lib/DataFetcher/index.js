...
var DataFetcher = (_dec = (0, _di.Library)({
  ...
  function DataFetcher(_ref) {
    var auth = _ref.auth,
        ...
        options = (0, _objectWithoutProperties3.default)(_ref, ['auth', 'client', 'storage', 'subscription', 'tabManager', 'timeToRetry', 'ttl', 'polling', 'disableCache', 'name', 'actionTypes', 'getReducer', 'getDataReducer', 'getTimestampReducer', 'dataStorageKey', 'timestampStorageKey', 'fetchFunction', 'forbiddenHandler', 'subscriptionFilters', 'subscriptionHandler', 'readyCheckFn', 'cleanOnReset']);
