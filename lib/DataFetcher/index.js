...
var _getDataFetcherReducer = _interopRequireWildcard(require("./getDataFetcherReducer"));
...
function (_Pollable) {
  ...
  function DataFetcher(_ref) {
    ...
    var auth = _ref.auth,
      ...
      prefix: name
        ...
        getReducer = _ref$getReducer === void 0 ? _getDataFetcherReducer.default : _ref$getReducer,
        _ref$getDataReducer = _ref.getDataReducer,
        getDataReducer = _ref$getDataReducer === void 0 ? _getDataFetcherReducer.getDefaultDataReducer : _ref$getDataReducer,
        _ref$getTimestampRedu = _ref.getTimestampReducer,
        getTimestampReducer = _ref$getTimestampRedu === void 0 ? _getDataFetcherReducer.getDefaultTimestampReducer : _ref$getTimestampRedu,
        ...
        options = _objectWithoutProperties(_ref, ["auth", "client", "storage", "subscription", "tabManager", "availabilityMonitor", "timeToRetry", "ttl", "polling", "disableCache", "name", "actionTypes", "getReducer", "getDataReducer", "getTimestampReducer", "fetchFunction", "forbiddenHandler", "subscriptionFilters", "subscriptionHandler", "readyCheckFn", "cleanOnReset"]);
    ...
    _this._storageKey = "".concat(name, "-data"); // differentiate from old key
  ...
  _createClass(DataFetcher, [{
    ...
    value: function _isDataReady() {
      ...
      return this.status === _moduleStatuses.default.initializing && this.data !== null;
    }
  }, {
    key: "_init",
    value: function () {
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                if (this._availabilityMonitor) {
                  this._availabilityMonitor.handleInitialError(_context3.t0);
                }
