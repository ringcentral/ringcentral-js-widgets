...
var DataFetcher = function (_RcModule) {
  ...
  function DataFetcher(_ref) {
    ...
    var auth = _ref.auth,
        ...
        options = (0, _objectWithoutProperties3.default)(_ref, ['auth', 'client', 'storage', 'subscription', 'tabManager', 'ttl', 'timeToRetry', 'polling', 'name', 'actionTypes', 'getReducer', 'getDataReducer', 'getTimestampReducer', 'dataStorageKey', 'timestampStorageKey', 'fetchFunction', 'subscriptionFilters', 'subscriptionHandler', 'readyCheckFn']);
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!(_this._auth.loggedIn && _this._storage.ready && (!_this._readyCheckFn || _this._readyCheckFn()) && (!_this._subscription || _this._subscription.ready) && _this.status === _moduleStatus2.default.pending)) {
                _context.next = 12;
                break;
              }
            ...
            case 12:
              if ((!_this._auth.loggedIn || !_this._storage.ready || _this._readyCheckFn && !_this._readyCheckFn() || _this._subscription && !_this._subscription.ready) && _this.ready) {
                _this._clearTimeout();
                _this._promise = null;
                _this.store.dispatch({
  ...
  (0, _createClass3.default)(DataFetcher, [{
    ...
    value: function _startPolling() {
      ...
      this._timeoutId = setTimeout(function () {
        ...
        } else if (_this3.timestamp && Date.now() - _this3.timestamp < _this3._ttl) {
          _this3._startPolling();
        } else {
