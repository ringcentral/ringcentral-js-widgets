...
exports.ValueProvider = exports.FactoryProvider = exports.ExistingProvider = exports.ClassProvider = exports.Provider = void 0;
...
function (_Provider) {
  ...
  function ClassProvider(token, klass, deps, isPrivate) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ClassProvider).call(this, token, isPrivate));
    _this.klass = klass;
    _this.deps = deps;
    return _this;
  }
...
function (_Provider2) {
  ...
  function ExistingProvider(token, useExisting, isPrivate) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ExistingProvider).call(this, token, isPrivate));
...
function (_Provider3) {
  ...
  function FactoryProvider(token, func, deps, spread, isPrivate) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(FactoryProvider).call(this, token, isPrivate));
    _this3.func = func;
    _this3.deps = deps || [];
...
function (_Provider4) {
  ...
  function ValueProvider(token, value, spread, isPrivate) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ValueProvider).call(this, token, isPrivate));
    _this4.value = value;
