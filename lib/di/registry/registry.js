...
var Registry = (_temp = _class = function () {
  ...
  (0, _createClass3.default)(Registry, null, [{
    ...
    value: function resolveInheritedModuleFactory(currentClass) {
      ...
      var providerMetadata = this.mergeProviders(hasProviders ? moduleProviderMetadata.providers : [], !(0, _is_type.isEmpty)(parentClass.name) ? this.resolveInheritedModuleFactory(parentClass) : []);
    ...
    value: function resolveInheritedDependencies(currentClass) {
      ...
      var deps = this.mergeDependencies(hasDeps ? moduleMetadata.deps : [], !(0, _is_type.isEmpty)(parentClass.name) ? this.resolveInheritedDependencies(parentClass) : []);
