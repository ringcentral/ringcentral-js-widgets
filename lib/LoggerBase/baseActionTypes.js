...
var baseActionTypes = _ObjectMap.ObjectMap.fromKeys([].concat(_toConsumableArray(_ObjectMap.ObjectMap.keys(_moduleActionTypes.moduleActionTypes)), ['log', 'logSuccess', 'logError']));
