...
function (_TransportBase) {
  _inherits(ScriptTransport, _TransportBase);

  function ScriptTransport(_ref3) {
    var _this;
    ...
    _classCallCheck(this, ScriptTransport);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ScriptTransport).call(this, _objectSpread({}, options, {
...
exports["default"] = ScriptTransport;
