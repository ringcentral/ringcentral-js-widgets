    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = _args.length > 1 && _args[1] !== undefined ? _args[1] : {}, _ref2$timeout = _ref2.timeout, timeout = _ref2$timeout === void 0 ? 30 * 1000 : _ref2$timeout, _ref2$onTimeout = _ref2.onTimeout, onTimeout = _ref2$onTimeout === void 0 ? function (_, reject) {
              reject(null);
            ...
            return Promise.race([fn, new Promise(function (resolve, reject) {
              ...
              timeoutId = setTimeout(function () {
                return onTimeout(resolve, reject);
              }, timeout);
            })]);
