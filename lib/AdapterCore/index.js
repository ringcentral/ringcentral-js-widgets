...
function () {
  ...
  _createClass(AdapterCore, [{
    ...
    value: function togglePresenceDropdown() {
      var dropdownPresence = this._root.querySelector(".".concat(this._styles.dropdownPresence));

      if (dropdownPresence) {
        dropdownPresence.classList.toggle("".concat(this._styles.showDropdown));
      }
    }
  }, {
    key: "_postMessage",
    ...
    value: function _renderMinimizedBar() {
      this._logoEl.setAttribute('class', (0, _classnames.default)(this._styles.logo, this._styles.dock, this._logoUrl && this._logoUrl !== '' && this._styles.visible));
