...
var AdapterCore = exports["default"] = /*#__PURE__*/function () {
  function AdapterCore(_ref) {
    ...
    var prefix = _ref.prefix,
      ...
      themeVariableString = _ref.themeVariableString;
    ...
    this._themeVariableString = void 0;
  ...
  return _createClass(AdapterCore, [{
    key: "_beforeRender",
    value:
    // life cycle
    function _beforeRender() {}
  }, {
    key: "setThemeVariables",
    value: function setThemeVariables(variableString) {
    ...
    value: function _generateContentDOM() {
      ...
      this._contentFrameContainerEl = this._root.querySelector(".".concat(this._styles.frameContainer));
      ...
      this._presenceItemEls.forEach(function (itemEl) {
        ...
        itemEl.addEventListener(clickEvent, function (evt) {
          ...
          _this2._postMessage({
            ...
            presenceType: _presenceStatus.presenceStatus[dataPresence] || _Presence.dndStatus[dataPresence]
          });
        });
      });
    ...
    value: function _onHeaderClicked() {
      if (this._minimized) {
        var _this$contentFrameEl;
        this.toggleMinimized();

        // focus on frame let user can use tab easily or page autoFocus event
        (_this$contentFrameEl = this.contentFrameEl) === null || _this$contentFrameEl === void 0 ? void 0 : _this$contentFrameEl.focus();
      }
    }
  }, {
    ...
    value: function _setLogoUrl(logoUrl) {
      ...
      this._logoEl.setAttribute('class', (0, _clsx["default"])(this._styles.logo, this._logoUrl && this._logoUrl !== '' && this._styles.visible));
    }
  }, {
    key: "_setAppUrl",
    ...
    value: function _renderRestrictedPosition() {
      var positions = this._calculateMinMaxPosition();
      if (!positions) return;
      var minimumX = positions.minimumX,
        minimumY = positions.minimumY,
        maximumX = positions.maximumX,
        maximumY = positions.maximumY;
      if (this._minimized) {
    ...
    value: function _renderMainClass() {
      var _this$_headerEl;
      this._container.setAttribute('class', (0, _clsx["default"])(this._styles.root, this._styles[this._defaultDirection], this._closed && this._styles.closed, this._minimized && this._styles.minimized, this._dragging && this._styles.dragging, this._hover && this._styles.hover, this._loading && this._styles.loading));
      (_this$_headerEl = this._headerEl) === null || _this$_headerEl === void 0 ? void 0 : _this$_headerEl.setAttribute('class', (0, _clsx["default"])(this._styles.header, this._minimized && this._styles.minimized, this._ringing && this._styles.ringing));
    }
  }, {
    key: "renderPresence",
    value: function renderPresence() {
      var _this3 = this;
      this._presenceEl.setAttribute('class', (0, _clsx["default"])(this._minimized && this._styles.minimized, this._styles.presence, this._userStatus && this._styles[this._userStatus], this._dndStatus && this._styles[this._dndStatus]));
      this._presenceItemEls.forEach(function (presenceItem) {
        var dataPresence = presenceItem.getAttribute('data-presence');
        if (
        // @ts-expect-error TS(7053): Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        _presenceStatus.presenceStatus[dataPresence] === _this3._presenceOption ||
        // @ts-expect-error TS(7053): Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        _Presence.dndStatus[dataPresence] === _this3._presenceOption) {
          presenceItem.setAttribute('class', (0, _clsx["default"])(_this3._styles.presenceItem, _this3._styles.selected));
        } else {
          presenceItem.setAttribute('class', (0, _clsx["default"])(_this3._styles.presenceItem));
        }
      });
    }
  }, {
    ...
    value: function renderCallsBar() {
      ...
      this.callInfoMap = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, CURRENT_CALL, this._currentStartTime > 0), RINGING_CALLS, this._ringingCallsLength > 0), ON_HOLD_CALLS, this._onHoldCallsLength > 0), OTHER_DEVICE_CALLS, this._otherDeviceCallsLength > 0);
    ...
    value: function _renderMinimizedBar() {
      ...
      this._logoEl.setAttribute('class', (0, _clsx["default"])(this._styles.logo, this._logoUrl && this._logoUrl !== '' && this._styles.visible));
      this._durationEl.setAttribute('class', (0, _clsx["default"])(this._styles.duration));
      this._ringingCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.ringingCalls));
      this._onHoldCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.onHoldCalls));
      (_this$_otherDeviceCal = this._otherDeviceCallsEl) === null || _this$_otherDeviceCal === void 0 ? void 0 : _this$_otherDeviceCal.setAttribute('class', (0, _clsx["default"])(this._styles.otherDeviceCalls));
      this._currentCallEl.setAttribute('class', (0, _clsx["default"])(this._styles.currentCallBtn));
      this._viewCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.viewCallsBtn));
    }
  }, {
    key: "_renderCallsBar",
    value: function _renderCallsBar() {
      ...
      this._logoEl.setAttribute('class', (0, _clsx["default"])(this._styles.logo, !this._hasActiveCalls && this._logoUrl && this._logoUrl !== '' && this._styles.visible));
      this._durationEl.setAttribute('class', (0, _clsx["default"])(this._styles.duration, this.showDuration && this._styles.visible, this.centerDuration && this._styles.center, this.moveOutDuration && this._styles.moveOut, this.moveInDuration && this._styles.moveIn));
      this._ringingCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.ringingCalls, this.showRingingCalls && this._styles.visible, this.centerCallInfo && this._styles.center, this.moveOutRingingInfo && this._styles.moveOut, this.moveInRingingInfo && this._styles.moveIn));
      this._onHoldCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.onHoldCalls, this.showOnHoldCalls && this._styles.visible, this.centerCallInfo && this._styles.center, this.moveOutOnHoldInfo && this._styles.moveOut, this.moveInOnHoldInfo && this._styles.moveIn));
      (_this$_otherDeviceCal2 = this._otherDeviceCallsEl) === null || _this$_otherDeviceCal2 === void 0 ? void 0 : _this$_otherDeviceCal2.setAttribute('class', (0, _clsx["default"])(this._styles.otherDeviceCalls, this.showOtherDeviceCalls && this._styles.visible, this.centerCallInfo && this._styles.center, this.isInMoveOutStatus(OTHER_DEVICE_CALLS) && this._styles.moveOut, this.isInMoveInStatus(OTHER_DEVICE_CALLS) && this._styles.moveIn));
      this._currentCallEl.setAttribute('class', (0, _clsx["default"])(this._styles.currentCallBtn, this.showCurrentCallBtn && this._styles.visible, this.moveOutCurrentCallBtn && this._styles.moveOut, this.moveInCurrentCallBtn && this._styles.moveIn));
      this._viewCallsEl.setAttribute('class', (0, _clsx["default"])(this._styles.viewCallsBtn, this.showViewCallsBtn && this._styles.visible, !this.moveInViewCallsBtn && this.moveOutViewCallsBtn && this._styles.moveOut, this.moveInViewCallsBtn && this._styles.moveIn));
    }
  }, {
    ...
    value: function _renderCallDuration() {
      ...
      var duration = (0, _formatDuration.formatDuration)(this.calculateState());
      this._durationEl.innerHTML = duration;
      // @ts-expect-error TS(2322): Type 'Timeout' is not assignable to type 'number'.
      this.durationInterval = setInterval(function () {
        var duration = (0, _formatDuration.formatDuration)(_this5.calculateState());
