...
var AdapterCore = function () {
  ...
  (0, _createClass3.default)(AdapterCore, [{
    ...
    value: function _renderCallsBar() {
      if (this._minimized) {
        this._logoEl.setAttribute('class', (0, _classnames2.default)(this._styles.logo, this._logoUrl && this._logoUrl !== '' && this._styles.visible, this._styles.dock));
      ...
      this._durationEl.setAttribute('class', (0, _classnames2.default)(this._styles.duration, !this._scrollable && !this._hoverBar && this.showDuration && this._styles.visible, this._onCurrentCallPath && this._styles.center, this.moveOutDuration && this._styles.moveOut, this.moveInDuration && this._styles.moveIn));
      this._ringingCallsEl.setAttribute('class', (0, _classnames2.default)(this._styles.ringingCalls, !this._scrollable && !this._hoverBar && this.showRingingCalls && this._styles.visible, this._onAllCallsPath && this._styles.center, this.moveOutRingingInfo && this._styles.moveOut, this.moveInRingingInfo && this._styles.moveIn));
      this._onHoldCallsEl.setAttribute('class', (0, _classnames2.default)(this._styles.onHoldCalls, !this._scrollable && !this._hoverBar && this.showOnHoldCalls && this._styles.visible, this._onAllCallsPath && this._styles.center, this.moveOutOnHoldInfo && this._styles.moveOut, this.moveInOnHoldInfo && this._styles.moveIn));
      this._currentCallEl.setAttribute('class', (0, _classnames2.default)(this._styles.currentCallBtn, !this._scrollable && this.showCurrentCallBtn && this._styles.visible, this._hoverBar && this._styles.visible, this._hoverBar && this._styles.left, this.moveOutCurrentCallBtn && this._styles.moveOut, this.moveInCurrentCallBtn && this._styles.moveIn));
      this._viewCallsEl.setAttribute('class', (0, _classnames2.default)(this._styles.viewCallsBtn, this._hoverBar && this._styles.visible, !this._scrollable && this.showViewCallsBtn && this._styles.visible, !this.moveInViewCallsBtn && this.moveOutViewCallsBtn && this._styles.moveOut, this.moveInViewCallsBtn && this._styles.moveIn));
    }
  }, {
