...
var AdapterCore = function () {
  function AdapterCore(_ref) {
    ...
    var prefix = _ref.prefix,
        ...
        messageTransport = _ref.messageTransport,
    ...
    this._messageTransport = _ensureExist2.default.call(this, messageTransport, 'messageTransport');
    ...
    this._messageTransport.addListener(function (msg) {
      if (msg) {
        switch (msg.type) {
          case _this._messageTypes.syncClosed:
            _this._onSyncClosed(msg.closed);
            break;
          case _this._messageTypes.syncMinimized:
            _this._onSyncMinimized(msg.minimized);
            break;
          case _this._messageTypes.syncSize:
            _this._onSyncSize(msg.size);
            break;
          case _this._messageTypes.syncPresence:
            _this._onSyncPresence(msg);
            break;
          case _this._messageTypes.syncAdapterState:
            _this._onSyncAdapterState(msg);
            break;
          default:
            break;
        }
  ...
  (0, _createClass3.default)(AdapterCore, [{
    ...
    key: '_onSyncPresence',
    value: function _onSyncPresence(_ref3) {
    ...
    key: '_onSyncAdapterState',
    value: function _onSyncAdapterState(_ref4) {
      var _ref4$size = _ref4.size,
          width = _ref4$size.width,
          height = _ref4$size.height,
          minimized = _ref4.minimized,
          closed = _ref4.closed,
          _ref4$position = _ref4.position,
          translateX = _ref4$position.translateX,
          translateY = _ref4$position.translateY,
          minTranslateX = _ref4$position.minTranslateX,
          dndStatus = _ref4.dndStatus,
