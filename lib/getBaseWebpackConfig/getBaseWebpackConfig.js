...
var getBaseWebpackConfig = exports.getBaseWebpackConfig = function getBaseWebpackConfig(_ref) {
  ...
  var enablePseudo = process.argv.includes('--pseudo') || mode === 'production';
  if (useThreadLoader) {
  ...
  // https://github.com/mui-org/material-ui/issues/14711
  {
    ...
    use: {
      ...
      options: {
        ...
        replace: 'globalThis.HTMLAnchorElement&&"download"in globalThis.HTMLAnchorElement.prototype'
      }
    }
  },
