...
var TransportInteractionBase = exports.TransportInteractionBase = /*#__PURE__*/function () {
  function TransportInteractionBase(_transport) {
    _classCallCheck(this, TransportInteractionBase);
    this._transport = _transport;
    this._transportEvents = {};
  }
  return _createClass(TransportInteractionBase, [{
    ...
    value: function () {
      var _fetchAndResponse2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(_ref2) {
        var requestId, fetchFunc, emitData, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              return fetchFunc();
            case 2:
              emitData.result = _context.v;
              _context.n = 4;
              break;
            case 3:
              _context.p = 3;
              _t = _context.v;
              console.log('FetchAndResponse|error', _t);
              emitData.error = _t;
            case 4:
              this._transport.response(emitData);
              return _context.a(2, emitData);
          }
        }, _callee, this, [[1, 3]]);
      }));
