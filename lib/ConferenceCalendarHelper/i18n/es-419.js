...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Lo sentimos, cometimos un error. Vuelva a intentarlo.'), "deleteBtn", 'Eliminar'), "settingsBtn", 'Configuración'), "saveAsDefaultAndNotShowAgain", 'Guardar como configuración por defecto y no mostrar de nuevo'), "saveAsDefault", 'Guardar como configuración por defecto'), "done", 'Listo'), "update", 'Actualizar'), "conferenceSettingsTitle", 'Configuración del servicio de conferencias de {brand}'), "videoSettingsTitle", 'Configuración de {brand} Meetings'), "password", 'Contraseña'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Se perdió la conexión de red. Elimine esta reunión e inténtelo de nuevo más tarde.'), "meetingSettingsTitle", '{brand} Meetings - Configuración'), "recurringMeeting", 'Reunión recurrente'), "meetingOptions", 'Opciones de reunión'), "schedule", 'Programar'), "settingsBtn", 'Configuración')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
