...
var _default = (_inviteMeetingContent = {
  ...
  noMeetingPermission: "Désolé, vous n'avez pas les permissions requises pour les {brandName} Meetings. Communiquez avec l'administrateur de votre entreprise pour continuer.",
...
}, _defineProperty(_inviteMeetingContent, "scheduleError", "Désolé, un problème est survenu. Veuillez réessayer."), _defineProperty(_inviteMeetingContent, "deleteBtn", "Supprimer"), _defineProperty(_inviteMeetingContent, "settingsBtn", "Paramètres"), _defineProperty(_inviteMeetingContent, "saveAsDefaultAndNotShowAgain", "Enregistrer comme valeur par défaut et ne plus demander"), _defineProperty(_inviteMeetingContent, "saveAsDefault", "Enregistrer comme valeur par défaut"), _defineProperty(_inviteMeetingContent, "done", "Terminé"), _defineProperty(_inviteMeetingContent, "update", "Mettre à jour"), _defineProperty(_inviteMeetingContent, "conferenceSettingsTitle", "Paramètres de Téléconférence {brand}"), _defineProperty(_inviteMeetingContent, "videoSettingsTitle", "Paramètres de {brand} Meetings"), _defineProperty(_inviteMeetingContent, "password", "Mot de passe"), _defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", "Perte de la connexion réseau. Supprimez cette réunion et réessayez plus tard."), _defineProperty(_inviteMeetingContent, "meetingSettingsTitle", "Paramètres de {brand} Meetings"), _defineProperty(_inviteMeetingContent, "recurringMeeting", "Réunion périodique"), _defineProperty(_inviteMeetingContent, "meetingOptions", "Options de réunion"), _defineProperty(_inviteMeetingContent, "schedule", "Planifier"), _defineProperty(_inviteMeetingContent, "settingsBtn", "Paramètres"), _inviteMeetingContent); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
