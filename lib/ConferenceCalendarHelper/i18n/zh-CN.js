...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", '抱歉，出现问题，请重试。'), "deleteBtn", '删除'), "settingsBtn", '设置'), "saveAsDefaultAndNotShowAgain", '保存为默认值且不再显示'), "saveAsDefault", '另存为默认值'), "done", '完成'), "update", '更新'), "conferenceSettingsTitle", '{brand} 电话会议设置'), "videoSettingsTitle", '{brand} Meetings 设置'), "password", '密码'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", '网络连接中断。请删除此会议，然后再重试。'), "meetingSettingsTitle", '{brand} 会议 - 设置'), "recurringMeeting", '定期会议'), "meetingOptions", '会议选项'), "schedule", '安排'), "settingsBtn", '设置')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
