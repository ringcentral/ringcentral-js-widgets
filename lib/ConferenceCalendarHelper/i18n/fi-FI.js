...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Jokin meni vikaan. Yritä uudelleen.'), "deleteBtn", 'Poista'), "settingsBtn", 'Asetukset'), "saveAsDefaultAndNotShowAgain", 'Tallenna oletuksena äläkä näytä uudelleen'), "saveAsDefault", 'Tallenna oletukseksi'), "done", 'Valmis'), "update", 'Päivitä'), "conferenceSettingsTitle", '{brand}-neuvotteluasetukset'), "videoSettingsTitle", '{brand} Meetings -asetukset'), "password", 'Salasana'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Verkkoyhteys menetettiin. Poista tapaaminen ja yritä myöhemmin uudelleen.'), "meetingSettingsTitle", '{brand} Meetings – asetukset'), "recurringMeeting", 'Toistuva tapaaminen'), "meetingOptions", 'Tapaamisasetukset'), "schedule", 'Aikataulu'), "settingsBtn", 'Asetukset')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
