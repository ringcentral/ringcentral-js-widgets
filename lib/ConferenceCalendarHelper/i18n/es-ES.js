...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Se produjo un error; inténtelo de nuevo.'), "deleteBtn", 'Eliminar'), "settingsBtn", 'Configuración'), "saveAsDefaultAndNotShowAgain", 'Guardar como predeterminado y no mostrar de nuevo'), "saveAsDefault", 'Guardar como predeterminado'), "done", 'Listo'), "update", 'Actualizar'), "conferenceSettingsTitle", 'Configuración del servicio de conferencias de{brand}'), "videoSettingsTitle", 'Configuración de{brand}Meetings'), "password", 'Contraseña'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Se ha perdido la conexión de la red. Elimine esta reunión e inténtelo de nuevo más tarde.'), "meetingSettingsTitle", '{brand}Meetings - Configuración'), "recurringMeeting", 'Reunión periódica'), "meetingOptions", 'Opciones de reunión'), "schedule", 'Programar'), "settingsBtn", 'Configuración')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
