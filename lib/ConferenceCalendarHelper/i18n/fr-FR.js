...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Désolé, quelque chose s’est mal passé. Veuillez réessayer.'), "deleteBtn", 'Supprimer'), "settingsBtn", 'Paramètres'), "saveAsDefaultAndNotShowAgain", 'Enregistrer par défaut et ne plus afficher'), "saveAsDefault", 'Enregistrer par défaut'), "done", 'Terminé'), "update", 'M. à jour'), "conferenceSettingsTitle", 'Paramètres de la conférence {brand}'), "videoSettingsTitle", 'Paramètres de {brand} Meetings'), "password", 'Mot de passe'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Perte de la connexion réseau. Supprimez cette réunion et réessayez plus tard.'), "meetingSettingsTitle", '{brand} Meetings - Paramètres'), "recurringMeeting", 'Réunion périodique'), "meetingOptions", 'Options de réunion'), "schedule", 'Planifier'), "settingsBtn", 'Paramètres')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
