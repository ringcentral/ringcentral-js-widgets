...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Si è verificato un problema. Riprova più tardi.'), "deleteBtn", 'Elimina'), "settingsBtn", 'Impostazioni'), "saveAsDefaultAndNotShowAgain", 'Salva come predefinito e non mostrare più'), "saveAsDefault", 'Salva come predefinito'), "done", 'Fatto'), "update", 'Aggiorna'), "conferenceSettingsTitle", 'Impostazioni conferenza {brand}'), "videoSettingsTitle", 'Impostazioni {brand} Meetings'), "password", 'Password'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Connessione di rete persa. Elimina questa riunione e riprova più tardi.'), "meetingSettingsTitle", '{brand} Meetings - Impostazioni'), "recurringMeeting", 'Riunione ricorrente'), "meetingOptions", 'Opzioni riunione'), "schedule", 'Programma'), "settingsBtn", 'Impostazioni')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
