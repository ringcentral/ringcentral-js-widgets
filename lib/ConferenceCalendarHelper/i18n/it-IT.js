...
}, _defineProperty(_inviteMeetingContent, "scheduleError", 'Si è verificato un problema. Riprova più tardi.'), _defineProperty(_inviteMeetingContent, "deleteBtn", 'Elimina'), _defineProperty(_inviteMeetingContent, "settingsBtn", 'Impostazioni'), _defineProperty(_inviteMeetingContent, "saveAsDefaultAndNotShowAgain", 'Salva come predefinito e non mostrare più'), _defineProperty(_inviteMeetingContent, "saveAsDefault", 'Salva come predefinito'), _defineProperty(_inviteMeetingContent, "done", 'Fatto'), _defineProperty(_inviteMeetingContent, "update", 'Aggiorna'), _defineProperty(_inviteMeetingContent, "conferenceSettingsTitle", 'Impostazioni conferenza {brand}'), _defineProperty(_inviteMeetingContent, "videoSettingsTitle", 'Impostazioni {brand} Meetings'), _defineProperty(_inviteMeetingContent, "password", 'Password'), _defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Connessione di rete persa. Elimina questa riunione e riprova più tardi.'), _defineProperty(_inviteMeetingContent, "meetingSettingsTitle", '{brand} Meetings - Impostazioni'), _defineProperty(_inviteMeetingContent, "recurringMeeting", 'Riunione ricorrente'), _defineProperty(_inviteMeetingContent, "meetingOptions", 'Opzioni riunione'), _defineProperty(_inviteMeetingContent, "schedule", 'Programma'), _defineProperty(_inviteMeetingContent, "settingsBtn", 'Impostazioni'), _inviteMeetingContent); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
