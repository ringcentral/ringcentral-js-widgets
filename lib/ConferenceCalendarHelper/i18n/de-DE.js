...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", 'Da ist leider etwas schief gelaufen. Versuchen Sie es erneut.'), "deleteBtn", 'Löschen'), "settingsBtn", 'Einstellungen'), "saveAsDefaultAndNotShowAgain", 'Als Standard speichern und nicht erneut anzeigen'), "saveAsDefault", 'Als Standard speichern'), "done", 'Erledigt'), "update", 'Aktualisieren'), "conferenceSettingsTitle", '{brand}-Konferenzeinstellungen'), "videoSettingsTitle", '{brand} Meetings-Einstellungen'), "password", 'Kennwort'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Die Netzwerkverbindung wurde unterbrochen. Diese Besprechung löschen und später erneut versuchen.'), "meetingSettingsTitle", 'Einstellungen für {brand} Meetings'), "recurringMeeting", 'Wiederkehrende Besprechung'), "meetingOptions", 'Besprechungsoptionen'), "schedule", 'Planen'), "settingsBtn", 'Einstellungen')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
