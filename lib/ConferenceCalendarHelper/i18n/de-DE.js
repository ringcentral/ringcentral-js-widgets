...
}, _defineProperty(_inviteMeetingContent, "scheduleError", 'Da ist leider etwas schief gelaufen. Versuchen Sie es erneut.'), _defineProperty(_inviteMeetingContent, "deleteBtn", 'Löschen'), _defineProperty(_inviteMeetingContent, "settingsBtn", 'Einstellungen'), _defineProperty(_inviteMeetingContent, "saveAsDefaultAndNotShowAgain", 'Als Standard speichern und nicht erneut anzeigen'), _defineProperty(_inviteMeetingContent, "saveAsDefault", 'Als Standard speichern'), _defineProperty(_inviteMeetingContent, "done", 'Erledigt'), _defineProperty(_inviteMeetingContent, "update", 'Aktualisieren'), _defineProperty(_inviteMeetingContent, "conferenceSettingsTitle", '{brand}-Konferenzeinstellungen'), _defineProperty(_inviteMeetingContent, "videoSettingsTitle", '{brand} Meetings-Einstellungen'), _defineProperty(_inviteMeetingContent, "password", 'Kennwort'), _defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'Die Netzwerkverbindung wurde unterbrochen. Diese Besprechung löschen und später erneut versuchen.'), _defineProperty(_inviteMeetingContent, "meetingSettingsTitle", 'Einstellungen für {brand} Meetings'), _defineProperty(_inviteMeetingContent, "recurringMeeting", 'Wiederkehrende Besprechung'), _defineProperty(_inviteMeetingContent, "meetingOptions", 'Besprechungsoptionen'), _defineProperty(_inviteMeetingContent, "schedule", 'Planen'), _defineProperty(_inviteMeetingContent, "settingsBtn", 'Einstellungen'), _inviteMeetingContent); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
