...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", '抱歉，發生問題，請再試一次。'), "deleteBtn", '刪除'), "settingsBtn", '設定'), "saveAsDefaultAndNotShowAgain", '儲存為預設值且不再顯示'), "saveAsDefault", '儲存為預設值'), "done", '完成'), "update", '更新'), "conferenceSettingsTitle", '{brand} 電話會議設定'), "videoSettingsTitle", '{brand} Meetings 設定'), "password", '密碼'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", '網路連線中斷。請刪除此會議，並稍後再試一次。'), "meetingSettingsTitle", '{brand} Meetings - 設定'), "recurringMeeting", '定期會議'), "meetingOptions", '會議選項'), "schedule", '排程'), "settingsBtn", '設定')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
