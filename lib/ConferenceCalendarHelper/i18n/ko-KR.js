...
var _default = (_inviteMeetingContent = {
  ...
  noMeetingPermission: "죄송합니다. {brandName} Meetings 권한이 없습니다. 계속하려면 회사 관리자에게 문의하세요.",
...
}, _defineProperty(_inviteMeetingContent, "scheduleError", "죄송합니다. 문제가 발생했습니다. 다시 시도하세요."), _defineProperty(_inviteMeetingContent, "deleteBtn", "삭제"), _defineProperty(_inviteMeetingContent, "settingsBtn", "설정"), _defineProperty(_inviteMeetingContent, "saveAsDefaultAndNotShowAgain", "기본값으로 저장하고 다시 표시 안 함"), _defineProperty(_inviteMeetingContent, "saveAsDefault", "기본값으로 저장"), _defineProperty(_inviteMeetingContent, "done", "완료"), _defineProperty(_inviteMeetingContent, "update", "업데이트"), _defineProperty(_inviteMeetingContent, "conferenceSettingsTitle", "{brand} 전화 회의 설정"), _defineProperty(_inviteMeetingContent, "videoSettingsTitle", "{brand} Meetings 설정"), _defineProperty(_inviteMeetingContent, "password", "비밀번호"), _defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", "네트워크 연결이 끊어졌습니다. 이 모임을 삭제하고 나중에 다시 시도하세요."), _defineProperty(_inviteMeetingContent, "meetingSettingsTitle", "{brand} Meetings - 설정"), _defineProperty(_inviteMeetingContent, "recurringMeeting", "되풀이 모임"), _defineProperty(_inviteMeetingContent, "meetingOptions", "모임 옵션"), _defineProperty(_inviteMeetingContent, "schedule", "예약"), _defineProperty(_inviteMeetingContent, "settingsBtn", "설정"), _inviteMeetingContent); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
