...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", '죄송합니다. 문제가 발생했습니다. 다시 시도하세요.'), "deleteBtn", '삭제'), "settingsBtn", '설정'), "saveAsDefaultAndNotShowAgain", '기본값으로 저장하고 다시 표시 안 함'), "saveAsDefault", '기본값으로 저장'), "done", '완료'), "update", '업데이트'), "conferenceSettingsTitle", '{brand} 전화 회의 설정'), "videoSettingsTitle", '{brand} 모임 설정'), "password", '비밀번호'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", '네트워크 연결이 끊어졌습니다. 이 모임을 삭제하고 나중에 다시 시도하세요.'), "meetingSettingsTitle", '{brand} 모임 - 설정'), "recurringMeeting", '되풀이 모임'), "meetingOptions", '모임 옵션'), "schedule", '예약'), "settingsBtn", '설정')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
