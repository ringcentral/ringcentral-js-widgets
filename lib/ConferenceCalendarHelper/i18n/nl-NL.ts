...
export default {
  ...
  saveAsDefaultAndNotShowAgain: 'Opslaan als standaard en niet meer weergeven',
  saveAsDefault: 'Opslaan als standaard',
  done: 'Gereed',
  update: 'Bijwerken',
  conferenceSettingsTitle: '{brand}-conference-instellingen',
  videoSettingsTitle: '{brand}-meetinginstellingen',
  password: 'Wachtwoord',
  failedToRetrieveMeeting:
    'De netwerkverbinding is verbroken. Verwijder deze meeting en probeer het later opnieuw.',
