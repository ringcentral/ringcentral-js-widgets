...
export default {
  ...
  updateConferencingDetails:
    'Mise à jour des renseignements sur la téléconférence',
  // @ts-expect-error TS(1117): An object literal cannot have multiple properties ... Remove this comment to see the full error message
  scheduleError: 'Désolés, un problème est survenu. Veuillez réessayer.',
  deleteBtn: 'Supprimer',
  settingsBtn: 'Paramètres',
  saveAsDefaultAndNotShowAgain:
    'Enregistrer comme valeur par défaut et ne plus demander',
  saveAsDefault: 'Enregistrer par défaut',
  done: 'Terminer',
  update: 'Mettre à jour',
  conferenceSettingsTitle: 'Paramètres des téléconférences {brand}',
  videoSettingsTitle: 'Paramètres des réunions {brand}',
  password: 'Mot de passe',
  failedToRetrieveMeeting:
    'Perte de la connexion réseau. Supprimez cette réunion et réessayez plus tard.',
  meetingSettingsTitle: 'Paramètres des réunions {brand}',
