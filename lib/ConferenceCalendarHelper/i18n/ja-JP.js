...
var _default = exports["default"] = (_inviteMeetingContent = {
  ...
  noMeetingPermission: '申し訳ございませんが、お客様は{brandName} Meetingsに参加する権限をお持ちではありません。続行するには、会社の管理者にお問い合わせください。',
...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "scheduleError", '問題が発生しました。お手数をおかけしますが、もう一度やり直してください。'), "deleteBtn", '削除'), "settingsBtn", '設定'), "saveAsDefaultAndNotShowAgain", '既定として保存し次から表示しない'), "saveAsDefault", '既定として保存'), "done", '完了'), "update", '更新'), "conferenceSettingsTitle", '{brand}会議の設定'), "videoSettingsTitle", '{brand} Meetingsの設定'), "password", 'パスワード'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_inviteMeetingContent, "failedToRetrieveMeeting", 'ネットワーク接続が切断されています。会議を削除し、後でもう一度やり直してください。'), "meetingSettingsTitle", '{brand} Meetings - 設定'), "recurringMeeting", '定期的な会議'), "meetingOptions", '会議オプション'), "schedule", 'スケジュール'), "settingsBtn", '設定')); // @key: @#@"inviteMeetingContent"@#@ @source: @#@"{accountName} is inviting you to a {brandName} meeting.\n\nJoin from PC, Mac, iOS or Android: {joinUri}{passwordTpl}\n\n Or iPhone one-tap:\n\t    {mobileDialingNumberTpl}\n\n    Or Telephone:\n\t     Dial:\n\t    {phoneDialingNumberTpl}\n\t     Meeting ID: {meetingId}\n\t     International numbers available: {teleconference} "@#@
