  ...
  (0, _ramda.forEach)(function (folderPath) {
    (0, _ramda.forEach)(function (locale) {
      if (locale !== sourceLocale) {
        ...
        var output = "".concat(eslint).concat(code, "\n\n").concat(annotations, "\n");
...
function mergeTranslationData(_x2) {
