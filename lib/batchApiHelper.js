...
function _batchPutApi() {
  _batchPutApi = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(_ref) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          result = _context.v;
          return _context.a(2, platform._client.toMultipart(result));
      }
    }, _callee);
  }));
  return _batchPutApi.apply(this, arguments);
...
function _batchGetApi() {
  _batchGetApi = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref2) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          result = _context2.v;
          return _context2.a(2, platform._client.toMultipart(result));
      }
    }, _callee2);
  }));
  return _batchGetApi.apply(this, arguments);
