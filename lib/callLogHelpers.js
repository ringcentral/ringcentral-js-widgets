      ...
      case 4000:
        {
          ...
          // call-log
          if (inbound.action === _callActions2.default.phoneCall && (outbound.action === _callActions2.default.ringOutWeb || outbound.action === _callActions2.default.ringOutPC || outbound.action === _callActions2.default.ringOutMobile) && (inbound.from.phoneNumber === outbound.from.phoneNumber || inbound.from.extensionNumber === outbound.from.extensionNumber) && inbound.to.phoneNumber === outbound.to.phoneNumber) {
            return true;
          }
          break;
        }
