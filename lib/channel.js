...
var Channel = exports.Channel = /*#__PURE__*/function () {
  ...
  return _createClass(Channel, [{
    ...
    key: "send",
    value: function () {
      var _send = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(packet) {
    ...
    key: "broadcast",
    value: function () {
      var _broadcast = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(packet) {
        var _this = this;
        var tabs;
