...
function () {
  function Tabbie(_ref) {
    ...
    this._prefix = prefix && prefix !== '' ? "".concat(prefix, "-") : '';
    ...
    this._heartBeatKey = "".concat(this.prefix, "tabbie-heartBeat-").concat(this.id);
    this._heartBeatRegExp = new RegExp("^".concat(this.prefix, "tabbie-heartBeat-"));
    this._mainTabKey = "".concat(this.prefix, "tabbie-mainTab-id");
    this._eventRegExp = new RegExp("^".concat(this.prefix, "tabbie-event-"));
                ...
                case 19:
                  if (_this._eventRegExp.test(e.key) && e.newValue && e.newValue !== '') {
                    ...
                    if (id !== _this.id) {
                      ...
                      _this.emit.apply(_this, ['event', event].concat(_toConsumableArray(args)));
                    }
                  }
...
(0, _eventEmitter.default)(Tabbie.prototype);
