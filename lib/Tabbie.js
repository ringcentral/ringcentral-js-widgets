...
function (_EventEmitter) {
  ...
  function Tabbie(_ref) {
    ...
    _this._gc = function () {
      ...
      _this._getHeartBeatKeys().forEach(function _callee(key) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return regeneratorRuntime.awrap(_this.getMainTabId());
    ...
    if (_this.enabled) {
      ...
      window.addEventListener('storage', function _callee2(e) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 12:
                ...
                _context2.next = 17;
                return regeneratorRuntime.awrap(_this._fightForMainTab());
  ...
  _createClass(Tabbie, [{
    ...
    value: function _fightForMainTab() {
      var originalMainTabId;
      return regeneratorRuntime.async(function _fightForMainTab$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return regeneratorRuntime.awrap((0, _sleep["default"])(this._fightTimeout));
    ...
    key: "getMainTabId",
    value: function getMainTabId() {
      var _this3 = this;

      var mainTabId;
      return regeneratorRuntime.async(function getMainTabId$(_context4) {
        while (1) {
    ...
    key: "checkIsMain",
    value: function checkIsMain() {
      return regeneratorRuntime.async(function checkIsMain$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return regeneratorRuntime.awrap(this.getMainTabId());
    ...
    get: function get() {
      ...
      return this.enabled && this._getHeartBeatKeys().filter(function (key) {
        return Date.now() - localStorage.getItem(key) < _this4._heartBeatInterval * 2 - 100;
      }).length > 1;
    }
  }]);
