  ...
  _createClass(Tabbie, [{
    ...
    value: function _getHeartBeatKeys() {
      ...
      for (var _i = 0; _i < length; _i += 1) {
        ...
        if (_key && _key !== '' && this._heartBeatRegExp.test(_key)) keys.add(_key);
      }
    ...
    value: function send(event) {
      if (this.enabled) {
        ...
        var _key3 = "".concat(this.prefix, "tabbie-event-").concat(id);
        ...
        localStorage.setItem(_key3, JSON.stringify(payload));
