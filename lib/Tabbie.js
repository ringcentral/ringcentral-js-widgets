...
var Tabbie = /*#__PURE__*/function () {
  _createClass(Tabbie, [{
    ...
    get: function get() {
      ...
      return this.enabled && this.tabs.filter(function (key) {
        return Date.now() - Math.floor(+localStorage.getItem(key)) < _this._heartBeatInterval * 2 - 100;
      }).length > 1;
    }
  }]);
  ...
  function Tabbie(_ref) {
    ...
    this._heartBeat = function () {
      localStorage.setItem(_this2._heartBeatKey, "".concat(Date.now()));
    };
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              expiredCut = Date.now() - _this2._heartBeatExpire;
              isMainTabAlive = false;
              _context.next = 4;
              return _this2.getMainTabId();
            ...
            case 4:
              ...
              for (i = 0, len = tabs.length; i < len; i++) {
                ...
                isMainTab = _this2._getActualId(key) === mainTabId;
    ...
    this._setAsVisibleTab = function () {
      ...
      if (!document.hidden && !_this2.isMainTab) {
        _this2._setAsMainTab();
      }
    };

    this.prefix = prefix && prefix !== '' ? "".concat(prefix, "-") : '';
    ...
    this._eventKey = "".concat(this.prefix, "tabbie-event-");
  ...
  _createClass(Tabbie, [{
    ...
    value: function _bindListener() {
      ...
      window.addEventListener('storage', /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref3) {
          var key, newValue, payload, _payload, id, event, args, _this3$_emitter;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  if (!(key === _this3._mainTabKey)) {
                    _context2.next = 10;
                    break;
                  }

                  _context2.t0 = _this3._emitter;
                  _context2.t1 = _this3.events.mainTabIdChanged;
                  _context2.next = 6;
                ...
                case 10:
                  if (!(_this3._heartBeatRegExp.test(key) && (!newValue || newValue === ''))) {
                    _context2.next = 19;
                    break;
                  }

                  _context2.t3 = _this3._getActualId(key);
                  _context2.next = 14;
                  return _this3.getMainTabId();
                ...
                case 19:
                  if (_this3._eventRegExp.test(key) && newValue && newValue !== '') {
                    ...
                    if (id !== _this3.id) {
                      ...
                      (_this3$_emitter = _this3._emitter).emit.apply(_this3$_emitter, [_this3.events.event, event].concat(_toConsumableArray(args)));
                    }
                  }
      ...
      window.addEventListener('unload', function () {
        clearInterval(_this3._gcIntervalId);
        clearInterval(_this3._heartBeatIntervalId);
        localStorage.removeItem(_this3._heartBeatKey);
      });
    }
  }, {
    key: "send",
    value: function send(event) {
      ...
      var key = "".concat(this._eventKey).concat(_uuid["default"].v4());
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                return _context3.abrupt("return", new Promise(function (resolve) {
                  _this4._emitter.once(_this4.events.mainTabIdChanged, resolve);
                }));
    ...
    value: function checkTabAliveById(id) {
      ...
      return this.tabs.some(function (key) {
        return _this5._getActualId(key) === id;
      });
    }
  }, {
    key: "on",
