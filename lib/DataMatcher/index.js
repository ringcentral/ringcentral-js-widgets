...
function (_RcModule) {
  ...
  _createClass(DataMatcher, [{
    ...
    key: "triggerMatch",
    value: function triggerMatch() {
      return regeneratorRuntime.async(function triggerMatch$(_context) {
        while (1) {
    ...
    value: function match(_ref4) {
      ...
      return regeneratorRuntime.async(function match$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return regeneratorRuntime.awrap(Promise.all(_toConsumableArray(this._searchProviders.keys()).map(function (name) {
    ...
    value: function _fetchMatchResult(_ref5) {
      var name, queries, provider, promise, data;
      return regeneratorRuntime.async(function _fetchMatchResult$(_context3) {
        while (1) {
            ...
            case 0:
              ...
              if (filteredQueries.length) {
                if (ignoreQueue) {
                  ...
                  queue.promise = function _callee() {
                    var promise;
                    return regeneratorRuntime.async(function _callee$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.next = 2;
                            return regeneratorRuntime.awrap(matching.promise);
    ...
    key: "insertMatching",
    value: function insertMatching(_ref7) {
      var name = _ref7.name,
          data = _ref7.data,
