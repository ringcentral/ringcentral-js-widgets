...
var DataMatcher = function (_RcModule) {
  ...
  function DataMatcher() {
    ...
    _this.addSelector('dataMapping', _this._selectors.data, function (data) {
      ...
      (0, _keys2.default)(data).forEach(function (query) {
        ...
        var matchesList = [];
        (0, _keys2.default)(queryResult).forEach(function (providerName) {
  ...
  (0, _createClass3.default)(DataMatcher, [{
    ...
    value: function _shouldInit() {
      return !!(this.pending && (!this._storage || this._storage.ready) && this.searchProvidersReady && this.querySourcesReady);
    }
  }, {
    key: '_shouldReset',
    value: function _shouldReset() {
      return !!(this.ready && (!!this._storage && !this._storage.ready || !this.searchProvidersReady || !this.querySourcesReady));
    }
  }, {
    ...
    key: 'querySourcesReady',
    get: function get() {
      return [].concat((0, _toConsumableArray3.default)(this._querySources.values())).every(function (readyCheckFn) {
        return readyCheckFn();
      });
    }
  }, {
