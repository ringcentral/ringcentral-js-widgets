...
var contactMatchIdentifyDecode = function contactMatchIdentifyDecode(identify) {
  var _identify$split = identify.split(separator),
      _identify$split2 = _slicedToArray(_identify$split, 2),
      phoneNumber = _identify$split2[0],
      callType = _identify$split2[1];
