...
var separator = '_';
var contactMatchIdentifyEncode = exports.contactMatchIdentifyEncode = function contactMatchIdentifyEncode(_ref) {
  var phoneNumber = _ref.phoneNumber,
    callType = _ref.callType;
  return "".concat(phoneNumber).concat(separator).concat(callType).toLocaleLowerCase();
};
var contactMatchIdentifyDecode = exports.contactMatchIdentifyDecode = function contactMatchIdentifyDecode(identify) {
