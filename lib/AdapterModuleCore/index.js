...
var AdapterModuleCore = (_dec = (0, _di.Module)({
  ...
  function AdapterModuleCore(_ref) {
    ...
    _this.addSelector('localeStrings', function () {
    ...
    }, function (currentLocale, ringingCallsLength, onHoldCallsLength) {
      ...
      return {
        ...
        viewCalls: _i18n2.default.getString('viewCall', currentLocale),
  ...
  (0, _createClass3.default)(AdapterModuleCore, [{
    ...
    value: function _shouldInit() {
      return this.pending && this._globalStorage.ready && this._locale.ready && this._router.ready && (!this._userGuide || this._userGuide.ready) && (!this._quickAccess || this._quickAccess.ready);
    }
  }, {
    key: '_onStateChange',
    ...
    value: function _pushRingState() {
      ...
      if (callingMode === _callingModes2.default.webphone) {
        ...
        if (this._lastPath !== this._router.currentPath) {
          ...
          var onCurrentCallPath = this._router.currentPath === ACTIVE_CALL_PATH || this._router.currentPath === ACTIVE_CALL_PATH + '/' + this._webphone.activeSessionId;
          if (this.onCurrentCallPath !== onCurrentCallPath) {
          ...
          var onAllCallsPath = this._router.currentPath === ALL_CALL_PATH;
