  ...
  function AdapterModuleCore(_ref) {
    var prefix = _ref.prefix,
      ...
      targetWindow: window.parent
        ...
        options = (0, _objectWithoutProperties3.default)(_ref, ['prefix', 'storageKey', 'messageTypes', 'actionTypes', 'presence', 'locale', 'routerInteraction', 'globalStorage', 'getGlobalStorageReducer', 'messageTransport']);
