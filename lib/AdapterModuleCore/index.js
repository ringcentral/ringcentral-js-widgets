...
var _excluded = ["prefix", "storageKey", "actionTypes", "callingSettings", "globalStorage", "locale", "presence", "routerInteraction", "webphone", "callMonitor", "userGuide", "quickAccess", "messageTransport", "activeCallControl", "callLogSection"];
...
var ALL_CALL_PATH = exports.ALL_CALL_PATH = '/calls';
var ACTIVE_CALL_PATH = '/calls/active';
var AdapterModuleCore = exports["default"] = (_dec = (0, _di.Module)({
  ...
  function AdapterModuleCore(_ref) {
    ...
    _this = _callSuper(this, AdapterModuleCore, [_objectSpread({
      prefix: prefix,
    ...
    _initializerDefineProperty(_this, "localeStrings", _descriptor, _this);
  ...
  return _createClass(AdapterModuleCore, [{
    ...
    value: function () {
      var _onNavigateToCurrentCall2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    ...
    value: function () {
      var _onNavigateToViewCalls2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
