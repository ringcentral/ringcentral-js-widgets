...
var AdapterModuleCore = (_dec = (0, _di.Module)({
  deps: ['CallingSettings', 'GlobalStorage', 'Locale', 'Presence', 'RouterInteraction', 'Storage', 'Webphone']
  ...
  function AdapterModuleCore(_ref) {
    var prefix = _ref.prefix,
      ...
      targetWindow: window.parent
        ...
        options = (0, _objectWithoutProperties3.default)(_ref, ['prefix', 'storageKey', 'messageTypes', 'actionTypes', 'callingSettings', 'globalStorage', 'locale', 'presence', 'routerInteraction', 'webphone', 'getGlobalStorageReducer', 'messageTransport']);
