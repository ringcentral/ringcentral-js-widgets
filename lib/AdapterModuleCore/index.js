...
function (_AdapterModuleCoreBas) {
  ...
  _createClass(AdapterModuleCore, [{
    ...
    value: function _onNavigateToCurrentCall() {
      ...
      return regeneratorRuntime.async(function _onNavigateToCurrentCall$(_context) {
        while (1) {
    ...
    value: function _onNavigateToViewCalls() {
      return regeneratorRuntime.async(function _onNavigateToViewCalls$(_context2) {
        while (1) {
...
}(_AdapterModuleCoreBase["default"]), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "localeStrings", [_selector.selector], {
  configurable: true,
  enumerable: true,
  writable: true,
