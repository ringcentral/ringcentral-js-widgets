...
/*#__PURE__*/
function (_AdapterModuleCoreBas) {
  ...
  function AdapterModuleCore(_ref) {
    ...
    var prefix = _ref.prefix,
      ...
      targetWindow: window.parent
        ...
        options = _objectWithoutProperties(_ref, ["prefix", "storageKey", "actionTypes", "callingSettings", "globalStorage", "locale", "presence", "routerInteraction", "webphone", "callMonitor", "userGuide", "quickAccess", "messageTransport"]);

    _classCallCheck(this, AdapterModuleCore);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AdapterModuleCore).call(this, _objectSpread({
      prefix: prefix,
    ...
    _this.addSelector('localeStrings', function () {
      ...
      var availableBtn = _i18n2["default"].getString(_presenceStatus["default"].available, currentLocale);

      var busyBtn = _i18n2["default"].getString(_presenceStatus["default"].busy, currentLocale);

      var offlineBtn = _i18n2["default"].getString(_presenceStatus["default"].offline, currentLocale);
...
}(_AdapterModuleCoreBase["default"]), (_applyDecoratedDescriptor(_class2.prototype, "_onNavigateToCurrentCall", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "_onNavigateToCurrentCall"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_onNavigateToViewCalls", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "_onNavigateToViewCalls"), _class2.prototype)), _class2)) || _class);
