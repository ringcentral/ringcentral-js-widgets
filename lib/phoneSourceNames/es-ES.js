...
var _default = (_phoneSources$account = {}, _defineProperty(_phoneSources$account, _phoneSources.phoneSources.account, 'Cuenta'), _defineProperty(_phoneSources$account, _phoneSources.phoneSources.contact, 'Contacto'), _defineProperty(_phoneSources$account, _phoneSources.phoneSources.rcContact, '{brand}'), _defineProperty(_phoneSources$account, _phoneSources.phoneSources.lead, 'Cliente potencial'), _defineProperty(_phoneSources$account, _phoneSources.phoneSources.opportunity, 'Oportunidad'), _defineProperty(_phoneSources$account, _phoneSources.phoneSources.systemUser, 'Usuario del sistema'), _phoneSources$account); // @key: @#@"[phoneSources.account]"@#@ @source: @#@"Account"@#@
