    ...
    if (typeof (0, _index.getStagedState)() === 'undefined') {
      try {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          if (executionTime > 200) console.warn("The execution time of method '".concat(this[_constant.identifierKey], ".").concat(key.toString(), "' is ").concat(executionTime, " ms, it's recommended to use 'dispatch' API.")); // performance detail: https://immerjs.github.io/immer/docs/performance
        }
