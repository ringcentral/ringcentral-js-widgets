...
exports.createStore = exports.setPatchesToggle = exports.getPatchesToggle = void 0;
  ...
  options.modules.forEach(function (module, index) {
    ...
    if (service[_constant.stateKey]) {
      var _loop = function _loop(key) {
        var descriptor = Object.getOwnPropertyDescriptor(service, key); // eslint-disable-next-line no-continue
      ...
      var serviceReducers = Object.entries(initState).reduce(function (serviceReducersMapObject, _ref) {
        ...
        var reducer = function reducer() {
          ...
          return action._usm === _constant.usm ? action._state[identifier][key] : state;
        };
