...
var _excluded = ["transporterType", "transporterDirection", "targetWindow", "origin"];
...
var TRANSPORTER_TYPES = exports.TRANSPORTER_TYPES = {
  POST_MESSAGE: 'postMessage',
  EVENT_EMITTER: 'eventEmitter'
};
var MessageTransport = exports["default"] = /*#__PURE__*/function (_TransportBase) {
  function MessageTransport(_ref) {
    ...
    _this = _callSuper(this, MessageTransport, [_objectSpread(_objectSpread({}, options), {}, {
  ...
  return _createClass(MessageTransport, [{
    key: "addListeners",
    ...
    key: "request",
    value: (function () {
      var _request = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(_ref3) {
        var _this2 = this;
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              return _context.a(2, promise.then(function (result) {
