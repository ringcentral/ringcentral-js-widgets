...
!function (a, b) {
  ...
  _r.fn = _r.prototype = {
    ...
    var a,
      ...
      i = arguments.length,
      j = !1;
    for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == _typeof(g) || _r.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++) if (null != (a = arguments[h])) for (b in a) c = g[b], d = a[b], g !== d && (j && d && (_r.isPlainObject(d) || (e = Array.isArray(d))) ? (e ? (e = !1, f = c && Array.isArray(c) ? c : []) : f = c && _r.isPlainObject(c) ? c : {}, g[b] = _r.extend(j, f, d)) : void 0 !== d && (g[b] = d));
    return g;
  }, _r.extend({
  ...
  function E(a, b, c) {
    ...
    }) : D.test(b) ? _r.filter(b, a, c) : (b = _r.filter(b, a), _r.grep(a, function (a) {
  ...
  _r.filter = function (a, b, c) {
    ...
    is: function is(a) {
      return !!E(this, "string" == typeof a && A.test(a) ? _r(a) : a || [], !1).length;
    }
  });
  var F,
    G = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
    H = _r.fn.init = function (a, b, c) {
      var e, f;
      if (!a) return this;
      if (c = c || F, "string" == typeof a) {
        if (e = "<" === a[0] && ">" === a[a.length - 1] && a.length >= 3 ? [null, a, null] : G.exec(a), !e || !e[1] && b) return !b || b.jquery ? (b || c).find(a) : this.constructor(b).find(a);
        if (e[1]) {
          if (b = b instanceof _r ? b[0] : b, _r.merge(this, _r.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)), C.test(e[1]) && _r.isPlainObject(b)) for (e in b) _r.isFunction(this[e]) ? this[e](b[e]) : this.attr(e, b[e]);
          return this;
        }
  ...
  _r.each({
    ...
    contents: function contents(a) {
      return B(a, "iframe") ? a.contentDocument : (B(a, "template") && (a = a.content || a), _r.merge([], a.childNodes));
    }
  }, function (a, b) {
    _r.fn[a] = function (c, d) {
      var e = _r.map(this, b, c);
      return "Until" !== a.slice(-5) && (d = c), d && "string" == typeof d && (e = _r.filter(d, e)), this.length > 1 && (J[a] || _r.uniqueSort(e), I.test(a) && e.reverse()), this.pushStack(e);
    };
  });
  var L = /[^\x20\t\r\n\f]+/g;
  function M(a) {
    var b = {};
    return _r.each(a.match(L) || [], function (a, c) {
      b[c] = !0;
    }), b;
  }
  _r.Callbacks = function (a) {
    a = "string" == typeof a ? M(a) : _r.extend({}, a);
    var b,
      c,
      d,
      e,
  ...
  function P(a, b, c, d) {
    var e;
    try {
      a && _r.isFunction(e = a.promise) ? e.call(a).done(b).fail(c) : a && _r.isFunction(e = a.then) ? e.call(a, b, c) : b.apply(void 0, [a].slice(d));
    } catch (a) {
      c.apply(void 0, [a]);
    }
  }
  _r.extend({
        ...
        e = {
          ...
          then: function then(b, d, e) {
                ...
                var h = this,
                  ...
                  j = function j() {
                    ...
                    if (!(b < f)) {
                      ...
                      j = a && ("object" == _typeof(a) || "function" == typeof a) && a.then, _r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [a]), (e || c.resolveWith)(h, i));
                    }
                  },
                  k = e ? j : function () {
                    try {
                      ...
                      _r.Deferred.exceptionHook && _r.Deferred.exceptionHook(a, k.stackTrace), b + 1 >= f && (d !== O && (h = void 0, i = [a]), c.rejectWith(h, i));
                    }
                  };
            ...
            return _r.Deferred(function (a) {
              c[0][3].add(g(0, a, _r.isFunction(e) ? e : N, a.notifyWith)), c[1][3].add(g(0, a, _r.isFunction(b) ? b : N)), c[2][3].add(g(0, a, _r.isFunction(d) ? d : O));
            }).promise();
          },
    ...
    when: function when(a) {
      ...
      if (b <= 1 && (P(a, g.done(h(c)).resolve, g.reject, !b), "pending" === g.state() || _r.isFunction(e[c] && e[c].then))) return g.then();
  ...
  _r.fn.ready = function (a) {
    ...
    ready: function ready(a) {
      (a === !0 ? --_r.readyWait : _r.isReady) || (_r.isReady = !0, a !== !0 && --_r.readyWait > 0 || R.resolveWith(d, [_r]));
    }
  }), _r.ready.then = R.then;
  function S() {
    d.removeEventListener("DOMContentLoaded", S), a.removeEventListener("load", S), _r.ready();
  }
  "complete" === d.readyState || "loading" !== d.readyState && !d.documentElement.doScroll ? a.setTimeout(_r.ready) : (d.addEventListener("DOMContentLoaded", S), a.addEventListener("load", S));
  var _T = function T(a, b, c, d, e, f, g) {
      var h = 0,
        i = a.length,
        j = null == c;
      if ("object" === _r.type(c)) {
        e = !0;
        for (h in c) _T(a, b, h, c[h], !0, f, g);
  ...
  V.uid = 1, V.prototype = {
    ...
    remove: function remove(a, b) {
      ...
      if (void 0 !== d) {
        if (void 0 !== b) {
          Array.isArray(b) ? b = b.map(_r.camelCase) : (b = _r.camelCase(b), b = b in d ? [b] : b.match(L) || []), c = b.length;
  ...
  _r.extend({
    ...
    data: function data(a, b) {
      ...
      if (void 0 === a) {
        if (this.length && (e = X.get(f), 1 === f.nodeType && !W.get(f, "hasDataAttrs"))) {
          c = g.length;
          while (c--) g[c] && (d = g[c].name, 0 === d.indexOf("data-") && (d = _r.camelCase(d.slice(5)), _(f, d, e[d])));
    ...
    queue: function queue(a, b, c) {
      var d;
      if (a) return b = (b || "fx") + "queue", d = W.get(a, b), c && (!d || Array.isArray(c) ? d = W.access(a, b, _r.makeArray(c)) : d.push(c)), d || [];
    },
  ...
  function fa(a, b, c, d) {
    var e,
      ...
      k = (_r.cssNumber[b] || "px" !== j && +i) && ba.exec(_r.css(a, b));
    if (k && k[3] !== j) {
      j = j || k[3], c = c || [], k = +i || 1;
  ...
  function ha(a) {
    var b,
      ...
      d = a.nodeName,
      e = ga[d];
    return e ? e : (b = c.body.appendChild(c.createElement(d)), e = _r.css(b, "display"), b.parentNode.removeChild(b), "none" === e && (e = "block"), ga[d] = e, e);
  }
  function ia(a, b) {
  ...
  _r.fn.extend({
    ...
    toggle: function toggle(a) {
      return "boolean" == typeof a ? a ? this.show() : this.hide() : this.each(function () {
        da(this) ? _r(this).show() : _r(this).hide();
      });
    }
  });
  ...
  function na(a, b) {
    var c;
    return c = "undefined" != typeof a.getElementsByTagName ? a.getElementsByTagName(b || "*") : "undefined" != typeof a.querySelectorAll ? a.querySelectorAll(b || "*") : [], void 0 === b || b && B(a, b) ? _r.merge([a], c) : c;
  }
  function oa(a, b) {
  ...
  function qa(a, b, c, d, e) {
    for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++) if (f = a[n], f || 0 === f) if ("object" === _r.type(f)) _r.merge(m, f.nodeType ? [f] : f);else if (pa.test(f)) {
      g = g || l.appendChild(b.createElement("div")), h = (ka.exec(f) || ["", ""])[1].toLowerCase(), i = ma[h] || ma._default, g.innerHTML = i[1] + _r.htmlPrefilter(f) + i[2], k = i[0];
      while (k--) g = g.lastChild;
      _r.merge(m, g.childNodes), g = l.firstChild, g.textContent = "";
    } else m.push(b.createTextNode(f));
    l.textContent = "", n = 0;
    while (f = m[n++]) if (d && _r.inArray(f, d) > -1) e && e.push(f);else if (j = _r.contains(f.ownerDocument, f), g = na(l.appendChild(f), "script"), j && oa(g), c) {
      k = 0;
  ...
  _r.event = {
    ...
    add: function add(a, b, c, d, e) {
      var f,
        ...
        q = W.get(a);
      if (q) {
        c.handler && (f = c, c = f.handler, e = f.selector), e && _r.find.matchesSelector(ra, e), c.guid || (c.guid = _r.guid++), (i = q.events) || (i = q.events = {}), (g = q.handle) || (g = q.handle = function (b) {
          return "undefined" != typeof _r && _r.event.triggered !== b.type ? _r.event.dispatch.apply(a, arguments) : void 0;
        }), b = (b || "").match(L) || [""], j = b.length;
        while (j--) h = ua.exec(b[j]) || [], n = p = h[1], o = (h[2] || "").split(".").sort(), n && (l = _r.event.special[n] || {}, n = (e ? l.delegateType : l.bindType) || n, l = _r.event.special[n] || {}, k = _r.extend({
          type: n,
          origType: p,
          data: d,
          handler: c,
    ...
    remove: function remove(a, b, c, d, e) {
      ...
      if (q && (i = q.events)) {
        ...
        _r.isEmptyObject(i) && W.remove(a, "handle events");
      }
    },
  ...
  var za = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
    ...
    Da = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  function Ea(a, b) {
    return B(a, "table") && B(11 !== b.nodeType ? b : b.firstChild, "tr") ? _r(">tbody", a)[0] || a : a;
  }
  function Fa(a) {
  ...
  function Ha(a, b) {
    ...
    if (1 === b.nodeType) {
      ...
      X.hasData(a) && (h = X.access(a), i = _r.extend({}, h), X.set(b, i));
    }
  }
  function Ia(a, b) {
    var c = b.nodeName.toLowerCase();
  ...
  function Ja(a, b, c, d) {
    ...
    if (m && (e = qa(b, a[0].ownerDocument, !1, a, d), f = e.firstChild, 1 === e.childNodes.length && (e = f), f || d)) {
      for (h = _r.map(na(e, "script"), Fa), i = h.length; l < m; l++) j = e, l !== n && (j = _r.clone(j, !0, !0), i && _r.merge(h, na(j, "script"))), c.call(a[l], j, l);
      if (i) for (k = h[h.length - 1].ownerDocument, _r.map(h, Ga), l = 0; l < i; l++) j = h[l], la.test(j.type || "") && !W.access(j, "globalEval") && _r.contains(k, j) && (j.src ? _r._evalUrl && _r._evalUrl(j.src) : p(j.textContent.replace(Da, ""), k));
    }
    return a;
  }
  function Ka(a, b, c) {
    for (var d, e = b ? _r.filter(b, a) : a, f = 0; null != (d = e[f]); f++) c || 1 !== d.nodeType || _r.cleanData(na(d)), d.parentNode && (c && _r.contains(d.ownerDocument, d) && oa(na(d, "script")), d.parentNode.removeChild(d));
    return a;
  }
  _r.extend({
    ...
    clone: function clone(a, b, c) {
      ...
      if (!(o.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || _r.isXMLDoc(a))) for (g = na(h), f = na(a), d = 0, e = f.length; d < e; d++) Ia(f[d], g[d]);
      if (b) if (c) for (f = f || na(a), g = g || na(h), d = 0, e = f.length; d < e; d++) Ha(f[d], g[d]);else Ha(a, h);
      return g = na(h, "script"), g.length > 0 && oa(g, !i && na(a, "script")), h;
    },
    cleanData: function cleanData(a) {
      for (var b, c, d, e = _r.event.special, f = 0; void 0 !== (c = a[f]); f++) if (U(c)) {
        if (b = c[W.expando]) {
    ...
    empty: function empty() {
      for (var a, b = 0; null != (a = this[b]); b++) 1 === a.nodeType && (_r.cleanData(na(a, !1)), a.textContent = "");
      return this;
    },
    ...
    html: function html(a) {
      return _T(this, function (a) {
        ...
        if ("string" == typeof a && !Aa.test(a) && !ma[(ka.exec(a) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; c < d; c++) b = this[c] || {}, 1 === b.nodeType && (_r.cleanData(na(b, !1)), b.innerHTML = a);
            b = 0;
          } catch (e) {}
        }
    ...
    replaceWith: function replaceWith() {
      ...
      return Ja(this, arguments, function (b) {
        ...
        _r.inArray(this, a) < 0 && (_r.cleanData(na(this)), c && c.replaceChild(b, this));
      }, a);
    }
  }), _r.each({
    appendTo: "append",
  ...
  function Oa(a, b, c) {
    var d,
      ...
      g,
      h = a.style;
    return c = c || Na(a), c && (g = c.getPropertyValue(b) || c[b], "" !== g || _r.contains(a.ownerDocument, a) || (g = _r.style(a, b)), !o.pixelMarginRight() && Ma.test(g) && La.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), void 0 !== g ? g + "" : g;
  }
  function Pa(a, b) {
    return {
      get: function get() {
  ...
  function Xa(a) {
    var b = _r.cssProps[a];
    return b || (b = _r.cssProps[a] = Wa(a) || a), b;
  }
  function Ya(a, b, c) {
    var d = ba.exec(b);
  ...
  function Za(a, b, c, d, e) {
    var f,
      g = 0;
    for (f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0; f < 4; f += 2) "margin" === c && (g += _r.css(a, c + ca[f], !0, e)), d ? ("content" === c && (g -= _r.css(a, "padding" + ca[f], !0, e)), "margin" !== c && (g -= _r.css(a, "border" + ca[f] + "Width", !0, e))) : (g += _r.css(a, "padding" + ca[f], !0, e), "padding" !== c && (g += _r.css(a, "border" + ca[f] + "Width", !0, e)));
    return g;
  }
  function $a(a, b, c) {
    var d,
      e = Na(a),
      f = Oa(a, b, e),
      g = "border-box" === _r.css(a, "boxSizing", !1, e);
  ...
  _r.extend({
    ...
    css: function css(a, b, c, d) {
      var e,
        ...
        h = _r.camelCase(b),
        i = Ra.test(b);
      return i || (b = Xa(h)), g = _r.cssHooks[b] || _r.cssHooks[h], g && "get" in g && (e = g.get(a, !0, c)), void 0 === e && (e = Oa(a, b, d)), "normal" === e && b in Ta && (e = Ta[b]), "" === c || c ? (f = parseFloat(e), c === !0 || isFinite(f) ? f || 0 : e) : e;
    }
  }), _r.each(["height", "width"], function (a, b) {
    _r.cssHooks[b] = {
      get: function get(a, c, d) {
        if (c) return !Qa.test(_r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width ? $a(a, b, d) : ea(a, Sa, function () {
          return $a(a, b, d);
        });
      },
      set: function set(a, c, d) {
        var e,
          f = d && Na(a),
          g = d && Za(a, b, d, "border-box" === _r.css(a, "boxSizing", !1, f), f);
        return g && (e = ba.exec(c)) && "px" !== (e[3] || "px") && (a.style[b] = c, c = _r.css(a, b)), Ya(a, c, g);
      }
    };
  }), _r.cssHooks.marginLeft = Pa(o.reliableMarginLeft, function (a, b) {
    ...
    }, La.test(a) || (_r.cssHooks[a + b].set = Ya);
  }), _r.fn.extend({
    css: function css(a, b) {
      return _T(this, function (a, b, c) {
        var d,
          e,
          f = {},
          g = 0;
        if (Array.isArray(b)) {
          for (d = Na(a), e = b.length; g < e; g++) f[b[g]] = _r.css(a, b[g], !1, d);
          return f;
        }
  ...
  _r.Tween = _a, _a.prototype = {
    ...
    run: function run(a) {
      ...
      return this.options.duration ? this.pos = b = _r.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = b = a, this.now = (this.end - this.start) * b + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), c && c.set ? c.set(this) : _a.propHooks._default.set(this), this;
    }
    ...
    _default: "swing"
  }, _r.fx = _a.prototype.init, _r.fx.step = {};
  var ab,
    bb,
    cb = /^(?:toggle|show|hide)$/,
    db = /queueHooks$/;
  function eb() {
    bb && (d.hidden === !1 && a.requestAnimationFrame ? a.requestAnimationFrame(eb) : a.setTimeout(eb, _r.fx.interval), _r.fx.tick());
  }
  function fb() {
  ...
  function ib(a, b, c) {
    ...
    if (i = !_r.isEmptyObject(b), i || !_r.isEmptyObject(n)) {
      l && 1 === a.nodeType && (c.overflow = [o.overflow, o.overflowX, o.overflowY], j = q && q.display, null == j && (j = W.get(a, "display")), k = _r.css(a, "display"), "none" === k && (j ? k = j : (ia([a], !0), j = a.style.display || j, k = _r.css(a, "display"), ia([a]))), ("inline" === k || "inline-block" === k && null != j) && "none" === _r.css(a, "float") && (i || (m.done(function () {
        o.display = j;
  ...
  function jb(a, b) {
    var c, d, e, f, g;
    for (c in a) if (d = _r.camelCase(c), e = b[d], f = a[c], Array.isArray(f) && (e = f[1], f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), g = _r.cssHooks[d], g && "expand" in g) {
  ...
  function kb(a, b, c) {
    var d,
      ...
      k = j.props;
    for (jb(k, j.opts.specialEasing); f < g; f++) if (d = kb.prefilters[f].call(j, a, k, j.opts)) return _r.isFunction(d.stop) && (_r._queueHooks(j.elem, j.opts.queue).stop = _r.proxy(d.stop, d)), d;
    return _r.map(k, hb, j), _r.isFunction(j.opts.start) && j.opts.start.call(a, j), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail).always(j.opts.always), _r.fx.timer(_r.extend(i, {
      elem: a,
      anim: j,
      queue: j.opts.queue
    })), j;
  }
  _r.Animation = _r.extend(kb, {
    tweeners: {
      "*": [function (a, b) {
    ...
    tweener: function tweener(a, b) {
      _r.isFunction(a) ? (b = a, a = ["*"]) : a = a.match(L);
    ...
    var d = a && "object" == _typeof(a) ? _r.extend({}, a) : {
      complete: c || !c && b || _r.isFunction(a) && a,
      duration: a,
      easing: c && b || b && !_r.isFunction(b) && b
    };
    return _r.fx.off ? d.duration = 0 : "number" != typeof d.duration && (d.duration in _r.fx.speeds ? d.duration = _r.fx.speeds[d.duration] : d.duration = _r.fx.speeds._default), null != d.queue && d.queue !== !0 || (d.queue = "fx"), d.old = d.complete, d.complete = function () {
      _r.isFunction(d.old) && d.old.call(this), d.queue && _r.dequeue(this, d.queue);
    }, d;
  }, _r.fn.extend({
    ...
    var a,
      b = 0,
      c = _r.timers;
    for (ab = _r.now(); b < c.length; b++) a = c[b], a() || c[b] !== a || c.splice(b--, 1);
    c.length || _r.fx.stop(), ab = void 0;
  }, _r.fx.timer = function (a) {
    _r.timers.push(a), _r.fx.start();
  ...
  var lb,
    mb = _r.expr.attrHandle;
  _r.fn.extend({
    attr: function attr(a, b) {
      return _T(this, _r.attr, a, b, arguments.length > 1);
    },
  ...
  _r.fn.extend({
    prop: function prop(a, b) {
      return _T(this, _r.prop, a, b, arguments.length > 1);
    },
  ...
  _r.fn.extend({
    addClass: function addClass(a) {
      ...
      if (_r.isFunction(a)) return this.each(function (b) {
        _r(this).addClass(a.call(this, b, qb(this)));
      });
    ...
    removeClass: function removeClass(a) {
      var b,
        ...
        i = 0;
      if (_r.isFunction(a)) return this.each(function (b) {
        _r(this).removeClass(a.call(this, b, qb(this)));
      });
    ...
    toggleClass: function toggleClass(a, b) {
      ...
      return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : _r.isFunction(a) ? this.each(function (c) {
        _r(this).toggleClass(a.call(this, c, qb(this), b), b);
      }) : this.each(function () {
        var b, d, e, f;
        if ("string" === c) {
          d = 0, e = _r(this), f = a.match(L) || [];
  ...
  _r.fn.extend({
    val: function val(a) {
        ...
        e = this[0];
      {
        if (arguments.length) return d = _r.isFunction(a), this.each(function (c) {
          var e;
          1 === this.nodeType && (e = d ? a.call(this, c, _r(this).val()) : a, null == e ? e = "" : "number" == typeof e ? e += "" : Array.isArray(e) && (e = _r.map(e, function (a) {
            return null == a ? "" : a + "";
          })), b = _r.valHooks[this.type] || _r.valHooks[this.nodeName.toLowerCase()], b && "set" in b && void 0 !== b.set(this, e, "value") || (this.value = e));
        });
        if (e) return b = _r.valHooks[e.type] || _r.valHooks[e.nodeName.toLowerCase()], b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(rb, "") : null == c ? "" : c);
      }
    }
  }), _r.extend({
    valHooks: {
    ...
    _r.valHooks[this] = {
      set: function set(a, b) {
        if (Array.isArray(b)) return a.checked = _r.inArray(_r(a).val(), b) > -1;
      }
  ...
  _r.extend(_r.event, {
    trigger: function trigger(b, c, e, f) {
      ...
      if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !sb.test(p + _r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, b = b[_r.expando] ? b : new _r.Event(p, "object" == _typeof(b) && b), b.isTrigger = f ? 2 : 3, b.namespace = q.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : _r.makeArray(c, [b]), n = _r.event.special[p] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
        ...
        return b.type = p, f || b.isDefaultPrevented() || n._default && n._default.apply(o.pop(), c) !== !1 || !U(e) || k && _r.isFunction(e[p]) && !_r.isWindow(e) && (i = e[k], i && (e[k] = null), _r.event.triggered = p, e[p](), _r.event.triggered = void 0, i && (e[k] = i)), b.result;
      }
    },
  ...
  function Ab(a, b, c, d) {
    var e;
    if (Array.isArray(b)) _r.each(b, function (b, e) {
      c || wb.test(a) ? d(a, e) : Ab(a + "[" + ("object" == _typeof(e) && null != e ? b : "") + "]", e, c, d);
    });else if (c || "object" !== _r.type(b)) d(a, b);else for (e in b) Ab(a + "[" + e + "]", b[e], c, d);
  }
  _r.param = function (a, b) {
    ...
    if (Array.isArray(a) || a.jquery && !_r.isPlainObject(a)) _r.each(a, function () {
    ...
    serializeArray: function serializeArray() {
      return this.map(function () {
        ...
        var a = this.type;
        return this.name && !_r(this).is(":disabled") && zb.test(this.nodeName) && !yb.test(a) && (this.checked || !ja.test(a));
      }).map(function (a, b) {
        var c = _r(this).val();
        return null == c ? null : Array.isArray(c) ? _r.map(c, function (a) {
          return {
            name: b.name,
            value: a.replace(xb, "\r\n")
          };
  ...
  _r.extend({
    ...
    ajaxSetup: function ajaxSetup(a, b) {
      return b ? Ob(Ob(a, _r.ajaxSettings), b) : Ob(_r.ajaxSettings, a);
    },
    ajaxPrefilter: Mb(Ib),
    ajaxTransport: Mb(Jb),
    ajax: function ajax(b, c) {
      ...
      if (o.data && o.processData && "string" != typeof o.data && (o.data = _r.param(o.data, o.traditional)), Nb(Ib, o, c, y), k) return y;
      l = _r.event && o.global, l && 0 === _r.active++ && _r.event.trigger("ajaxStart"), o.type = o.type.toUpperCase(), o.hasContent = !Gb.test(o.type), f = o.url.replace(Cb, ""), o.hasContent ? o.data && o.processData && 0 === (o.contentType || "").indexOf("application/x-www-form-urlencoded") && (o.data = o.data.replace(Bb, "+")) : (n = o.url.slice(f.length), o.data && (f += (vb.test(f) ? "&" : "?") + o.data, delete o.data), o.cache === !1 && (f = f.replace(Db, "$1"), n = (vb.test(f) ? "&" : "?") + "_=" + ub++ + n), o.url = f + n), o.ifModified && (_r.lastModified[f] && y.setRequestHeader("If-Modified-Since", _r.lastModified[f]), _r.etag[f] && y.setRequestHeader("If-None-Match", _r.etag[f])), (o.data && o.hasContent && o.contentType !== !1 || c.contentType) && y.setRequestHeader("Content-Type", o.contentType), y.setRequestHeader("Accept", o.dataTypes[0] && o.accepts[o.dataTypes[0]] ? o.accepts[o.dataTypes[0]] + ("*" !== o.dataTypes[0] ? ", " + Kb + "; q=0.01" : "") : o.accepts["*"]);
      ...
      function A(b, c, d, h) {
        var j,
          ...
          w,
          x = c;
        k || (k = !0, i && a.clearTimeout(i), e = void 0, g = h || "", y.readyState = b > 0 ? 4 : 0, j = b >= 200 && b < 300 || 304 === b, d && (v = Pb(o, y, d)), v = Qb(o, v, y, j), j ? (o.ifModified && (w = y.getResponseHeader("Last-Modified"), w && (_r.lastModified[f] = w), w = y.getResponseHeader("etag"), w && (_r.etag[f] = w)), 204 === b || "HEAD" === o.type ? x = "nocontent" : 304 === b ? x = "notmodified" : (x = v.state, m = v.data, n = v.error, j = !n)) : (n = x, !b && x || (x = "error", b < 0 && (b = 0))), y.status = b, y.statusText = (c || x) + "", j ? s.resolveWith(p, [m, x, y]) : s.rejectWith(p, [y, x, n]), y.statusCode(u), u = void 0, l && q.trigger(j ? "ajaxSuccess" : "ajaxError", [y, o, j ? m : n]), t.fireWith(p, [y, x]), l && (q.trigger("ajaxComplete", [y, o]), --_r.active || _r.event.trigger("ajaxStop")));
      }
      return y;
    },
  ...
  var Rb = {
    ...
    Sb = _r.ajaxSettings.xhr();
  o.cors = !!Sb && "withCredentials" in Sb, o.ajax = Sb = !!Sb, _r.ajaxTransport(function (b) {
    var _c, d;
  ...
  _r.ajaxSetup({
    ...
    if (h || "jsonp" === b.dataTypes[0]) return e = b.jsonpCallback = _r.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Ub, "$1" + e) : b.jsonp !== !1 && (b.url += (vb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
      return g || _r.error(e + " was not called"), g[0];
    }, b.dataTypes[0] = "json", f = a[e], a[e] = function () {
      g = arguments;
    }, d.always(function () {
      void 0 === f ? _r(a).removeProp(e) : a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Tb.push(e)), g && _r.isFunction(f) && f(g[0]), g = f = void 0;
    }), "script";
    ...
    var e, f, g;
    return b || (o.createHTMLDocument ? (b = d.implementation.createHTMLDocument(""), e = b.createElement("base"), e.href = d.location.href, b.head.appendChild(e)) : b = d), f = C.exec(a), g = !c && [], f ? [b.createElement(f[1])] : (f = qa([a], b, g), g && g.length && _r(g).remove(), _r.merge([], f.childNodes));
    ...
    var d,
      ...
      g = this,
      h = a.indexOf(" ");
    return h > -1 && (d = pb(a.slice(h)), a = a.slice(0, h)), _r.isFunction(b) ? (c = b, b = void 0) : b && "object" == _typeof(b) && (e = "POST"), g.length > 0 && _r.ajax({
      url: a,
      type: e || "GET",
      dataType: "html",
      data: b
    ...
    position: function position() {
      if (this[0]) {
        ...
        return "fixed" === _r.css(c, "position") ? b = c.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), B(a[0], "html") || (d = a.offset()), d = {
    ...
    var c = "pageYOffset" === b;
    _r.fn[a] = function (d) {
      return _T(this, function (a, d, e) {
        var f;
        return _r.isWindow(a) ? f = a : 9 === a.nodeType && (f = a.defaultView), void 0 === e ? f ? f[b] : a[d] : void (f ? f.scrollTo(c ? f.pageXOffset : e, c ? e : f.pageYOffset) : a[d] = e);
      }, a, d, arguments.length);
    };
  }), _r.each(["top", "left"], function (a, b) {
    _r.cssHooks[b] = Pa(o.pixelPosition, function (a, c) {
      if (c) return c = Oa(a, b), Ma.test(c) ? _r(a).position()[b] + "px" : c;
    });
  }), _r.each({
    Height: "height",
    Width: "width"
  ...
  }), _r.holdReady = function (a) {
    a ? _r.readyWait++ : _r.ready(!0);
  }, _r.isArray = Array.isArray, _r.parseJSON = JSON.parse, _r.nodeName = B, "function" == typeof define && define.amd && define("jquery", [], function () {
    return _r;
  });
  var Vb = a.jQuery,
    Wb = a.$;
  return _r.noConflict = function (b) {
    return a.$ === _r && (a.$ = Wb), b && a.jQuery === _r && (a.jQuery = Vb), _r;
  }, b || (a.jQuery = a.$ = _r), _r;
});
