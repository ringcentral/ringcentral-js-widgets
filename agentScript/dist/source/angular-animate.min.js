...
(function (H, u, Sa) {
  ...
  u.module("ngAnimate", []).directive("ngAnimateChildren", [function () {
    ...
    function c() {
      if (d.length) {
        for (var b = d.shift(), h = 0; h < b.length; h++) {
          b[h]();
        }
        e || a(function () {
          e || c();
    ...
    this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", function (d, s, h, g, v, r, $, u, R, C) {
      ...
      function l(a, f, k) {
        ...
        if (C) {
          ...
          if (b("cancel", a, g, z)) {
            if (2 === z.state) z.runner.end();else if (z.structural) z.close();else return Q(a, z.options, g.options), z.runner;
      ...
      return function (g, C, D) {
        ...
        function y(a, b) {
          ...
          for (var c = [], f = 0; f < a.length; f++) {
            var d = a[f];
            if ("ng-" !== d.substring(0, 3)) for (var m = 0; m < b.length; m++) {
              if (d === b[m]) {
                c.push(d);
                break;
              }
        ...
        function A() {
          ...
          if (!ga) if (n.parentNode) {
            var A,
              x = [],
              l = function l(a) {
                if (va) k && a && (k = !1, m());else if (k = !a, E.animationDuration) if (a = na(n, k), k) y.push(a);else {
                  var b = y,
                    c = b.indexOf(a);
                  0 <= a && b.splice(c, 1);
                }
    ...
    this.$get = ["$injector", "$$AnimateRunner", "$$jqLite", function (b, c, d) {
      ...
      return function (a, b, d, r) {
        ...
        function C(a, b, d, e, f) {
          ...
          if (0 === g.length) {
            var h, l;
            "beforeSetClass" === f ? (h = B(a, "removeClass", d, e, "beforeRemoveClass"), l = B(a, "addClass", d, e, "beforeAddClass")) : "setClass" === f && (h = B(a, "removeClass", d, e, "removeClass"), l = B(a, "addClass", d, e, "addClass"));
            h && (g = g.concat(h));
            l && (g = g.concat(l));
          }
