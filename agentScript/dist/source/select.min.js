...
!function () {
  ...
  i.factory("$$uisDebounce", ["$timeout", function (e) {
    ...
    function h(e, t, s) {
      ...
      for (var i, c = Object(e), n = c.length >>> 0, l = 0; l < n; l++) if (i = c[l], t.call(s, i, l, c)) return l;
      return -1;
    }
    function g() {
    ...
    function f(e, t) {
      var s,
        i,
        c = [];
      for (s = 0; s < t.length; s++) for (i = 0; i < e.length; i++) e[i].name == [t[s]] && c.push(e[i]);
      return c;
    }
    function v(e, t) {
      var s = I.indexOf(e);
    ...
    function b(e) {
      ...
      switch (e) {
        case t.DOWN:
          if (!y.open && y.multiple) y.activate(!1, !0);else if (y.activeIndex < y.items.length - 1) for (var i = ++y.activeIndex; m(y.items[i]) && i < y.items.length;) y.activeIndex = ++i;
          break;
        case t.UP:
          var c = 0 === y.search.length && y.tagging.isActivated ? -1 : 0;
          if (!y.open && y.multiple) y.activate(!1, !0);else if (y.activeIndex > c) for (var n = --y.activeIndex; m(y.items[n]) && n > c;) y.activeIndex = --n;
          break;
        case t.TAB:
    ...
    y.isEmpty = function () {
      ...
      if (y.disabled || y.open) y.open && !y.searchEnabled && y.close();else {
        ...
        if (y.$animate && y.$animate.on && y.$animate.enabled(n[0])) {
          var _a = function a(t, s) {
            "start" === s && 0 === y.items.length ? (y.$animate.off("removeClass", l[0], _a), c(function () {
              y.focusSearchInput(e);
            })) : "close" === s && (y.$animate.off("enter", n[0], _a), c(function () {
              y.focusSearchInput(e);
            }));
          };
          y.items.length > 0 ? y.$animate.on("enter", n[0], _a) : y.$animate.on("removeClass", l[0], _a);
        } else c(function () {
    ...
    y.sizeSearchInput = function () {
      ...
      ~[t.ENTER, t.ESC].indexOf(i) && (e.preventDefault(), e.stopPropagation()), s.$apply(function () {
        ...
        if ((y.items.length > 0 || y.tagging.isActivated) && (b(i) || y.searchEnabled || (e.preventDefault(), e.stopPropagation()), y.taggingTokens.isActivated)) {
          for (var n = 0; n < y.taggingTokens.tokens.length; n++) y.taggingTokens.tokens[n] === t.MAP[e.keyCode] && y.search.length > 0 && (s = !0);
          s && c(function () {
    ...
    return {
      ...
      link: function link(c, n, l, a) {
        ...
        function d(e, t) {
          var s = -1;
          if (angular.isArray(e)) for (var i = angular.copy(e), c = 0; c < i.length; c++) if (void 0 === p.tagging.fct) i[c] + " " + p.taggingLabel === t && (s = c);else {
            var n = i[c];
        ...
        p.multiple = !0, p.focusInput = p.searchInput, h.$isEmpty = function (e) {
          ...
          for (var e, t = {}, s = [], i = p.selected.length - 1; i >= 0; i--) t = {}, t[p.parserResult.itemName] = p.selected[i], e = p.parserResult.modelMapper(c, t), s.unshift(e);
          return s;
          ...
          if (!e) return n;
          for (var a = e.length - 1; a >= 0; a--) l(p.selected, e[a]) || l(s, e[a]) || n.unshift(e[a]);
          return n;
      ...
      link: function link(c, n, l, a) {
        ...
        o.$parsers.unshift(function (t) {
          ...
          if (i) {
            ...
            for (var a = i.length - 1; a >= 0; a--) if (l(i[a])) return i[a];
          }
          return t;
