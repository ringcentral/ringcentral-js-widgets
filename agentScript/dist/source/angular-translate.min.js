...
!function (a, b) {
  "function" == typeof define && define.amd ? define([], function () {
    return b();
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b() : b();
}(0, function () {
  function a(a) {
    "use strict";
  ...
  function b() {
    ...
    var a,
      ...
      f = !1;
    c = {
      sanitize: function sanitize(a, b) {
      ...
      sanitizeParameters: function sanitizeParameters(a, b) {
        return "params" === b && (a = _j(a, h)), a;
      },
      escapeParameters: function escapeParameters(a, b) {
        return "params" === b && (a = _j(a, g)), a;
      },
      sce: function sce(a, b, c) {
        return "text" === b ? a = i(a) : "params" === b && "filter" !== c && (a = _j(a, g)), a;
      },
      sceParameters: function sceParameters(a, b) {
        return "params" === b && (a = _j(a, i)), a;
      }
      ...
      return g.has("$sanitize") && (a = g.get("$sanitize")), g.has("$sce") && (b = g.get("$sce")), {
        ...
        sanitize: function sanitize(a, b, c, e) {
      ...
      _j = function j(a, b, c) {
        ...
        if (angular.isObject(a)) {
          ...
          return c.push(a), angular.forEach(a, function (a, e) {
            angular.isFunction(a) || (d[e] = _j(a, b, c));
          }), c.splice(-1, 1), d;
        }
  ...
  function c(a, b, c, d) {
    ...
    var K = function K(a, b) {
      ...
      N = function N(a, b) {
        ...
        } else angular.isObject(u[a]) || (u[a] = {}), angular.extend(u[a], _O(b));
        return this;
      };
    ...
    var _O = function O(a, b, c, d) {
      var e, f, g, h;
      b || (b = []), c || (c = {});
      for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (h = a[e], angular.isObject(h) ? _O(h, b.concat(e), c, e) : (f = b.length ? "" + b.join(B) + B + e : e, b.length && e === d && (g = "" + b.join(B), c[g] = "@:" + f), c[f] = h));
      return c;
    };
    _O.displayName = "flatObject", this.addInterpolation = function (a) {
    ...
    this.storageKey = R, this.useUrlLoader = function (a, b) {
      ...
      var f,
          ...
          if (j && ja(j), angular.isArray(a)) {
            return function (a) {
              for (var e = {}, f = [], g = 0, i = a.length; g < i; g++) f.push(function (a) {
                ...
                return _U(a, b, c, h, j).then(g, g), f.promise;
              }(a[g]));
        ...
        W = function W(a) {
          i = a, k && f.put(_U.storageKey(), i), c.$emit("$translateChangeSuccess", {
            language: a
          }), H.setLocale(i);
          ...
          var g = angular.extend({}, p, {
            ...
            h = function h(b) {
              ...
              c.$emit("$translateLoadingSuccess", {
                ...
                angular.extend(d, _O(a));
              }) : angular.extend(d, _O(b)), I = !1, e.resolve({
                key: a,
                table: d
      ...
      var Z = function Z(a) {
        ...
        _$ = function $(a, b, c, e, f) {
          var g = d.defer(),
            h = function h(d) {
              if (Object.prototype.hasOwnProperty.call(d, b) && null !== d[b]) {
                e.setLocale(a);
                var h = d[b];
                if ("@:" === h.substr(0, 2)) _$(a, h.substr(2), c, e, f).then(g.resolve, g.reject);else {
        ...
        _2 = function _(a, b, c, d, e) {
          ...
          if (g && Object.prototype.hasOwnProperty.call(g, b) && null !== g[b]) {
            if (d.setLocale(a), f = d.interpolate(g[b], c, "filter", e, b), f = ia(b, g[b], f, c, a, e), !angular.isString(f) && angular.isFunction(f.$$unwrapTrustedValue)) {
              ...
              if ("@:" === h.substr(0, 2)) return _2(a, h.substr(2), c, d, e);
            } else if ("@:" === f.substr(0, 2)) return _2(a, f.substr(2), c, d, e);
            d.setLocale(i);
          }
          return f;
        },
        aa = function aa(a, c, d, e) {
          return m ? b.get(m)(a, i, c, d, e) : a;
        },
        _ba = function ba(a, b, c, e, f, h) {
          var i = d.defer();
          if (a < g.length) {
            var j = g[a];
            _$(j, b, c, e, h).then(function (a) {
              i.resolve(a);
            }, function () {
              return _ba(a + 1, b, c, e, f, h).then(i.resolve, i.reject);
            });
        ...
        _ca = function ca(a, b, c, d, e) {
          var f;
          if (a < g.length) {
            var h = g[a];
            f = _2(h, b, c, d, e), f || "" === f || (f = _ca(a + 1, b, c, d));
          }
          return f;
        },
        da = function da(a, b, c, d, e) {
          return _ba(G > 0 ? G : l, a, b, c, d, e);
        },
        ea = function ea(a, b, c, d) {
          return _ca(G > 0 ? G : l, a, b, c, d);
        },
        fa = function fa(a, b, c, e, f, h) {
          var i = d.defer(),
            j = f ? u[f] : u,
            k = c ? S[c] : H;
          if (j && Object.prototype.hasOwnProperty.call(j, a) && null !== j[a]) {
            var l = j[a];
            if ("@:" === l.substr(0, 2)) _U(l.substr(2), b, c, e, f).then(i.resolve, i.reject);else {
        ...
        _ga = function ga(a, b, c, d, e) {
          var f,
            h = d ? u[d] : u,
            i = H;
          if (S && Object.prototype.hasOwnProperty.call(S, c) && (i = S[c]), h && Object.prototype.hasOwnProperty.call(h, a) && null !== h[a]) {
            var j = h[a];
            "@:" === j.substr(0, 2) ? f = _ga(j.substr(2), b, c, d, e) : (f = i.interpolate(j, b, "filter", e, a), f = ia(a, j, f, b, d, e));
          } else {
            var k;
      ...
      _U.preferredLanguage = function (a) {
        return a && P(a), e;
      }, _U.cloakClassName = function () {
        return y;
      }, _U.nestedObjectDelimeter = function () {
        return B;
      }, _U.fallbackLanguage = function (a) {
        if (void 0 !== a && null !== a) {
          if (Q(a), o && g && g.length) for (var b = 0, c = g.length; b < c; b++) T[g[b]] || (T[g[b]] = X(g[b]));
          _U.use(_U.use());
        }
        return h ? g[0] : g;
      }, _U.useFallbackLanguage = function (a) {
        if (void 0 !== a && null !== a) if (a) {
          var b = K(g, a);
          b > -1 && (G = b);
        } else G = 0;
      }, _U.proposedLanguage = function () {
        return j;
      }, _U.storage = function () {
        return f;
      }, _U.negotiateLocale = M, _U.use = function (a) {
        if (!a) return i;
        var b = d.defer();
        ...
        return v.length > 0 && !e ? d.reject(a) : (e && (a = e), j = a, !A && u[a] || !o || T[a] ? T[a] ? T[a].then(function (a) {
          ...
          return !i && g && g.length > 0 && g[0] !== a ? _U.use(g[0]).then(b.resolve, b.reject) : b.reject(a);
      ...
      }, _U.resolveClientLocale = function () {
        return J();
      }, _U.storageKey = function () {
        return R();
      }, _U.isPostCompilingEnabled = function () {
        return z;
      }, _U.isForceAsyncReloadEnabled = function () {
        return A;
      }, _U.isKeepContent = function () {
        return D;
      }, _U.refresh = function (a) {
        function b(a) {
          var b = X(a);
        ...
        return e.promise;
      }, _U.instant = function (a, b, c, d, f) {
        var h = d && d !== i ? M(d) || d : i;
        if (null === a || angular.isUndefined(a)) return a;
        if (d && ja(d), angular.isArray(a)) {
          for (var j = {}, k = 0, l = a.length; k < l; k++) j[a[k]] = _U.instant(a[k], b, c, d, f);
          return j;
        }
        ...
        for (var p = 0, s = o.length; p < s; p++) {
          var t = o[p];
          if (u[t] && void 0 !== u[t][a] && (n = _ga(a, b, c, h, f)), void 0 !== n) break;
        }
        ...
        return n;
      }, _U.versionInfo = function () {
        return "2.15.2";
      }, _U.loaderCache = function () {
        return s;
      }, _U.directivePriority = function () {
        return E;
      }, _U.statefulFilter = function () {
        return F;
      }, _U.isReady = function () {
        return C;
      };
      ...
      ka.promise.then(function () {
        C = !0;
      }), _U.onReady = function (a) {
        var b = d.defer();
        return angular.isFunction(a) && b.promise.then(a), C ? b.resolve() : ka.promise.then(b.resolve), b.promise;
      }, _U.getAvailableLanguageKeys = function () {
        return v.length > 0 ? v : null;
      }, _U.getTranslationTable = function (a) {
        return a = a || _U.use(), a && u[a] ? angular.copy(u[a]) : null;
      };
      ...
      if (o) {
        if (angular.equals(u, {}) && _U.use() && _U.use(_U.use()), g && g.length) for (var na = function na(a) {
    ...
    return {
      ...
      compile: function compile(h, i) {
        ...
        return function (h, o, p) {
          ...
          var q = {},
            _r = function r(a) {
              if (angular.isFunction(_r._unwatchOld) && (_r._unwatchOld(), _r._unwatchOld = void 0), angular.equals(a, "") || !angular.isDefined(a)) {
                var c = g.apply(o.text()),
                  d = c.match(m);
                if (angular.isArray(d)) {
                  h.preText = d[1], h.postText = d[3], q.translate = b(d[2])(h.$parent);
                  var e = c.match(n);
                  angular.isArray(e) && e[2] && e[2].length && (_r._unwatchOld = h.$watch(e[2], function (a) {
                    q.translate = a, v();
                  }));
          ...
          p.$observe("translate", function (a) {
            void 0 === a ? _r("") : "" === a && s || (q.translate = a, v()), s = !1;
          });
          ...
          o.text().length ? _r(p.translate ? p.translate : "") : p.translate && _r(p.translate), v(), h.$on("$destroy", y);
        };
      }
    };
  }
