  ...
  function c(a, b, c, d) {
    ...
    var e,
      ...
      I = function I() {
        ...
        if (angular.isArray(e.languages)) for (a = 0; a < e.languages.length; a++) {
          if ((c = e.languages[a]) && c.length) return c;
        }
        for (a = 0; a < f.length; a++) {
          if ((c = e[f[a]]) && c.length) return c;
        }
        return null;
      };
    ...
    var O = function O(a, b, c, d) {
      var e, f, g, h;
      b || (b = []), c || (c = {});
      for (e in a) {
        Object.prototype.hasOwnProperty.call(a, e) && (h = a[e], angular.isObject(h) ? O(h, b.concat(e), c, e) : (f = b.length ? "" + b.join(B) + B + e : e, b.length && e === d && (g = "" + b.join(B), c[g] = "@:" + f), c[f] = h));
      }
      return c;
    };
    ...
    this.storageKey = R, this.useUrlLoader = function (a, b) {
      ...
      var f,
        ...
        S = {},
        T = {},
        U = function U(a, b, c, h, j) {
          !i && e && (i = e);
          var m = j && j !== i ? M(j) || j : i;
          if (j && ja(j), angular.isArray(a)) {
            return function (a) {
              for (var e = {}, f = [], g = 0, i = a.length; g < i; g++) {
                f.push(function (a) {
                  var f = d.defer(),
                    g = function g(b) {
                      e[a] = b, f.resolve([a, b]);
      ...
      U.preferredLanguage = function (a) {
        ...
        if (void 0 !== a && null !== a) {
          if (Q(a), o && g && g.length) for (var b = 0, c = g.length; b < c; b++) {
            T[g[b]] || (T[g[b]] = X(g[b]));
          }
          U.use(U.use());
        }
      ...
      if (o) {
        if (angular.equals(u, {}) && U.use() && U.use(U.use()), g && g.length) for (var na = function na(a) {
    ...
    return {
      ...
      compile: function compile(h, i) {
        ...
        return function (h, o, p) {
          ...
          for (var t in p) {
            p.hasOwnProperty(t) && "translateAttr" === t.substr(0, 13) && t.length > 13 && function (a) {
          ...
          if (p.$observe("translateDefault", function (a) {
            ...
            for (var u in p) {
              Object.prototype.hasOwnProperty.call(p, u) && "translateValue" === u.substr(0, 14) && "translateValues" !== u && function (a) {
                p.$observe(a, function (b) {
          ...
          var v = function v() {
              for (var a in q) {
                q.hasOwnProperty(a) && void 0 !== q[a] && w(a, q[a], h, h.interpolateParams, h.defaultText, h.translateNamespace);
              }
            },
