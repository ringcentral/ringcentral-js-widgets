...
(function (R, U, x) {
  ...
  function he() {
    ...
    if (!Ac) {
      ...
      (pa = r(b) ? R.jQuery : b ? R[b] : x) && pa.fn.on ? (D = pa, N(pa.fn, {
        ...
        var c;
        if (Rb) Rb = !1;else for (var e = 0, f; null != (f = b[e]); e++) {
  ...
  function Cc(a, b) {
    ...
    this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, l, y, w, V, F, Q, E) {
      ...
      function W(a, b, c, d, e, f) {
        function g(a, c, d, e) {
          var f, k, m, l, n, E, A;
          if (q) for (A = Array(c.length), l = 0; l < h.length; l += 3) {
            f = h[l], A[f] = c[f];
          } else A = c;
          l = 0;
  ...
  fc.prototype = {
    ...
    lex: function lex(a) {
      ...
      for (this.tokens = []; this.index < this.text.length;) {
        if (a = this.text.charAt(this.index), '"' === a || "'" === a) this.readString(a);else if (this.isNumber(a) || "." === a && this.isNumber(this.peek())) this.readNumber();else if (this.isIdent(a)) this.readIdent();else if (this.is(a, "(){}[].,;:?")) this.tokens.push({
          index: this.index,
          text: a
  ...
  var Ce = ["$animate", function (a) {
    ...
    this.$$parseAndValidate = function () {
      ...
      if (A = r(b) ? x : !0) for (var c = 0; c < q.$parsers.length; c++) {
    ...
    a.$watch(function () {
      ...
      if (b !== q.$modelValue && (q.$modelValue === q.$modelValue || b === b)) {
        ...
        for (var c = q.$formatters, d = c.length, e = b; d--;) {
          e = c[d](e);
        }
      ...
      link: {
        ...
        post: function post(b, g, h, k) {
          ...
          function r(a) {
            var b = y && y[0],
                c = u && u[0];
            if (b || c) for (; a && (a === b || a === c || 8 === a.nodeType || "option" === oa(a) && "" === a.value);) {
              a = a.nextSibling;
            }
            return a;
          }
          ...
          if (t) {
            ...
            for (var w = g.children(), v = w.length; k < v; k++) {
              if ("" === w[k].value) {
                y = w.eq(k);
                break;
              }
        ...
        return function (a, e, f, k, m) {
          ...
          a.$watchCollection(l, function (f) {
            var k,
                ...
                H;
            n && (a[n] = f);
            if (Aa(f)) G = f, l = q || y;else for (H in l = q || w, G = [], f) {
            ...
            for (v in r) {
              ...
              E = qb(B.clone);
              b.leave(E);
              if (E[0].parentNode) for (k = 0, l = E.length; k < l; k++) {
                E[k].$$NG_REMOVED = !0;
              }
              B.scope.$destroy();
            }
