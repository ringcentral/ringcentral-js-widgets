...
(function (u, n, v) {
  ...
  n.module("ngAria", ["ng"]).provider("$aria", function () {
    ...
    return {
      ...
      require: "?ngModel",
      priority: 200,
      compile: function compile(l, m) {
        var d = f(m, l);
        return {
          pre: function pre(a, b, c, h) {
            "checkbox" === d && "checkbox" !== c.type && (h.$isEmpty = function (b) {
              return !1 === b;
            });
          },
          post: function post(e, b, g, h) {
            function f() {
              return h.$modelValue;
            }
            function m() {
            ...
            switch (d) {
              ...
              case "range":
                ...
                if (a.config("ariaValue")) {
                  var n = !b.attr("aria-valuemin") && (g.hasOwnProperty("min") || g.hasOwnProperty("ngMin")),
