...
(function (J, f, C) {
  ...
  function D(t, e) {
    ...
    for (var k in t) {
      !t.hasOwnProperty(k) || "$" === k.charAt(0) && "$" === k.charAt(1) || (e[k] = t[k]);
    }
  ...
  f.module("ngResource", ["ng"]).provider("$resource", function () {
    ...
    this.$get = ["$http", "$log", "$q", function (k, F, G) {
            ...
            n = k(v).then(function (b) {
              ...
              if (c) {
                ...
                a.isArray ? (p.length = 0, u(c, function (b) {
                  "object" === _typeof(b) ? p.push(new d(b)) : p.push(b);
                })) : (D(c, p), p.$promise = m);
              }
      ...
      var E = f.noop,
          ...
          x = f.isFunction;
      w.prototype = {
        setUrlParams: function setUrlParams(l, g, e) {
          var h = this,
              c = e || h.template,
              k,
              d,
