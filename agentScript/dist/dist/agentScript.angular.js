...
angular.module('render', ['ui.select', 'ngSanitize', 'angular-growl', 'pascalprecht.translate', 'formly', 'formlyBootstrap', 'gridstack-angular', 'ngAnimate', 'ngMaterial', 'scriptingStudio.render', 'agent_ui.factories.localeLoader']).config(function ($mdThemingProvider, $translateProvider) {
...
}).provider('$stateParams', StateParams).controller('RenderCtrl', function ($scope, $timeout, $q) {
  ...
  function requestToOurApp(key, message) {
    ...
    return $q(function (resolve) {
      ...
      app.eventEmitter.once(app.toAngularKey + key, function (value) {
        console.log(value);
        resolve(value);
      });
    });
  ...
  function getScriptData() {
    return _returnPromise({
      ...
      call: {
        uii: $scope.uii,
        dispositions: $scope.call && $scope.call.outdialDispositions ? $scope.call.outdialDispositions.dispositions : []
      }
    });
  }
    ...
    return _updateScript({
      ...
      data: {
        tools: [{
          ...
          connections: [{
            label: '',
            type: ['default', '', 'default,,flowLink', 'inactive', 'flowLink'],
            target: 'end'
          }],
          properties: {
            pageData: [{
...
//# sourceMappingURL=agentScript.angular.js.map
