...
'scriptingStudio.render', // Scripting Studio Modules
'scriptingStudio.app.base', // default state for this app
'scriptingStudio.app.configure', 'scriptingStudio.app.render', // Tool Config Controllers
'scriptingStudio.configure.javascript', 'scriptingStudio.configure.page', 'scriptingStudio.configure.www', 'scriptingStudio.configure.switch', 'scriptingStudio.configure.mapping', 'scriptingStudio.configure.dataBuilder', // Directives
'scriptingStudio.directives.jsPlumb', 'scriptingStudio.directives.preview', 'scriptingStudio.directives.toolbar', 'scriptingStudio.directives.uiSelectCustom', // Tools directives
'scriptingStudio.directives.tools.scriptingTool', 'scriptingStudio.directives.tools.toolbarTool', 'scriptingStudio.directives.cfResizeable', // Factories
'scriptingStudio.factories.localeLoader', 'scriptingStudio.factories.plumbInstance', 'scriptingStudio.factories.scriptDocument', 'scriptingStudio.factories.ngBootstrap', 'scriptingStudio.factories.ngBootstrap.confirmModal', 'scriptingStudio.factories.ngBootstrap.renderModal', 'scriptingStudio.factories.ngBootstrap.inputModal', // Services
'scriptingStudio.service.interceptor', 'scriptingStudio.service.script', 'scriptingStudio.service.session', 'scriptingStudio.service.scriptData', 'scriptingStudio.service.mapping', 'scriptingStudio.service.aceEditor', 'scriptingStudio.service.javascriptBuilder', 'scriptingStudio.service.object', 'scriptingStudio.service.sorting', 'scriptingStudio.service.render.renderService', 'scriptingStudio.service.render.navService', 'scriptingStudio.service.apiCalls', 'scriptingStudio.service.editorInfo', // HTML Form Builder
'scriptingStudio.directives.textEditor', 'scriptingStudio.directives.modelTag', 'scriptingStudio.directives.modelTag.modal', 'scriptingStudio.directives.modelTag.data.modal', 'scriptingStudio.directives.customFormats', 'scriptingStudio.directives.cfInputs', 'scriptingStudio.directives.formBuilder', 'scriptingStudio.directives.formBuilder.form', 'scriptingStudio.directives.formBuilder.form.element', 'scriptingStudio.directives.formBuilder.form.element.edit', 'scriptingStudio.directives.formBuilder.select', 'scriptingStudio.directives.formBuilder.select.icon', // HTML Renderer
'scriptingStudio.directives.render.scriptRenderer']).config(['$stateProvider', '$urlRouterProvider', 'localStorageServiceProvider', '$translateProvider', '$mdThemingProvider', '$httpProvider', 'growlProvider', 'cfpLoadingBarProvider', 'ngQuillConfigProvider', function myAppConfig($stateProvider, $urlRouterProvider, localStorageServiceProvider, $translateProvider, $mdThemingProvider, $httpProvider, growlProvider, cfpLoadingBarProvider, ngQuillConfigProvider) {
  $urlRouterProvider.otherwise('/'); // set a prefix for localStorage

  localStorageServiceProvider.setPrefix('engage-admin'); // setup translation file loader factory

  $translateProvider.preferredLanguage('us');
  $translateProvider.useSanitizeValueStrategy('sanitizeParameters');
  $translateProvider.useLoader('localeLoader'); // SET THE DEFAULT GROWL SETTINGS
  ...
  ngQuillConfigProvider.set({
    modules: {
      ...
      [{
        align: []
      }], ['blockquote', 'code-block'], ['link'], // link and image, video
