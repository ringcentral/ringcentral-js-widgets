 ...
 * https://test_id_domain/test-cases/RCI-4153
 * Preconditions:
...
export class DefaultAreaCode extends Step {
  ...
  @examples(`
      ...
      | '+1(205) 879-3409' | '205'                 | '+1 (403) 370-0051' | '403'                     | '205'                 |
      | '+65 3333 4444'    | null                  | '+65 4444 5555'     | null                      | null                  |
      | '+65 3333 4444'    | null                  | '+1 (403) 370-0051' | '403'                     | '403'                 |
    `)
  run() {
