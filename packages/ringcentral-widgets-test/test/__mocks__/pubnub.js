const RealPubnub = require('pubnub');
// const RealPubnub = jest.genMockFromModule('pubnub');
const pubnubs = [];

export default class MockedPubNub {
...
MockedPubNub.getLastPubnub = getLastPubnub;
