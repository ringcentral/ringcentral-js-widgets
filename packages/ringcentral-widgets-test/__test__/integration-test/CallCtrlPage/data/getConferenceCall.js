...
const randomPeerPartyId = (index) =>
  `cs172622555${Math.round(10 ** 9 * Math.random())}-${index}`;
...
export default (conferencePartiesCount = 3) => {
  ...
  return {
    ...
    voiceCallToken:
      'conf_59334d784e7a49324d6a49314e5451794d6a63794d5441324d544135514445774c6a63304c6a49754d6a45344031302e37342e322e3231383a35303730',
    parties,
  };
};
