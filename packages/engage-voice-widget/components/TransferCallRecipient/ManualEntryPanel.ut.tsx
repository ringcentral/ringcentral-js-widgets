...
export const UTCheckManualEntryRender: StepFunction<UTCheckManualEntryRenderProps> = async ({
  internalOptions,
}) => {
  const wrapper = setup({});
  const dataSign = {
...
export const UTManualEntryInternationalTransferForbid: StepFunction<any> = async () => {
...
export const UTManualEntryInternationalTransferAllowed: StepFunction<any> = async () => {
...
export const UTManualEntryInternationalTransferRender: StepFunction<any> = async () => {
  const transferRecipientCountryId = 'FRA';
