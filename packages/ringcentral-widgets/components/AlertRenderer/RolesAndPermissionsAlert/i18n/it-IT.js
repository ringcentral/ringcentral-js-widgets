...
export default {
  [permissionsMessages.invalidTier]: "La tua versione non supporta l'integrazione {application}. Contatta il rappresentante dell'account per aggiornare la versione {brand}.",
  [permissionsMessages.insufficientPrivilege]: "Privilegi insufficienti. Contatta il rappresentante dell'account per effettuare un upgrade."
};
