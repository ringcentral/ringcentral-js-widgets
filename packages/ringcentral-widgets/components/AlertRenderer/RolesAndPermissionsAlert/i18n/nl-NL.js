...
export default {
  [permissionMessages.invalidTier]: "Uw versie ondersteunt geen integratie van {application}. Neem contact op met uw accountvertegenwoordiger om uw {brand}-versie te upgraden.",
  [permissionMessages.insufficientPrivilege]: "Onvoldoende rechten. Neem contact op met uw accountvertegenwoordiger voor een upgrade."
};
