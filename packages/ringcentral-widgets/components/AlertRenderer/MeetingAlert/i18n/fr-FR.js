...
export default {
  ...
  [meetingStatus.updatedSuccess]: "La réunion est mise à jour.",
  [meetingStatus.internalError]: "Erreur interne, échec de la planification de la réunion. Réessayez plus tard."
};
