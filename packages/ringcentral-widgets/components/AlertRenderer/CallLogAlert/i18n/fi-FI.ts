...
export default {
  [callLogMessages.logCallLogFailed]: "Puhelulokin lataaminen epäonnistui odottamattoman virheen vuoksi. Päivitä sivu ja yritä uudelleen.",
  // New version of log failed message
  [callLogMessages.logFailed]: "Puhelun tallentaminen lokiin epäonnistui. Yritä myöhemmin uudelleen.",
