...
export default {
  ...
  [connectivityTypes.offline]: "无法连接到服务器。请稍后再试。",
  [connectivityTypes.serverUnavailable]: "抱歉，我们这边发生了问题。请稍后再试。",
  [connectivityTypes.voipOnly]: "抱歉，我们这边发生了问题，但我们正在努力解决问题。您仍可以拨打电话，但其他功能此时会受到限制。",
  [connectivityTypes.survival]: "抱歉，我们这边发生了问题，但我们正在努力解决问题。您对某些功能的访问可能会受到限制。应用一变为可用状态，就会自动恢复。"
};
