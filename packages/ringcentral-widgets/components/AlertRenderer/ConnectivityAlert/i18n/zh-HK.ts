...
export default {
  ...
  [connectivityTypes.serverUnavailable]: "抱歉，系統發生錯誤。請稍後再試。",
  [connectivityTypes.voipOnly]: "抱歉，系統發生錯誤，但我們正在努力修復。您仍然可以撥打電話，但其他功能目前受到限制。",
  [connectivityTypes.survival]: "抱歉，系統發生錯誤，但我們正在努力進行修復。特定功能可能受到限制。應用程式將在可以使用時自動復原。"
};
