...
export default {
  [connectivityTypes.networkLoss]:
    "Désolé, une erreur s'est produite, vérifiez votre connexion réseau et réessayez.",
  ...
  [connectivityTypes.voipOnly]:
    "Désolé, une erreur s'est produite de notre côté, mais nous nous efforçons de la corriger. Vous pouvez toujours passer des appels, mais les autres fonctions sont actuellement limitées.",
  [connectivityTypes.survival]:
    "Désolé, une erreur s'est produite de notre côté, mais nous nous efforçons de la corriger. Vous pouvez avoir un accès limité à certaines fonctionnalités. L'application se rétablira automatiquement dès qu'elle sera disponible.",
};
