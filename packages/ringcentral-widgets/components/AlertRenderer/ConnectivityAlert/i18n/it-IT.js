...
export default {
  [connectivityTypes.networkLoss]:
    'Si è verificato un problema, controllare la connessione di rete e riprovare.',
  [connectivityTypes.offline]:
    'Impossibile connettersi al server. Riprova più tardi.',
  [connectivityTypes.serverUnavailable]:
    'Spiacenti, si è verificato un problema. Riprova più tardi.',
  [connectivityTypes.voipOnly]:
    'Siamo spiacenti, stiamo lavorando per risolvere il problema. È comunque possibile effettuare chiamate, ma le altre funzioni sono limitate.',
  [connectivityTypes.survival]:
    "Siamo spiacenti, stiamo lavorando per risolvere il problema. È possibile che l'accesso a determinate funzioni risulti limitato. L'app sarà ripristinata automaticamente non appena disponibile.",
};
