...
export default {
  ...
  [webphoneErrors.provisionUpdate]: "죄송합니다. RingCentral 시스템에서 문제가 발생했습니다. 곧 자동으로 다시 연결하려고 시도합니다.",
  ...
  failWithoutStatusCode: "죄송합니다. RingCentral 시스템에서 문제가 발생했습니다. 오류가 지속되면 {brandName} 지원팀에 이 오류를 보고하세요.",
