...
export default {
  ...
  [webphoneErrors.provisionUpdate]: "Se produjo un error por nuestra parte. Intentaremos restablecer la conexión automáticamente.",
  ...
  [webphoneErrors.pauseRecordError]: "Lo sentimos, no pudimos dejar de grabar la llamada. Vuelva a intentarlo más tarde.",
  ...
  registeringWithoutStatusCode: "Se produjo un error. Estamos intentando restablecer la conexión. Si el problema persiste, póngase en contacto con el soporte técnico de {brandName}."
};
