...
export default {
  ...
  [webphoneErrors.webphoneCountOverLimit]: "Er kunnen maximaal 5 webtelefoons worden geregistreerd.",
  ...
  [webphoneErrors.provisionUpdate]: "Er is bij ons iets fout gegaan. We zullen na een ogenblik automatisch proberen om opnieuw verbinding te maken.",
  ...
  [webphoneErrors.transferError]: "Kan de oproep niet doorverbinden. Probeer het later opnieuw.",
  ...
  registeringWithStatusCode: "Er ging iets mis. We proberen opnieuw verbinding te maken. Meld deze fout aan {brandName}-support als het probleem zich blijft voordoen. Foutcode: {errorCode}.",
  ...
  registeringWithoutStatusCode: "Er ging iets mis. We proberen opnieuw verbinding te maken. Meld deze fout aan {brandName}-support als het probleem zich blijft voordoen."
};
