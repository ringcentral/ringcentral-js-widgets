...
export default {
  ...
  [unHoldConflictError]: "Cet appel a été mis en attente sur un autre appareil. Veuillez reprendre l'appel avant votre action dans l'application.",
  ...
  [holdConflictError]: "Cet appel a été repris sur un autre appareil. Veuillez mettre en attente l'appel avant toute action au sein de l'application.",
