...
export default {
  [permissionsMessages.invalidTier]: "Sua edição não oferece suporte à integração com {application}. Entre em contato com o representante da conta para fazer upgrade da edição do {brand}.",
  [permissionsMessages.insufficientPrivilege]: "Privilégios insuficientes. Entre em contato com o representante da conta para fazer uma atualização."
};
