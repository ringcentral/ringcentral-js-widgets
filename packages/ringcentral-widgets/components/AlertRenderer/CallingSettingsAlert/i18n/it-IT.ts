...
export default {
  ...
  [callingSettingsMessages.saveSuccessWithSoftphone]: "Impostazioni salvate. Assicurati che {brand} sia installato nel computer.",
  ...
  [callingSettingsMessages.saveSuccessWithJupiter]: "Impostazioni salvate. Assicurati che {brand} sia installato nel computer.",
