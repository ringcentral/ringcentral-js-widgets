...
export default {
  ...
  [callingSettingsMessages.saveSuccessWithSoftphone]: "Settings saved successfully. Please make sure you have {brand} installed in your computer.",
  ...
  [callingSettingsMessages.saveSuccessWithJupiter]: "Settings saved successfully. Please make sure you have {brand} installed in your computer.",
