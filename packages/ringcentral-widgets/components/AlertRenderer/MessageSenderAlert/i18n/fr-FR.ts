...
export default {
  ...
  [messageSenderMessages.numberValidateError]:
    'Erreur de validité du numéro de téléphone.',
  ...
  [messageSenderMessages.senderEmpty]:
    'Vous devez sélectionner un numéro à envoyer parmi vos numéros de téléphone',
  [messageSenderMessages.noToNumber]:
    'Veuillez saisir un numéro de téléphone valide.',
  [messageSenderMessages.recipientsEmpty]:
    'Veuillez entrer un numéro de destinataire valide.',
  [messageSenderMessages.textTooLong]:
    'Le texte est trop long, 1 000 caractères maximum',
  [messageSenderMessages.multipartTextTooLong]:
    'Le texte est trop long, 5 000 caractères maximum',
  [messageSenderMessages.recipientNumberInvalids]:
    'Veuillez entrer un numéro de téléphone valide.',
  [messageSenderMessages.noAreaCode]:
    'Veuillez paramétrer l’{areaCodeLink} pour utiliser des numéros de téléphone locaux à 7 chiffres.',
  [messageSenderMessages.specialNumber]:
    'L’envoi de textos à des numéros d’urgence ou à des numéros pour services spéciaux n’est pas pris en charge.',
  [messageSenderMessages.connectFailed]:
    'Échec de la connexion. Veuillez réessayer ultérieurement.',
  [messageSenderMessages.internalError]:
    'Connexion impossible en raison d’erreurs internes. Veuillez réessayer ultérieurement.',
  [messageSenderMessages.notAnExtension]:
    'Le numéro de l’extension n’existe pas.',
  [messageSenderMessages.networkError]:
    'Connexion impossible en raison de problèmes de réseau. Veuillez réessayer ultérieurement.',
  [messageSenderMessages.senderNumberInvalid]:
    'Un numéro de téléphone valide est requis pour envoyer des messages à des destinataires externes à votre entreprise. Veuillez contacter votre administrateur pour ajouter un numéro direct à votre compte.',
  [messageSenderMessages.notSmsToExtension]:
    'Envoi impossible à un numéro d’extension avec un numéro de téléphone principal. Si vous souhaitez envoyer un message à un numéro d’extension, veuillez saisir le numéro d’extension.',
  [messageSenderMessages.internationalSMSNotSupported]:
    'L’envoi de SMS vers un numéro de téléphone international n’est pas pris en charge.',
  [messageSenderMessages.noInternalSMSPermission]:
    'Vous n’êtes pas autorisé à envoyer des messages. Veuillez contacter votre administrateur de compte {brand} pour une mise à niveau.',
  [messageSenderMessages.noSMSPermission]:
    'Vous n’êtes pas autorisé à envoyer des messages à des destinataires extérieurs à votre entreprise.',
  ...
  [messageSenderMessages.attachmentSizeLimitation]:
    'La taille totale des pièces jointes ne peut pas dépasser 1,5 Mo par message.',
  [messageSenderMessages.noAttachmentToExtension]:
    'L’envoi de MMS à une extension n’est pas pris en charge.',
  areaCode: 'indicatif',
  [messageSenderMessages.sending]:
    'Message en cours d’envoi… Cela peut prendre quelques minutes.',
  [messageSenderMessages.shortNumbersNotAvailable]:
    'L’envoi de SMS à des numéros courts n’est pas disponible.',
} as const;
