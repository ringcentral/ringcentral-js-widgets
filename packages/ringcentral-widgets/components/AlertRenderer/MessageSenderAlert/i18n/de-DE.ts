...
export default {
  ...
  [messageSenderMessages.numberValidateError]:
    'Fehler beim Validieren der Telefonnummer.',
  [messageSenderMessages.textEmpty]:
    'Geben Sie die Textnachricht ein, den Sie senden möchten.',
  [messageSenderMessages.noPermission]:
    'Sie verfügen nicht über die Berechtigung zum Versenden der Nachricht.',
  [messageSenderMessages.senderEmpty]:
    'Zum Senden müssen Sie eine Nummer aus Ihren Telefonnummern auswählen',
  [messageSenderMessages.noToNumber]:
    'Geben Sie eine gültige Telefonnummer ein.',
  [messageSenderMessages.recipientsEmpty]:
    'Geben Sie eine gültige Empfängernummer ein.',
  [messageSenderMessages.textTooLong]:
    'Textnachricht ist zu lang, auf 1.000 beschränkt',
  [messageSenderMessages.multipartTextTooLong]:
    'Textnachricht ist zu lang, auf 5.000 beschränkt',
  ...
  [messageSenderMessages.specialNumber]:
    'Textnachrichten an Notrufnummern/bestimmte Servicenummern werden nicht unterstützt.',
  ...
  [messageSenderMessages.notAnExtension]:
    'Die Nebenstellennummer ist nicht vorhanden.',
  ...
  [messageSenderMessages.senderNumberInvalid]:
    'Um eine Textnachricht an einen Empfänger außerhalb Ihres Unternehmens zu senden, ist eine gültige Telefonnummer nötig. Wenden Sie sich an Ihren Administrator, um eine Durchwahlnummer zu Ihrem Konto hinzuzufügen.',
  [messageSenderMessages.notSmsToExtension]:
    'Mit der Haupttelefonnummer kann keine Textnachricht an eine Nebenstellennummer gesendet werden. Wenn Sie an eine Nebenstellennummer senden möchten, geben Sie einfach die Nebenstellennummer ein.',
  [messageSenderMessages.internationalSMSNotSupported]:
    'SMS können nicht an internationale Telefonnummern gesendet werden.',
  [messageSenderMessages.noInternalSMSPermission]:
    'Sie verfügen nicht über die Berechtigung zum Versenden von Nachrichten. Wenden Sie sich an den Administrator des {brand}-Kontos, um ein Upgrade durchzuführen.',
  ...
  [messageSenderMessages.noAttachmentToExtension]:
    'Versenden von MMS an Nebenstellen wird nicht unterstützt.',
  areaCode: 'Vorwahl',
  [messageSenderMessages.sending]:
    'Nachricht wird versendet … Dies kann einige Minuten dauern.',
  [messageSenderMessages.shortNumbersNotAvailable]:
    'Das Senden von SMS an Kurznummern ist nicht verfügbar.',
} as const;
