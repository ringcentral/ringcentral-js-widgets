...
export default {
  ...
  [messageSenderMessages.textEmpty]: "Introduza o texto a enviar.",
  [messageSenderMessages.noPermission]: "Não tem permissão para enviar a mensagem.",
  [messageSenderMessages.senderEmpty]: "Selecione um número entre os seus números de telefone para enviar",
  ...
  [messageSenderMessages.textTooLong]: "O texto é demasiado longo. Limitado a 1000",
  [messageSenderMessages.multipartTextTooLong]: "O texto é demasiado longo. Limitado a 5000",
  [messageSenderMessages.recipientNumberInvalids]: "Introduza um número de telefone válido.",
  [messageSenderMessages.noAreaCode]: "Defina {areaCodeLink} para utilizar números de telefone locais com 7 dígitos.",
  [messageSenderMessages.specialNumber]: "O envio de texto para números de emergência/serviços especiais não é suportado.",
  [messageSenderMessages.connectFailed]: "Falha na ligação. Tente novamente mais tarde.",
  ...
  [messageSenderMessages.networkError]: "Não é possível efetuar a ligação devido a problemas de rede. Tente novamente mais tarde.",
  [messageSenderMessages.senderNumberInvalid]: "É necessário um número de telefone válido para enviar a mensagem de texto para destinatários fora da empresa. Contacte o administrador para adicionar um número direto à sua conta.",
  [messageSenderMessages.notSmsToExtension]: "Não é possível enviar para um número de extensão com número de telefone principal. Caso pretenda enviar para um número de extensão, introduza apenas o número da extensão.",
  [messageSenderMessages.internationalSMSNotSupported]: "O envio de SMS para um número de telefone internacional não é suportado.",
  [messageSenderMessages.noInternalSMSPermission]: "Não tem permissão para enviar mensagens. Contacte o administrador da conta do {brand} para obter uma atualização.",
