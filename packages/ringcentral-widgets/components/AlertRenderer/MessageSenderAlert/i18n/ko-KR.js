...
export default {
  ...
  [messageSenderMessages.connectFailed]: "연결에 실패했습니다. 나중에 다시 시도하세요.",
  [messageSenderMessages.internalError]: "내부 오류로 인해 연결할 수 없습니다. 나중에 다시 시도하세요.",
  [messageSenderMessages.notAnExtension]: "내선 번호가 없습니다.",
  [messageSenderMessages.networkError]: "네트워크 문제로 인해 연결할 수 없습니다. 나중에 다시 시도하세요.",
  [messageSenderMessages.senderNumberInvalid]: "회사 외부의 수신자에게 문자 메시지를 보내려면 유효한 전화번호가 필요합니다. 관리자에게 문의하여 직통 번호를 계정에 추가하세요.",
  ...
  [messageSenderMessages.noInternalSMSPermission]: "메시지를 보낼 수 있는 권한이 없습니다. {brand} 계정 관리자에게 문의하여 업그레이드하세요.",
  [messageSenderMessages.noSMSPermission]: "조직 외부의 수신자에게 메시지를 보낼 수 있는 권한이 없습니다.",
  [messageSenderMessagesV2.attachmentCountLimitation]: "최대 10개의 첨부 파일.",
  [messageSenderMessagesV2.attachmentSizeLimitation]: "첨부 파일은 1.5M바이트로 제한됩니다.",
  [messageSenderMessagesV2.noAttachmentToExtension]: "내선으로 MMS 보내기는 지원되지 않습니다.",
  areaCode: "지역 코드",
