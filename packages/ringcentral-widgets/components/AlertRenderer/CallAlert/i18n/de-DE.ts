...
export default {
  ...
  [callErrors.internalError]: "Herstellen der Verbindung aufgrund interner Fehler nicht möglich. Bitte versuchen Sie es später erneut.",
  [callErrors.notAnExtension]: "Die Durchwahlnummer ist nicht vorhanden.",
  [callErrors.networkError]: "Verbindung aufgrund von Netzwerkproblemen fehlgeschlagen. Versuchen Sie es später erneut.",
