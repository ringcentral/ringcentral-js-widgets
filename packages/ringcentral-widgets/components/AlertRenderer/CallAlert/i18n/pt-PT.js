...
export default {
  ...
  [callErrors.noAreaCode]: "Defina {areaCodeLink} para utilizar números de telefone locais com 7 dígitos.",
  [callErrors.specialNumber]: "A marcação de números de emergência ou de serviços especiais não é suportada.",
  [callErrors.connectFailed]: "Falha na ligação. Tente novamente mais tarde.",
  ...
  [callErrors.networkError]: "Não é possível efetuar a ligação devido a problemas de rede. Tente novamente mais tarde.",
