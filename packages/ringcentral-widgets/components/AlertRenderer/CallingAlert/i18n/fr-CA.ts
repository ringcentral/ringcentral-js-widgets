...
export default {
  [permissionsMessages.callingDisable]: "Vous ne disposez pas des autorisations pour faire des appels sortants. Veuillez communiquer avec votre administrateur de compte {brand} pour obtenir une mise à niveau."
};
