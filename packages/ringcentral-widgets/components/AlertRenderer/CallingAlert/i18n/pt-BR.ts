...
export default {
  [permissionsMessages.callingDisable]: "Você não tem permissões para fazer chamadas de saída. Entre em contato com o administrador da sua conta do {brand} para fazer uma atualização."
};
