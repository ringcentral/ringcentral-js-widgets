...
export default {
  [permissionsMessages.callingDisable]: "Vous ne disposez pas des permissions pour faire des appels sortants. Veuillez communiquer avec votre administrateur de compte {brand} pour obtenir une mise à niveau."
};
