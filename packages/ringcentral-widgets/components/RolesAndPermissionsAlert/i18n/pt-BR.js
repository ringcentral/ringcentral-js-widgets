...
export default {
  [permissionMessages.invalidTier]: 'Sua edição não oferece suporte à integração com {application}. Entre em contato com o representante da conta para fazer upgrade da edição do {brand}.',
  [permissionMessages.insufficientPrivilege]: 'Privilégios insuficientes. Entre em contato com o representante da conta para fazer um upgrade.'
};
