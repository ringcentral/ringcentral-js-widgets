...
export default {
  [permissionMessages.invalidTier]: "Esta edición no admite la integración con {application}. Llame a su representante de cuentas para actualizar su edición de {brand}.",
  [permissionMessages.insufficientPrivilege]: "Privilegios insuficientes. Póngase en contacto con el representante de su cuenta para conseguir una actualización."
};
