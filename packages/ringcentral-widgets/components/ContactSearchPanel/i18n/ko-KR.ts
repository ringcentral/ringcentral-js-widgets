...
export default {
  [HintsType.thirdPartyNoRecordsContent]: "{sourceName} 레코드를 모두 찾으려면 검색어(문자 또는 숫자)를 최소 {minimumLength}자 이상 입력하세요.",
  [HintsType.noFilterOrSearchRecordsTitle]: "검색 결과 없음",
  [HintsType.noFilterOrSearchRecordsContent]: "다른 소스에서 결과를 확인하거나 키워드를 변경하세요.",
  [HintsType.searching]: "검색하는 중...",
  companyTabTitle: "회사",
  personalTabTitle: "개인",
  direct: "직접",
  extension: "내선",
