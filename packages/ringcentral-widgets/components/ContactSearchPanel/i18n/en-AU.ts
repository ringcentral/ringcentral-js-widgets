...
export default {
  [HintsType.thirdPartyNoRecordsContent]: "Enter at least {minimumLength} characters or digits to search all {sourceName} records.",
  [HintsType.noFilterOrSearchRecordsTitle]: "No results found",
  [HintsType.noFilterOrSearchRecordsContent]: "Check results from other sources or change your keyword.",
