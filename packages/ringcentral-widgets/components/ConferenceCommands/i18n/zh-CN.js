export default {
  ...
  starSharp2Body: "记录正在通话的人数",
  starSharp3Title: "离开会议",
  starSharp3Body: "让主机挂断并结束通话",
  starSharp4Title: "菜单",
  starSharp4Body: "收听按键音命令列表",
  starSharp5Title: "设置收听模式",
  starSharp5Body: "按 1 次：静音主叫者 - 主叫者可以通过 *、#、6 取消静音\n按 2 次：静音主叫者 - 仅收听。无取消静音选项\n按 3 次：取消静音主叫者 - 再次打开线路",
  starSharp6Title: "静音主机线路",
  starSharp6Body: "按一次静音\n再按一次取消静音",
  starSharp7Title: "保护通话",
  starSharp7Body: "按一次阻止所有主叫者\n再按一次开放通话",
  starSharp8Title: "收听人员进入或退出通话时的声音",
