export default {
  title: "전화 회의 명령",
  starSharp2Title: "발신자 수",
  starSharp2Body: "통화 중인 인원수 추적",
  starSharp3Title: "전화 회의 나가기",
  starSharp3Body: "호스트가 전화를 끊고 통화를 종료",
  starSharp4Title: "메뉴",
  ...
  starSharp7Body: "한 번 누르면 모든 발신자 차단\n다시 누르면 통화 공개",
  starSharp8Title: "참가자가 통화에 참여하거나 통화에서 나갈 때 소리 듣기",
  starSharp8Body: "1회 누르기: 소리 꺼짐\n2회 누르기: 입장 소리 켜짐 퇴장 소리 꺼짐\n3회 누르기: 입장 소리 꺼짐 퇴장 소리 켜짐\n4회 누르기: 소리 켜짐",
  star9Title: "전화 회의 녹음",
  star9Body: "한 번 누르면 녹음 시작\n다시 누르면 녹음 중지"
};
