export default {
  infoMessageMins: "{delayTime}분 후 로그인 자동 저장...",
  infoMessageMin: "{delayTime}분 후 로그인 자동 저장...",
  infoMessageSecs: "{delayTime}초 후 로그인 자동 저장...",
  infoMessageSec: "{delayTime}초 후 로그인 자동 저장..."
};
