...
export default {
  [webphoneErrors.connectFailed]: 'Error en la conexión con el servidor web del teléfono.',
  ...
  webphoneUnavailable: '{error}. Estamos volviendo a conectar con el servidor. Si el error persiste, póngase en contacto con el servicio técnico de {brandName}.',
