...
export default {
  [webphoneErrors.connectFailed]: "抱歉，電話功能目前無法使用。請稍後再試一次。",
  ...
  [webphoneErrors.checkDLError]: "無法撥打外發通話。如果此錯誤持續發生，請聯絡 {brandName} 尋求支援。",
  [webphoneErrors.noOutboundCallWithoutDL]: "您的分機目前不允許使用瀏覽器進行撥出通話，請聯絡您的帳戶代表進行升級。",
