export default {
  header: "Desactivar el seguimiento de errores",
  content: "Desactivar el modo de seguimiento de errores eliminará todos los registros de errores actuales. ¿Desea continuar?",
  confirm: "Desactivar",
  cancel: "Cancelar"
};
