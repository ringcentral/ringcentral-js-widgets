export default {
  ...
  joinBeforeHost: 'Permit. entrar antes do host',
  ...
  passwordInvalidError:
    'Use de 1 a 10 caracteres que incluam letras e números, mas sem símbolos',
  passwordHintText:
    'A senha deve ter entre 1 e 10 letras e números, mas não pode conter símbolos',
