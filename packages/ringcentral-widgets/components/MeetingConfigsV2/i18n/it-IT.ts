export default {
  ...
  passwordInvalidError:
    'Usa da 1 a 10 caratteri che includono caratteri alfanumerici, ma senza simboli',
  passwordHintText:
    'La password deve contenere da 1 a 10 lettere e numeri ma non contenere simboli',
