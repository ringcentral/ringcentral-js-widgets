export default {
  ...
  saveAsDefaultAndNotShowAgain: "Enregistrer comme valeur par défaut et ne plus demander",
  saveAsDefault: "Enregistrer comme valeur par défaut",
  done: "Terminé",
  update: "Mettre à jour",
  conferenceSettingsTitle: "Paramètres de Téléconférence {brand}",
  videoSettingsTitle: "Paramètres de {brand} Meetings",
  password: "Mot de passe",
  failedToRetrieveMeeting: "Perte de la connexion réseau. Supprimez cette réunion et réessayez plus tard.",
  meetingSettingsTitle: "Paramètres de {brand} Meetings",
