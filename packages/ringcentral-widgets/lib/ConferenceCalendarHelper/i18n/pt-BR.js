export default {
  ...
  noConferencePermission: "Você não tem permissões do {brandName} Meetings. Entre em contato com o administrador da sua empresa para continuar.",
  conferenceTitle: "Reunião de conferência de {displayName}",
  internationalNumber: "Números de discagem internacional:",
  inviteText_att: "Participe da conferência {brandName}.\n\nNúmero de discagem: {formattedDialInNumber} \n{additionalNumbersSection} \nAcesso de participantes: {participantCode} \n\nPrecisa de um número de telefone de discagem internacional? Acesse {dialInNumbersLinks} \n\nEsta chamada em conferência foi possibilitada pelo {brandName} Conferencing.",
  inviteText_bt: "Participe da conferência {brandName}.\n\nNúmero de discagem: {formattedDialInNumber} \n{additionalNumbersSection} \nAcesso de participantes: {participantCode} \n\nNúmeros de discagem adicionais: {dialInNumbersLinks} ",
  inviteText_rc: "Participe da conferência {brandName}.\n\nNúmero de discagem: {formattedDialInNumber} \n{additionalNumbersSection} \nAcesso de participantes: {participantCode} \n\nPrecisa de um número de telefone de discagem internacional? Acesse {dialInNumbersLinks} \n\nEsta chamada em conferência foi possibilitada pelo {brandName} Conferencing.",
