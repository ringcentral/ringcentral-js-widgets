...
export default {
  ...
  noMeetingPermission:
    'Lo sentimos, no tiene permiso para utilizar {brandName} Meetings. Comuníquese con el administrador de su empresa para continuar.',
  noConferencePermission:
    'Lo sentimos, no tiene permiso para utilizar el servicio de conferencias {brandName}. Comuníquese con el administrador de su empresa para continuar.',
  ...
  saveAsDefaultAndNotShowAgain:
    'Guardar como configuración por defecto y no mostrar de nuevo',
  saveAsDefault: 'Guardar como configuración por defecto',
  done: 'Listo',
  update: 'Actualizar',
  ...
  failedToRetrieveMeeting:
    'Se perdió la conexión de red. Elimine esta reunión e inténtelo de nuevo más tarde.',
