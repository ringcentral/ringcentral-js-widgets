...
export default {
  ...
  saveAsDefaultAndNotShowAgain:
    'Guardar como predefinição e não mostrar novamente',
  saveAsDefault: 'Guardar como predefinição',
  done: 'Concluído',
  update: 'Atualizar',
  conferenceSettingsTitle: 'Definições do {brand} Conference',
  videoSettingsTitle: 'Definições do {brand} Meetings',
  password: 'Palavra-passe',
  failedToRetrieveMeeting:
    'Perdeu-se a ligação de rede. Elimine esta reunião e tente novamente mais tarde.',
