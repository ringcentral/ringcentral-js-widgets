export default {
  ...
  saveAsDefaultAndNotShowAgain: "Guardar como predefinição e não mostrar novamente",
  ...
  failedToRetrieveMeeting: "A ligação de rede foi perdida. Elimine esta reunião e tente novamente mais tarde.",
