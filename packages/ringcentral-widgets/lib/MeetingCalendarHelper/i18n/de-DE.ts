...
export default {
  ...
  rcvE2EEInviteMeetingContent:
    '{accountName} hat Sie zu einer End-to-End-verschlüsselten {rcvProductName}-Besprechung eingeladen.\n\nBitte nehmen Sie über folgenden Link teil. Beachten Sie, dass Sie sich zuerst bei der {brandName}-App anmelden müssen:\n{joinUri}\n\nFür diese Besprechung ist keine Einwahl möglich.\n\n{e2EESupportLinkText}\n{rcvE2EESupportUrl}',
  e2EESupportLinkText:
    'Erfahren Sie mehr über die End-to-End-Verschlüsselung von {brandName}.',
