export default {
  pmiChangeCancel: "Annulla",
  pmiChangeConfirmed: "Modifica",
  pmiChangeConfirmTitle: "Modificare impostazioni riunione personale?",
  pmiChangeConfirmContext: "La modifica di queste impostazioni avrà effetto su tutte le riunioni che utilizzano il tuo ID o nome riunione personale, comprese quelle che hai già programmato"
};
