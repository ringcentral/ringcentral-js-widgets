...
function mapToFunctions(_, {
  ...
  return {
    ...
    participantListClickHangupTrack: () => conferenceCall.participantListClickHangupTrack(),
    removeParticipantClickCancelTrack: () => conferenceCall.removeParticipantClickCancelTrack(),
  };
}
