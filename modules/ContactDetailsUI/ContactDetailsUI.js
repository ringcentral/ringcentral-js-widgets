...
function (_RcUIModule) {
  ...
  function ContactDetailsUI(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ContactDetailsUI).call(this, _objectSpread({
  ...
  _createClass(ContactDetailsUI, [{
    ...
    value: function handleClickToDial(contact, phoneNumber) {
      var recipient;
      return regeneratorRuntime.async(function handleClickToDial$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              recipient = _objectSpread({}, contact, {
    ...
    value: function handleClickToSMS(contact, phoneNumber) {
      var recipient;
      return regeneratorRuntime.async(function handleClickToSMS$(_context2) {
        while (1) {
    ...
    value: function getUIProps(_ref4) {
      ...
      return {
        ...
        disableLinks: !!(this._connectivityManager.isOfflineMode || this._connectivityManager.isVoipOnlyMode || this._rateLimiter.throttling),
