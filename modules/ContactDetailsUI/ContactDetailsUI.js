...
var ContactDetailsUI = exports.ContactDetailsUI = (_dec = (0, _di.Module)({
  ...
  function ContactDetailsUI(deps) {
    ...
    _this = _callSuper(this, ContactDetailsUI, [{
      deps: deps
    }]);
    _initializerDefineProperty(_this, "currentContact", _descriptor, _this);
    _initializerDefineProperty(_this, "currentContactReadyState", _descriptor2, _this);
    return _this;
  }
  _inherits(ContactDetailsUI, _RcUIModuleV);
  return _createClass(ContactDetailsUI, [{
    ...
    value: function () {
      var _showContactDetails = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(_ref2) {
    ...
    key: "getPresence",
    value: function () {
      var _getPresence = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(contact, useCache) {
        var presence;
