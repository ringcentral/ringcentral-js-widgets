...
var Webphone = (_dec = (0, _di.Module)({
  name: 'Webphone',
  deps: []
}), _dec2 = (0, _core.track)(_trackEvents.trackEvents.inboundWebRTCCallConnected), _dec3 = (0, _core.track)(function (that) {
  return that.isOnTransfer ? [_trackEvents.trackEvents.coldTransferCall] : null;
  ...
  _createClass(Webphone, [{
    ...
    value: function _onStorageChangeEvent(e) {
      _get(_getPrototypeOf(Webphone.prototype), "_onStorageChangeEvent", this).call(this, e);
    ...
    value: function () {
      var _forward = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(sessionId, forwardNumber) {
        var _this5 = this;
        var session, validatedResult, validPhoneNumber, _this$_deps$appFeatur, isEDPEnabled, parsedNumbers, _parsedNumbers$0$avai, _validatedResult$numb, _validatedResult$numb2;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 9:
                ...
                _context5.t0 = this._deps.numberValidate.validate([forwardNumber]);
                _context5.next = 17;
                break;
              case 14:
                _context5.next = 16;
    ...
    value: function () {
      var _transfer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(transferNumber, sessionId) {
        var _this9 = this;
        var session, numberResult, validPhoneNumber, _this$_deps$appFeatur2, isEDPEnabled, _numberResult, _parsedNumbers$0$avai2, parsedNumbers, _numberResult$numbers, _numberResult$numbers2;
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 11:
                ...
                throw new _numberValidError.NumberValidError([_context15.t0]);
              case 14:
              ...
              case 17:
                ...
                _context15.t1 = this._deps.numberValidate.validate([transferNumber]);
                _context15.next = 25;
                break;
              case 22:
                _context15.next = 24;
              ...
              case 43:
                ...
                session.__rc_isOnTransfer = false;
                this._updateSessions();
                if (!(_context15.t2 instanceof _numberValidError.NumberValidError)) {
                  _context15.next = 50;
                  break;
                }
                _context15.t2.errors.forEach(function (error) {
    ...
    value: function () {
      var _pickupInboundCall = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee27(_ref12) {
        var sessionId, toNumber, fromNumber, serverId, extraHeaders, inviteOptions, session;
        return regeneratorRuntime.wrap(function _callee27$(_context27) {
          while (1) {
            switch (_context27.prev = _context27.next) {
              case 0:
                sessionId = _ref12.sessionId, toNumber = _ref12.toNumber, fromNumber = _ref12.fromNumber, serverId = _ref12.serverId;
      ...
      function pickupInboundCall(_x36) {
    ...
    value: function () {
      var _updateSessionMatchedContact = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee28(sessionId, contact) {
        var _this10 = this;
    ...
    value: function () {
      var _setSessionCaching2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee29(sessionIds) {
      ...
      function setSessionCaching(_x39) {
    ...
    value: function () {
      var _clearSessionCaching2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee30() {
    ...
    key: "toggleMinimized",
    value: function () {
      var _toggleMinimized = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee31(sessionId) {
        var _this11 = this;
    ...
    key: "_disconnect",
    value: function () {
      var _disconnect2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee32() {
