...
var BlockedNumber = (_dec = (0, _di.Module)({
  name: 'BlockedNumber',
  deps: ['Client', 'DataFetcherV2', 'ExtensionFeatures', {
    dep: 'BlockedNumberOptions',
    optional: true
  }]
  ...
  _inherits(BlockedNumber, _DataFetcherV2Consume);

  var _super = _createSuper(BlockedNumber);

  function BlockedNumber(deps) {
    var _this;
    ...
    _this._source = new _DataFetcherV.DataSource(_objectSpread(_objectSpread({}, deps.blockedNumberOptions), {}, {
      key: 'blockedNumber',
      cleanOnReset: true,
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  return _context.abrupt("return", (0, _fetchList["default"])(function (params) {
                    return _this._deps.client.account().extension().blockedNumber().list(params);
                  }));
      ...
      readyCheckFunction: function readyCheckFunction() {
        return !!(_this._deps.extensionFeatures.ready && _this._deps.dataFetcherV2.ready);
      },
...
}(_DataFetcherV.DataFetcherV2Consumer), (_applyDecoratedDescriptor(_class2.prototype, "numbers", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "numbers"), _class2.prototype)), _class2)) || _class);
