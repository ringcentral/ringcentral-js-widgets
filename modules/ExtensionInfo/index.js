...
var ExtensionInfo = function (_RcModule) {
  ...
  function ExtensionInfo(_ref) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (ExtensionInfo.__proto__ || (0, _getPrototypeOf2.default)(ExtensionInfo)).call(this, (0, _extends3.default)({}, options, {
      actionTypes: _extensionInfoActionTypes2.default
    })));
    ...
    _this._ttl = ttl;
    _this._storageKey = 'extensionInfo';
    _this._reducer = (0, _getExtensionInfoReducer2.default)(_this.prefix);
    _this._promise = null;
    return _this;
  }
  ...
  (0, _createClass3.default)(ExtensionInfo, [{
    ...
    value: function initialize() {
      ...
      this.store.subscribe(function () {
        if (_this2._storage.status !== _this2._storage.storageStatus.pending && _this2.status === _extensionInfoStatus2.default.pending) {
          if (_this2._auth.isFreshLogin || !_this2._storage.hasItem(_this2._storageKey) || Date.now() - _this2.data.timestamp > _this2._ttl) {
            _this2.loadExtensionInfo();
          } else {
            _this2.store.dispatch({
              type: _this2.actionTypes.init
            });
          }
        } else if (_this2._storage.status === _this2._storage.storageStatus.pending && _this2.status !== _extensionInfoStatus2.default.pending) {
          _this2.store.dispatch({
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 6;
                            return _this3._client.account().extension().get();

                          case 6:
                            _context.t2 = _context.sent;
                            _context.t3 = Date.now();
                            _context.t4 = {
                              extensionInfo: _context.t2,
