...
_dec = (0, _di.Module)({
  ...
  _inherits(BlockedNumber, _DataFetcher);
  ...
  _createClass(BlockedNumber, [{
    ...
    get: function get() {
      ...
      return (_this$_extensionFeatu = (_this$_extensionFeatu2 = this._extensionFeatures.features) === null || _this$_extensionFeatu2 === void 0 ? void 0 : (_this$_extensionFeatu3 = _this$_extensionFeatu2.ReadBlockedNumbers) === null || _this$_extensionFeatu3 === void 0 ? void 0 : _this$_extensionFeatu3.available) !== null && _this$_extensionFeatu !== void 0 ? _this$_extensionFeatu : false;
    }
  }]);

  return BlockedNumber;
}(_DataFetcher2["default"]), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "numbers", [_selector.selector], {
  configurable: true,
  enumerable: true,
  writable: true,
