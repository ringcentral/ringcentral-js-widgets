...
var QuickAccess = exports.QuickAccess = (_dec = (0, _di.Module)({
  name: 'QuickAccess',
  deps: ['Auth', 'Webphone', {
  ...
  function QuickAccess(deps) {
    ...
    _this = _callSuper(this, QuickAccess, [{
      deps: deps
    }]);
    _initializerDefineProperty(_this, "entered", _descriptor, _this);
    return _this;
  }
  _inherits(QuickAccess, _RcModuleV);
  return _createClass(QuickAccess, [{
    key: "onInitOnce",
    ...
    key: "enter",
    value: function () {
      var _enter = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    ...
    key: "exit",
    value: function () {
      var _exit = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
