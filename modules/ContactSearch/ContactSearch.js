                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          searching = _objectSpread({}, _this4.searching); // @ts-expect-error
                          _context2.next = 3;
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                // search source
                searchFn = this._searchSources.get(sourceName); // @ts-expect-error
                _context4.next = 13;
                return searchFn({
                  searchString: searchString
                });
              case 13:
                ...
                // format result
                formatFn = this._searchSourcesFormat.get(sourceName); // @ts-expect-error
