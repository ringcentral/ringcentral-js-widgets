 ...
 */
_dec = (0, _di.Module)(), _dec(_class = /*#__PURE__*/function (_DataFetcher) {
  ...
  function MeetingProvider(_ref) {
    ...
    return _this = _super.call(this, _objectSpread(_objectSpread({}, options), {}, {
  ...
  _createClass(MeetingProvider, [{
    ...
    get: function get() {
      ...
      return (_this$data = this.data) === null || _this$data === void 0 ? void 0 : _this$data.provider;
    }
  }, {
    key: "_name",
    get: function get() {
