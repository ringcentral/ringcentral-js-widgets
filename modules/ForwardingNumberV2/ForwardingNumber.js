  ...
  _createClass(ForwardingNumber, [{
    ...
    get: function get() {
      return (0, _ramda.filter)(function (phoneNumber) {
        ...
        return !!(((_phoneNumber$features = phoneNumber.features) === null || _phoneNumber$features === void 0 ? void 0 : _phoneNumber$features.indexOf('CallFlip')) !== -1 && phoneNumber.phoneNumber);
      }, this.numbers);
    }
  }, {
    ...
    get: function get() {
      return (0, _ramda.filter)(function (phoneNumber) {
        ...
        return !!(((_phoneNumber$features2 = phoneNumber.features) === null || _phoneNumber$features2 === void 0 ? void 0 : _phoneNumber$features2.indexOf('CallForwarding')) !== -1 && phoneNumber.phoneNumber);
      }, this.numbers);
    }
  }]);
