...
var GlipCompany = exports.GlipCompany = (_dec = (0, _di.Module)({
  name: 'GlipCompany',
  deps: ['Client', 'DataFetcherV2', 'AppFeatures', {
  ...
  function GlipCompany(deps) {
    ...
    _this = _callSuper(this, GlipCompany, [{
      deps: deps
    }]);
    _this._source = new _DataFetcherV.DataSource(_objectSpread(_objectSpread({}, deps.glipCompanyOptions), {}, {
      ...
      permissionCheckFunction: function permissionCheckFunction() {
        return _this._deps.appFeatures.hasGlipPermission;
      }
    }));
  ...
  return _createClass(GlipCompany, [{
    key: "info",
    get: function get() {
      var _this$data;
