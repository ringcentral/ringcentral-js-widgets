...
var _getForwardingNumberReducer = require('./getForwardingNumberReducer');
...
var ForwardingNumber = function (_RcModule) {
  ...
  function ForwardingNumber(_ref) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (ForwardingNumber.__proto__ || (0, _getPrototypeOf2.default)(ForwardingNumber)).call(this, (0, _extends3.default)({}, options, {
      actionTypes: _forwardingNumberActionTypes2.default
    })));
    ...
    _this._ttl = ttl;
    _this._storageKey = 'forwardingNumber';
    _this._reducer = (0, _getForwardingNumberReducer2.default)(_this.prefix);
    _this._promise = null;
    return _this;
  }
  ...
  (0, _createClass3.default)(ForwardingNumber, [{
    ...
    value: function initialize() {
      ...
      this.store.subscribe(function () {
        if (_this2._storage.status !== _this2._storage.storageStatus.pending && _this2.status === _forwardingNumberStatus2.default.pending) {
          if (_this2._auth.isFreshLogin || !_this2._storage.hasItem(_this2._storageKey) || Date.now() - _this2.data.timestamp > _this2._ttl) {
            _this2.loadForwardingNumber();
          } else {
            _this2.store.dispatch({
              type: _this2.actionTypes.init
            });
          }
        } else if (_this2._storage.status === _this2._storage.storageStatus.pending && _this2.status !== _forwardingNumberStatus2.default.pending) {
          _this2.store.dispatch({
    ...
    value: function () {
                        ...
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            return (0, _fetchList2.default)(function (params) {
                              return _this3._client.account().extension().forwardingNumber().list(params);
                            });
      ...
      function loadForwardingNumber() {
        return _ref2.apply(this, arguments);
      }

      return loadForwardingNumber;
    }()
  }, {
    key: 'data',
    get: function get() {
