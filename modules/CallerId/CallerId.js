...
var CallerId = (_dec = (0, _di.Module)({
  ...
  _inherits(CallerId, _DataFetcher);

  var _super = _createSuper(CallerId);

  function CallerId(_ref) {
    var _this;
    ...
    _initializerDefineProperty(_this, "ringOut", _descriptor, _assertThisInitialized(_this));
  ...
  return CallerId;
}(_DataFetcher2["default"]), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "ringOut", [_selector.selector], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return [function () {
      return _this2.byFeature;
    }, function () {
      var _settings$find;

      var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      return (_settings$find = settings.find(function (item) {
        return item.feature === 'RingOut';
      })) === null || _settings$find === void 0 ? void 0 : _settings$find.callerId;
    }];
  }
})), _class2)) || _class);
