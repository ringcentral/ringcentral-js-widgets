...
var EvActiveCallControl = exports.EvActiveCallControl = (_dec = (0, _di.Module)({
  ...
  function EvActiveCallControl(deps) {
    ...
    _this = _callSuper(this, EvActiveCallControl, [{
      deps: deps,
      enableCache: true,
      storageKey: 'EvActiveCallControl'
    }]);
    _initializerDefineProperty(_this, "isRecording", _descriptor, _this);
    _initializerDefineProperty(_this, "timeStamp", _descriptor2, _this);
    return _this;
  }
  _inherits(EvActiveCallControl, _ref);
  return _createClass(EvActiveCallControl, [{
    ...
    key: "record",
    value: function () {
      var _record = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              _yield$this$_deps$evC = _context.v;
    ...
    key: "stopRecord",
    value: function () {
      var _stopRecord = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            ...
            case 1:
              _yield$this$_deps$evC2 = _context2.v;
    ...
    key: "pauseRecord",
    value: function () {
      var _pauseRecord = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            ...
            case 1:
              _yield$this$_deps$evC3 = _context3.v;
