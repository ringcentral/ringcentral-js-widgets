...
var actionTypes = new _Enum2.default(['init', 'mainTabIdChanged', 'event'], 'active-tab');
...
var TabManager = function (_RcModule) {
  ...
  function TabManager(_ref4) {
    var options = (0, _objectWithoutProperties3.default)(_ref4, []);
    ...
    _this._reducer = getTabManagerReducer(_this.actionTypes);
    return _this;
  }
              ...
              case 4:
                ...
                if (this._tabbie.enabled) {
                  this._tabbie.on('mainTabIdChanged', function () {
                    var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(mainTabId) {
                        ...
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              ...
                              _context.next = 5;
                              return _this2._tabbie.getIsMain();
