...
function (_RcUIModule) {
  ...
  function CallMonitorUI(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CallMonitorUI).call(this, _objectSpread({}, options)));
    _this._brand = void 0;
  ...
  _createClass(CallMonitorUI, [{
    ...
    value: function getUIFunctions(_ref3) {
      ...
      return {
        ...
        onViewContact: onViewContact ? function _callee(_ref5) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  _context.next = 7;
                  return regeneratorRuntime.awrap(onViewContact({
                    phoneNumber: phoneNumber,
                    contact: contact
                  }));
        ...
        onCreateContact: onCreateContact ? function _callee2(_ref6) {
        ...
        onLogCall: onLogCall || this._callLogger && function _callee3(_ref7) {
        ...
        onClickToSms: this._composeText ? function _callee4(contact) {
          var isDummyContact,
              _args4 = arguments;
