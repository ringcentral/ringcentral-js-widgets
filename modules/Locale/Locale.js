...
function (_RcModule) {
  ...
  _createClass(Locale, [{
      ...
      return regeneratorRuntime.async(function initialize$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(this.setLocale(this._detectBrowser ? this.browserLocale : this._defaultLocale));
    ...
    value: function _syncBrowserLocale() {
      var _this2 = this;

      return regeneratorRuntime.async(function _syncBrowserLocale$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return regeneratorRuntime.awrap(this.setLocale(this.browserLocale));
    ...
    value: function initializeProxy() {
      ...
      return regeneratorRuntime.async(function initializeProxy$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return regeneratorRuntime.awrap(this._setLocale(this.currentLocale));
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _context3.next = 3;
                        return regeneratorRuntime.awrap(_this3._setLocale(_this3.state.currentLocale));
    ...
    value: function toggleDebugMode() {
      return regeneratorRuntime.async(function toggleDebugMode$(_context5) {
        while (1) {
    ...
    value: function _setLocale(locale) {
      return regeneratorRuntime.async(function _setLocale$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return regeneratorRuntime.awrap(_i18n["default"].setLocale(locale));
    ...
    value: function setLocale(locale) {
      return regeneratorRuntime.async(function setLocale$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.prev = 1;
              _context7.next = 4;
              return regeneratorRuntime.awrap(this._setLocale(locale));
