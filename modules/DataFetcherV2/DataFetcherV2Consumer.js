...
var DataFetcherV2Consumer = exports.DataFetcherV2Consumer = /*#__PURE__*/function (_RcModuleV) {
  function DataFetcherV2Consumer() {
    ...
    _this = _callSuper(this, DataFetcherV2Consumer, [].concat(args));
  ...
  return _createClass(DataFetcherV2Consumer, [{
    key: "data",
    get: function get() {
    ...
    value: function _shouldInit() {
      return !!(_superPropGet(DataFetcherV2Consumer, "_shouldInit", this, 3)([]) && this._deps.dataFetcherV2.getSourceStatus(this._source) === _sourceStatus.sourceStatus.ready);
    }
  }, {
    key: "_shouldReset",
    value: function _shouldReset() {
      return !!(_superPropGet(DataFetcherV2Consumer, "_shouldReset", this, 3)([]) || this.ready && this._deps.dataFetcherV2.getSourceStatus(this._source) !== _sourceStatus.sourceStatus.ready);
    }
  }, {
    key: "fetchData",
    value: function () {
      var _fetchData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              return _context.a(2, this._deps.dataFetcherV2.fetchData(this._source));
            case 1:
              return _context.a(2);
          }
        }, _callee, this);
