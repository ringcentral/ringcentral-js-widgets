...
var _excluded = ["titleProps", "contentProps", "footerProps"],
  _excluded2 = ["autoDisableBackdropClick", "disableBackdropClick", "fullScreen"],
  _excluded3 = ["id", "onConfirm", "onCancel", "onExited", "title", "content", "footer", "confirmButtonText", "cancelButtonText", "titleProps", "contentProps", "footerProps", "variant", "handlerIDs", "autoDisableBackdropClick", "disableBackdropClick", "loading", "loadingOverlay", "useLoadingOverlay", "onClose"];
...
var ModalUI = exports.ModalUI = (_dec = (0, _di.Module)({
  name: 'ModalUI',
  deps: ['Locale']
  ...
  return _createClass(ModalUI, [{
    ...
    key: "_genericHandler",
    value: function () {
      var _genericHandler2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(id, handlerID) {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              return _context.a(2, (_this$_handlerRegiste = this._handlerRegister.get(id)) === null || _this$_handlerRegiste === void 0 ? void 0 : (_this$_handlerRegiste2 = _this$_handlerRegiste.get(handlerID)) === null || _this$_handlerRegiste2 === void 0 ? void 0 : _this$_handlerRegiste2.apply(void 0, args));
          }
        }, _callee, this);
      }));
    ...
    key: "_onConfirm",
    value: function () {
      var _onConfirm2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(id, onConfirm) {
        var handler, _t, _t2;
    ...
    key: "_onExited",
    value: function () {
      var _onExited2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, onExited) {
    ...
    key: "_onCancel",
    value: function () {
      var _onCancel2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(id, onCancel) {
