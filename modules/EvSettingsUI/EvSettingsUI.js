...
var EvSettingsUI = exports.EvSettingsUI = (_dec = (0, _di.Module)({
  name: 'EvSettingsUI',
  ...
  function EvSettingsUI(deps) {
    ...
    return _callSuper(this, EvSettingsUI, [{
      deps: deps
    }]);
  }
  _inherits(EvSettingsUI, _RcUIModuleV);
  return _createClass(EvSettingsUI, [{
    key: "sessionInfo",
    get: function get() {
      var _this = this,
      ...
      var _dialDest$split = dialDest.split('@'),
        ...
        type = _dialDest$split2$ === void 0 ? 'RC_EXTERNAL' : _dialDest$split2$;
      ...
      var getLocalString = function getLocalString(name) {
        return _i18n["default"].getString(name, _this._deps.locale.currentLocale);
      };
    ...
    value: function getUIFunctions() {
      ...
      return {
        onLogout: function onLogout() {
          return _this2._deps.evAuth.logout();
        },
        goToSessionUpdatePage: function goToSessionUpdatePage() {
          return _this2.goToSessionUpdatePage();
        }
      };
    }
  }]);
