...
var EvChooseAccountUI = exports.EvChooseAccountUI = (_dec = (0, _di.Module)({
  ...
  function EvChooseAccountUI(deps) {
    ...
    return _callSuper(this, EvChooseAccountUI, [{
      deps: deps
    }]);
  }
  _inherits(EvChooseAccountUI, _RcUIModuleV);
  return _createClass(EvChooseAccountUI, [{
    key: "_onAccountItemClick",
    value: function () {
      var _onAccountItemClick2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(agentId) {
        var _this = this;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return this._deps.block.next(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
