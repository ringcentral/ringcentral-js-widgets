...
var _hasClickToCallPermission = require("./hasClickToCallPermission");
Object.keys(_hasClickToCallPermission).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _hasClickToCallPermission[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _hasClickToCallPermission[key];
    }
  });
});
