...
var _getExtensionPhoneNumberReducer = require('./getExtensionPhoneNumberReducer');
...
var ExtensionPhoneNumber = function (_RcModule) {
  ...
  function ExtensionPhoneNumber(_ref) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (ExtensionPhoneNumber.__proto__ || (0, _getPrototypeOf2.default)(ExtensionPhoneNumber)).call(this, (0, _extends3.default)({}, options, {
      actionTypes: _extensionPhoneNumberActionTypes2.default
    })));
    ...
    _this._ttl = ttl;
    _this._storageKey = 'extensionPhoneNumber';
    _this._reducer = (0, _getExtensionPhoneNumberReducer2.default)(_this.prefix);
    _this._promise = null;
  ...
  (0, _createClass3.default)(ExtensionPhoneNumber, [{
    ...
    value: function initialize() {
      ...
      this.store.subscribe(function () {
        if (_this2._storage.status === _this2._storage.storageStatus.ready && _this2.status === _extensionPhoneNumberStatus2.default.pending) {
                        ...
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            return (0, _fetchList2.default)(function (params) {
                              return _this3._client.account().extension().phoneNumber().list(params);
                            });
