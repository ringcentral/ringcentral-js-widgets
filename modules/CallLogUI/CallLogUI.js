...
var CallLogUIBase = exports.CallLogUIBase = (_dec = (0, _di.Module)({
  name: 'CallLogUI',
  ...
  function CallLogUIBase(_ref2) {
    ...
    return _callSuper(this, CallLogUIBase, [_objectSpread({
      deps: deps
    }, options)]);
  }
  _inherits(CallLogUIBase, _ref);
  return _createClass(CallLogUIBase, [{
    key: "getUIProps",
    ...
    value: function getUIFunctions() {
      ...
      return {
        ...
        answer: function answer(telephonySessionId) {
          var _this$_deps$activeCal9, _this$_deps$activeCal0;
          (_this$_deps$activeCal9 = (_this$_deps$activeCal0 = _this._deps.activeCallControl).answer) === null || _this$_deps$activeCal9 === void 0 ? void 0 : _this$_deps$activeCal9.call(_this$_deps$activeCal0, telephonySessionId);
          _this._deps.callLogSection.discardAndHandleNotification();
        },
        clickForwardTrack: function clickForwardTrack() {
          var _this$_deps$activeCal1, _this$_deps$activeCal10;
          return (_this$_deps$activeCal1 = (_this$_deps$activeCal10 = _this._deps.activeCallControl).clickForwardTrack) === null || _this$_deps$activeCal1 === void 0 ? void 0 : _this$_deps$activeCal1.call(_this$_deps$activeCal10);
        },
        openEntityDetailLinkTrack: function openEntityDetailLinkTrack(path) {
          var _this$_deps$activeCal11, _this$_deps$activeCal12;
          return (_this$_deps$activeCal11 = (_this$_deps$activeCal12 = _this._deps.activeCallControl).openEntityDetailLinkTrack) === null || _this$_deps$activeCal11 === void 0 ? void 0 : _this$_deps$activeCal11.call(_this$_deps$activeCal12, path);
        }
      };
    }
  }]);
}(_core.RcUIModuleV2)) || _class); // @ts-expect-error TS(2554): Expected 1 arguments, but got 0.
var CallLogUI = exports.CallLogUI = (_dec2 = (0, _di.Module)(), _dec2(_class2 = /*#__PURE__*/function (_CallLogUIBase) {
  function CallLogUI(deps) {
    _classCallCheck(this, CallLogUI);
    return _callSuper(this, CallLogUI, [{
      deps: deps
    }]);
  }
  _inherits(CallLogUI, _CallLogUIBase);
  return _createClass(CallLogUI);
