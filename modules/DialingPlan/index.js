...
var DialingPlan = function (_RcModule) {
  ...
  function DialingPlan(_ref) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (DialingPlan.__proto__ || (0, _getPrototypeOf2.default)(DialingPlan)).call(this, (0, _extends3.default)({}, options, {
      actionTypes: _dialingPlanActionTypes2.default
    })));
    ...
    _this._ttl = ttl;
    _this._storageKey = 'dialingPlan';
    _this._reducer = (0, _getDialingPlanReducer2.default)(_this.prefix);
    _this._promise = null;
    return _this;
  }
  ...
  (0, _createClass3.default)(DialingPlan, [{
    ...
    value: function initialize() {
      ...
      this.store.subscribe(function () {
        if (_this2._storage.status !== _this2._storage.storageStatus.pending && _this2.status === _dialingPlanStatus2.default.pending) {
          if (_this2._auth.isFreshLogin || !_this2._storage.hasItem(_this2._storageKey) || Date.now() - _this2.data.timestamp > _this2._ttl) {
            _this2.loadDialingPlan();
          } else {
            _this2.store.dispatch({
              type: _this2.actionTypes.init
            });
          }
        } else if (_this2._storage.status === _this2._storage.storageStatus.pending && _this2.status !== _dialingPlanStatus2.default.pending) {
          _this2.store.dispatch({
    ...
    value: function () {
                        ...
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            return (0, _fetchList2.default)(function (params) {
                              return _this3._client.account().dialingPlan().list(params);
                            });
      ...
      function loadDialingPlan() {
        return _ref2.apply(this, arguments);
      }

      return loadDialingPlan;
    }()
  }, {
    key: 'data',
    get: function get() {
