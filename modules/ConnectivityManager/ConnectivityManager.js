...
var ConnectivityManager = (_dec = (0, _di.Module)({
  ...
  _createClass(ConnectivityManager, [{
    ...
    get: function get() {
      ...
      return !!((_this$_deps$callingSe = this._deps.callingSettings) === null || _this$_deps$callingSe === void 0 ? void 0 : _this$_deps$callingSe.isWebphoneMode) && (!this._deps.webphone.ready || this._deps.webphone.disconnected || this._deps.webphone.connecting || this._deps.webphone.connectFailed);
    }
  }, {
