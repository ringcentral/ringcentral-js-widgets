...
var ActiveCallsUI = (_dec = (0, _di.Module)({
  ...
  function ActiveCallsUI(_ref) {
    ...
    var brand = _ref.brand,
        ...
        modalUI = _ref.modalUI,
        options = _objectWithoutProperties(_ref, ["brand", "locale", "webphone", "callLogger", "callMonitor", "rateLimiter", "composeText", "contactSearch", "regionSettings", "conferenceCall", "contactMatcher", "callingSettings", "contactDetailsUI", "activeCallControl", "routerInteraction", "rolesAndPermissions", "connectivityMonitor", "modalUI"]);
    ...
    _this._modalUI = modalUI;
    (_this$_modalUI = _this._modalUI) === null || _this$_modalUI === void 0 ? void 0 : _this$_modalUI.registerRenderer(ModalContentRendererID, function (_ref2) {
      var currentLocale = _ref2.currentLocale,
          contactName = _ref2.contactName;
      return /*#__PURE__*/React.createElement(_ActiveCallItemV.ModalContent, {
    ...
    value: function getUIFunctions(_ref4) {
      ...
      return {
        modalConfirm: function modalConfirm(props) {
          return _this2._modalUI && _this2._modalUI.confirm(_objectSpread(_objectSpread({}, props), {}, {
            content: ModalContentRendererID
          }));
        },
        modalClose: function modalClose(id) {
          return _this2._modalUI && _this2._modalUI.close(id);
        },
        ...
        onViewContact: showViewContact ? onViewContact || function (_ref5) {
        ...
        onClickToSms: this._composeText ? /*#__PURE__*/function () {
          var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(contact) {
            var isDummyContact,
                _args12 = arguments;
        ...
        onCreateContact: onCreateContact ? /*#__PURE__*/function () {
          var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(_ref7) {
        ...
        onLogCall: onLogCall || this._callLogger && /*#__PURE__*/function () {
          var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(_ref9) {
        ...
        clickSwitchTrack: function clickSwitchTrack() {
          ...
          (_this2$_activeCallCon3 = _this2._activeCallControl) === null || _this2$_activeCallCon3 === void 0 ? void 0 : (_this2$_activeCallCon4 = _this2$_activeCallCon3.clickSwitchTrack) === null || _this2$_activeCallCon4 === void 0 ? void 0 : _this2$_activeCallCon4.call(_this2$_activeCallCon3);
        }
      };
    }
  }]);
