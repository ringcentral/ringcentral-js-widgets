...
exports.default = new _Enum2.default([].concat((0, _toConsumableArray3.default)((0, _keys2.default)(_moduleActionTypes2.default)), ['updateCurrentConversationId', 'updateSearchInput', 'updateTypeFilter', 'fetchOldConverstaions', 'fetchOldConverstaionsSuccess', 'fetchOldConverstaionsError', 'fetchOldMessagesSuccess', 'fetchOldMessagesError', 'fetchOldMessages', 'updateMessageText', 'removeMessageText', 'reply', 'replySuccess', 'replyError', 'deleteConversation', 'increaseCurrentPage', 'resetCurrentPage', 'cleanOldConversatioans', 'addEntity', 'removeEntity', 'addResponses', 'removeResponse']), 'conversations');
