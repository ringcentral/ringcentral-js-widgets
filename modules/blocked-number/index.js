...
var _getBlockedNumberReducer = require('./get-blocked-number-reducer');

var _getBlockedNumberReducer2 = _interopRequireDefault(_getBlockedNumberReducer);

var _blockedNumberEvents = require('./blocked-number-events');

var _blockedNumberEvents2 = _interopRequireDefault(_blockedNumberEvents);
...
var BlockedNumber = (_class = function (_RcModule) {
  ...
  function BlockedNumber() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (BlockedNumber.__proto__ || (0, _getPrototypeOf2.default)(BlockedNumber)).call(this, (0, _extends3.default)({}, options, {
      actions: _blockedNumberActions2.default
    })));
    ...
    _this.on('state-change', function (_ref) {
      ...
      if (oldState) {
        if (oldState.status !== newState.status) {
          _this.emit(_blockedNumberEvents2.default.statusChange, {
            oldStatus: oldState.status,
            newStatus: newState.status
          });
        }
        if (newState.error && newState.error !== oldState.error) {
          _this.emit(_blockedNumberEvents2.default.error, newState.error);
        }
      }
    });
  ...
  (0, _createClass3.default)(BlockedNumber, [{
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.loadBlockedNumbers();
    ...
    value: function () {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return (0, _fetchList2.default)(function (params) {
                  return _this3[symbols.api].account().extension().blockedNumber().list(params);
                });
      ...
      function loadBlockedNumbers(_x2) {
        return _ref4.apply(this, arguments);
      }

      return loadBlockedNumbers;
    }()
  }, {
    key: 'data',
    get: function get() {
    ...
    key: 'reducer',
    get: function get() {
      return (0, _getBlockedNumberReducer2.default)(this.prefix);
    }
  }, {
    ...
    key: 'blockedNumberEvents',
    get: function get() {
      return _blockedNumberEvents2.default;
    }
  }, {
    key: 'status',
    get: function get() {
...
}(_rcModule2.default), (_applyDecoratedDescriptor(_class.prototype, 'init', [_rcModule.initFunction], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'init'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'loadBlockedNumbers', [_proxy.proxify], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'loadBlockedNumbers'), _class.prototype)), _class);
