...
var EvRequeueCall = exports.EvRequeueCall = (_dec = (0, _di.Module)({
  name: 'EvRequeueCall',
  ...
  function EvRequeueCall(deps) {
    ...
    _this = _callSuper(this, EvRequeueCall, [{
      deps: deps,
      enableCache: true,
      storageKey: 'EvRequeueCall'
    }]);
    _initializerDefineProperty(_this, "selectedQueueGroupId", _descriptor, _this);
    _initializerDefineProperty(_this, "selectedGateId", _descriptor2, _this);
    _initializerDefineProperty(_this, "stayOnCall", _descriptor3, _this);
    _initializerDefineProperty(_this, "requeuing", _descriptor4, _this);
    return _this;
  }
  _inherits(EvRequeueCall, _RcModuleV);
  return _createClass(EvRequeueCall, [{
    ...
    key: "requeueCall",
    value: function () {
      var _requeueCall = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var loadingId, result, _t;
