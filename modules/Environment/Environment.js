...
var Environment = exports.Environment = (_dec = (0, _di.Module)({
  name: 'Environment',
  ...
  function Environment(deps) {
    ...
    _initializerDefineProperty(_this, "server", _descriptor, _this);
    _initializerDefineProperty(_this, "recordingHostState", _descriptor2, _this);
    _initializerDefineProperty(_this, "enabled", _descriptor3, _this);
    _initializerDefineProperty(_this, "changeCounter", _descriptor4, _this);
  ...
  return _createClass(Environment, [{
    ...
    value: function () {
      var _changeEnvironment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    ...
    key: "setData",
    value: function () {
      var _setData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref2) {
