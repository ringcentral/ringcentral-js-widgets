...
var RegionSettingsUI = exports.RegionSettingsUI = (_dec = (0, _di.Module)({
  name: 'RegionSettingsUI',
  deps: ['Auth', 'Locale', 'RegionSettings', 'RouterInteraction', 'AppFeatures', {
  ...
  function RegionSettingsUI(deps) {
    ...
    return _callSuper(this, RegionSettingsUI, [{
      deps: deps
    }]);
  }
  _inherits(RegionSettingsUI, _RcUIModuleV);
  return _createClass(RegionSettingsUI, [{
    key: "getUIProps",
    ...
    value: function getUIFunctions() {
      ...
      return {
        ...
        canAreaCodeShow: function canAreaCodeShow(currentCountryCode) {
          var isEDPEnabled = _this._deps.appFeatures.isEDPEnabled;
          if (isEDPEnabled) {
