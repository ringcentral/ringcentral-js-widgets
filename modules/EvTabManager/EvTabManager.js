...
var EvTabManager = exports.EvTabManager = (_dec = (0, _di.Module)({
  name: 'TabManager',
  deps: ['GlobalStorage']
  ...
  function EvTabManager() {
    ...
    _this = _callSuper(this, EvTabManager, [].concat(args));
    _this._eventEmitter = new _events.EventEmitter();
    _initializerDefineProperty(_this, "mainTabId", _descriptor, _this);
    return _this;
  }
  _inherits(EvTabManager, _TabManager);
  return _createClass(EvTabManager, [{
    key: "setMainTabId",
    ...
    value: function () {
      var _checkIsMainTabAlive = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              return _context.a(2, !this.enable || this.mainTabId &&
