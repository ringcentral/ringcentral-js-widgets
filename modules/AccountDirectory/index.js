...
var _getAccountDirectoryReducer = require("./getAccountDirectoryReducer");

var _accountDirectoryHelper = require("./accountDirectoryHelper");
...
var AccountDirectory = (_dec = (0, _di.Module)({
  deps: ['Client', 'RolesAndPermissions', {
    dep: 'AccountDirectoryOptions',
    optional: true
  }]
}), _dec(_class = (_class2 = (_temp =
/*#__PURE__*/
function (_DataFetcher) {
  _inherits(AccountDirectory, _DataFetcher);
   ...
   */
  function AccountDirectory(_ref) {
    var _context3;
    ...
    _classCallCheck(this, AccountDirectory);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AccountDirectory).call(this, _objectSpread({}, options, {
      name: 'AccountDirectory',
      client: client,
      ttl: ttl,
      actionTypes: _actionTypes.default,
      getDataReducer: _getAccountDirectoryReducer.getDataReducer,
      getTimestampReducer: _getAccountDirectoryReducer.getTimestampReducer,
      subscriptionFilters: [_subscriptionFilters.default.accountDirectory],
              ...
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return (0, _fetchList.default)(function (params) {
                    var fetchRet = _this._client.account().directory().contacts().list(params);
  ...
  _createClass(AccountDirectory, [{
    key: "_extensionFilter",
    value: function _extensionFilter(ext) {
      return (0, _accountDirectoryHelper.hasExtensionNumber)(ext) && (!this._checkStatus || (0, _accountDirectoryHelper.isEnabled)(ext) || this._showNotActivated && (0, _accountDirectoryHelper.isNotActivated)(ext)) && !(0, _accountDirectoryHelper.isFiltered)(ext, this._typeList);
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (!( // for new
                message && contactsRegExp.test(message.event) && message.body && message.body.contacts)) {
                  _context4.next = 27;
                  break;
                }
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee4(item) {
        var id, eventType, extensionData;
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                return _context6.abrupt("return", this._client.account().directory().contacts(id).get());
...
exports.default = AccountDirectory;
