...
function (_RcUIModule) {
  _inherits(UserGuideUI, _RcUIModule);

  function UserGuideUI() {
    _classCallCheck(this, UserGuideUI);

    return _possibleConstructorReturn(this, _getPrototypeOf(UserGuideUI).apply(this, arguments));
  }
