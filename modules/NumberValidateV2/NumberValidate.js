...
var NumberValidate = (_dec = (0, _di.Module)({
  ...
  _createClass(NumberValidate, [{
    ...
    value: function isNoAreaCode(input) {
      ...
      if (this._deps.brand.id === '1210' && !isServiceNumber && !hasPlus && phoneNumber.length === 7 && (countryCode === 'CA' || countryCode === 'US') && areaCode === '') {
        return true;
      }
    ...
    value: function isNotAnExtension(extensionNumber) {
      if (extensionNumber && extensionNumber.length <= 6 && !this._deps.companyContacts.isAvailableExtension(extensionNumber)) {
        return true;
      }
    ...
    value: function validateFormat(phoneNumbers) {
      ...
      phoneNumbers.forEach(function (phoneNumber) {
        ...
        } else if (_this.isNoAreaCode(phoneNumber)) {
          errors.push({
            phoneNumber: phoneNumber,
            type: 'noAreaCode'
          });
...
}(_core.RcModuleV2), (_applyDecoratedDescriptor(_class2.prototype, "validateNumbers", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "validateNumbers"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "validateWithNumberParser", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "validateWithNumberParser"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_numberParser", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "_numberParser"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_numberParserApi", [_proxify["default"]], Object.getOwnPropertyDescriptor(_class2.prototype, "_numberParserApi"), _class2.prototype)), _class2)) || _class);
