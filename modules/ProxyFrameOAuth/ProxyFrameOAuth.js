...
var ProxyFrameOAuth = (_dec = (0, _di.Module)({
  ...
  _createClass(ProxyFrameOAuth, [{
    ...
    get: function get() {
      ...
      var proxyUri = _url["default"].resolve(window.location.href, // @ts-expect-error TS(2345): Argument of type 'string | undefined' is not assig... Remove this comment to see the full error message
      (_this$_deps$oAuthOpti3 = this._deps.oAuthOptions) === null || _this$_deps$oAuthOpti3 === void 0 ? void 0 : _this$_deps$oAuthOpti3.proxyUri);
