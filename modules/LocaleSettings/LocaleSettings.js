...
var LocaleSettings = exports.LocaleSettings = (_dec = (0, _di.Module)({
  name: 'LocaleSettings',
  ...
  function LocaleSettings(deps) {
    ...
    _this = _callSuper(this, LocaleSettings, [{
      deps: deps,
    ...
    _initializerDefineProperty(_this, "savedLocale", _descriptor, _this);
  ...
  return _createClass(LocaleSettings, [{
    key: "_saveLocale",
    ...
    key: "saveLocale",
    value: function () {
      var _saveLocale2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(locale) {
