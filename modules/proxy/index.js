...
var _getProxyClientReducer = require('./get-proxy-client-reducer');
...
function initProxy() {
  ...
  for (var subModule in this) {
    if (this.hasOwnProperty(subModule) && this[subModule] instanceof _rcModule2.default) {
      var _context;
...
function setTransport(transport, actions) {
  ...
  for (var subModule in this) {
    if (this.hasOwnProperty(subModule) && this[subModule] instanceof _rcModule2.default) {
      ...
      (_context2 = this[subModule], _rcModule.suppressInit).call(_context2);
    }
  }
}
  ...
  return _class = function (_RcModule) {
    ...
    function _class(options) {
      ...
      var _loop = function _loop(subModule) {
        if (_this2[symbols.module].hasOwnProperty(subModule) && _this2[symbols.module][subModule] instanceof _rcModule2.default) {
    ...
    return _class;
  }(_rcModule2.default), (_applyDecoratedDescriptor(_class.prototype, 'init', [_rcModule.initFunction], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'init'), _class.prototype)), _class;
}
