...
var _getProxyServerReducer = require('./get-proxy-server-reducer');
...
function getProxyServer(Module) {
  return function (_RcModule) {
    ...
    function _class(options) {
      ...
      _rcModule.addModule.call(_this, 'module', new Module((0, _extends3.default)({}, options, {
...
//# sourceMappingURL=get-proxy-server.js.map
