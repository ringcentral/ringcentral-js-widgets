...
function _updateJoinBeforeHost() {
  _updateJoinBeforeHost = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(client, allowJoinBeforeHost) {
    var data;
...
function _getConferenceInfo() {
  _getConferenceInfo = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(client) {
    var data;
