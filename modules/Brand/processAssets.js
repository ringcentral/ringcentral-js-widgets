...
var processedKey = '$$processed$$';

/** combine origin url with assets relative path to actual url */
var processAssets = function processAssets(assets, origin) {
  ...
  return Object.entries(assets).reduce(function (acc, _ref) {
    ...
    return acc;
  }, _defineProperty({}, processedKey, '1'));
};
