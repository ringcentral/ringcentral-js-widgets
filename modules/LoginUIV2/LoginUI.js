  ...
  _createClass(LoginUI, [{
    ...
    value: function getUIProps(props) {
      return _objectSpread({
        ...
        showSpinner: !this._deps.auth.ready || this._deps.auth.loginStatus === _loginStatus["default"].loggingIn || this._deps.auth.loginStatus === _loginStatus["default"].loggingOut || this._deps.auth.loginStatus === _loginStatus["default"].beforeLogout || this._deps.auth.loginStatus === _loginStatus["default"].loggedIn
      }, props);
    }
  }, {
    key: "getUIFunctions",
    value: function getUIFunctions() {
      ...
      return {
        onLoginButtonClick: function onLoginButtonClick() {
          return _this._deps.oAuth.openOAuthPage();
        }
      };
    }
  }]);
