...
var ConferenceDialerUI = exports.ConferenceDialerUI = (_dec = (0, _di.Module)({
  ...
  function ConferenceDialerUI() {
    ...
    _this = _callSuper(this, ConferenceDialerUI, [].concat(args));
    _initializerDefineProperty(_this, "lastSessionId", _descriptor, _this);
    return _this;
  }
  _inherits(ConferenceDialerUI, _DialerUI);
  return _createClass(ConferenceDialerUI, [{
    key: "_backURL",
    get: function get() {
      var _this$_deps$conferenc;
      return ((_this$_deps$conferenc = this._deps.conferenceDialerUIOptions) === null || _this$_deps$conferenc === void 0 ? void 0 : _this$_deps$conferenc.backURL) || '/calls/active';
    }
  }, {
    ...
    value: function () {
      var _setLastSessionId2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(sessionId) {
    ...
    value: function _onBeforeCall(fromSessionId) {
      ...
      if (this._deps.conferenceCall && fromSessionId && !((_this$_deps$conferenc2 = this._deps.conferenceCall.mergingPair) === null || _this$_deps$conferenc2 === void 0 ? void 0 : _this$_deps$conferenc2.fromSessionId)) {
    ...
    value: function getUIProps() {
      return _objectSpread(_objectSpread({}, _superPropGet(ConferenceDialerUI, "getUIProps", this, 3)([])), {}, {
        inConference: true,
        showFromField: false
      });
    }
    ...
    value: function getUIFunctions(props) {
      ...
      return _objectSpread(_objectSpread({}, _superPropGet(ConferenceDialerUI, "getUIFunctions", this, 3)([props])), {}, {
