...
var ConferenceDialerUI = (_dec = (0, _di.Module)({
  ...
  _createClass(ConferenceDialerUI, [{
    ...
    value: function _onBeforeCall(fromSessionId) {
      ...
      if (fromSessionId && !((_this$_deps$conferenc = this._deps.conferenceCall.mergingPair) === null || _this$_deps$conferenc === void 0 ? void 0 : _this$_deps$conferenc.fromSessionId)) {
