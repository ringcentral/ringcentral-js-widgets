export default {
  ...
  pmiChangeConfirmed: "Alterar",
  pmiChangeConfirmTitle: "Pretende alterar as definições da reunião pessoal?",
  pmiChangeConfirmContext: "A alteração destas definições irá afetar todas as reuniões que utilizam o seu ID ou nome da reunião pessoal, incluindo as que já agendou"
};
