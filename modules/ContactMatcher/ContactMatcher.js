...
var ContactMatcher = exports.ContactMatcher = (_dec = (0, _di.Module)({
  name: 'ContactMatcher',
  deps: [{
  ...
  function ContactMatcher(deps) {
    ...
    return _callSuper(this, ContactMatcher, [deps, 'ContactMatcher', (_deps$contactMatcherO = deps.contactMatcherOptions) === null || _deps$contactMatcherO === void 0 ? void 0 : _deps$contactMatcherO.disableCache]);
  }
