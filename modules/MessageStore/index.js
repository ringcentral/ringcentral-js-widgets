...
var MessageStore = function (_RcModule) {
  ...
  (0, _createClass3.default)(MessageStore, [{
        ...
        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return this._sync((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8() {
    ...
    key: '_sync',
    value: function () {
      var _ref12 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(syncFunction) {
        var _this5 = this;
        ...
        return _regenerator2.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                if (!this._promise) {
                  this._promise = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10() {
    ...
    value: function () {
      var _ref14 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(messageId, status) {
        ...
        return _regenerator2.default.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 3:
                updateRequest = _context12.sent;
                return _context12.abrupt('return', updateRequest);
    ...
    value: function () {
      var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(messageIds, body) {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 4:
                ...
                return _context13.abrupt('return', responses);
    ...
    value: function () {
      var _ref16 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(messageIds, status) {
    ...
    key: 'readMessages',
    value: function () {
      var _ref17 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(conversationId) {
        ...
        return _regenerator2.default.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 9:
                updatedMessages = _context15.sent;
