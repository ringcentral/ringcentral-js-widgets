...
var CallLog = exports.CallLog = (_dec = (0, _di.Module)({
  name: 'CallLog',
  ...
  return _createClass(CallLog, [{
    ...
    key: "_daySpan",
    get: function get() {
      var _this$_deps$callLogOp9, _this$_deps$callLogOp0;
      return (_this$_deps$callLogOp9 = (_this$_deps$callLogOp0 = this._deps.callLogOptions) === null || _this$_deps$callLogOp0 === void 0 ? void 0 : _this$_deps$callLogOp0.daySpan) !== null && _this$_deps$callLogOp9 !== void 0 ? _this$_deps$callLogOp9 : DEFAULT_DAY_SPAN;
    }
  }, {
    key: "_polling",
    get: function get() {
      var _this$_deps$callLogOp1, _this$_deps$callLogOp10;
      return (_this$_deps$callLogOp1 = (_this$_deps$callLogOp10 = this._deps.callLogOptions) === null || _this$_deps$callLogOp10 === void 0 ? void 0 : _this$_deps$callLogOp10.polling) !== null && _this$_deps$callLogOp1 !== void 0 ? _this$_deps$callLogOp1 : true;
    }
  }, {
    key: "_isLimitList",
    get: function get() {
      var _this$_deps$callLogOp11, _this$_deps$callLogOp12;
      return (_this$_deps$callLogOp11 = (_this$_deps$callLogOp12 = this._deps.callLogOptions) === null || _this$_deps$callLogOp12 === void 0 ? void 0 : _this$_deps$callLogOp12.isLimitList) !== null && _this$_deps$callLogOp11 !== void 0 ? _this$_deps$callLogOp11 : false;
    }
  }, {
    key: "_listRecordCount",
    get: function get() {
      var _this$_deps$callLogOp13, _this$_deps$callLogOp14;
      return (_this$_deps$callLogOp13 = (_this$_deps$callLogOp14 = this._deps.callLogOptions) === null || _this$_deps$callLogOp14 === void 0 ? void 0 : _this$_deps$callLogOp14.listRecordCount) !== null && _this$_deps$callLogOp13 !== void 0 ? _this$_deps$callLogOp13 : LIST_RECORD_COUNT;
    }
  }, {
    key: "_recordCount",
    get: function get() {
      var _this$_deps$callLogOp15, _this$_deps$callLogOp16;
      return (_this$_deps$callLogOp15 = (_this$_deps$callLogOp16 = this._deps.callLogOptions) === null || _this$_deps$callLogOp16 === void 0 ? void 0 : _this$_deps$callLogOp16.recordCount) !== null && _this$_deps$callLogOp15 !== void 0 ? _this$_deps$callLogOp15 : RECORD_COUNT;
    }
  }, {
    key: "_enableDeleted",
    get: function get() {
    ...
    value: function _shouldInit() {
      return !!(_superPropGet(CallLog, "_shouldInit", this, 3)([]) && this._deps.auth.loggedIn);
    }
  }, {
    key: "_shouldReset",
    value: function _shouldReset() {
      return !!(_superPropGet(CallLog, "_shouldReset", this, 3)([]) || this.ready && !this._deps.auth.loggedIn);
    }
  }, {
    key: "onInit",
    value: function () {
    ...
    value: function onInitOnce() {
      ...
      (0, _core.watch)(this, function () {
        ...
        var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(message) {
          var _message$body;
          var ownerId;
    ...
    get: function get() {
      ...
      this.list.filter(function (call) {
        ...
        var isOutBoundCompanyNumber = call.from && call.from.phoneNumber && _this5.mainCompanyNumbers.indexOf(call.from.phoneNumber) > -1;
        var isOutBoundFromSelfExtNumber = call.from && call.from.extensionNumber && call.from.extensionNumber === _this5._deps.extensionInfo.info.extensionNumber;
    ...
    key: "_fetch",
    value: function () {
      var _fetch2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(_ref5) {
        var _this7 = this;
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              ...
              return _context5.a(2, (0, _fetchList["default"])(function (params) {
                return _this7._deps.client.account().extension().callLog().list(_objectSpread(_objectSpread({}, params), {}, {
                  dateFrom: dateFrom,
                  dateTo: dateTo
                }, perPageParam));
              }));
    ...
    key: "_iSync",
    value: function () {
      var _iSync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var ownerId, data, _this$_handleSyncApiE, _t2;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 4:
              ...
              _context6.n = 5;
              return (_this$_handleSyncApiE = this._handleSyncApiError) === null || _this$_handleSyncApiE === void 0 ? void 0 : _this$_handleSyncApiE.call(this, _t2);
            case 5:
              throw _t2;
            case 6:
    ...
    key: "_fSync",
    value: function () {
      var _fSync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var ownerId, dateFrom, data, supplementRecords, _processData, records, timestamp, syncToken, _this$_handleSyncApiE2, _t3;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 7:
              ...
              _context7.n = 8;
              return (_this$_handleSyncApiE2 = this._handleSyncApiError) === null || _this$_handleSyncApiE2 === void 0 ? void 0 : _this$_handleSyncApiE2.call(this, _t3);
            case 8:
              throw _t3;
            case 9:
    ...
    key: "_sync",
    value: function () {
      var _sync2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(syncType) {
        var ownerId, shouldFSync, _t4, _t5;
    ...
    key: "sync",
    value: function () {
      var _sync3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        var _this8 = this;
        var syncType,
          _args1 = arguments;
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.n) {
            case 0:
              syncType = _args1.length > 0 && _args1[0] !== undefined ? _args1[0] : this.token ? _syncTypes.syncTypes.iSync : _syncTypes.syncTypes.fSync;
              if (this._promise) {
                _context1.n = 1;
                break;
              }
              this._promise = this._sync(syncType);
              return _context1.a(2, this._promise);
            case 1:
              if (this._queueSync) {
                _context1.n = 2;
                break;
              }
              this._queueSync = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
                return _regenerator().w(function (_context0) {
                  while (1) switch (_context0.n) {
                    ...
                    case 1:
                      _this8._promise = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
                        return _regenerator().w(function (_context9) {
                          while (1) switch (_context9.n) {
                            ...
                            case 1:
                              return _context9.a(2, _this8._sync(syncType));
                          }
                        }, _callee9);
                      }))();
                      _this8._queueSync = null;
                      return _context0.a(2, _this8._promise);
                  }
                }, _callee0);
              }))();
              return _context1.a(2, this._queueSync);
            case 2:
              return _context1.a(2, this._queueSync);
          }
        }, _callee1, this);
    ...
    value: function _startPolling() {
      ...
      this._timeoutId = setTimeout(function () {
        ...
        if (!_this9._deps.tabManager || _this9._deps.tabManager.active) {
          if (!_this9.timestamp || Date.now() - _this9.timestamp > _this9.ttl) {
            _this9.fetchData();
          } else {
            _this9._startPolling();
          }
        } else if (_this9.timestamp && Date.now() - _this9.timestamp < _this9.ttl) {
          _this9._startPolling();
        } else {
          _this9._startPolling(_this9.timeToRetry);
        }
      }, t);
    }
  }, {
    ...
    value: function _retry() {
      ...
      this._timeoutId = setTimeout(function () {
        ...
        if (!_this0.timestamp || Date.now() - _this0.timestamp > _this0.ttl) {
          if (!_this0._deps.tabManager || _this0._deps.tabManager.active) {
            _this0.fetchData();
          } else {
