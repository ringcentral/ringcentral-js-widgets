...
var _default = exports["default"] = (_RINGS_TYPE$Phone_Rin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Phone_Ring1, '電話のベル1'), _const.RINGS_TYPE.Phone_Ring2, '電話のベル2'), _const.RINGS_TYPE.Acoustic_Dreams, 'アコースティック'), _const.RINGS_TYPE.Air_Raid, '空襲'), _const.RINGS_TYPE.Allusive, 'ひらめき'), _const.RINGS_TYPE.Attention, '注意'), _const.RINGS_TYPE.Blub_Blub, 'スイミング'), _const.RINGS_TYPE.Buzzy, 'バジー'), _const.RINGS_TYPE.Channel_Open, 'チャンネルオープン'), _const.RINGS_TYPE.Contemplation, '黙想'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Crystal_Ball, 'クリスタル'), _const.RINGS_TYPE.Disco, 'ディスコ'), _const.RINGS_TYPE.Door_Bell, 'ドアベル'), _const.RINGS_TYPE.Fairy, '妖精'), _const.RINGS_TYPE.Fast_Bells, '速い鐘'), _const.RINGS_TYPE.High_Gong, 'ハイゴング'), _const.RINGS_TYPE.Immersion, 'ピアノの音'), _const.RINGS_TYPE.Indeed, '確かに'), _const.RINGS_TYPE.Lazy_Day, 'リラックス'), _const.RINGS_TYPE.Neural_Funk, 'ニューロン'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, _const.RINGS_TYPE.Nice, 'いいね'), _const.RINGS_TYPE.Ring, 'ベルの音'), _const.RINGS_TYPE.Ringing_Bells, '鳴る鐘'), _const.RINGS_TYPE.Simple, 'シンプル'), _const.RINGS_TYPE.Soothing, '癒し'), _const.RINGS_TYPE.Sunshine, 'サンシャイン'), _const.RINGS_TYPE.Off, 'オフ'), "add", '追加'), "delete", '削除'), "play", '再生'), _defineProperty(_defineProperty(_RINGS_TYPE$Phone_Rin, "cancel", 'キャンセル'), "confirmToDelete", '{name}を削除しますか？')); // @key: @#@"[RINGS_TYPE.Phone_Ring1]"@#@ @source: @#@"Phone Ring 1"@#@
