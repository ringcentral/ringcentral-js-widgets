...
exports.default = (_muteConflictError$ho = {}, (0, _defineProperty3.default)(_muteConflictError$ho, muteConflictError, "Esta chamada foi silenciada em outro dispositivo. Reative a chamada antes da sua operação neste aplicativo."), (0, _defineProperty3.default)(_muteConflictError$ho, holdConflictError, "Esta chamada foi colocada em espera em outro dispositivo. Retire a chamada de espera antes da sua operação neste aplicativo."), (0, _defineProperty3.default)(_muteConflictError$ho, unMuteConflictError, "Esta chamada foi reativada em outro dispositivo. Silencie a chamada antes da sua operação neste aplicativo."), (0, _defineProperty3.default)(_muteConflictError$ho, unHoldConflictError, "Esta chamada foi retirada de espera em outro dispositivo. Coloque a chamada em espera antes da sua operação neste aplicativo."), (0, _defineProperty3.default)(_muteConflictError$ho, generalError, "Erro inesperado do servidor. Tente novamente mais tarde."), _muteConflictError$ho);
