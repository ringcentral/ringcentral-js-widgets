...
exports.default = (_muteConflictError$ho = {}, (0, _defineProperty3.default)(_muteConflictError$ho, muteConflictError, "此通話已在其他裝置上靜音。處理此應用程式前，請先取消通話的靜音。"), (0, _defineProperty3.default)(_muteConflictError$ho, holdConflictError, "此通話已由其他裝置保留。處理此應用程式前，請先取消保留該通話。"), (0, _defineProperty3.default)(_muteConflictError$ho, unMuteConflictError, "此通話已在其他裝置上取消靜音。處理此應用程式前，請先將該通話靜音。"), (0, _defineProperty3.default)(_muteConflictError$ho, unHoldConflictError, "此通話已由其他裝置取消保留。處理此應用程式前，請先保留該通話。"), (0, _defineProperty3.default)(_muteConflictError$ho, generalError, "伺服器發生意外錯誤。請稍後再試一次。"), _muteConflictError$ho);
