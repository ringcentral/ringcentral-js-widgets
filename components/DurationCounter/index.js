...
var DurationCounter = /*#__PURE__*/function (_Component) {
  _inherits(DurationCounter, _Component);
  var _super = _createSuper(DurationCounter);
  function DurationCounter(props) {
    var _this;
    _classCallCheck(this, DurationCounter);
  ...
  _createClass(DurationCounter, [{
    ...
    value: function render() {
      ...
      }, (0, _formatDuration.formatDuration)(this.state.duration));
    }
  }]);
