...
function setup() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    _ref$currentCallContr2 = _ref$currentCallContr === void 0 ? {} : _ref$currentCallContr,
    _ref$currentCallContr3 = _ref$currentCallContr2.allowTransferCall,
    allowTransferCall = _ref$currentCallContr3 === void 0 ? true : _ref$currentCallContr3,
    _ref$currentCallContr4 = _ref$currentCallContr2.allowRequeueCall,
    allowRequeueCall = _ref$currentCallContr4 === void 0 ? true : _ref$currentCallContr4,
...
describe('<ActivityCallLogPanel />', function () {
  ...
  [{
    ...
    return it("Verify permission of ".concat(disableControl), function () {
      wrapper = setup(_defineProperty(_defineProperty(_defineProperty({
        status: 'active',
        saveStatus: 'submit'
      }, disableControl, true), "isOnActive", disableControl === 'disableActive'), "showMuteButton", true));
