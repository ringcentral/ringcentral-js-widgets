...
var _default = {
  ...
  transfer: 'Siirrä',
  reject: 'Hylkää',
  switchCall: 'Siirrä puhelu tähän sovellukseen',
  callSwitch: 'Puhelun siirto',
  comfirmContext: 'Sinulla on meneillään puhelu henkilön {displayName} kanssa. Haluatko jatkaa puhelua tällä laitteella?',
  comfirmCancelButton: 'Peruuta',
  comfirmOKButton: 'Vaihda',
  ignore: 'Ohita',
