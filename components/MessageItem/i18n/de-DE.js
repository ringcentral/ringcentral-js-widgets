...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'Voicemail'), _messageTypes["default"].fax, 'Fax'), "mark", 'Als ungelesen markieren'), "unmark", 'Als gelesen markieren'), "delete", 'Löschen'), "faxSent", 'Fax gesendet'), "faxReceived", 'Fax erhalten'), "pages", 'Seiten'), "page", 'Seite'), "preview", 'Anzeigen'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'Herunterladen'), "mmsWithOneAttachment", 'MMS mit 1 Anhang'), "mmsWithAttachments", 'MMS mit {count} Anhängen')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
