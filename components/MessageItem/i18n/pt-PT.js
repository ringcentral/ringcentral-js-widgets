...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'Correio de voz'), _messageTypes["default"].fax, 'Fax'), "mark", 'Marcar como não lida'), "unmark", 'Marcar como lida'), "delete", 'Eliminar'), "faxSent", 'Fax enviado'), "faxReceived", 'Fax recebido'), "pages", 'páginas'), "page", 'página'), "preview", 'Ver'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'Transferir'), "mmsWithOneAttachment", 'MMS com 1 anexo'), "mmsWithAttachments", 'MMS com {count} anexos')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
