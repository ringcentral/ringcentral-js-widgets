...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'ボイスメール'), _messageTypes["default"].fax, 'FAX'), "mark", '未読にする'), "unmark", '既読にする'), "delete", '削除'), "faxSent", 'FAX送信済み'), "faxReceived", 'FAX受信済み'), "pages", 'ページ'), "page", 'ページ'), "preview", '表示'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'ダウンロード'), "mmsWithOneAttachment", 'MMSと添付ファイル1個'), "mmsWithAttachments", 'MMSと添付ファイル{count}個')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
