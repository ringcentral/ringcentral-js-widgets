...
var _default = exports["default"] = (_addLog$editLog$viewD = {
  ...
  voiceMessage: '음성 메시지'
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, '음성 사서함'), _messageTypes["default"].fax, '팩스'), "mark", '읽지 않은 상태로 표시'), "unmark", '읽은 상태로 표시'), "delete", '삭제'), "faxSent", '팩스 전송됨'), "faxReceived", '팩스 수신됨'), "pages", '페이지'), "page", '페이지'), "preview", '보기'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", '다운로드'), "mmsWithOneAttachment", 'MMS(첨부 파일 1개 포함)'), "mmsWithAttachments", 'MMS(첨부 파일 {count}개 포함)')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
