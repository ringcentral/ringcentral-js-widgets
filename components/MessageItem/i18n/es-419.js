...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'Mensaje de buzón de voz'), _messageTypes["default"].fax, 'Fax'), "mark", 'Marcar como no leído'), "unmark", 'Marcar como leído'), "delete", 'Eliminar'), "faxSent", 'Fax enviado'), "faxReceived", 'Fax recibido'), "pages", 'páginas'), "page", 'página'), "preview", 'Ver'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'Descargar'), "mmsWithOneAttachment", 'MMS con 1 adjunto'), "mmsWithAttachments", 'MMS con {count} adjuntos')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
