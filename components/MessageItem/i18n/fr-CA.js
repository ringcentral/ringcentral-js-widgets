...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'Message vocal'), _messageTypes["default"].fax, 'Télécopieur'), "mark", 'Marquer comme non lu'), "unmark", 'Marquer comme lu'), "delete", 'Supprimer'), "faxSent", 'Fax envoyé'), "faxReceived", 'Fax reçu'), "pages", 'pages'), "page", 'Téléavertir'), "preview", 'Afficher'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'Télécharger'), "mmsWithOneAttachment", 'MMS avec 1 pièce jointe'), "mmsWithAttachments", 'MMS avec {count} pièces jointes')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
