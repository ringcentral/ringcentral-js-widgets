...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, _messageTypes["default"].voiceMail, 'Correio de voz'), _messageTypes["default"].fax, 'Fax'), "mark", 'Marcar como não lido'), "unmark", 'Marcar como lido'), "delete", 'Excluir'), "faxSent", 'Fax enviado'), "faxReceived", 'Fax recebido'), "pages", 'páginas'), "page", 'página'), "preview", 'Exibir'), _defineProperty(_defineProperty(_defineProperty(_addLog$editLog$viewD, "download", 'Baixar'), "mmsWithOneAttachment", 'MMS com 1 anexo'), "mmsWithAttachments", 'MMS com {count} anexos')); // @key: @#@"addLog"@#@ @source: @#@"Log"@#@
