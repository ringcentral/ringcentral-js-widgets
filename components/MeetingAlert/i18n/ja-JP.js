...
var _default = (_meetingStatus$emptyT = {}, _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.emptyTopic, "会議のトピックを入力してください。"), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.noPassword, "会議のパスワードを入力してください。"), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.insufficientPermissions, "{application}には{permissionName}のアクセス許可がありません。"), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.scheduledSuccess, "会議の日時が設定されました。"), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.internalError, "内部エラーです。会議のスケジュールに失敗しました。後でもう一度やり直してください。"), _meetingStatus$emptyT); // @key: @#@"[meetingStatus.emptyTopic]"@#@ @source: @#@"Please enter meeting topic."@#@
