...
var _default = (_meetingStatus$emptyT = {}, _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.emptyTopic, "Insira um tópico de reunião."), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.noPassword, "Forneça uma senha para a reunião."), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.insufficientPermissions, "{application} não tem a permissão {permissionName}."), _defineProperty(_meetingStatus$emptyT, _meetingStatus.default.scheduledSuccess, "A reunião está agendada."), _meetingStatus$emptyT); // @key: @#@"[meetingStatus.emptyTopic]"@#@ @source: @#@"Please enter meeting topic."@#@
