...
function (_Component) {
  ...
  function ActiveCallsPanel() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ActiveCallsPanel).apply(this, arguments));
  }
  ...
  _createClass(ActiveCallsPanel, [{
    ...
    value: function render() {
      ...
      if (!this.hasCalls()) {
        ...
        }, _i18n.default.getString('noActiveCalls', currentLocale)), logSection, showSpinner ? _react.default.createElement(_SpinnerOverlay.default, {
