  ...
  _createClass(ActiveCallsPanel, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
        ...
        allCalls = _this$props3.allCalls;
      ...
      var otherDevice = showOtherDevice ? this.getCallList(otherDeviceCalls, _i18n["default"].getString('otherDeviceCall', currentLocale), true, allCalls) : null;
      return /*#__PURE__*/_react["default"].createElement("div", {
        "data-sign": "activeCalls",
      ...
      }, this.getCallList(activeRingCalls, _i18n["default"].getString('ringCall', currentLocale), showCallDetail, allCalls), this.getCallList(activeCurrentCalls, _i18n["default"].getString('currentCall', currentLocale), showCallDetail, allCalls), this.getCallList(activeOnHoldCalls, _i18n["default"].getString('onHoldCall', currentLocale), showCallDetail, allCalls), otherDevice), logSection, showSpinner ? /*#__PURE__*/_react["default"].createElement(_SpinnerOverlay.SpinnerOverlay, {
        className: _styles["default"].spinner
      }) : null);
    }
  }]);
