...
var _ContactDropdownListV = _interopRequireDefault(require("../ContactDropdownListV2"));

var _SelectedRecipients = _interopRequireDefault(require("./SelectedRecipients"));
...
var RecipientsInputV2 = (0, _react.forwardRef)(function RcipientsInputV2(_ref, ref) {
  ...
  var toNumberInput = !multiple && recipients.length ? null : _react["default"].createElement(_PhoneNumberInput["default"], {
    ref: inputEl,
  ...
  }, _react["default"].createElement(_SelectedRecipients["default"], {
    recipients: recipients,
    onRemove: removeFromRecipients,
    className: recipientsClassName
  }), toNumberInput), _react["default"].createElement(_ContactDropdownListV["default"], {
    currentLocale: currentLocale,
    ref: listEl,
...
var searchContactListType = _propTypes["default"].arrayOf(_propTypes["default"].shape({
...
var recipientsType = _propTypes["default"].arrayOf(_propTypes["default"].shape({
  phoneNumber: _propTypes["default"].string.isRequired,
...
RecipientsInputV2.propTypes = {
  ...
  onInputClear: _propTypes["default"].func.isRequired,
...
var _default = RecipientsInputV2;
