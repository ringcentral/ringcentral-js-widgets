...
var RecipientsInputV2 = (0, _react.forwardRef)(function (_ref, ref) {
  ...
  var toNumberInput = !multiple && recipients.length ? null : _react["default"].createElement(_PhoneNumberInput.PhoneNumberInput, {
    ref: inputEl,
  ...
  }), toNumberInput), _react["default"].createElement(_DropdownList.DropdownList, {
    currentLocale: currentLocale,
    ref: listEl,
