...
var _default = exports["default"] = {
  ...
  input: '输入',
  microphone: '麦克风',
  autoAdjustMicLevel: '自动调整麦克风音量',
  output: '输出',
  speakerSource: '扬声器音源',
  speakerVolume: '扬声器音量',
  ringtoneSource: '铃声和通知声源',
  ringtoneVolume: '铃声和通知音量',
  ringtones: '铃声',
  noDevices: '无设备',
  off: '关',
  noLabel: '未知设备',
  stopRecordDescription: '讲几句话来检查您的麦克风音量（{countDown} 秒）',
  stopPlaybackDescription: '正在播放录音…',
  startRecordButton: '测试麦克风',
  stopRecordButton: '停止录制',
  stopPlaybackButton: '停止测试',
  startTestButton: '测试扬声器',
  stopTestDescription: '正在播放音效样本…'
