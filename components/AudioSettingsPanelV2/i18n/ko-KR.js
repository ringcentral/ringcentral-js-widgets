...
var _default = exports["default"] = {
  ...
  input: '입력',
  microphone: '마이크',
  autoAdjustMicLevel: '마이크 레벨 자동 조정',
  output: '출력',
  speakerSource: '스피커 소스',
  speakerVolume: '스피커 볼륨',
  ringtoneSource: '벨소리 및 알림 소스',
  ringtoneVolume: '벨소리 및 알림 볼륨',
  ringtones: '벨소리',
  noDevices: '디바이스 없음',
  off: '끄기',
  noLabel: '알 수 없는 디바이스',
  stopRecordDescription: '마이크 레벨을 확인하려면 말하세요({countDown}초).',
  stopPlaybackDescription: '레코딩 재생 중...',
  startRecordButton: '마이크 테스트',
  stopRecordButton: '레코딩 중지',
  stopPlaybackButton: '테스트 중지',
  startTestButton: '스피커 테스트',
  stopTestDescription: '샘플 사운드 재생 중...'
