...
var _default = exports["default"] = {
  ...
  ringtoneSource: 'Ring tone and notification source',
  ringtoneVolume: 'Ring tone and notification volume',
  ringtones: 'Ring tones',
  noDevices: 'No devices',
  off: 'Off',
  noLabel: 'Unknown device',
  stopRecordDescription: 'Say something to check your mic level ({countDown} sec)',
