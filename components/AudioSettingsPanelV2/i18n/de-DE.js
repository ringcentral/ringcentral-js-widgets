...
var _default = {
  ...
  input: 'Eingabe',
  microphone: 'Mikrofon',
  autoAdjustMicLevel: 'Mikrofonlautstärke automatisch anpassen',
  output: 'Ausgabe',
  speakerSource: 'Lautsprecherquelle',
  speakerVolume: 'Lautsprecherlautstärke',
  ringtoneSource: 'Rufton- und Benachrichtigungsquelle',
  ringtoneVolume: 'Rufton- und Benachrichtigungslautstärke',
  ringtones: 'Ruftöne',
  noDevices: 'Keine Geräte',
  off: 'Aus',
  noLabel: 'Unbekanntes Gerät',
  stopRecordDescription: 'Sagen Sie etwas, um Ihren Mikrofonpegel zu testen ({countDown} Sek.)',
  stopPlaybackDescription: 'Wiedergabe Ihrer Aufzeichnung ...',
  startRecordButton: 'Mikrofon testen',
  stopRecordButton: 'Aufzeichnung beenden',
  stopPlaybackButton: 'Test beenden',
  startTestButton: 'Lautsprecher testen',
  stopTestDescription: 'Beispielton abspielen...'
