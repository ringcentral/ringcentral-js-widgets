...
var _default = {
  ...
  autoAdjustMicLevel: 'Regola automaticamente livello microfono',
  output: 'Output',
  speakerSource: 'Sorgente altoparlante',
  speakerVolume: 'Volume altoparlante',
  ringtoneSource: 'Sorgente suoneria e notifica',
  ringtoneVolume: 'Volume suoneria e notifica',
  ringtones: 'Suonerie',
  noDevices: 'Nessun dispositivo',
  off: 'Off',
  noLabel: 'Dispositivo sconosciuto',
  stopRecordDescription: 'Parla per controllare il livello del microfono ({countDown} sec)',
  stopPlaybackDescription: 'Riproduzione della registrazione in corso…',
  startRecordButton: 'Verifica microfono',
  stopRecordButton: 'Interrompi registrazione',
  stopPlaybackButton: 'Interrompi verifica',
  startTestButton: 'Verifica altoparlante',
  stopTestDescription: 'Riproduzione di un suono campione in corso...'
