...
var _default = exports["default"] = {
  ...
  ringtoneSource: 'Origen de las notificaciones y el tono de llamada',
  ringtoneVolume: 'Volumen de las notificaciones y el tono de llamada',
  ringtones: 'Tonos',
  noDevices: 'No hay dispositivos',
  off: 'Desactivado',
  noLabel: 'Dispositivo desconocido',
  stopRecordDescription: 'Diga algo para comprobar el nivel de su micrófono ({countDown} segundo/s)',
