...
var _default = {
  ...
  autoAdjustMicLevel: 'Automatisch mijn microfoonniveau aanpassen',
  output: 'Uitgang',
  speakerSource: 'Luidsprekerbron',
  speakerVolume: 'Luidsprekervolume',
  ringtoneSource: 'Bron van beltoon en meldingen',
  ringtoneVolume: 'Volume van beltoon en meldingen',
  ringtones: 'Beltonen',
  noDevices: 'Geen apparaten',
  off: 'Uit',
  noLabel: 'Onbekend apparaat',
  stopRecordDescription: 'Zeg iets om uw microfoonniveau te controleren ({countDown} seconden)',
  stopPlaybackDescription: 'Uw opname afspelen...',
  startRecordButton: 'Microfoon testen',
  stopRecordButton: 'Opname stoppen',
  stopPlaybackButton: 'Test stoppen',
  startTestButton: 'Luidspreker testen',
  stopTestDescription: 'Voorbeeldgeluid afspelen...'
