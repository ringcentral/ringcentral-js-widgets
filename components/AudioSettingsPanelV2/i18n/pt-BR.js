...
var _default = {
  ...
  autoAdjustMicLevel: 'Ajustar nível do mic automaticamente',
  output: 'Saída',
  speakerSource: 'Origem do alto-falante',
  speakerVolume: 'Volume do alto-falante',
  ringtoneSource: 'Origem do toque e da notificação',
  ringtoneVolume: 'Volume do toque e da notificação',
  ringtones: 'Toques',
  noDevices: 'Sem dispositivo',
  off: 'Desativado',
  noLabel: 'Dispositivo desconhecido',
  stopRecordDescription: 'Fale algo para verificar o nível do seu microfone ({countDown} s)',
  stopPlaybackDescription: 'Reproduzindo sua gravação...',
  startRecordButton: 'Testar microfone',
  stopRecordButton: 'Parar gravação',
  stopPlaybackButton: 'Parar teste',
  startTestButton: 'Testar alto-falante',
  stopTestDescription: 'Reproduzindo amostra de som...'
