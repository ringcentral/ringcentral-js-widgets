...
var _default = exports["default"] = {
  viewDetails: 'Näytä tietue',
  addEntity: 'Luo uusi yhteystieto',
  ...
  viewFax: 'Näytä',
  downloadFax: 'Lataa',
  downloadVoicemail: 'Lataa',
  copyNumber: 'Kopioi numero',
  createLog: 'Luo loki',
  selectRecordsForAutoLog: 'Valitse tallenteet automaattista lokiin kirjaamista varten',
  resolveThread: 'Ratkaise',
  assignToMe: 'Vastaa',
  assignThread: 'Määrää',
  reassignThread: 'Määrää uudelleen',
