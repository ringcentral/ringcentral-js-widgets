...
var _default = exports["default"] = {
  viewDetails: 'Exibir registro',
  addEntity: 'Criar novo contato',
  addRecord: 'Criar novo registro',
  call: 'Telefone',
  text: 'Texto',
  more: 'Mais',
  ...
  viewFax: 'Exibir',
  downloadFax: 'Baixar',
  downloadVoicemail: 'Baixar',
  copyNumber: 'Copiar número',
  createLog: 'Criar log',
  selectRecordsForAutoLog: 'Selecionar registros para log automático',
