...
var _default = exports["default"] = {
  viewDetails: 'Ver registo',
  addEntity: 'Criar novo contacto',
  addRecord: 'Criar novo registo',
  call: 'Telefone',
  text: 'SMS',
  more: 'Mais',
  ...
  "delete": 'Eliminar',
  viewFax: 'Vista',
  downloadFax: 'Transferir',
  downloadVoicemail: 'Transferir',
  copyNumber: 'Copiar número',
  createLog: 'Criar registo',
  selectRecordsForAutoLog: 'Selecionar registos para registo automático',
  resolveThread: 'Resolver',
  assignToMe: 'Responder',
  assignThread: 'Atribuir',
  reassignThread: 'Reatribuir',
