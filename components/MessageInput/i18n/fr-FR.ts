...
export default {
  ...
  send: 'Envoyer',
  emoji: 'Émoji',
  attachFiles: 'Joindre un fichier',
  smsNewLineHint: 'Appuyez sur Maj + Entrée pour une nouvelle ligne',
  smsEditHint: 'Saisir le message...',
  smsSendTooltip: 'Envoyer un message',
...
// @key: @#@"smsNewLineHint"@#@ @source: @#@"Press Shift+Enter for new line"@#@
// @key: @#@"smsEditHint"@#@ @source: @#@"Type message..."@#@
// @key: @#@"smsSendTooltip"@#@ @source: @#@"Send message"@#@
