...
exports.default = (_region$regionSetting = {
  region: 'Region'
}, (0, _defineProperty3.default)(_region$regionSetting, _regionSettingsMessages2.default.saveSuccess, 'Einstellungen wurden erfolgreich gespeichert.'), (0, _defineProperty3.default)(_region$regionSetting, _regionSettingsMessages2.default.dialingPlansChanged, 'Die vorherige Region wird f\xFCr Ihr Konto nicht mehr unterst\xFCtzt.\n    Pr\xFCfen Sie Ihre neuen {regionSettingsLink}.'), (0, _defineProperty3.default)(_region$regionSetting, 'regionSettings', 'Regionseinstellungen'), (0, _defineProperty3.default)(_region$regionSetting, _regionSettingsMessages2.default.areaCodeInvalid, 'Geben Sie eine gültige Vorwahl ein.'), _region$regionSetting);
