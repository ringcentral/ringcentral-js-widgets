...
exports.default = (_title$callingOptions = {
  title: "通話"
}, (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.softphone, "{brand} for Desktop"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.myphone, "自分の{brand}電話"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.otherphone, "その他の電話"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.customphone, "カスタム電話"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.browser, "ブラウザー"), (0, _defineProperty3.default)(_title$callingOptions, "makeCallsWith", "通話発信に使用する電話"), (0, _defineProperty3.default)(_title$callingOptions, "ringoutHint", "最初に自分の場所で自身を呼び出した後、通話相手に接続する"), (0, _defineProperty3.default)(_title$callingOptions, "myLocationLabel", "自分の場所"), (0, _defineProperty3.default)(_title$callingOptions, "press1ToStartCallLabel", "通話接続前に「1」をダイヤルするように指示するメッセージを受け取る"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.browser + "Tooltip", "通話の発着信にコンピューターのマイクロフォンとスピーカーを使用するには、このオプションを使用します。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.softphone + "Tooltip", "通話の発着信に{brand} for Desktopアプリを使用するには、このオプションを使用します。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.myphone + "Tooltip", "{brand}電話を使用して電話をかけるには、このオプションを使用します。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.myphone + "Tooltip1", "電話をかけた場合、最初に自分の{brand}電話が鳴ってから、通話相手の電話が鳴ります。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.otherphone + "Tooltip", "{brand}の内線に追加した自宅電話や携帯電話など、他の電話を使用して電話をかけるには、このオプションを使用します。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.otherphone + "Tooltip1", "電話をかけた場合、最初にこの電話が鳴ってから、通話相手の電話が鳴ります。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.customphone + "Tooltip", "以下のフィールドに有効な電話番号を入力することで任意の電話を使用して電話をかけるには、このオプションを使用します。"), (0, _defineProperty3.default)(_title$callingOptions, _callingOptions2.default.customphone + "Tooltip1", "電話をかけた場合、最初にこの電話が鳴ってから、通話相手の電話が鳴ります。"), _title$callingOptions);
