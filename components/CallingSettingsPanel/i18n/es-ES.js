...
var _default = exports["default"] = (_title$callingOptions = {
  title: 'Llamadas'
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_title$callingOptions, _CallingSettings.callingOptions.softphone, '{brand}for Desktop'), _CallingSettings.callingOptions.browser, 'Navegador'), _CallingSettings.callingOptions.jupiter, '{brand}'), "makeCallsWith", 'Realizar las llamadas con'), "ringoutHint", 'Llamar primero a mi ubicación y conectar después con la parte que llama'), "myLocationLabel", 'Mi ubicación'), "press1ToStartCallLabel", 'Avisarme de que marque 1 para conectar la llamada'), "".concat(_CallingSettings.callingOptions.browser, "Tooltip"), 'Utilice esta opción para hacer y recibir llamadas con el micrófono y los altavoces de su equipo.'), "".concat(_CallingSettings.callingOptions.softphone, "Tooltip"), 'Utilice esta opción para hacer y recibir llamadas usando su{brand}.'), "".concat(_CallingSettings.callingOptions.ringout, "Tooltip"), 'Use esta opción para hacer llamadas con el número de teléfono seleccionado o introducido.'), _defineProperty(_defineProperty(_title$callingOptions, "".concat(_CallingSettings.callingOptions.ringout, "Tooltip1"), 'Cuando haga una llamada, primero sonará este teléfono y, a continuación, la parte a la que llama.'), "".concat(_CallingSettings.callingOptions.jupiter, "Tooltip"), 'Utilice esta opción para hacer y recibir llamadas usando su{brand}.')); // @key: @#@"title"@#@ @source: @#@"Calling"@#@
