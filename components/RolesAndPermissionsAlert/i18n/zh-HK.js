...
exports.default = (_permissionMessages$i = {}, (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.invalidTier, "您的版本不支援對 {application} 的整合。請聯絡您的帳戶管理員以升級您的 {brand} 版本。"), (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.insufficientPrivilege, "權限不足。請聯絡您的客戶代表進行升級。"), _permissionMessages$i);
