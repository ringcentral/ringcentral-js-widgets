...
exports.default = (_permissionMessages$i = {}, (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.invalidTier, 'Sua edição não oferece suporte à integração com {application}. Entre em contato com o representante da conta para fazer upgrade da edição do {brand}.'), (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.insufficientPrivilege, 'Privilégios insuficientes. Entre em contato com o representante da conta para fazer um upgrade.'), _permissionMessages$i);
