...
exports.default = (_permissionMessages$i = {}, (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.invalidTier, "お使いのエディションでは、{application}の統合がサポートされていません。{brand}のエディションをアップグレードするには、アカウント担当者にお問い合わせください。"), (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.insufficientPrivilege, "権限が不足しています。アップグレードについてアカウント担当者にお問い合わせください。"), _permissionMessages$i);
