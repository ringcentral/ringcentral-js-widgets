...
exports.default = (_permissionMessages$i = {}, (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.invalidTier, "La tua versione non supporta l'integrazione {application}. Contatta il rappresentante dell'account per aggiornare la versione {brand}."), (0, _defineProperty3.default)(_permissionMessages$i, _permissionsMessages2.default.insufficientPrivilege, "Privilegi insufficienti. Contatta il rappresentante dell'account per effettuare un upgrade."), _permissionMessages$i);
