...
var _default = (_connectivityTypes$ne = {}, _defineProperty(_connectivityTypes$ne, _connectivityTypes["default"].networkLoss, "抱歉，发生问题，请检查网络连接并重试。"), _defineProperty(_connectivityTypes$ne, _connectivityTypes["default"].offline, "无法连接到服务器。请稍后再试。"), _defineProperty(_connectivityTypes$ne, _connectivityTypes["default"].serverUnavailable, "抱歉，我们这边发生了问题。请稍后再试。"), _defineProperty(_connectivityTypes$ne, _connectivityTypes["default"].voipOnly, "抱歉，我们这边发生了问题，但我们正在努力解决问题。您仍可以拨打电话，但其他功能此时会受到限制。"), _defineProperty(_connectivityTypes$ne, _connectivityTypes["default"].survival, "抱歉，我们这边发生了问题，但我们正在努力解决问题。您对某些功能的访问可能会受到限制。应用一变为可用状态，就会自动恢复。"), _connectivityTypes$ne); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
