...
var _default = (_phoneTypes$extension = {}, _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.extension, "内線"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.direct, "ダイレクト"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.mobile, "携帯電話"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.home, "自宅"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.business, "勤務先"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.fax, "FAX"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.company, "会社"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.other, "その他"), _defineProperty(_phoneTypes$extension, "emailLabel", "Eメール"), _defineProperty(_phoneTypes$extension, "call", "通話"), _defineProperty(_phoneTypes$extension, "text", "テキスト"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.available, "オンライン"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.offline, "非表示"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.busy, "取り込み中"), _defineProperty(_phoneTypes$extension, _dndStatus["default"].doNotAcceptAnyCalls, "応答不可"), _defineProperty(_phoneTypes$extension, "notActivated", "非アクティブ"), _defineProperty(_phoneTypes$extension, "company", "会社"), _defineProperty(_phoneTypes$extension, "jobTitle", "役職"), _phoneTypes$extension); // @key: @#@"[phoneTypes.extension]"@#@ @source: @#@"Ext."@#@
