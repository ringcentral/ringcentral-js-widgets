...
var _default = (_phoneTypes$extension = {}, _defineProperty(_phoneTypes$extension, _phoneTypes["default"].extension, "Poste"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].direct, "Direct"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].mobile, "Appareil mobile"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].home, "Domicile"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].business, "Bureau"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].fax, "Télécopieur"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].company, "Entreprise"), _defineProperty(_phoneTypes$extension, _phoneTypes["default"].other, "Autre"), _defineProperty(_phoneTypes$extension, "emailLabel", "Courriel"), _defineProperty(_phoneTypes$extension, "call", "Appeler"), _defineProperty(_phoneTypes$extension, "text", "Texto"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.available, "Disponible"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.offline, "Invisible"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.busy, "Occupé"), _defineProperty(_phoneTypes$extension, _dndStatus["default"].doNotAcceptAnyCalls, "Ne pas déranger"), _defineProperty(_phoneTypes$extension, "notActivated", "Inactif"), _defineProperty(_phoneTypes$extension, "company", "Entreprise"), _defineProperty(_phoneTypes$extension, "jobTitle", "Titre"), _phoneTypes$extension); // @key: @#@"[phoneTypes.extension]"@#@ @source: @#@"Ext."@#@
