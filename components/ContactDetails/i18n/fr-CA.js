...
exports.default = (_emailLabel$call$text = {
  ...
  call: "Appeler",
  text: "Texto"
}, (0, _defineProperty3.default)(_emailLabel$call$text, _presenceStatus2.default.available, "Disponible"), (0, _defineProperty3.default)(_emailLabel$call$text, _presenceStatus2.default.offline, "Invisible"), (0, _defineProperty3.default)(_emailLabel$call$text, _presenceStatus2.default.busy, "Occupé"), (0, _defineProperty3.default)(_emailLabel$call$text, _dndStatus2.default.doNotAcceptAnyCalls, "Ne pas déranger"), (0, _defineProperty3.default)(_emailLabel$call$text, 'notActivated', "Inactif"), _emailLabel$call$text);
