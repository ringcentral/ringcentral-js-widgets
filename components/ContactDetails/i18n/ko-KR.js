...
var _default = (_phoneTypes$extension = {}, _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.extension, "내선"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.direct, "직통"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.mobile, "모바일"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.contact, "연락처 전화번호"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.home, "홈"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.business, "비즈니스"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.fax, "팩스"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.company, "회사"), _defineProperty(_phoneTypes$extension, _phoneTypes.phoneTypes.other, "기타"), _defineProperty(_phoneTypes$extension, "emailLabel", "전자 메일"), _defineProperty(_phoneTypes$extension, "call", "통화"), _defineProperty(_phoneTypes$extension, "text", "문자"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.available, "통화 가능"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.offline, "오프라인으로 표시"), _defineProperty(_phoneTypes$extension, _presenceStatus.presenceStatus.busy, "통화 중"), _defineProperty(_phoneTypes$extension, _dndStatus["default"].doNotAcceptAnyCalls, "방해 금지"), _defineProperty(_phoneTypes$extension, "notActivated", "비활성"), _defineProperty(_phoneTypes$extension, "company", "회사"), _defineProperty(_phoneTypes$extension, "jobTitle", "제목"), _defineProperty(_phoneTypes$extension, "site", "사이트"), _phoneTypes$extension); // @key: @#@"[phoneTypes.extension]"@#@ @source: @#@"Ext."@#@
