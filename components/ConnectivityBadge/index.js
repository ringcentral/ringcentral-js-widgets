...
var ConnectivityBadge = function ConnectivityBadge(_ref) {
  ...
  if (isWebphoneConnecting) {
    view = /*#__PURE__*/_react["default"].createElement(_Badge["default"], {
      ...
      className: (0, _clsx["default"])(className, _styles["default"].badge, _styles["default"].loading),
    ...
    view = /*#__PURE__*/_react["default"].createElement(_Badge["default"], {
      dataSign: 'ConnectivityBadge',
      className: (0, _clsx["default"])(className, _styles["default"].badge, _styles["default"].result),
      name: _i18n["default"].getString(mode, currentLocale)
