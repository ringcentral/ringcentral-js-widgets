...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Webtelefon nicht verfügbar'), _ConnectivityManager.connectivityTypes.offline, 'Offline'), _ConnectivityManager.connectivityTypes.voipOnly, 'Nur VoIP'), _ConnectivityManager.connectivityTypes.survival, 'Eingeschränkter Modus'), _ConnectivityManager.connectivityTypes.connecting, 'Wird verbunden'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
