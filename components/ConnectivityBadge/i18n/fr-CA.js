...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Téléphone Web non disponible'), _ConnectivityManager.connectivityTypes.offline, 'Hors ligne'), _ConnectivityManager.connectivityTypes.voipOnly, 'VoIP uniquement'), _ConnectivityManager.connectivityTypes.survival, 'Mode limité'), _ConnectivityManager.connectivityTypes.connecting, 'Connexion'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
