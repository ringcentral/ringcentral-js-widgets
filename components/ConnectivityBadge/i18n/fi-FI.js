...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Verkkopuhelin ei käytettävissä'), _ConnectivityManager.connectivityTypes.offline, 'Offline'), _ConnectivityManager.connectivityTypes.voipOnly, 'Vain VoIP'), _ConnectivityManager.connectivityTypes.survival, 'Rajoitettu tila'), _ConnectivityManager.connectivityTypes.connecting, 'Yhdistetään'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
