...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Webtelefoon niet beschikbaar'), _ConnectivityManager.connectivityTypes.offline, 'Offline'), _ConnectivityManager.connectivityTypes.voipOnly, 'Alleen VoIP'), _ConnectivityManager.connectivityTypes.survival, 'Beperkte modus'), _ConnectivityManager.connectivityTypes.connecting, 'Verbinding maken'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
