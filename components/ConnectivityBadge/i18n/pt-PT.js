...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Telefone da web indisponível'), _ConnectivityManager.connectivityTypes.offline, 'Offline'), _ConnectivityManager.connectivityTypes.voipOnly, 'Apenas VoIP'), _ConnectivityManager.connectivityTypes.survival, 'Modo limitado'), _ConnectivityManager.connectivityTypes.connecting, 'A ligar'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
