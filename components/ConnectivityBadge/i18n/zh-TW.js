...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, '網路電話不可用'), _ConnectivityManager.connectivityTypes.offline, '離線'), _ConnectivityManager.connectivityTypes.voipOnly, '僅 VoIP'), _ConnectivityManager.connectivityTypes.survival, '限制模式'), _ConnectivityManager.connectivityTypes.connecting, '正在連線'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
