...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, '网络电话不可用'), _ConnectivityManager.connectivityTypes.offline, '离线'), _ConnectivityManager.connectivityTypes.voipOnly, '仅网络电话'), _ConnectivityManager.connectivityTypes.survival, '受限模式'), _ConnectivityManager.connectivityTypes.connecting, '正在连接'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
