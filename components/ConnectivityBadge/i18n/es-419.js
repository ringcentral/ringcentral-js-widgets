...
var _default = (_connectivityTypes$we = {}, _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].webphoneUnavailable, "El teléfono web no está disponible"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].offline, "Sin conexión"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].voipOnly, "Solo VoIP"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].survival, "Modo limitado"), _connectivityTypes$we); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
