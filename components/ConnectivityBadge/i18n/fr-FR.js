...
var _default = (_connectivityTypes$we = {}, _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].webphoneUnavailable, "Web Phone indisponible."), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].offline, "Hors ligne"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].voipOnly, "VoIP uniquement"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].survival, "Mode limité"), _connectivityTypes$we); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
