...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Téléphone Web indisponible.'), _ConnectivityManager.connectivityTypes.offline, 'Hors ligne'), _ConnectivityManager.connectivityTypes.voipOnly, 'VoIP seulement'), _ConnectivityManager.connectivityTypes.survival, 'Mode limité'), _ConnectivityManager.connectivityTypes.connecting, 'Connexion en cours'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
