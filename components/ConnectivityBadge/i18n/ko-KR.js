...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'WebPhone을 사용할 수 없음'), _ConnectivityManager.connectivityTypes.offline, '오프라인'), _ConnectivityManager.connectivityTypes.voipOnly, 'VoIP만'), _ConnectivityManager.connectivityTypes.survival, '제한 모드'), _ConnectivityManager.connectivityTypes.connecting, '연결 중'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
