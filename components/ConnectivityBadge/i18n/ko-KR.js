...
var _default = (_connectivityTypes$we = {}, _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].webphoneUnavailable, "WebPhone을 사용할 수 없음"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].offline, "오프라인"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].voipOnly, "VoIP만"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].survival, "제한 모드"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].connecting, "연결 중"), _connectivityTypes$we); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
