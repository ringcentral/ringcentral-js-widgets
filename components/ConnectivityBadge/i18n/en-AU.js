...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'Web phone unavailable'), _ConnectivityManager.connectivityTypes.offline, 'Offline'), _ConnectivityManager.connectivityTypes.voipOnly, 'VoIP Only'), _ConnectivityManager.connectivityTypes.survival, 'Limited mode'), _ConnectivityManager.connectivityTypes.connecting, 'Connecting'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
