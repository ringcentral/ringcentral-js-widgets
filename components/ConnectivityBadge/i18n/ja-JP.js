...
var _default = (_connectivityTypes$we = {}, _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].webphoneUnavailable, "ウェブ電話は利用できません"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].offline, "オフライン"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].voipOnly, "VoIPのみ"), _defineProperty(_connectivityTypes$we, _connectivityTypes["default"].survival, "制限モード"), _connectivityTypes$we); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
