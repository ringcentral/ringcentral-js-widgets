...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.webphoneUnavailable, 'ウェブ電話は利用できません'), _ConnectivityManager.connectivityTypes.offline, 'オフライン'), _ConnectivityManager.connectivityTypes.voipOnly, 'VoIPのみ'), _ConnectivityManager.connectivityTypes.survival, '制限モード'), _ConnectivityManager.connectivityTypes.connecting, '接続中'); // @key: @#@"[connectivityTypes.webphoneUnavailable]"@#@ @source: @#@"Web Phone Unavailable"@#@
