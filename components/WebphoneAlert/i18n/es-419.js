...
exports.default = (_webphoneErrors$conne = {}, (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.connectFailed, "Error al conectar con el servidor de telefonía web."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.connected, "Teléfono web registrado."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.browserNotSupported, "Las llamadas con el explorador solo son compatibles con Chrome."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.webphoneCountOverLimit, "Se pueden registrar 5 teléfonos web como máximo."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.notOutboundCallWithoutDL, "En este momento, su extensión no puede realizar llamadas salientes con navegador, Comuníquese con su representante para acceder a la actualización."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.getSipProvisionError, "No tiene permiso para enviar este mensaje."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.toVoiceMailError, "No se puede enviar la llamada al buzón de voz debido a un error interno"), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.muteError, "No se puede silenciar la llamada en este momento."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.holdError, "No se puede poner la llamada en espera en este momento."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.flipError, "No se puede voltear la llamada. Vuelva a intentarlo más tarde."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.recordError, "No puede grabar la llamada en este momento. Código de error: {errorCode}"), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.recordDisabled, "Su cuenta no incluye la función de grabar llamadas. Comuníquese con el administrador de su cuenta."), (0, _defineProperty3.default)(_webphoneErrors$conne, _webphoneErrors2.default.transferError, "No se puede transferir la llamada. Vuelva a intentarlo más tarde."), (0, _defineProperty3.default)(_webphoneErrors$conne, "webphoneUnavailable", "{error}. Estamos volviendo a conectar con el servidor. Si el error persiste, comuníquelo al servicio técnico de {brandName}."), (0, _defineProperty3.default)(_webphoneErrors$conne, "errorCode", "Código de error interno: {errorCode}"), (0, _defineProperty3.default)(_webphoneErrors$conne, "occurs", "Se produjo un error interno"), _webphoneErrors$conne);
