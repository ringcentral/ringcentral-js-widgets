...
var _default = (_webphoneErrors$conne = {}, _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.connectFailed, "與網路電話伺服器的連線失敗。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.connected, "網路電話已註冊。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.browserNotSupported, "僅支援在 Chrome 上使用瀏覽器撥號。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.webphoneCountOverLimit, "可註冊最多 5 支網路電話。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.notOutboundCallWithoutDL, "您的分機目前不允許使用瀏覽器進行撥出通話，請聯絡您的帳號代表進行升級。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.getSipProvisionError, "您沒有傳送訊息的權限。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.toVoiceMailError, "因為發生內部錯誤，無法將通話轉語音信箱"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.muteError, "目前無法靜音。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.holdError, "目前無法保留。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.flipError, "無法翻轉通話。請稍後再試一次。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.recordError, "目前無法對通話進行錄音。錯誤代碼：{errorCode}"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.recordDisabled, "抱歉，您的帳號並不具進行通話錄音的功能。請聯絡您的帳戶管理員。"), _defineProperty(_webphoneErrors$conne, _webphoneErrors.default.transferError, "無法轉接通話。請稍後再試一次。"), _defineProperty(_webphoneErrors$conne, "webphoneUnavailable", "{error}。我們正在重新連線至伺服器。若錯誤持續存在，請將這個錯誤回報至 {brandName} 支援部門。"), _defineProperty(_webphoneErrors$conne, "errorCode", "內部錯誤代碼：{errorCode}"), _defineProperty(_webphoneErrors$conne, "occurs", "發生內部錯誤"), _webphoneErrors$conne); // @key: @#@"[webphoneErrors.connectFailed]"@#@ @source: @#@"Connect with web phone server failed."@#@
