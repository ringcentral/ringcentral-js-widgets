...
var _default = {
  ...
  video: "Video",
  videoDescribe: "Bij deelname aan een meeting",
  host: "Video van host aan",
  participants: "Video van deelnemers aan",
  audioOptions: "Audio-opties",
  voIPOnly: "Alleen VoIP",
  both: "Beide",
  meetingOptions: "Meetingopties",
  requirePassword: "Wachtwoord voor meeting vereisen",
  password: "Wachtwoord",
  ...
  participantVideoOn: "Video van deelnemers aan",
  recurringEvery: "Alle",
  recurrenceType: "Herhalingstype",
  recurrenceEndDate: "Einddatum",
  currentLocale: "dag(en)",
  meetingId: "Meeting-ID",
  generateAutomatically: "Automatisch genereren",
  usePmi: "Persoonlijke meeting-ID (PMI, Personal Meeting ID): {meetingId}",
