...
var _default = exports["default"] = (_HintsType$thirdParty = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, _ContactSearchPanelEnum.HintsType.thirdPartyNoRecordsContent, 'Saisissez au moins {minimumLength} caractères ou chiffres pour chercher les enregistrements {sourceName}.'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsTitle, 'Aucun résultat'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsContent, 'Vérifiez les résultats d’autres sources ou modifiez votre mot clé.'), _ContactSearchPanelEnum.HintsType.searching, 'Recherche…'), "companyTabTitle", 'Entreprise'), "personalTabTitle", 'Personnel'), "direct", 'Direct'), "extension", 'Ext.'), "contact", 'Contact'), "mobile", 'Mobile'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "company", 'Entreprise'), "home", 'Domicile'), "home2", 'Domicile'), "other", 'Autre'), "business", 'Professionnel'), "business2", 'Professionnel'), "car", 'Véhicule'), "fax", 'Fax'), "assistant", 'Assistant'), "callback", 'Rappel'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "MobileNumber", 'Numéro de mobile'), "ContactNumber", 'Numéro de téléphone'), "DirectNumber", 'Numéro direct'), "doNotCall", 'Ne pas appeler')); // @key: @#@"[HintsType.thirdPartyNoRecordsContent]"@#@ @source: @#@"Enter at least {minimumLength} characters or digits to search all {sourceName} records."@#@
