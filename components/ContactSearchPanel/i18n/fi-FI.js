...
var _default = exports["default"] = (_HintsType$thirdParty = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, _ContactSearchPanelEnum.HintsType.thirdPartyNoRecordsContent, 'Anna vähintään {minimumLength} merkkiä tai numeroa kaikkien lähteen {sourceName} tietueiden hakemiseksi.'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsTitle, 'Tuloksia ei löytynyt'), _ContactSearchPanelEnum.HintsType.noFilterOrSearchRecordsContent, 'Tarkista tulokset toisista lähteistä tai vaihda avainsanaasi.'), _ContactSearchPanelEnum.HintsType.searching, 'Haetaan…'), "companyTabTitle", 'Yritys'), "personalTabTitle", 'Henkilökohtainen'), "direct", 'Suora'), "extension", 'Alanro'), "contact", 'Yhteystieto'), "mobile", 'Mobiili'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "company", 'Yritys'), "home", 'Etusivu'), "home2", 'Etusivu'), "other", 'Muu'), "business", 'Työ'), "business2", 'Työ'), "car", 'Auto'), "fax", 'Faksi'), "assistant", 'Avustaja'), "callback", 'Takaisinsoitto'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_HintsType$thirdParty, "MobileNumber", 'Matkapuhelinnumero'), "ContactNumber", 'Yhteysnumero'), "DirectNumber", 'Suora numero'), "doNotCall", 'Älä soita')); // @key: @#@"[HintsType.thirdPartyNoRecordsContent]"@#@ @source: @#@"Enter at least {minimumLength} characters or digits to search all {sourceName} records."@#@
