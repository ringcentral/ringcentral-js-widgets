...
var CallCtrlContainer = exports.CallCtrlContainer = /*#__PURE__*/function (_Component) {
  function CallCtrlContainer(props) {
    var _this;
    _classCallCheck(this, CallCtrlContainer);
    _this = _callSuper(this, CallCtrlContainer, [props]);
  ...
  return _createClass(CallCtrlContainer, [{
    ...
    value: function () {
      var _onLastMergingCallEnded = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
