...
var _default = {
  ...
  ctiPanelSize: 'Taille du panneau de la CTI',
  openInNewTab: 'Ouvrir dans un nouvel onglet',
  openInCurrentTab: 'Ouvrir dans l’onglet actuel',
  reportIssue: 'Signaler un problème',
  contactSupport: 'Communiquer avec le service de soutien',
  selectToDialHint: 'Pour une expérience optimale, choisissez le numéro à composer avec RingCentral sur la page contenant une grande quantité de numéros de téléphone.'
