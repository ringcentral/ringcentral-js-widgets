...
var _default = {
  ...
  ctiPanelSize: 'Dimensioni pannello CTI',
  openInNewTab: 'Apri in una nuova scheda',
  openInCurrentTab: 'Apri nella scheda corrente',
  reportIssue: 'Segnala problema',
  contactSupport: "Contatta l'assistenza",
  selectToDialHint: "Per un'esperienza migliore, seleziona il numero di telefono da chiamare con RingCentral nella pagina dei numeri di telefono di grandi quantità."
