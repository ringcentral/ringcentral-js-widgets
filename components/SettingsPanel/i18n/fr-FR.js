...
var _default = {
  ...
  ctiPanelSize: 'Taille du panneau CTI',
  openInNewTab: 'Ouvrir dans un nouvel onglet',
  openInCurrentTab: 'Ouvrir dans l’onglet actuel',
  reportIssue: 'Signaler un problème',
  contactSupport: 'Contacter l’assistance',
  selectToDialHint: 'Pour une meilleure expérience, sélectionnez le numéro de téléphone à composer avec RingCentral sur la page des numéros de téléphone en grande quantité.'
