...
var LinkLineItem = function LinkLineItem(_ref) {
  var show = _ref.show,
      ...
      rest = _objectWithoutProperties(_ref, ["show", "name", "customTitle", "currentLocale", "onClick", "pendoSignName"]);

  if (!show) {
    return null;
  }

  return /*#__PURE__*/_react["default"].createElement(_LinkLine["default"], _extends({
    hideUnderline: true,
    onClick: onClick,
