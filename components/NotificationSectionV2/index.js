  ...
  _createClass(NotificationSection, [{
    ...
    value: function renderLogSection() {
      var _this$props = this.props,
        ...
        shrinkNotification = _this$props.shrinkNotification; // @ts-expect-error TS(2339): Property 'call' does not exist on type 'object | u... Remove this comment to see the full error message
