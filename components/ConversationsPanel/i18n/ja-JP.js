...
}, _messageTypes["default"].all, 'すべて'), _messageTypes["default"].voiceMail, '音声'), _messageTypes["default"].text, 'テキスト'), _messageTypes["default"].fax, 'FAX'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
