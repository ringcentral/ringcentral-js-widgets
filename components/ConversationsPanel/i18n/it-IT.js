...
}, _messageTypes["default"].all, 'Tutto'), _messageTypes["default"].voiceMail, 'Voce'), _messageTypes["default"].text, 'SMS'), _messageTypes["default"].fax, 'Fax'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
