...
}, _messageTypes["default"].all, 'Todo'), _messageTypes["default"].voiceMail, 'Voz'), _messageTypes["default"].text, 'Mensaje'), _messageTypes["default"].fax, 'Fax'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
