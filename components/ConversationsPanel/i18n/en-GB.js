...
}, _messageTypes["default"].all, 'All'), _messageTypes["default"].voiceMail, 'Voice'), _messageTypes["default"].text, 'Text'), _messageTypes["default"].fax, 'Fax'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
