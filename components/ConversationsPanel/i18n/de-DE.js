...
}, _messageTypes["default"].all, 'Alle'), _messageTypes["default"].voiceMail, 'Sprachn.'), _messageTypes["default"].text, 'Textnachricht'), _messageTypes["default"].fax, 'Fax'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
