...
}, _messageTypes["default"].all, 'Tous'), _messageTypes["default"].voiceMail, 'Message vocal'), _messageTypes["default"].text, 'Texto'), _messageTypes["default"].fax, 'Télécopieur'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
