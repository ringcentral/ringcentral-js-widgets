...
}, _messageTypes["default"].all, '全部'), _messageTypes["default"].voiceMail, '語音'), _messageTypes["default"].text, '文字訊息'), _messageTypes["default"].fax, '傳真'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
