...
}, _messageTypes["default"].all, 'Kaikki'), _messageTypes["default"].voiceMail, 'Ääni'), _messageTypes["default"].text, 'Tekstiviesti'), _messageTypes["default"].fax, 'Faksi'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
