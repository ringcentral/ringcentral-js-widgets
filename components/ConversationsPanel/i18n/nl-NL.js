...
}, _messageTypes["default"].all, 'Alles'), _messageTypes["default"].voiceMail, 'Voice'), _messageTypes["default"].text, 'Tekstbericht'), _messageTypes["default"].fax, 'Fax'); // @key: @#@"title"@#@ @source: @#@"Messages"@#@
