...
function setup(_ref) {
  ...
  return (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_rcui.RcThemeProvider, null, /*#__PURE__*/_react["default"].createElement(_PhoneBookPanel.PhoneBookPanel, {
...
var getPhoneContacts = function getPhoneContacts() {
  return wrapper.find('RcList').at(0).find('[data-sign="phoneContact"]');
};
...
var UTPhoneBookContactListDisplayAndHighlight = function UTPhoneBookContactListDisplayAndHighlight() {
  ...
  expect(phoneContacts.at(transferPhoneBookSelectedIndex).prop('selected')).toBe(true);
};
