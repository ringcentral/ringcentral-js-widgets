...
var _default = {
  infoMessageMins: "ログを{delayTime}分後に自動保存します...",
  infoMessageMin: "ログを{delayTime}分後に自動保存します...",
  infoMessageSecs: "ログを{delayTime}秒後に自動保存します...",
  infoMessageSec: "ログを{delayTime}秒後に自動保存します..."
