...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, _RcVideo.ASSISTED_USERS_MYSELF, 'Mezelf'), "waitingRoomTitle", 'Wachtkamer gebruiken'), "waitingRoomDescription", 'Deelnemers wachten tot u ze toelaat. Geweldig voor sollicitatiegesprekken of deelnemers van buitenaf.'), "waitingRoomNotCoworker", 'Voor iedereen buiten mijn bedrijf'), "waitingRoomGuest", 'Voor iedereen die niet is aangemeld'), "waitingRoomAll", 'Voor alle deelnemers'), "enterPassword", 'Wachtwoord invoeren'), "onlyJoinAfterMe", 'Meeting starten nadat u deelneemt'), "allowJoinBeforeHostDescription", 'De meeting start nadat u deelneemt om vroegtijdige gesprekken te voorkomen.'), "requirePassword", 'Wachtwoord verplichten'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "requirePasswordDescription", 'Houd uw meeting veilig. Iedereen die de link gebruikt, wordt niet om een wachtwoord gevraagd.'), "password", 'Wachtwoord:'), "passwordEmptyError", 'Wachtwoord meeting vereist'), "passwordInvalidError", 'Uw wachtwoord moet 1-10 letters en cijfers lang zijn, maar mag geen symbolen bevatten'), "passwordHintText", 'Uw wachtwoord moet 1-10 letters en cijfers lang zijn, maar mag geen symbolen bevatten.'), "usePersonalMeetingIdInstead", 'Link persoonlijke meeting gebruiken'), "allowMeetingAccess", 'Beheren wie kan deelnemen'), "anyoneWithLink", 'Iedereen met een link'), "signedInUsers", 'Alleen {shortName}-accounts'), "signedInCoWorkers", "Alleen mijn collega's"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "passwordLabel", 'Wachtwoord'), "edit", 'Bewerken'), "editSettings", 'Instellingen bewerken'), "lockTooltip", 'Deze instelling wordt beheerd door uw bedrijfsbeheerder'), "cancel", 'Annuleren'), "update", 'Bijwerken'), "pmiSettingsTitle", 'Instellingen voor persoonlijke meeting'), "pmiSettingsDescription", 'Stel voor uw persoonlijke meetinglink in wie kan deelnemen en hoe.')); // @key: @#@"scheduleFor"@#@ @source: @#@"Schedule on behalf of"@#@
