...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, _RcVideo.ASSISTED_USERS_MYSELF, '我本人'), "waitingRoomTitle", '使用等候室'), "waitingRoomDescription", '参与者需要一直等待，直到您允许他们加入。非常适合面试或邀请外部与会者参加。'), "waitingRoomNotCoworker", '适用于我公司以外的所有人'), "waitingRoomGuest", '适用于未登录的所有人'), "waitingRoomAll", '适用于所有参会者'), "enterPassword", '输入密码'), "onlyJoinAfterMe", '在您加入后开始会议'), "allowJoinBeforeHostDescription", '会议将在您加入后开始，以防止对话提前进行。'), "requirePassword", '需要输入密码'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "requirePasswordDescription", '确保您的会议安全。使用该链接的任何人都不会收到输入密码的提示。'), "password", '密码：'), "passwordEmptyError", '会议密码为必填项'), "passwordInvalidError", '密码必须包含 1 到 10 个字母和数字，但不能包含特殊符号'), "passwordHintText", '密码应包含 1 到 10 个字母和数字，但不能包含特殊符号'), "usePersonalMeetingIdInstead", '使用个人会议链接'), "allowMeetingAccess", '管理哪些人可以加入'), "anyoneWithLink", '收到链接的任何人'), "signedInUsers", '仅限 {shortName} 帐户'), "signedInCoWorkers", '仅限我的同事'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "passwordLabel", '密码'), "edit", '编辑'), "editSettings", '编辑设置'), "lockTooltip", '此设置由公司管理员管理'), "cancel", '取消'), "update", '更新'), "pmiSettingsTitle", '个人会议设置'), "pmiSettingsDescription", '设置哪些人可以使用您的个人会议链接加入以及如何加入。')); // @key: @#@"scheduleFor"@#@ @source: @#@"Schedule on behalf of"@#@
