...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, _RcVideo.ASSISTED_USERS_MYSELF, 'Minä itse'), "waitingRoomTitle", 'Käytä odotushuonetta'), "waitingRoomDescription", 'Osallistujat odottavat, kunnes annat heidän liittyä. Sopii erinomaisesti haastatteluihin tai ulkopuolisille osallistujille.'), "waitingRoomNotCoworker", 'Yritykseni ulkopuolisille henkilöille'), "waitingRoomGuest", 'Henkilöille, jotka eivät ole kirjautuneet sisään'), "waitingRoomAll", 'Kaikille osallistujille'), "enterPassword", 'Anna salasana'), "onlyJoinAfterMe", 'Aloita tapaaminen liittymisen jälkeen'), "allowJoinBeforeHostDescription", 'Ennenaikaisten keskustelujen estämiseksi tapaaminen alkaa, kun olet liittynyt.'), "requirePassword", 'Edellytä salasanaa'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "requirePasswordDescription", 'Pidä tapaamisesi turvallisena. Linkin käyttäjiltä ei pyydetä salasanaa.'), "password", 'Salasana:'), "passwordEmptyError", 'Tapaamisen salasana vaaditaan'), "passwordInvalidError", 'Salasanasi on oltava 1–10 kirjainta ja numeroa pitkä, eikä se saa sisältää symboleita'), "passwordHintText", 'Salasanasi on oltava 1–10 kirjainta ja numeroa pitkä, eikä se saa sisältää symboleita.'), "usePersonalMeetingIdInstead", 'Käytä henkilökohtaista tapaamislinkkiä'), "allowMeetingAccess", 'Hallitse, ketkä voivat liittyä'), "anyoneWithLink", 'Kuka tahansa, jolla on linkki'), "signedInUsers", 'Vain {shortName} -tilit'), "signedInCoWorkers", 'Vain työtoverini'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "passwordLabel", 'Salasana'), "edit", 'Muokkaa'), "editSettings", 'Muokkaa asetuksia'), "lockTooltip", 'Asetus on yrityksen järjestelmänvalvojan hallinnassa'), "cancel", 'Peruuta'), "update", 'Päivitä'), "pmiSettingsTitle", 'Henkilökohtaisen tapaamisen asetukset'), "pmiSettingsDescription", 'Määritä henkilökohtaiseen tapaamislinkkiisi, ketkä voivat liittyä ja miten.')); // @key: @#@"scheduleFor"@#@ @source: @#@"Schedule on behalf of"@#@
