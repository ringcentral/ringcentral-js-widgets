...
}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, _RcVideo.ASSISTED_USERS_MYSELF, 'Mí'), "waitingRoomTitle", 'Ver sala de espera'), "waitingRoomDescription", 'Los participantes esperan hasta que los admita. Ideal para entrevistas o asistentes externos.'), "waitingRoomNotCoworker", 'Cualquiera que no sea parte de mi empresa'), "waitingRoomGuest", 'Para cualquiera que no haya iniciado sesión'), "waitingRoomAll", 'Para todos los participantes'), "enterPassword", 'Introducir contraseña'), "onlyJoinAfterMe", 'Iniciar reunión después de unirse'), "allowJoinBeforeHostDescription", 'La reunión comenzará después de que se una para evitar conversaciones antes de unirse.'), "requirePassword", 'Solicitar contraseña'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "requirePasswordDescription", 'Mantenga su reunión segura. A cualquier persona que use el enlace no se le pedirá una contraseña.'), "password", 'Contraseña:'), "passwordEmptyError", 'Contraseña de la reunión obligatoria'), "passwordInvalidError", 'La contraseña debe tener entre 1 y 10 caracteres o números y no puede incluir símbolos.'), "passwordHintText", 'Su contraseña debe tener entre 1 y 10 letras y números, pero no puede contener símbolos'), "usePersonalMeetingIdInstead", 'Usar enlace de reunión personal'), "allowMeetingAccess", 'Gestionar quién puede unirse'), "anyoneWithLink", 'Cualquier persona con un enlace'), "signedInUsers", 'Solo {shortName} cuentas'), "signedInCoWorkers", 'Solo compañeros'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_scheduleFor$schedule, "passwordLabel", 'Contraseña'), "edit", 'Editar'), "editSettings", 'Editar configuración'), "lockTooltip", 'Esta configuración la gestiona el administrador de su empresa'), "cancel", 'Cancelar'), "update", 'Actualizar'), "pmiSettingsTitle", 'Ajustes de la reunión personal'), "pmiSettingsDescription", 'Establezca quién puede unirse y cómo para el enlace de su reunión personal.')); // @key: @#@"scheduleFor"@#@ @source: @#@"Schedule on behalf of"@#@
