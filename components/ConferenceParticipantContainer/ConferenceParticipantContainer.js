...
exports.ConferenceParticipantContainer = void 0;
...
var ConferenceParticipantContainer = /*#__PURE__*/function (_Component) {
  _inherits(ConferenceParticipantContainer, _Component);

  var _super = _createSuper(ConferenceParticipantContainer);
  ...
  _createClass(ConferenceParticipantContainer, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      if (!nextProps.participants.length && nextProps.participants.length !== participants.length) {
        (0, _sleep.sleep)(750).then(function () {
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement(_ConferenceParticipantPanel["default"], this.props);
    }
  }]);
...
exports.ConferenceParticipantContainer = ConferenceParticipantContainer;
//# sourceMappingURL=ConferenceParticipantContainer.js.map
