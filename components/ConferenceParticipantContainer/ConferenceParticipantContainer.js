...
var ConferenceParticipantContainer = exports.ConferenceParticipantContainer = /*#__PURE__*/function (_Component) {
  function ConferenceParticipantContainer(props) {
    var _this;
    _classCallCheck(this, ConferenceParticipantContainer);
    _this = _callSuper(this, ConferenceParticipantContainer, [props]);
  ...
  return _createClass(ConferenceParticipantContainer, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      if (!nextProps.participants.length && nextProps.participants.length !== participants.length) {
        (0, _utils.sleep)(750).then(function () {
