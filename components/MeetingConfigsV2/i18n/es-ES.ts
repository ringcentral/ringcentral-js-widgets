export default {
  ...
  passwordInvalidError:
    'Utilice de 1 a 10 caracteres que incluyan letras y números, pero no símbolos',
  passwordHintText:
    'Su contraseña debe tener entre 1 y 10 letras y números, pero no debe contener símbolos',
