...
export default {
  ...
  rcmPasswordInvalidError: "A palavra-passe tem de ter 1–10 carateres e números e não pode conter símbolos, exceto @, * ou -",
  rcmPasswordHintText: "A palavra-passe deve ter 1–10 carateres e números e não pode conter símbolos, exceto @, * ou -",
