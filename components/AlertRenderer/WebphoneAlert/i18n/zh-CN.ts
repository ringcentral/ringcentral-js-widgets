...
export default {
  ...
  [webphoneErrors.noOutboundCallWithoutDL]: "当前您的分机不能通过浏览器呼出电话，请联系您的帐户代表进行升级。",
  [webphoneErrors.provisionUpdate]: "抱歉，系统出现问题。稍后我们将自动尝试重新连接。",
  [webphoneErrors.serverConnecting]: "抱歉，连接到电话服务器时发生问题。",
  [webphoneErrors.toVoiceMailError]: "由于内部错误，无法将呼叫发送到语音信箱",
  [webphoneErrors.muteError]: "暂时无法静音。",
  ...
  failWithoutStatusCode: "抱歉，系统出现问题。如果错误仍然存在，请向 {brandName} 支持部门报告此错误。",
