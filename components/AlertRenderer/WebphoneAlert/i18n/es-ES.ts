...
export default {
  ...
  [webphoneErrors.webphoneCountOverLimit]:
    'Se han podido registrar 5 teléfonos web en total.',
  ...
  [webphoneErrors.flipError]:
    'No se puede traspasar la llamada. Inténtelo de nuevo más tarde.',
  ...
  [webphoneErrors.pauseRecordError]:
    'Lo sentimos, no pudimos dejar de grabar la llamada. Inténtelo de nuevo más tarde.',
