...
export default {
  [webphoneErrors.connectFailed]:
    'Telefoonfuncties zijn momenteel niet beschikbaar. Probeer het later opnieuw. ',
  [webphoneErrors.connected]: 'Webtelefoon geregistreerd.',
  [webphoneErrors.browserNotSupported]:
    'Bellen met deze browser wordt niet ondersteund.',
  [webphoneErrors.webphoneCountOverLimit]:
    'Er kunnen maximaal vijf webtelefoons worden geregistreerd.',
  [webphoneErrors.checkDLError]:
    'Kan uitgaande oproep niet plaatsen. Neem contact op met {brandName} voor hulp als deze fout zich blijft voordoen.',
  [webphoneErrors.noOutboundCallWithoutDL]:
    'Uw extensie mag momenteel geen uitgaande oproepen plaatsen met de browser. Neem contact op met uw accountvertegenwoordiger voor een upgrade.',
  [webphoneErrors.provisionUpdate]:
    'Er is bij ons iets fout gegaan. We proberen over een ogenblik automatisch opnieuw verbinding te maken.',
  [webphoneErrors.serverConnecting]:
    'We kunnen geen verbinding maken met de telefoonserver.',
  [webphoneErrors.toVoiceMailError]:
    'Kan oproep niet naar voicemail verzenden vanwege een interne fout',
  [webphoneErrors.muteError]: 'Oproep kan momenteel niet worden gedempt.',
  [webphoneErrors.holdError]:
    'Oproep kan momenteel niet in de wacht worden gezet.',
  [webphoneErrors.flipError]:
    'Kan de oproep niet omkeren. Probeer het later opnieuw.',
  [webphoneErrors.recordError]:
    'U kunt de oproep momenteel niet opnemen. Foutcode: {errorCode}',
  [webphoneErrors.pauseRecordError]:
    'We kunnen het opnemen van de oproep niet stoppen. Probeer het later opnieuw.',
  [webphoneErrors.recordDisabled]:
    'Uw account heeft niet de functie om een oproep op te nemen. Neem contact op met uw accountbeheerder.',
  [webphoneErrors.transferError]:
    'Kan de oproep niet doorschakelen. Probeer het later opnieuw.',
  [webphoneMessages.parked]:
    'Uw oproep is geparkeerd op locatie: {parkedNumber}',
  failWithStatusCode:
    'Er is een fout opgetreden: {errorCode}. Meld deze fout aan {brandName}-support als het probleem aanhoudt.',
  registeringWithStatusCode:
    'Er is iets fout gegaan. We proberen opnieuw verbinding te maken. Meld deze fout aan {brandName}-support als het probleem zich blijft voordoen. Foutcode: {errorCode}.',
  failWithoutStatusCode:
    'Er is bij ons iets fout gegaan. Meld deze fout aan {brandName}-support als de fout zich blijft voordoen.',
  registeringWithoutStatusCode:
    'Er is iets fout gegaan. We proberen opnieuw verbinding te maken. Meld deze fout aan {brandName}-support als het probleem zich blijft voordoen.',
} as const;
