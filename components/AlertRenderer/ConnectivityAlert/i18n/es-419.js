...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Lo sentimos, se produjo un error; verifique su conexión de red y vuelva a intentarlo.'), _ConnectivityManager.connectivityTypes.offline, 'No se puede conectar al servidor. Inténtelo de nuevo más tarde.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Se produjo un error en nuestro sistema. Inténtelo de nuevo más tarde.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Se produjo un error en nuestro sistema, pero estamos trabajando arduamente para solucionarlo. Aún puede hacer llamadas, pero otras funciones están actualmente limitadas.'), _ConnectivityManager.connectivityTypes.survival, 'Se produjo un error en nuestro sistema, pero estamos trabajando arduamente para solucionarlo. Es posible que tenga acceso limitado a ciertas funciones. La aplicación se recuperará automáticamente tan pronto como esté disponible.'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
