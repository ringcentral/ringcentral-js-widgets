...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, '抱歉，发生问题，请检查网络连接并重试。'), _ConnectivityManager.connectivityTypes.offline, '无法连接到服务器。请稍后重试。'), _ConnectivityManager.connectivityTypes.serverUnavailable, '抱歉，系统出现问题。请稍后重试。'), _ConnectivityManager.connectivityTypes.voipOnly, '抱歉，我们这边发生了问题，但我们正在努力解决问题。您仍可以拨打电话，但其他功能此时会受到限制。'), _ConnectivityManager.connectivityTypes.survival, '抱歉，系统出现问题，我们正在努力解决。您对某些功能的访问可能会受到限制。应用一变为可用状态，就会自动恢复。'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
