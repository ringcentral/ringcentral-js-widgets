...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Er is iets fout gegaan. Controleer uw netwerkverbinding en probeer het opnieuw.'), _ConnectivityManager.connectivityTypes.offline, 'Kan niet verbinden met de server. Probeer het later opnieuw.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Er is bij ons iets fout gegaan. Probeer het later opnieuw.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Er is bij ons iets fout gegaan. We zijn druk bezig om dit op te lossen. U kunt nog steeds bellen, maar andere functies zijn momenteel beperkt.'), _ConnectivityManager.connectivityTypes.survival, 'Er is bij ons iets fout gegaan. We zijn druk bezig om dit op te lossen. U hebt beperkt toegang tot enkele functies. De app zal automatisch herstellen zodra deze beschikbaar is.'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
