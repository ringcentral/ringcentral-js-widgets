...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Désolés, une erreur s’est produite, vérifiez votre connexion réseau et réessayez.'), _ConnectivityManager.connectivityTypes.offline, 'Impossible d’accéder au serveur. Veuillez réessayer plus tard.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Désolés, une erreur s’est produite de notre côté. Réessayez plus tard.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Désolés, une erreur s’est produite de notre côté, mais nous nous efforçons de la corriger. Vous pouvez toujours passer des appels, mais les autres fonctions sont actuellement limitées.'), _ConnectivityManager.connectivityTypes.survival, 'Désolés, une erreur s’est produite de notre côté, mais nous nous efforçons de la corriger. Vous pouvez avoir un accès limité à certaines fonctionnalités. L’application se rétablira automatiquement dès qu’elle sera disponible.'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
