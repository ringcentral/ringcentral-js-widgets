...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Sorry, something went wrong. Check your network connection and try again.'), _ConnectivityManager.connectivityTypes.offline, 'Cannot connect to the server. Please retry later.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Sorry, something went wrong on our end. Try again later.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Sorry, something went wrong on our end, but we are working hard to fix it. You can still make calls, but other functions are currently limited.'), _ConnectivityManager.connectivityTypes.survival, 'Sorry, something went wrong on our end, but we are working hard to fix it. You may have limited access to certain features. The app will recover automatically as soon as it’s available.'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
