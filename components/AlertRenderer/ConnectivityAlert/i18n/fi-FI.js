...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Jokin meni vikaan. Tarkista verkkoyhteytesi ja yritä uudelleen.'), _ConnectivityManager.connectivityTypes.offline, 'Yhteyden muodostaminen palvelimeen epäonnistui. Yritä myöhemmin uudelleen.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Jokin meni vikaan palvelimellamme. Yritä myöhemmin uudelleen.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Jokin meni vikaan palvelimellamme. Pyrimme korjaamaan vian pikimmiten. Voit edelleen soittaa puheluita, mutta muita toimintoja on rajoitettu.'), _ConnectivityManager.connectivityTypes.survival, 'Jokin meni vikaan palvelimellamme. Pyrimme korjaamaan vian pikimmiten. Tietyt ominaisuudet voivat olla käytössä vain rajoitetusti. Sovellus palautuu normaalitilaan niin pian kuin mahdollista.'); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
