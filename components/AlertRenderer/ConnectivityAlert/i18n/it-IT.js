...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConnectivityManager.connectivityTypes.networkLoss, 'Si è verificato un problema, controlla la connessione di rete e riprova.'), _ConnectivityManager.connectivityTypes.offline, 'Impossibile connettersi al server. Riprova più tardi.'), _ConnectivityManager.connectivityTypes.serverUnavailable, 'Si è verificato un problema nei nostri sistemi. Riprova più tardi.'), _ConnectivityManager.connectivityTypes.voipOnly, 'Si è verificato un problema, ma stiamo lavorando per risolverlo. È comunque possibile effettuare chiamate, ma le altre funzioni sono limitate.'), _ConnectivityManager.connectivityTypes.survival, "Si è verificato un problema, ma stiamo lavorando per risolverlo. È possibile che l'accesso a determinate funzioni risulti limitato. L'app sarà ripristinata automaticamente non appena disponibile."); // @key: @#@"[connectivityTypes.networkLoss]"@#@ @source: @#@"Sorry, something went wrong, check your network connection and try again."@#@
