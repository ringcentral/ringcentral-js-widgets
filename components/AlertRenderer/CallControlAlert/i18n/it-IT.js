...
var _default = exports["default"] = (_callsMerged$somethin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_callsMerged$somethin, callsMerged, 'Chiamate unite'), somethingWentWrong, 'Si è verificato un problema. Riprova.'), tooManyParticipants, 'Numero massimo di partecipanti raggiunto.'), muteConflictError, "L'audio di questa chiamata è stato disattivato sull'altro dispositivo. Riattivalo prima di eseguire l'operazione in questa app."), unHoldConflictError, "Questa chiamata è stata messa in attesa sull'altro dispositivo. Riprendila prima di eseguire l'operazione in questa app."), unMuteConflictError, "L'audio di questa chiamata è stato riattivato sull'altro dispositivo. Disattivalo prima di eseguire l'operazione in questa app."), holdConflictError, "Questa chiamata è stata ripresa sull'altro dispositivo. Mettila in attesa prima di eseguire l'operazione in questa app."), generalError, 'Errore inatteso del server. Riprova più tardi.'), forwardSuccess, 'Chiamata trasferita'), transferCompleted, 'Chiamata trasferita'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Messaggio vocale inviato.')); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
