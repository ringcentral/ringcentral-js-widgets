...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, 'Oproepen samengevoegd'), _defineProperty(_callsMerged$somethin, somethingWentWrong, 'Er is een fout opgetreden. Probeer het opnieuw.'), _defineProperty(_callsMerged$somethin, tooManyParticipants, 'Maximale aantal deelnemers is bereikt.'), _defineProperty(_callsMerged$somethin, muteConflictError, 'Deze oproep is gedempt op een ander apparaat. Schakel het dempen van de oproep uit voordat u deze app bedient.'), _defineProperty(_callsMerged$somethin, unHoldConflictError, 'Deze oproep staat in de wacht op een ander apparaat. Haal de oproep uit de wacht voordat u deze app bedient.'), _defineProperty(_callsMerged$somethin, unMuteConflictError, 'Dempen van deze oproep is uitgeschakeld op een ander apparaat. Demp de oproep voordat u deze app bedient.'), _defineProperty(_callsMerged$somethin, holdConflictError, 'Deze oproep is uit de wacht gehaald op een ander apparaat. Zet de oproep in de wacht voordat u deze app bedient.'), _defineProperty(_callsMerged$somethin, generalError, 'Onverwachte serverfout. Probeer het later opnieuw.'), _defineProperty(_callsMerged$somethin, forwardSuccess, 'Oproep doorverbonden'), _defineProperty(_callsMerged$somethin, transferCompleted, 'Oproep doorverbonden'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Spraakbericht verzonden.'), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
