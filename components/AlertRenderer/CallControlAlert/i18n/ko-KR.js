...
var _default = (_muteConflictError$un = {}, _defineProperty(_muteConflictError$un, muteConflictError, "이 통화는 다른 디바이스에서 음소거되었습니다. 이 앱에서 제어하기 전에 통화 음소거를 해제하세요."), _defineProperty(_muteConflictError$un, unHoldConflictError, "이 통화는 다른 디바이스에서 대기되었습니다. 이 앱에서 제어하기 전에 통화 대기를 해제하세요."), _defineProperty(_muteConflictError$un, unMuteConflictError, "이 통화는 다른 디바이스에서 음소거 해제되었습니다. 이 앱에서 제어하기 전에 통화를 음소거하세요."), _defineProperty(_muteConflictError$un, holdConflictError, "이 통화는 다른 디바이스에서 대기 해제되었습니다. 이 앱에서 제어하기 전에 통화 대기하세요."), _defineProperty(_muteConflictError$un, generalError, "예기치 않은 서버 오류입니다. 나중에 다시 시도하세요."), _defineProperty(_muteConflictError$un, forwardSuccess, "착신 전환됨"), _muteConflictError$un); // @key: @#@"muteConflictError"@#@ @source: @#@"This call had been muted on other device. Please unmute the call before you control in this App."@#@
