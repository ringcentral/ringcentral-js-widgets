...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, 'Llamadas combinadas'), _defineProperty(_callsMerged$somethin, somethingWentWrong, 'Se produjo un error. Vuelva a intentarlo.'), _defineProperty(_callsMerged$somethin, tooManyParticipants, 'Se alcanzó la cantidad máxima de participantes.'), _defineProperty(_callsMerged$somethin, muteConflictError, 'Esta llamada se había silenciado en otro dispositivo. Reactive el audio de la llamada antes de empezar a utilizar esta aplicación.'), _defineProperty(_callsMerged$somethin, unHoldConflictError, 'Esta llamada se había puesto en espera en otro dispositivo. Reanude la llamada antes de empezar a utilizar esta aplicación.'), _defineProperty(_callsMerged$somethin, unMuteConflictError, 'El audio de esta llamada se había activado en otro dispositivo. Silencie la llamada antes de empezar a utilizar esta aplicación.'), _defineProperty(_callsMerged$somethin, holdConflictError, 'Esta llamada se había reanudado en otro dispositivo. Ponga la llamada en espera antes de empezar a utilizar esta aplicación.'), _defineProperty(_callsMerged$somethin, generalError, 'Se ha producido un error inesperado en el servidor. Inténtelo de nuevo más tarde.'), _defineProperty(_callsMerged$somethin, forwardSuccess, 'Llamada desviada'), _defineProperty(_callsMerged$somethin, transferCompleted, 'Llamada transferida'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Mensaje de voz enviado.'), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
