...
var _default = exports["default"] = (_callsMerged$somethin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_callsMerged$somethin, callsMerged, 'Las llamadas se combinaron'), somethingWentWrong, 'Se ha producido un error. Vuelva a intentarlo.'), tooManyParticipants, 'Se alcanzó el número máximo de participantes.'), muteConflictError, 'Esta llamada se había silenciado en otro dispositivo. Active el audio de la llamada antes de empezar a utilizar la aplicación.'), unHoldConflictError, 'Esta llamada se había puesto en espera en otro dispositivo. Reanude la llamada antes de empezar a controlar en esta aplicación.'), unMuteConflictError, 'El audio de esta llamada se había activado en otro dispositivo. Silencie la llamada antes de controlar en esta aplicación.'), holdConflictError, 'Esta llamada se había reanudado en otro dispositivo. Ponga la llamada en espera antes de controlar en esta aplicación.'), generalError, 'Error inesperado del servidor. Inténtelo de nuevo más tarde.'), forwardSuccess, 'Llamada desviada'), transferCompleted, 'Llamada transferida'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Mensaje de voz enviado.')); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
