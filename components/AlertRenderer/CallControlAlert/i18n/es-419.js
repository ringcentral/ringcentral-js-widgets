...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, "Las llamadas se combinaron"), _defineProperty(_callsMerged$somethin, somethingWentWrong, "Se ha producido un error. Vuelva a intentarlo."), _defineProperty(_callsMerged$somethin, tooManyParticipants, "Se alcanzó el número máximo de participantes."), _defineProperty(_callsMerged$somethin, muteConflictError, "Esta llamada se había silenciado en otro dispositivo. Desactive el silencio de la llamada antes de empezar a utilizar la aplicación."), _defineProperty(_callsMerged$somethin, unHoldConflictError, "Esta llamada se había puesto en espera en otro dispositivo. Reanude la llamada antes de empezar a utilizar la aplicación."), _defineProperty(_callsMerged$somethin, unMuteConflictError, "El audio de esta llamada se había activado en otro dispositivo. Silencie la llamada antes de empezar a utilizar la aplicación."), _defineProperty(_callsMerged$somethin, holdConflictError, "Esta llamada se había reanudado en otro dispositivo. Ponga la llamada en espera antes de empezar a utilizar la aplicación."), _defineProperty(_callsMerged$somethin, generalError, "Error en el servidor. Inténtelo de nuevo más tarde."), _defineProperty(_callsMerged$somethin, forwardSuccess, "Llamada desviada"), _defineProperty(_callsMerged$somethin, transferCompleted, "Llamada transferida"), _defineProperty(_callsMerged$somethin, replyCompleted, "Mensaje de voz enviado."), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
