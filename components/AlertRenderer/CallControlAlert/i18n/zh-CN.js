...
var _default = (_muteConflictError$ho = {}, _defineProperty(_muteConflictError$ho, muteConflictError, "此通话已经在其他设备上被静音。请取消静音该通话，然后再通过此应用进行操作。"), _defineProperty(_muteConflictError$ho, holdConflictError, "此通话已经在其他设备上被搁置。请取消搁置该通话，然后再通过此应用进行操作。"), _defineProperty(_muteConflictError$ho, unMuteConflictError, "此通话已经在其他设备上被取消静音。请静音该通话，然后再通过此应用进行操作。"), _defineProperty(_muteConflictError$ho, unHoldConflictError, "此通话已经在其他设备上被取消搁置。请搁置该通话，然后再通过此应用进行操作。"), _defineProperty(_muteConflictError$ho, generalError, "意外的服务器错误，请稍后再试。"), _defineProperty(_muteConflictError$ho, forwardSuccess, "已转移呼叫"), _muteConflictError$ho); // @key: @#@"muteConflictError"@#@ @source: @#@"This call had been muted on other device. Please unmute the call before you control in this App."@#@
