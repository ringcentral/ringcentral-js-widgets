...
var _default = exports["default"] = (_callsMerged$somethin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_callsMerged$somethin, callsMerged, 'Anrufe zusammengeführt'), somethingWentWrong, 'Ein Fehler ist aufgetreten. Versuchen Sie es erneut.'), tooManyParticipants, 'Maximale Teilnehmerzahl ist erreicht.'), muteConflictError, 'Dieser Anruf wurde auf einem anderen Gerät stummgeschaltet. Heben Sie die Stummschaltung vor der Inbetriebnahme in dieser App auf.'), unHoldConflictError, 'Dieser Anruf wurde auf einem anderen Gerät gehalten. Heben Sie den Haltestatus vor der Inbetriebnahme in dieser App auf.'), unMuteConflictError, 'Die Stummschaltung dieses Anrufs wurde auf einem anderen Gerät aufgehoben. Schalten Sie ihn vor der Inbetriebnahme in dieser App stumm.'), holdConflictError, 'Der Haltestatus dieses Anrufs wurde auf einem anderen Gerät aufgehoben. Halten Sie ihn vor der Inbetriebnahme in dieser App.'), generalError, 'Unerwarteter Serverfehler. Versuchen Sie es später noch einmal.'), forwardSuccess, 'Anruf weitergeleitet'), transferCompleted, 'Anruf weitergeleitet'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Sprachnachricht gesendet.')); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
