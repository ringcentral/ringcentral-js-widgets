...
var _default = exports["default"] = (_callsMerged$somethin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_callsMerged$somethin, callsMerged, 'Appels fusionnés'), somethingWentWrong, 'Un problème est survenu. Merci de réessayer.'), tooManyParticipants, 'Le nombre maximum de participants est atteint.'), muteConflictError, 'Le son de cet appel a été désactivé sur un autre terminal. Veuillez activer le son de l’appel avant votre action dans l’application.'), unHoldConflictError, 'Cet appel a été mis en attente sur un autre terminal. Veuillez reprendre l’appel avant votre action dans l’application.'), unMuteConflictError, 'Le son de cet appel a été activé sur un autre terminal. Veuillez désactiver le son de l’appel avant votre action dans l’application.'), holdConflictError, 'Cet appel a été repris sur un autre terminal. Veuillez mettre en attente l’appel avant toute action au sein de l’application.'), generalError, 'Erreur de serveur inconnue. Veuillez réessayer ultérieurement.'), forwardSuccess, 'Appel renvoyé'), transferCompleted, 'Appel transféré'), _defineProperty(_callsMerged$somethin, replyCompleted, 'Message vocal envoyé.')); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
