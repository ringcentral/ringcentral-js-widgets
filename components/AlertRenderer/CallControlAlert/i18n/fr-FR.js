...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, "Appels fusionnés"), _defineProperty(_callsMerged$somethin, somethingWentWrong, "Un problème est survenu. Veuillez réessayer."), _defineProperty(_callsMerged$somethin, tooManyParticipants, "Le nombre maximum de participants est atteint."), _defineProperty(_callsMerged$somethin, muteConflictError, "Le son de cet appel a été désactivé sur un autre terminal. Veuillez activer le son de l’appel avant votre action dans l’application."), _defineProperty(_callsMerged$somethin, unHoldConflictError, "Cet appel a été mis en attente sur un autre terminal. Veuillez reprendre l’appel avant votre action dans l’application."), _defineProperty(_callsMerged$somethin, unMuteConflictError, "Le son de cet appel a été activé sur un autre terminal. Veuillez désactiver le son de l’appel avant votre action dans l’application."), _defineProperty(_callsMerged$somethin, holdConflictError, "Cet appel a été repris sur un autre terminal. Veuillez mettre en attente l’appel avant toute action au sein de l’application."), _defineProperty(_callsMerged$somethin, generalError, "Erreur de serveur inconnue. Veuillez réessayer ultérieurement."), _defineProperty(_callsMerged$somethin, forwardSuccess, "Appel renvoyé"), _defineProperty(_callsMerged$somethin, transferCompleted, "Appel transféré"), _defineProperty(_callsMerged$somethin, replyCompleted, "Message vocal envoyé."), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
