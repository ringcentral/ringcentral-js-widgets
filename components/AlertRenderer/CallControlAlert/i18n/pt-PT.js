...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, "Chamadas unidas"), _defineProperty(_callsMerged$somethin, somethingWentWrong, "Ocorreu um erro. Tente novamente."), _defineProperty(_callsMerged$somethin, tooManyParticipants, "Número máximo de participantes atingido."), _defineProperty(_callsMerged$somethin, muteConflictError, "O som desta chamada foi desativado noutro dispositivo. Ative o som da chamada antes de assumir o controlo nesta aplicação."), _defineProperty(_callsMerged$somethin, unHoldConflictError, "Esta chamada foi colocada em espera noutro dispositivo. Retome a chamada antes de assumir o controlo nesta aplicação."), _defineProperty(_callsMerged$somethin, unMuteConflictError, "O som desta chamada foi ativado noutro dispositivo. Desative o som da chamada antes de assumir o controlo nesta aplicação."), _defineProperty(_callsMerged$somethin, holdConflictError, "Esta chamada foi retomada noutro dispositivo. Coloque a chamada em espera antes de assumir o controlo nesta aplicação."), _defineProperty(_callsMerged$somethin, generalError, "Erro de servidor inesperado. Tente novamente mais tarde."), _defineProperty(_callsMerged$somethin, forwardSuccess, "Chamada reencaminhada"), _defineProperty(_callsMerged$somethin, transferCompleted, "Chamada transferida"), _defineProperty(_callsMerged$somethin, replyCompleted, "Mensagem de voz enviada."), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
