...
var _default = (_callsMerged$somethin = {}, _defineProperty(_callsMerged$somethin, callsMerged, "通話がマージされました"), _defineProperty(_callsMerged$somethin, somethingWentWrong, "問題が発生しました。もう一度やり直してください。"), _defineProperty(_callsMerged$somethin, tooManyParticipants, "参加者の最大数に達しています。"), _defineProperty(_callsMerged$somethin, muteConflictError, "この通話は他のデバイスでミュートされていました。通話のミュートを解除してから、このアプリで操作してください。"), _defineProperty(_callsMerged$somethin, unHoldConflictError, "この通話は他のデバイスで保留に設定されていました。通話の保留を解除してから、このアプリで操作してください。"), _defineProperty(_callsMerged$somethin, unMuteConflictError, "この通話は他のデバイスでミュートが解除されていました。通話をミュートしてから、このアプリで操作してください。"), _defineProperty(_callsMerged$somethin, holdConflictError, "この通話は他のデバイスで保留解除されています。通話を保留に設定してから、このアプリで操作してください。"), _defineProperty(_callsMerged$somethin, generalError, "予期しないサーバエラーが発生しました。後でもう一度やり直してください。"), _defineProperty(_callsMerged$somethin, forwardSuccess, "通話が転送されました"), _defineProperty(_callsMerged$somethin, transferCompleted, "通話が転送されました"), _defineProperty(_callsMerged$somethin, replyCompleted, "ボイスメッセージを送信しました。"), _callsMerged$somethin); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
