...
var _default = exports["default"] = (_callsMerged$somethin = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_callsMerged$somethin, callsMerged, '通話がマージされました'), somethingWentWrong, '問題が発生しました。もう一度やり直してください。'), tooManyParticipants, '参加者数の上限に達しています。'), muteConflictError, 'この通話は他のデバイスでミュートされていました。通話をミュート解除してから、このアプリで操作してください。'), unHoldConflictError, 'この通話は他のデバイスで保留に設定されていました。通話の保留を解除してから、このアプリで操作してください。'), unMuteConflictError, 'この通話は他のデバイスでミュートが解除されていました。通話をミュートしてから、このアプリで操作してください。'), holdConflictError, 'この通話は他のデバイスで保留が解除されています。通話を保留に設定してから、このアプリで操作してください。'), generalError, '予期しないサーバエラーが発生しました。後でもう一度やり直してください。'), forwardSuccess, '通話が転送されました'), transferCompleted, '通話が転送されました'), _defineProperty(_callsMerged$somethin, replyCompleted, 'ボイスメッセージが送信されました。')); // @key: @#@"callsMerged"@#@ @source: @#@"Calls merged"@#@
