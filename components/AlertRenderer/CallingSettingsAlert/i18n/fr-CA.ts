...
export default {
  ...
  [callingSettingsMessages.saveSuccessWithSoftphone]: "Les paramètres ont été enregistrés. Veuillez vous assurer que {brand} est installé sur votre ordinateur.",
  ...
  [callingSettingsMessages.saveSuccessWithJupiter]: "Les paramètres ont été enregistrés. Veuillez vous assurer que {brand} est installé sur votre ordinateur.",
