...
export default {
  ...
  [callingSettingsMessages.saveSuccessWithSoftphone]: "Settings saved successfully. Please make sure that you have {brand} installed in your computer.",
  ...
  [callingSettingsMessages.saveSuccessWithJupiter]: "Settings saved successfully. Please make sure that you have {brand} installed in your computer.",
  [callingSettingsMessages.disableEmergencyInJapan]: "Emergency service is not available in Japan."
};
