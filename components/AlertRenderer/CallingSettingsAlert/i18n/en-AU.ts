...
export default {
  ...
  [callingSettingsMessages.saveSuccessWithSoftphone]:
    'Settings saved successfully. Please make sure that you have {brand} installed in your computer.',
  ...
  [callingSettingsMessages.webphonePermissionRemoved]:
    'Your permissions have been changed and you cannot make calls with your browser. For details, please contact your account administrator.',
  [callingSettingsMessages.emergencyCallingNotAvailable]:
    'Dialling emergency or special service numbers is not supported. In an emergency, use your traditional wireline or wireless phone to call an emergency number.',
