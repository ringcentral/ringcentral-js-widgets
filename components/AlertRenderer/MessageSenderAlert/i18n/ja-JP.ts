...
export default {
  ...
  [messageSenderMessages.specialNumber]: "緊急サービスまたは特別なサービスの番号へのテキスト送信はサポートされていません。",
  ...
  [messageSenderMessages.senderNumberInvalid]: "社外の受信者にテキストメッセージを送信するには、有効な電話番号が必要です。管理者に連絡して、アカウントにダイレクトナンバーを追加してください。",
  [messageSenderMessages.notSmsToExtension]: "代表電話番号の付いた内線番号には送信できません。内線番号に送信する場合は、内線番号だけを入力してください。",
  ...
  [messageSenderMessages.noSMSPermission]: "テキストメッセージを組織外の受信者に送信するアクセス許可がありません。",
  [messageSenderMessages.attachmentCountLimitation]: "添付ファイルは最大10件です。",
