...
export default {
  ...
  [messageSenderMessages.noPermission]:
    'Não tem permissão para enviar a mensagem.',
  [messageSenderMessages.senderEmpty]:
    'Tem de selecionar um número dos seus números de telefone para enviar',
  [messageSenderMessages.noToNumber]: 'Introduza um número de telefone válido.',
  [messageSenderMessages.recipientsEmpty]:
    'Introduza um número de destinatário válido.',
  [messageSenderMessages.textTooLong]:
    'O texto é demasiado longo; limite de 1000',
  [messageSenderMessages.multipartTextTooLong]:
    'O texto é demasiado longo; limite de 5000',
  ...
  [messageSenderMessages.specialNumber]:
    'O envio de texto para números de emergência/serviços especiais não é suportado.',
  [messageSenderMessages.connectFailed]:
    'A ligação falhou. Tente novamente mais tarde.',
  ...
  [messageSenderMessages.notSmsToExtension]:
    'Não é possível enviar para um número de extensão com o número de telefone principal. Se pretender enviar para um número de extensão, basta introduzir o número da extensão.',
  [messageSenderMessages.internationalSMSNotSupported]:
    'O envio de SMS para números de telefone internacionais não é suportado.',
  [messageSenderMessages.noInternalSMSPermission]:
    'Não tem permissão para enviar mensagens. Contacte o administrador da sua conta {brand} para atualizar.',
  [messageSenderMessages.noSMSPermission]:
    'Não tem permissão para enviar mensagens para destinatários fora da sua empresa.',
  ...
  [messageSenderMessages.attachmentSizeLimitation]:
    'O tamanho geral do anexo não pode ser superior a 1,5 MB por mensagem.',
  [messageSenderMessages.noAttachmentToExtension]:
    'Não é possível enviar MMS para uma extensão.',
  areaCode: 'indicativo de zona',
  [messageSenderMessages.sending]:
    'A enviar mensagem… Pode demorar alguns minutos a concluir.',
