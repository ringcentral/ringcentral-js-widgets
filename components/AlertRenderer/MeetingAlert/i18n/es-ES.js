...
var _default = (_meetingStatus$emptyT = {}, _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.emptyTopic, "Escriba el tema de la reunión."), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.noPassword, "Indique la contraseña de la reunión."), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.insufficientPermissions, "{application} no tiene el permiso {permissionName}."), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.scheduledSuccess, "Se ha añadido la reunión"), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.updatedSuccess, "Se ha actualizado la reunión"), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.meetingIsDeleted, "Se ha eliminado la reunión"), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.internalError, "Se ha producido un error en nuestro sistema. Inténtelo de nuevo."), _defineProperty(_meetingStatus$emptyT, _Meeting.meetingStatus.renderInviteError, "Lo sentimos, hemos tenido un problema y no hemos podido añadir la invitación a la reunión. Vuelva a intentarlo más tarde."), _meetingStatus$emptyT); // @key: @#@"[meetingStatus.emptyTopic]"@#@ @source: @#@"Please enter meeting topic."@#@
