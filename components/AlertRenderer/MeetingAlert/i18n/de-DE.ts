...
export default {
  ...
  [meetingStatus.internalError]: "Leider ist auf unserer Seite ein Fehler aufgetreten. Versuchen Sie es erneut.",
  [meetingStatus.renderInviteError]: "Leider bestand unsererseits ein Problem. Wir konnten daher die Besprechungseinladung nicht hinzufügen. Versuchen Sie es später noch einmal."
};
