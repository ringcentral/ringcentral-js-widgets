...
var _default = (_meetingStatus$emptyT = {}, _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].emptyTopic, "Voer het onderwerp voor de meeting in."), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].noPassword, "Geef het wachtwoord voor de meeting op."), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].insufficientPermissions, "{application} heeft geen {permissionName}-rechten."), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].scheduledSuccess, "Meeting toegevoegd"), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].updatedSuccess, "Meeting bijgewerkt"), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].meetingIsDeleted, "Meeting is verwijderd"), _defineProperty(_meetingStatus$emptyT, _meetingStatus["default"].internalError, "Er is bij ons iets fout gegaan. Probeer het later opnieuw."), _meetingStatus$emptyT); // @key: @#@"[meetingStatus.emptyTopic]"@#@ @source: @#@"Please enter meeting topic."@#@
