...
export default {
  [authMessages.internalError]: "Se produjo un error en el inicio de sesión debido a un error interno. Inténtelo de nuevo más tarde.",
  ...
  [authMessages.siteAccessForbidden]: "Lo sentimos, use una cuenta diferente para iniciar sesión. Comuníquese con su administrador de TI para que lo asista."
};
