...
var _default = (_authMessages$interna = {}, _defineProperty(_authMessages$interna, _authMessages["default"].internalError, "Inloggen is mislukt vanwege interne fouten. Probeer het later opnieuw."), _defineProperty(_authMessages$interna, _authMessages["default"].accessDenied, "Toegang geweigerd. Neem contact op met support."), _defineProperty(_authMessages$interna, _authMessages["default"].sessionExpired, "Sessie verlopen. Meld u aan."), _authMessages$interna); // @key: @#@"[authMessages.internalError]"@#@ @source: @#@"Login failed due to internal errors. Please try again later."@#@
