...
var _default = (_authMessages$interna = {}, _defineProperty(_authMessages$interna, _authMessages["default"].internalError, "由于内部错误，登录失败。请稍后重试。"), _defineProperty(_authMessages$interna, _authMessages["default"].accessDenied, "访问被拒绝。请联系支持。"), _defineProperty(_authMessages$interna, _authMessages["default"].sessionExpired, "会话已过期。请登录。"), _authMessages$interna); // @key: @#@"[authMessages.internalError]"@#@ @source: @#@"Login failed due to internal errors. Please try again later."@#@
