...
export default {
  [authMessages.internalError]: "Se ha producido un fallo en el inicio de sesión debido a un error interno. Inténtelo de nuevo más tarde.",
  ...
  [authMessages.siteAccessForbidden]: "Utilice una cuenta distinta para iniciar sesión. Solicite ayuda a su administrador de TI."
};
