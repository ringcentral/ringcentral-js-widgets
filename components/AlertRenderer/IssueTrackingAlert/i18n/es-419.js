...
var _default = (_issueTrackingMessage = {}, _defineProperty(_issueTrackingMessage, _issueTrackingMessages.issueTrackingMessages.downloadSuccess, "Registro descargado. El modo de registro de errores está desactivado."), _defineProperty(_issueTrackingMessage, _issueTrackingMessages.issueTrackingMessages.downloadFail, "Error al descargar el registro. Vuelva a intentarlo."), _issueTrackingMessage); // @key: @#@"[issueTrackingMessages.downloadSuccess]"@#@ @source: @#@"Log downloaded. Error tracking mode is turned off now."@#@
