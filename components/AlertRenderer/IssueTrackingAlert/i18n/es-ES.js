...
var _default = (_issueTrackingMessage = {}, _defineProperty(_issueTrackingMessage, _issueTrackingMessages.issueTrackingMessages.downloadSuccess, "Registro descargado. El modo de seguimiento de errores está desactivado ahora."), _defineProperty(_issueTrackingMessage, _issueTrackingMessages.issueTrackingMessages.downloadFail, "Error al descargar el registro de errores. Inténtelo de nuevo."), _issueTrackingMessage); // @key: @#@"[issueTrackingMessages.downloadSuccess]"@#@ @source: @#@"Log downloaded. Error tracking mode is turned off now."@#@
