...
export default {
  ...
  [permissionsMessages.insufficientPrivilege]: "Privilegios insuficientes. Póngase en contacto con el representante de su cuenta para conseguir una actualización."
};
