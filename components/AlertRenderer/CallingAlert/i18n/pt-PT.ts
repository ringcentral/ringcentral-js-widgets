...
export default {
  [permissionsMessages.callingDisable]: "Não tem permissões para realizar chamadas de saída. Contacte o administrador da conta {brand} para obter uma atualização."
};
