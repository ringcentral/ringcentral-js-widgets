...
var _default = exports["default"] = _defineProperty({}, _permissionsMessages.permissionsMessages.callingDisable, 'Você não tem permissões para fazer chamadas de saída. Entre em contato com o administrador da sua conta {brand} para fazer uma atualização.'); // @key: @#@"[permissionsMessages.callingDisable]"@#@ @source: @#@"You don't have permissions to place outbound calls. Please contact your {brand} account administrator for an upgrade."@#@
