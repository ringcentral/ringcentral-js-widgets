...
var _default = _defineProperty({}, _permissionsMessages.permissionsMessages.callingDisable, 'No tiene permisos para hacer llamadas salientes. Comuníquese con el administrador de su cuenta de {brand} para conseguir esta función.'); // @key: @#@"[permissionsMessages.callingDisable]"@#@ @source: @#@"You don't have permissions to place outbound calls. Please contact your {brand} account administrator for an upgrade."@#@
