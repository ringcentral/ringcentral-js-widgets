...
export default {
  [permissionsMessages.callingDisable]: "No tiene permisos para hacer llamadas salientes. Comuníquese con el administrador de su cuenta de {brand} para conseguir esta función."
};
