...
var _default = exports["default"] = _defineProperty({}, _permissionsMessages.permissionsMessages.callingDisable, 'Não tem permissões para realizar chamadas de saída. Contacte o administrador da conta {brand} para obter uma atualização.'); // @key: @#@"[permissionsMessages.callingDisable]"@#@ @source: @#@"You don't have permissions to place outbound calls. Please contact your {brand} account administrator for an upgrade."@#@
