...
var _default = exports["default"] = _defineProperty({}, _permissionsMessages.permissionsMessages.callingDisable, '通話を発信するためのアクセス許可がありません。アップグレードについては、{brand}のアカウント管理者にお問い合わせください。'); // @key: @#@"[permissionsMessages.callingDisable]"@#@ @source: @#@"You don't have permissions to place outbound calls. Please contact your {brand} account administrator for an upgrade."@#@
