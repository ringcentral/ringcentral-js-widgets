...
var _default = (_callErrors$noToNumbe = {}, _defineProperty(_callErrors$noToNumbe, _callErrors["default"].noToNumber, "請輸入有效的電話號碼。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].noAreaCode, "請設定讓{areaCodeLink}使用 7 位數的本地電話號碼。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].specialNumber, "不支援撥打緊急或特別服務號碼。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].connectFailed, "連線失敗。請稍後再試一次。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].internalError, "因為內部錯誤導致無法連線。請稍後再試一次。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].notAnExtension, "分機號碼不存在。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].networkError, "因為網路問題導致無法連線。請稍後再試一次。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].noInternational, "您沒有進行國際通話的權限。請聯絡您的 {brand} 帳戶管理員進行升級。"), _defineProperty(_callErrors$noToNumbe, _callErrors["default"].noRingoutEnable, "您的分機可以使用桌面應用程式進行通話。\n    若您希望切換至其他通話選項，\n    請聯絡您的帳戶管理員進行升級。"), _defineProperty(_callErrors$noToNumbe, "areaCode", "區碼"), _defineProperty(_callErrors$noToNumbe, "telus911", "不支援緊急撥號。"), _callErrors$noToNumbe); // @key: @#@"[callErrors.noToNumber]"@#@ @source: @#@"Please enter a valid phone number."@#@
