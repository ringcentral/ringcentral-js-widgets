...
export default {
  ...
  [callErrors.noAreaCode]: "Määritä {areaCodeLink} käyttämään 7-numeroisia paikallispuhelinnumeroita.",
  [callErrors.connectFailed]: "Yhteys epäonnistui. Yritä myöhemmin uudelleen.",
  [callErrors.internalError]: "Ei voida yhdistää sisäisten virheiden takia. Yritä myöhemmin uudelleen.",
