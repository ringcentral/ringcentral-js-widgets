...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Falha ao unir as chamadas devido a erros inesperados. Tente novamente mais tarde.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Falha ao unir as chamadas devido a erros inesperados. Tente novamente mais tarde.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Falha ao desligar a conferência devido a erros inesperados. Tente novamente mais tarde.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Falha ao remover o participante devido a erros inesperados. Tente novamente mais tarde.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Gravação de chamada em curso. Pare a gravação e tente novamente.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
