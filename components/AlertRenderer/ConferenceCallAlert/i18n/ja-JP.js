...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, '予期しないエラーにより、通話をマージできませんでした。後でもう一度やり直してください。'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, '予期しないエラーにより、通話をマージできませんでした。後でもう一度やり直してください。'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, '予期しないエラーにより、会議を終了できませんでした。後でもう一度やり直してください。'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, '予期しないエラーにより、参加者を削除できませんでした。後でもう一度やり直してください。'), _ConferenceCall.conferenceCallErrors.callIsRecording, '通話を録音中です。録音を停止し、もう一度やり直してください。'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
