...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Het samenvoegen van de oproepen is mislukt vanwege onverwachte fouten. Probeer het later opnieuw.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Het samenvoegen van de oproepen is mislukt vanwege onverwachte fouten. Probeer het later opnieuw.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Het ophangen van de conference is mislukt vanwege onverwachte fouten. Probeer het later opnieuw.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Het verwijderen van de deelnemer is mislukt vanwege onverwachte fouten. Probeer het later opnieuw.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Oproepopname bezig. Stop met opnemen en probeer het opnieuw.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
