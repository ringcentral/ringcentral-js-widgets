...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Puheluiden yhdistäminen epäonnistui odottamattoman virheen vuoksi. Yritä myöhemmin uudelleen.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Puheluiden yhdistäminen epäonnistui odottamattoman virheen vuoksi. Yritä myöhemmin uudelleen.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Neuvottelupuhelun lopettaminen epäonnistui odottamattoman virheen vuoksi. Yritä myöhemmin uudelleen.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Osallistujan poistaminen epäonnistui odottamattoman virheen vuoksi. Yritä myöhemmin uudelleen.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Puhelun tallennus on käynnissä. Lopeta tallennus ja yritä uudelleen.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
