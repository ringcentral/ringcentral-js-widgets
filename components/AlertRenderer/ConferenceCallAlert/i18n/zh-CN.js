...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, '由于意外错误，合并通话失败。请稍后重试。'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, '由于意外错误，合并通话失败。请稍后重试。'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, '由于意外错误，挂断电话会议失败。请稍后重试。'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, '由于意外错误，移除参与者失败。请稍后重试。'), _ConferenceCall.conferenceCallErrors.callIsRecording, '正在通话录音。请停止录音并重试。'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
