...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Failed to merge the calls due to unexpected errors. Please try again later.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Failed to merge the calls due to unexpected errors. Please try again later.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Failed to hang up the conference due to unexpected errors. Please try again later.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Failed to remove the participant due to unexpected errors. Please try again later.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Call recording in progress. Please stop recording and try again.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
