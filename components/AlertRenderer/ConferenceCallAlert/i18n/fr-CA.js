...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Impossible de fusionner les appels en raison d’erreurs inattendues. Veuillez réessayer plus tard.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Impossible de fusionner les appels en raison d’erreurs inattendues. Veuillez réessayer plus tard.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Impossible de raccrocher en raison d’erreurs inattendues. Veuillez réessayer plus tard.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Impossible de supprimer le participant en raison d’erreurs inattendues. Veuillez réessayer plus tard.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Enregistrement d’appel en cours. Veuillez arrêter l’enregistrement et réessayer.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
