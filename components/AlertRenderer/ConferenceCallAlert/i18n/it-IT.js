...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _ConferenceCall.conferenceCallErrors.bringInFailed, 'Impossibile unire le chiamate a causa di errori imprevisti. Riprova più tardi.'), _ConferenceCall.conferenceCallErrors.makeConferenceFailed, 'Impossibile unire le chiamate a causa di errori imprevisti. Riprova più tardi.'), _ConferenceCall.conferenceCallErrors.terminateConferenceFailed, 'Impossibile chiudere la conferenza a causa di errori imprevisti. Riprova più tardi.'), _ConferenceCall.conferenceCallErrors.removeFromConferenceFailed, 'Impossibile rimuovere il partecipante a causa di errori imprevisti. Riprova più tardi.'), _ConferenceCall.conferenceCallErrors.callIsRecording, 'Registrazione chiamata in corso. Interrompi la registrazione e riprova.'); // @key: @#@"[conferenceCallErrors.bringInFailed]"@#@ @source: @#@"Failed to merge the calls due to unexpected errors. Please try again later."@#@
