...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, 'No se pudo cargar el registro de llamadas a causa de un error inesperado. Actualice la página y vuelva a intentarlo.'), _callLogMessages["default"].logFailed, 'No pudimos registrar su llamada. Inténtelo de nuevo más tarde.'), _callLogMessages["default"].fieldRequired, 'Se deben completar los campos obligatorios.'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
