...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, 'No se ha podido cargar el registro de llamadas por un error inesperado. Actualice la página y vuelva a intentarlo.'), _callLogMessages["default"].logFailed, 'Lo sentimos, no hemos podido registrar su llamada. Inténtelo de nuevo más tarde.'), _callLogMessages["default"].fieldRequired, 'Se deben completar los cambios obligatorios.'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
