...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, 'Impossible de charger le formulaire du journal des appels en raison d’une erreur inattendue. Veuillez actualiser la page et réessayer.'), _callLogMessages["default"].logFailed, 'Désolés, nous n’avons pas réussi à enregistrer votre appel. Veuillez réessayer plus tard.'), _callLogMessages["default"].fieldRequired, 'Tous les champs obligatoires sont requis.'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
