...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, '發生未預期的錯誤，無法載入通話記錄表格。請重新整理頁面然後再試一次。'), _callLogMessages["default"].logFailed, '抱歉，我們無法記錄您的電話。請稍後再試。'), _callLogMessages["default"].fieldRequired, '請填寫必要欄位。'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
