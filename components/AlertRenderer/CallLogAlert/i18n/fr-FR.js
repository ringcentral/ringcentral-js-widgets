...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, 'Échec du chargement du formulaire du journal des appels en raison d’une erreur inattendue. Veuillez actualiser la page et réessayer.'), _callLogMessages["default"].logFailed, 'L’enregistrement de votre appel a échoué. Veuillez réessayer ultérieurement.'), _callLogMessages["default"].fieldRequired, 'Remplissez les champs obligatoires.'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
