...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty({}, _callLogMessages["default"].logCallLogFailed, '由于意外错误，加载通话记录表单失败。请刷新页面并重试。'), _callLogMessages["default"].logFailed, '抱歉，我们无法记录您的通话。请稍后重试。'), _callLogMessages["default"].fieldRequired, '请填写必填字段。'); // @key: @#@"[callLogMessages.logCallLogFailed]"@#@ @source: @#@"Failed to load call log form due to unexpected error. Please refresh the page and try again."@#@
