...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _AudioSettings.audioSettingsErrors.userMediaPermission, '請向 {application} 授予存取音訊的權限。'), _AudioSettings.audioSettingsErrors.ringtoneSizeOverLimit, '您嘗試上傳的檔案太大。請嘗試小於 5MB 的檔案。'), _AudioSettings.audioSettingsErrors.duplicateRingtone, '您嘗試新增的鈴聲已存在。'), _AudioSettings.audioSettingsErrors.uploadRingtoneFailed, '新增您的鈴聲時發生錯誤。請再試一次。'), _AudioSettings.audioSettingsErrors.deleteRingtoneFailed, '刪除您的鈴聲時發生錯誤。請再試一次。'); // @key: @#@"[audioSettingsErrors.userMediaPermission]"@#@ @source: @#@"Please grant {application} to access your audio."@#@
