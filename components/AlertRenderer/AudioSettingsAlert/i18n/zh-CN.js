...
var _default = exports["default"] = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _AudioSettings.audioSettingsErrors.userMediaPermission, '请授予 {application} 访问您音频的权限。'), _AudioSettings.audioSettingsErrors.ringtoneSizeOverLimit, '您尝试上传的文件太大。请尝试上传小于 5MB 的文件。'), _AudioSettings.audioSettingsErrors.duplicateRingtone, '您尝试添加的铃声已存在。'), _AudioSettings.audioSettingsErrors.uploadRingtoneFailed, '添加您的铃声时发生错误。请重试。'), _AudioSettings.audioSettingsErrors.deleteRingtoneFailed, '删除您的铃声时发生错误。请重试。'); // @key: @#@"[audioSettingsErrors.userMediaPermission]"@#@ @source: @#@"Please grant {application} to access your audio."@#@
