...
var ContactDropdownList = exports.ContactDropdownList = /*#__PURE__*/function (_Component) {
  function ContactDropdownList() {
    ...
    _this = _callSuper(this, ContactDropdownList, [].concat(args));
    _this.node = void 0;
    return _this;
  }
  _inherits(ContactDropdownList, _Component);
  return _createClass(ContactDropdownList, [{
