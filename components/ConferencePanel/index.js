  ...
  function ConferencePanel(props) {
    ...
    _this.inviteTxt = function () {
      var _this$props = _this.props,
          ...
          dialInNumbersLink = _this$props.dialInNumbersLink,
          conferenceInviteText = _this$props.conferenceInviteText,
      ...
      return (0, _formatMessage["default"])(conferenceInviteText, {
        brandName: brandName,
        ...
        dialInNumbersLink: dialInNumbersLink
      });
    };
...
ConferencePanel.propTypes = {
  ...
  dialInNumbersLink: _propTypes["default"].string.isRequired,
  conferenceInviteText: _propTypes["default"].string.isRequired,
